    ...
    where r.access>0 and p.id=r.page_id and p.feature_id=f.id and r.user_id=" . $user_id . " and f.module_id=" . $mod_id . "  order by f.ordering,f.id";
        ...
        if ($count > 0) {
            ...
            while ($menu = mysql_fetch_object($query)) {
                ...
                echo '<div class="silverheader mhafuz' . $m . '"><a href="#"><i class="';
                echo ($menu->icon != '') ? $menu->icon : 'fa fa-cubes';
                echo '" aria-hidden="true"></i> ' . $menu->feature_name . '<span ></span></a></div>';
        ...
        <div style="background:#1b2733;">
            ...
            ?>
                <h6 style="background-color:#4f64a5;color:white;padding:10px;text-align:center;"><a href="../../../<?php echo $module_data->module_link; ?>" style="color:white!important;" target="_blank">
