...
<div class="input-wrap row">
    ...
    <label for="inputName" class="col-1 col-form-label">Shop</label>
    <div class="col-2">
...
<label for="inputName" class="col-1 col-form-label">Order</label>
<div class="col-3"><input class="form-control" name="do_no" id="do_no" placeholder="do_no" 
value="<? if($$unique_master>0) echo $$unique_master; else echo (find_a_field($table_master,'max('.$unique_master.')','1')+1);?>" readonly="readonly">
</div>    
    

            
            <label for="do_date" class="col-1 col-form-label">Date</label>
            <div class="col-3">
...
<div class="col-2"><? $field='shop_status';?>
...
<label for="inputName" class="col-1 col-form-label">Note</label>
<div class="col-3"><input class="form-control" name="remarks" id="remarks" placeholder="remarks" 
value="<?=$remarks?>">
</div>
...
<a href="do_view.php?do=<?php echo $$unique_master;?>" class="btn btn-primary" role="button">View</a>
</div>    
		  ...
		  <? }else{?>
		<div class="col-6 mt-3">
		  <input name="new" type="submit" class="btn btn-primary" value="Initiate"/>
...
<input list="browsers" class="form-control" name="item_id" id="item_id" tabindex="1" onChange="getData()" autocomplete="off" style="width:80px;" autofocus/>
