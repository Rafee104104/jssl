...
<form action="" method="POST" class="form-fill">
        <div class="row h-100">
            <div class="col-11 col-sm-11 col-md-6 col-lg-5 col-xl-3 mx-auto align-self-center py-4">
                <h2 class="mb-4"><span class="text-secondary fw-light">Sign in to </span><br />Secondary Sales</h2>
                <div class="form-group form-floating mb-3 is-valid">
                    <input type="number" class="form-control" name="username" 
					value="<?php echo $_COOKIE['user_2sales'];?>" id="username" placeholder="Employee Code" autocomplete="off">
            ...
            <div class="col-11 col-sm-11 mt-auto mx-auto py-4">
                <div class="row ">
                    <div class="col-12 d-grid">
                        <button type="submit" class="btn btn-default btn-lg btn-rounded shadow-sm" id="login">Sign In</button>
                    </div>
                </div>
<div class="row mt-3">
<center>
<!-- <span style="color:#CC6699">Developed BY: ERP.COM.BD</span> -->
<!--<p><strong>Help Line</strong></p>-->
<!--<p>Sohel Rana, IT <a href="tel:01709647801">01709647801</a></p>-->
<!--<p>Tapos Paul, Sales Admin <a href="tel:01755520888">01755520888</a></p>-->
<!--<p>Jakaria Bhuiyan <a href="tel:01713653161">01713653161</a></p>-->
