...
<!-- User list items  -->
<div class="row">
<div class="row text-center mb-2"><h4>Order List</h4></div>    
    ...
    <div class="card shadow-sm mb-2">        
            ...
            <li class="list-group-item border-0">
                ...
                <div class="row">
                    ...
                    <div class="col px-0">
                        <p class="mb-0">Order No: <?=$data->do_no?>  <?=$data->shop_name?><br><small class="text-secondary">Order Date: <?=$data->do_date?></small></p>
                    </div>
