...
<div class="col-md-8">
    ...
    <select class="form-control col-md-12" name="shop_route_type" required>
        ...
        <option>Outsite  Bazar</option>
                            ...
                            <textarea id="addressss" readonly class="form-control"></textarea>
...
<div id="panel" class="text-center">
  ...
  <input type="button" id="locatedMe" value="Locate Me"  onclick="initMap()" class="btn btn-danger" >
</div>
...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCPfrXFXYtJA_xSPSP4mZcE-qlGSSQzu-0">
</script>
<script>
...
function updateMarkerAddress(str) {
    ...
    document.getElementById('addressss').value = str;
