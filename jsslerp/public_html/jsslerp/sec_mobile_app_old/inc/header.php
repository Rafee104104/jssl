...
<body class="body-scroll theme-indigo" data-page="shop">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    ...
                                    <a class="dropdown-item nav-link" href="do_list.php">
                                        ...
                                        <div class="col align-self-center">Delivery</div>
                                ...
                                <li>
                                    ...
                                    <a class="dropdown-item nav-link" href="chalan_list.php">
                                        ...
                                        <div class="col align-self-center">Chalan List</div>
                                ...
                                <li>
                                    ...
                                    <a class="dropdown-item nav-link" href="do_status.php">
                                        ...
                                        <div class="col align-self-center">DO List</div>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    ...
                                    <a class="dropdown-item nav-link" href="new_shop2.php">
