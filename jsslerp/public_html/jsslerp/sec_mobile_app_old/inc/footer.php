...
<input type="hidden" id="retunrValues">
...
<script>
        ...
        var longValues = 0;
    checkNowLocation();
    setInterval(function(){checkNowLocation()},5000);
    function checkNowLocation(){
        
        navigator.geolocation.getCurrentPosition(function(position){ 

            latValues=position.coords.latitude;
            longValues = position.coords.longitude;
...
$.ajax({
         ...
         success: function(html) {
            console.log(html);
        document.getElementById("retunrValues").value=html;
