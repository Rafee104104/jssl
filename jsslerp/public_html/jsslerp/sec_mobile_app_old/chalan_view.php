...
<span class="">Authorized Distributor<br>of MEP Group</span>
                ...
                <div class="col align-self-center">
                    <div class="card">
                        <div class="card-header bg-success text-white">
                            <div class="row">
                                <center><span style="font-size:20px;">Invoice Copy</span></center>
  ...
  <table class="table table-sm table-bordered">
    <thead>
      <tr>
			...
			<th class="text-left">NSP(Rate)</th>
...
?>			 
	<tr>
		...
		<td class="unit"><?php echo number_format($row->t_price,2)?></td>
		<td class="unit"><?php echo number_format($row->nsp_per,2)?></td>
...
<span style="float: left;">Customer Signature</span> 
<span style="float: right;">FO Signature</span>
