                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col align-self-center">
                                    ...
                                    <span style="font-size:10px;">TP: <?=$data->t_price?> Dis: <?=$data->nsp_per?>%</span>
                                    <h6>BDT <?php echo $data->unit_price;?> <small class="text-secondary size-12">x <?php echo $data->total_unit;?> Qty</small></h6>
                                </div>
                                
                                
                                <div class="col-auto align-self-center ps-0">
                                    <!--<a href="track.php">Track <i class="bi bi-chevron-right"></i></a>-->
                                    TK: <?php echo $data->total_amt;?>
                                </div>
                            </div>
...
<?php } ?>                
            ...
            <div class="row mb-4">
                <div class="col-12 mb-4">
                    <a href="#" class="btn btn-default shadow-sm btn-lg w-100 btn-rounded">Thank You<br>MEP GROUP</a>
                </div>
            </div>
        </div>
