...
<div class="form-group row">
            <div class="col-3"><label for="do_no" class="col-form-label">Order NO:</label></div>
            <div class="col-3 mb-1"><div class="col-sm-2"><? $field='do_no';?><input  class="form-control border border-info" name="<?=$field?>" type="text" id="<?=$field?>" value="<?=$$field?>" disabled="disabled"/></div></div>
...
<div class="form-group row mb-2">
            ...
            <div class="col-1"><label for="shop" class="col-sm-2 col-form-label">Shop:</label></div> 
            <div class="col-6"><? $field='dealer_code';?>
                ...
                <? }else{ ?>
                      ...
                      <input class="form-control border border-info" list="party" name="<?=$field?>" id="<?=$field?>" 
                      value="<?=$$field?> <?php echo $party_name=find1('select shop_name from ss_shop where dealer_code="'.$$field.'"');?>" autocomplete="off" required/>
                      <datalist id="party">
...
<tr>
    ...
    <input class="form-control border border-info" list="browsers" name="item_id" id="item_id" tabindex="1" onChange="getData()" autocomplete="off"/>
    <datalist id="browsers">
    	<?php optionlist('select item_id,item_name from item_info where 1 and finish_goods_code>0 and status=1 and item_name like "%nocilla%" order by item_name');?>
    </datalist>
    </td>
    <td></td>
    <td></td>
...
<tr>
    ...
    <td align="center" bgcolor="#0099FF"><span class="style1"><strong>Price</strong></span></td>
...
<tr>
    ...
    <td align="center" bgcolor="#CCCCCC">
    <input name="unit_price" type="text" class="input3" id="unit_price" tabindex="4" style="width:80px;"  onChange="count()" autocomplete="off" readonly/>
    </td>
    ...
    <td align="center" bgcolor="#CCCCCC"><input name="total_amt" tabindex="6" type="text" class="input3" id="total_amt" style="width:90px;" readonly="readonly" required/></td>
...
<tr><th>Name</th><th>Price*Qty</th><th>Amt</th><th>X</th></tr>
<?
$sl=1;
...
<tr>
<td colspan="1"><strong>Total</strong></td><td><strong><?=$gqty?></strong></td><td><strong><?=$gamt?></strong></td>
</tr>    
</table>
