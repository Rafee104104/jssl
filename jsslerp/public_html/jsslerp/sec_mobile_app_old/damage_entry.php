...
if(isset($_POST['new'])){
		...
		?><script>window.location.href = "damage_entry.php?oi_no=<?=$$unique;?>";</script><?
...
if(isset($_POST['delete'])){
		...
		?><script>window.location.href='damage_entry.php?pal=2';</script><?php 
}
...
<section class="content-main">
                <div class="content-header">
					<div>
						<center><h4 class="content-title card-title">Damage Entry</h4></center>
					</div>
            	</div>
...
<div class="form-group row">
            <div class="col-1"><label for="oi_no" class="col-form-label">NO:</label></div>
            <div class="col-3 mb-1"><div class="col-sm-2"><? $field='oi_no';?><input  class="form-control border border-info" name="<?=$field?>" type="text" id="<?=$field?>" value="<?=$$field?>" disabled="disabled"/></div></div>

            <div class="col-1"><label for="oi_date" class="col-form-label">Date</label></div> 
            <div class="col-5">
