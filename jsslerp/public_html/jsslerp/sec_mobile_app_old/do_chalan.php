...
$q = "INSERT INTO  ss_do_chalan (order_no, chalan_no, do_no, item_id, dealer_code,t_price,nsp_per, unit_price, pkt_size, pkt_unit, dist_unit, total_unit, total_amt, chalan_date, depot_id, driver_name, driver_name_real,shipping_name, vehicle_no,gate_pass_no, delivery_man, entry_by, entry_at,do_date)
VALUES 
('".$data->id."', '".$chalan_no."', '".$do_no."', '".$data->item_id."', '".$dealer_code."','".$data->t_price."','".$data->nsp_per."', '".$data->unit_price."', '".$data->pkt_size."', '".$chalan_pkt."', '".$chalan_dist."', '".$unit_qty."', '".$total_amt."', '".$chalan_date."', '".$_SESSION['warehouse_id']."', '".$driver_name."',
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td bgcolor="#9966FF"><strong>
			<input style="width:150px;"  name="chalan_date" type="date" id="chalan_date" required="required" value="<?=date('Y-m-d');?>"/>
          </strong></td>
