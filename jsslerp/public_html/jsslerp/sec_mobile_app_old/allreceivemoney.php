                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col align-self-center ps-0">
                                    <p class="small mb-1"><a href="profile.php" class="fw-medium">Shelvey</a> <span class="text-secondary">request send</span></p>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col align-self-center ps-0">
                                    <p class="small mb-1"><a href="profile.php" class="fw-medium">John Pattent</a>
                            ...
                            <div class="row">
                                ...
                                <div class="col align-self-center ps-0">
                                    <div class="row">
                                        <div class="col">
                                            <p class="small mb-1">
                                                <a href="profile.php" class="fw-medium">Alice Doe</a>
