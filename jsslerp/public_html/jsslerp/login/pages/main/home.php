...
<?php /*?><? if($cid == 'robi' || $cid == 'mark' || $cid == 'mamun'){ ?><?php */?>
    ...
    <header class="oe_website_header">
      ...
      <div class="oe_row oe_fit">
        ...
        <div align="left" style="float:left">
            ...
            ?>
            <img src="<?=$show_logo?>" class="logo-new-cid-class" style="height:auto;">
			<!--<img src="<?=$show_logo?>" width="200px" height="60px">-->

        </div>

        <div align="right" style="float:right">
            <img src="../../../logo/erp1.png" width="100%" height="40px">
        </div>
...
//$sql22="select a.module_name,a.module_link,a.module_icon_img,a.module_description,a.id,b.user_id,b.module_id ,b.status from user_module_manage a,user_module_define b, user_module_order_list c where b.module_id=a.id and b.user_id='".$u_id."' and b.status='enable' AND c.user=b.user_id AND c.module=b.module_id ORDER BY c.order_list";
