    ...
    <header class="oe_website_header">
      ...
      <div class="oe_row oe_fit">
        ...
        <div align="right" style="float:right">
            <img src="../../../logo/erp1.png" width="100%" height="60px">
        </div>
...
$sort_qry = "SELECT * FROM user_module_order_list WHERE order_list <> 0 AND user='$u_id' ORDER BY order_list";
$sort_rslt = mysql_query($sort_qry);
while($sort = mysql_fetch_object($sort_rslt)){
    

    $sql22="select a.module_name,a.module_link,a.module_icon_img,a.module_description,a.id,b.user_id,b.module_id ,b.status from user_module_manage a,user_module_define b where b.module_id=a.id and b.user_id='".$sort->user."' AND a.id='".$sort->module."' and b.status='enable' ";
...
<?php 
    ...
    $sql22="select a.module_name,a.module_link,a.module_icon_img,a.module_description,a.id,b.user_id,b.module_id ,b.status from user_module_manage a,user_module_define b where b.module_id=a.id and b.user_id='".$u_id."' and b.status='enable' AND a.id NOT IN (SELECT module FROM user_module_order_list)";
...
<?php } ?>
        ...
        <div class="oe_row oe_appstore new-apps">
			...
			<a href="../../../all_module_apk/EmployeePortal.apk" title="vehicle.apk" class="oe_app ab_app_descr download_a">
                ...
                <div class="oe_app_icon"><img src="../../../home/vehicle.png"></div>
...
<!-- this code for apps show and hide robi and dev -->
<? if($cid == 'robi'){?> 
<style>
.new-apps{
	display:block;
