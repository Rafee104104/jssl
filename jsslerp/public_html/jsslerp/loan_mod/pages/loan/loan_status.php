...
<script type="text/javascript"> function DoNav(lk){
    ...
    window.open("<?=$view_page?>?<?=$unique?>="+lk, "_blank");
...
<div class="oe_form_sheetbg">
        ...
        <div class="oe_form_sheet oe_form_sheet_width">
          ...
          <? $res='select l.loan_no,p.PBI_NAME as Employee_name,t.type,l.loan_amt,l.loan_date,l.total_installment,l.status,u.fname as entry_by from loan_master l, personnel_basic_info p,loan_type t, user_activity_management u where l.PBI_ID=p.PBI_ID and t.id=l.type and u.user_id=l.entry_by';
