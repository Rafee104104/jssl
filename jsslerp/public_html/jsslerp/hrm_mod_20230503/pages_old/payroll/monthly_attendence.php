...
if (pbi_held_up.checked == true){
var sta = 1;}
else
{var sta=0;}

var strURL="monthly_attendence_ajax.php?PBI_ID="+PBI_ID+"&td="+td+"&fd="+fd+"&od="+od+"&hd="+hd+"&lt="+lt+"&ab="+ab+"&lv="+lv+"&lwp="+lwp+"&pre="+pre+"&pay="+pay+"&deduction="+deduction+"&mon="+mon+"&year="+year+"&bonus="+bonus+"&benefits="+benefits+"&other_benefits="+other_benefits+"&dealer_code="+dealer_code+"&remarks="+remarks+"&pbi_held_up="+sta;
...
<td align="center"><input name="dealer_code_<?=$info->PBI_ID?>" type="text" id="dealer_code_<?=$info->PBI_ID?>" style="font-size:10px; width:45px; min-width:45px;" value="<?=($data->dealer_code=='')?$att->dealer_code:$data->dealer_code;?>" size="2" maxlength="10" /></td>
...
<td align="center"><input name="deduction_<?=$info->PBI_ID?>" type="text" id="deduction_<?=$info->PBI_ID?>" style="font-size:10px; width:35px; min-width:20px;"  value="<?=$mobile_bills?>" size="8" maxlength="8" readonly="readonly" /></td>
          ...
          <td align="center"><input name="other_benefits_<?=$info->PBI_ID?>" type="text" id="other_benefits_<?=$info->PBI_ID?>" style="font-size:10px; width:35px; min-width:20px;" 
value="<?=$data->other_benefits?$data->other_benefits:$other_bill;?>" size="8" maxlength="8" /></td>
