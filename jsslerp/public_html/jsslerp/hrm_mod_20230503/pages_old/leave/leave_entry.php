...
<tr>
  ...
  <td align="center">Total working day <?=$total_d?></td>
  <td align="center">Start Date <?=$cdate?>. End date <?=$last_date?> </td>
</tr>
<tr>
  <td align="center" bgcolor="#CC99FF">Year</td>
<td align="center" bgcolor="#CC99FF">Leave Quota</td>
...
<td align="center">
<?=$leave_c1 = find_a_field('hrm_leave_info','sum(total_days)','type not in("LWP (Leave Without Pay)","Compensatory Off") 
