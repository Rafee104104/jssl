    ...
    <div class="oe_view_manager_body">
      ...
      <div class="oe_view_manager_view_form">
        <div style="opacity: 1; text-align: right;" class="oe_formview oe_view oe_form_editable">
                          ...
                          <tbody>
                            ...
                            <tr >
                              ...
                              <td align="right"><div align="left"><span class="oe_form_group_cell"> </span><span class="oe_form_group_cell">
								...
								value="<? if($_POST['roster_date']>0){echo $_POST['roster_date'];}else{echo date("Y-m-d");}?>" required />
                              </span></div></td>
                            </tr>
		  ...
		  <td><span id="loc"><select name="job_location" id="job_location" >
...
<input name="department" style="width:160px;" id="department" value="<?=$dept_id; ?>" readonly="readonly">
