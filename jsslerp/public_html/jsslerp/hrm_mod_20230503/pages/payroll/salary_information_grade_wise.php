                    ...
                    <table  border="0" cellpadding="0" cellspacing="0" class="table table-bordered table-sm">
                      <tbody>
                        <tr class="oe_form_group_row">
						  ...
						  <select name="grade" id="grade" onchange="getData2('grade_ajax.php', 'grade_year_id', document.getElementById('grade').value)" >
						  <option></option>
                          ...
                          <td  class="oe_form_group_cell">
						          <span id="grade_year_id">
						                <select name="year_no"  id="year_no"  tabindex="2" style="width:220px;">
										<option></option>
                        ...
                        <tr class="oe_form_group_row">
                          <td  colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Salary Scale Grade Wise :
						  ...
						  <span id="grade_year_val">
							...
							<input name="ta" type="text" id="ta" onclick="pf_cal()"  value="<?=$ta?>" class="form-control" />
