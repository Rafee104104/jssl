...
<script type="text/javascript"> function DoNav(lk){
    ...
    <form  action="" method="post" enctype="multipart/form-data">
		...
		<?
            ...
            $res='select s.id,s.id, s.schedule_name,s.office_start_time,s.office_end_time,s.min_in,s.max_out,s.status,u.group_name from hrm_schedule_info s, user_group u ';
