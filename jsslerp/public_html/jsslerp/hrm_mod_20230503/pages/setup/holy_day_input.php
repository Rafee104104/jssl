        ...
        <a href="home2.php" rel = "gb_page_center[940, 600]"><?=$title?></a>
            ...
            <td class="oe_form_group_cell"><table width="261" height="99" border="0" cellpadding="0" cellspacing="0" class="oe_form_group ">
              <tbody>
				...
				<tr class="oe_form_group_row">
				<td width="18%" height="33" colspan="1" bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Holy Day For:</td>
                  <td height="33" colspan="" class="oe_form_group_cell oe_form_group_cell_label"><select name="job_loc_id" id="job_loc_id" class="form-control">
                  <option></option>
