...
<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" eight="790">
  <tr>
    <td height="" colspan="5"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td width="1"><img src="../../../logo/1.png" width="200"  style="padding-left:20px;" /></td> 
          <td>
...
<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" eight="790">
  ...
  <? 
 $res = "select o.*, a.PBI_ID, a.PBI_NAME from personnel_basic_info a, hrm_leave_info o where  a.PBI_ID=o.PBI_ID and leave_status='GRANTED' and s_date>='".$g_s_date."' and e_date<='".$g_e_date."'  and o.PBI_ID=".$hrm_leave_info->PBI_ID;
