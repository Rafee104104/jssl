                        ...
                        <table width="100%" border="0" class="oe_list_content">
                          <thead>
                            <tr class="oe_list_header_columns">
                              <th colspan="4"><div align="center"><span >Roster Day Set</span></div></th>
                            </tr>
                            <tr class="oe_list_header_columns">
                          ...
                          <tbody>
                            ...
                            <tr >
                              ...
                              <td width="15%" align="right"><div align="right"><strong>Date :</strong></div></td>
                              <td width="34%" align="right"><div align="left"><span class="oe_form_group_cell">
                                <input name="roster_date" type="text" id="roster_date" value="<?=$_POST['roster_date']?>" required="required"  class="form-control"/>
                              </span></div></td>
                              <td width="23%" align="right"><div align="left"><span class="oe_form_group_cell"> </span></div></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                              ...
                              <td><select name="group_for" id="group_for"   onchange="getData2('ajax_location.php', 'loc', this.value,  this.value)" required="required"  class="form-control">
							    <? foreign_relation('domai', 'DOMAIN_CODE', 'DOMAIN_DESC',$_POST['group_for'],'1')?>
                                <? //old foreign_relation('user_group', 'id', 'group_name',$_POST['group_for'],'1') ?>
                              </select></td>
                              <td>&nbsp;</td>
                            </tr>
							...
							<tr>
                              <td align="center" style="text-align: right">&nbsp;</td>
                              <td align="center" style="text-align: right"><div align="right"><strong>Department : </strong></div></td>
                            ...
                            <tr>
                              ...
                              <td><select name="job_location" id="job_location"   class="form-control">
							...
							<br /><br />
                              <input name="create" id="create" value="SHOW EMPLOYEE" type="submit" class="btn btn-info">
                            </div></td>
                            </tr>
                          </tbody>
                        </table>
