                ...
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <div class="container n-form2">
						...
						<div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                <input name="PBI_DOMAIN" id="PBI_DOMAIN" value="<?=$sec_name; ?>" readonly="readonly" />
                            </div>
                        </div>
						<div class="form-group row m-0 pb-1">
...
<!--            table start hear-->
            <table class="table1  table-striped table-bordered table-hover table-sm">
                ...
                <tr>
                    <td><input type="radio" placeholder="test 2" id="1" id="report" name="report" value="1"/></td>
                    <td class="bold" align="left"> <label for="1">Roster Schedule Report (1)</label> </td>
                </tr>
				
				 <tr>
                    <td><input type="radio" id="2" placeholder="test 2" id="report" name="report" value="2"/></td>
                    <td class="bold" align="left"> <label for="2">Schedule Vs Attendance Report(2)</label> </td>
                </tr>
				
				 <tr>
                    <td><input type="radio" id="2025" placeholder="test 2" id="report" name="report" value="2025"/></td>
