...

{
		...
		$report="Dally Attendance Report";
    ...
    <th width="10%" bgcolor="#FFFACD">DEPARTMENT</th>
		...
		<th width="20%" bgcolor="#FFFACD">Over TIME Hour</th>
...
$section_con .= ' and p.SECTION_ID = "'.$_POST['PBI_SECTION'].'" ';
 		 ...
 		 $sql="select p.* from personnel_basic_info p where 1 ".$dept_con.$desg_con.$section_con."";
 ...
 $max_min_time=date("h:i:s a",strtotime($max_time[$row->PBI_ID]));
  ...
  <td><? if($max_min_time!=$new_min_time) echo $max_min_time;?></td>
	...
	<td><?=find_a_field('hrm_att_summary','over_time_hour','emp_id="'.$row->PBI_ID.'" and att_date="'.$t_date.'"');?>
...
?>
	 ...
	 <table width="100%">
		...
		<tr><td width="25%" align="center" style="border:0px; border-color:white;"><img src="../../../logo/tecno.png" style="width:220px;"></td>
...
//////////////////////
		...
		while($info=mysql_fetch_object($res2)){
