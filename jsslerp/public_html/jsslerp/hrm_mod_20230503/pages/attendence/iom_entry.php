...
$up_query='update hrm_att_summary set iom_type="", iom_sl_no="", iom_reason="", iom_approved_by="", iom_entry_at="0000-00-00 00:00:00", iom_entry_by="" where iom_id="'.$_GET['iom_id'].'" and emp_id="'.$_GET['emp_id'].'"';
...
if($_POST['iom_type']=='Early Half'){
 ...
 $ssql = "INSERT INTO hrm_iom_info (`dept_head_status` ,`PBI_ID` ,`type` ,`s_date` ,`e_date` , `reason` ,`iom_category`,`total_days`,`s_time`,`e_time`,`entry_at`)

VALUES (  'Approve', '".$emp_id."', '".$_POST['iom_type']."',  '".$_POST['f_date']."', '".$_POST['t_date']."', '".$iom_reason."','".$iom_category."','".$total_days."', '".$s_time."' , '".$e_time."','".date('Y-m-d H:i:s')."')";
