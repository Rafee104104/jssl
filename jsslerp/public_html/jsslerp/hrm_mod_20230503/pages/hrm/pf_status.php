...
echo "test tttttttttttt SUCCESSFUL TEST PURPOSE";
...
<table width="1050" border="0" cellpadding="0" cellspacing="0" class="table table-bordered table-sm " >

  <tr class="oe_form_group_row">


<table width="1050" height="184" border="0" cellpadding="0" cellspacing="0" class="table table-bordered table-sm " >
  <tbody>
    <tr class="oe_form_group_row">
...
<input type="file" name="PBI_PICTURE_ATT_PATH" id="PBI_PICTURE_ATT_PATH" accept="image/jpeg" class="form-control" style="opacity:3!important;position:initial;" />
      ...
      <td bgcolor="#E8E8E8" width="23%" class="oe_form_group_cell"><span class="oe_form_group_cell oe_form_group_cell_label style1"> Medical Certificate :</span></td>
    ...
    <tr class="oe_form_group_row">
      ...
      <td class="oe_form_group_cell"><span class="oe_form_group_cell oe_form_group_cell_label style1">Security Money Receipt :</span></td>
    ...
    <tr class="oe_form_group_row">
      ...
      <td bgcolor="#E8E8E8" class="oe_form_group_cell"><span class="oe_form_group_cell oe_form_group_cell_label style1"> Received Aya Allowance :</span></td>
    ...
    <tr class="oe_form_group_row">
      ...
      <td class="oe_form_group_cell"><span class="oe_form_group_cell oe_form_group_cell_label style1">Posting Letter :</span></td>
      <td class="oe_form_group_cell"><span class="oe_form_group_cell oe_form_group_cell_label">
    ...
    <tr class="oe_form_group_row">
      ...
      <td bgcolor="#E8E8E8" class="oe_form_group_cell"><span class="oe_form_group_cell oe_form_group_cell_label style1">Clearance Certificate :</span></td>
      <td bgcolor="#E8E8E8" class="oe_form_group_cell"><span class="oe_form_group_cell oe_form_group_cell_label">
    ...
    <tr class="oe_form_group_row">
      ...
      <td class="oe_form_group_cell oe_form_group_cell_label style1"> Nominee :</td>
    ...
    <tr class="oe_form_group_row">
      ...
      <td bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label style1">Nominee Photo :</td>
