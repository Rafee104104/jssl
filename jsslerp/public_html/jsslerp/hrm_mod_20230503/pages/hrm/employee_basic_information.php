...
?>
                        <div class="row">
                          <div class="col-md-3 form-group">
                            ...
                            <a href="../../../assets/support/upload_view.php?name=<?=$row->PBI_PICTURE_ATT_PATH?>&folder=hrm_emp_pic" target="_blank" download> <img src="../../../assets/support/upload_view.php?name=<?=$row->PBI_PICTURE_ATT_PATH?>&folder=hrm_emp_pic&proj_id=<?=$_SESSION['proj_id']?>&mod=<?=$module_name?>" width="120" height="152" /></a>
                            <? }else{ ?>
                          ...
                          <div class="col-md-3 form-group">
                            ...
                            <a href="../../../assets/support/upload_view.php?name=<?=$row->PBI_NID_ATT_PATH?>&folder=hrm_nid_pic" target="_blank" download> <img src="../../../assets/support/upload_view.php?name=<?=$row->PBI_NID_ATT_PATH?>&folder=hrm_nid_pic&proj_id=<?=$_SESSION['proj_id']?>&mod=<?=$module_name?>" width="120" height="152"/></a>
                            <? }else{ ?>
                          ...
                          <div class="col-md-3 form-group">
                           ...
                           <a href="../../../assets/support/upload_view.php?name=<?=$row->PBI_PASSPORT_ATT_PATH?>&folder=hrm_passport_pic" target="_blank" download> 
						   <img src="../../../assets/support/upload_view.php?name=<?=$row->PBI_PASSPORT_ATT_PATH?>&folder=hrm_passport_pic&proj_id=<?=$_SESSION['proj_id']?>&mod=<?=$module_name?>" width="120" height="152" /></a>
								 
                            <? }else{ ?>
                            <img src="../../pic/tin.png&proj_id=<?=$_SESSION['proj_id']?>&mod=<?=$module_name?>" width="150px" height=""/>
                            <? } ?>
                          </div>
                            ...
                            <? }else{ ?>
                            <img src="../../pic/passport.png&proj_id=<?=$_SESSION['proj_id']?>&mod=<?=$module_name?>" width="150px" height=""/>
                            <? } ?>
                          </div>
