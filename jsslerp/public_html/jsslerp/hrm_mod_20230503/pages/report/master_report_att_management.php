...
<table style="width: auto; margin: 0 auto; font-size: 20px;text-align:center;" border="1" bordercolor="#FFFFFF">
<tr><td style="border:0px solid white;"><strong><?=$str?></strong></td></tr>
...
<td><?=$s1++;?></td>
<td><div align="center"><?=$r->PBI_ID?></div></td>
<td><?=$r->PBI_NAME?></td>
<td><?=$r->PBI_DOJ;?></td>
...
$basic=find_all_field('personnel_basic_info','',"PBI_ID=".$_POST['pbi_id_in']);?>
    <div class="col-12">
      ...
      <table width="70%" border="1" align="center" cellpadding="0" cellspacing="0" eight="790" 
 class="table table-bordered table-sm" style="border-color:#CCCCCC;">
        <tbody>
        <h3 class="panel-title" align="center">JOB CARD</h3>
        <tr >
        ...
        <tr align="center" valign="middle" bgcolor="#FFFFFF">
          ...
          <td width="8%"><div align="center" class="style4">
              <?=find_a_field('designation','DESG_DESC','DESG_ID='.$basic->DESG_ID);?>
            </div></td>
          <td width="8%"><div align="center" class="style4">
              <?=$basic->PBI_SEX?>
            </div></td>
          <td width="10%"><div align="center" class="style4">
              <?=find_a_field('department','DEPT_DESC','DEPT_ID='.$basic->DEPT_ID);?>
            </div></td>
        </tr>
        <tr align="center" valign="middle" bgcolor="#FFFFFF">
          ...
          <td width="8%">&nbsp;</td>
          <td width="8%"><div align="center" class="style14">Project</div></td>
          <td width="8%"><div align="center" class="style14"></div>
            Service Length</td>
        </tr>
        <tr align="center" valign="middle" bgcolor="#FFFFFF">
          <td width="8%"><div align="center" class="style4">
          ...
          <td width="8%"><div align="center" class="style4">
              <?=$basic->PBI_APPOINTMENT_LETTER_DATE?>
            </div></td>
          <td width="8%">&nbsp;</td>
          <td width="8%"><div align="center" class="style4">
              <?=find_a_field('project','PROJECT_DESC','PROJECT_ID='.$basic->JOB_LOCATION);?>
            </div></td>
          <td width="8%"><div align="center" class="style4">
              <?=$basic->PBI_SERVICE_LENGTH?>
            </div></td>
        </tr>
        </tbody>
      </table>
...
$endDate = $_POST['year'].'-'.$_POST['mon'].'-31';
 ...
 $leave_query=mysql_query($leave_sql);
 while($data = mysql_fetch_object($leave_query)){
...
$val[$data->att_date]['over_time_hour'] = $data->over_time_hour;
...
?>
      <tr bgcolor="<?=$bgcolor?>">
        ...
        <td><div align="center">
            <?=date("h:i:sa",strtotime($val[$day_date]['in_time']));?>
          </div></td>
        <?php }else{  ?>
        <td></td>
        <?php  } ?>
        ...
        <td><div align="center">
            <?=date("h:i:sa",strtotime($val[$day_date]['out_time']));?>
          </div></td>
        <?php }else{  ?>
        <td></td>
        <?php  } ?>
  ...
  <table width="70%" cellspacing="0" cellpadding="2" border="0" style="margin:auto;background-color:#D4EDDA">
    <thead>
      <? 
 $PBI_ID = $_POST['pbi_id_in'];



 $final_data = find_all_field('hrm_attendence_final','','PBI_ID="'.$PBI_ID.'" and mon="'.$_POST['mon'].'" and year="'.$_POST['year'].'"');
    ...
    <tbody>
      <tr>
        ...
        <td align="right"><?=$final_data->lt?></td>
        <td align="right"><?=$final_data->eo?></td>
...
?>
	  ...
	  ?></td>
        ...
        <td><? $my_grand_total=($my_total+$my_year_total_profit); echo number_format($my_grand_total,2);?>
        </td>
      </tr>
      <tr style="color:red;">
        ...
        <td><? $gov_year_gov_tax = find_a_field('salary_pl_journal','sum(amt_in)',' 1 and fascicle_year="'.$data->year.'" and PBI_ID="'.$data->PBI_ID.'" and tr_from in ("Government")'); echo number_format($gov_year_gov_tax,2);?>
        </td>
        <td><? $gov_advanced_gotten = 0; echo number_format($gov_advanced_gotten,2);?>
        </td>
        <td><? $gov_year_advance_given = 0; echo number_format($gov_year_advance_given,2);?>
        </td>
        <td><? $gov_total=(($gov_before_year_stay+$gov_year_gov_tax+$gov_advanced_gotten)-$gov_year_advance_given); echo number_format($gov_total,2);?>
        </td>
        <td><?
	 ...
	 echo number_format($gov_year_tax_on_profit,2);
	  ...
	  ?>
        ...
        <td><? $gov_year_total_profit = ($gov_before_year_stay_profit+$gov_year_tax_on_profit);echo number_format($gov_year_total_profit,2);?>
        </td>
        <td><? $gov_grand_total=($gov_total+$gov_year_total_profit); echo number_format($gov_grand_total,2);?>
        </td>
      </tr>
      <tr>
        <td style="font-size: 12px"><b> মোট : </b></td>
        <td><b>
          <? $grand_before_year_stay = ($my_before_year_stay+$gov_before_year_stay); echo number_format($grand_before_year_stay,2)?>
          </b></td>
        <td><b>
          <? $grand_year_tax = ($my_year_tax+$gov_year_gov_tax); echo number_format($grand_year_tax,2)?>
          </b></td>
        <td><b>
          <? $grand_advanced_gotten = ($my_advanced_gotten+$gov_advanced_gotten); echo number_format($grand_advanced_gotten,2)?>
          </b></td>
        <td><b>
          <? $grand_year_advance_given = ($my_year_advance_given+$gov_year_advance_given); echo number_format($grand_year_advance_given,2)?>
          </b></td>
        <td><b>
          <? $grand_total = ($gov_total+$my_total); echo number_format($grand_total,2)?>
          </b> </td>
        <td><b>
          <? $grand_before_year_stay_profit = ($gov_before_year_stay_profit+$my_before_year_stay_profit); echo number_format($grand_before_year_stay_profit,2)?>
          </b></td>
        <td><b>
          <? $grand_year_tax_on_profit = ($gov_year_tax_on_profit+$my_year_tax_on_profit); echo number_format($grand_year_tax_on_profit,2)?>
          </b></td>
        <td><b>
          <? $grand_year_total_profit = ($gov_year_total_profit+$my_year_total_profit); echo number_format($grand_year_total_profit,2)?>
          </b></td>
        <td><b>
          <? $g_g_total = ($gov_grand_total+$my_grand_total); echo number_format($g_g_total,2)?>
          </b></td>
      </tr>
      <?
...
?>
  <table width="70%" cellspacing="0" cellpadding="2" border="0" style="margin:auto;">
    <thead>
      <tr>
        <th style="border:0px;" colspan="16"> <h2 align="center">Alin Food Products Ltd.</h2>
  ...
  <table width="80%" cellspacing="0" cellpadding="0" border="0" style="margin:auto; font-size:15px;">
    <tr style="page-break-before:always">
      <td style="border-bottom:0px; border-left:0px; border-right:0px;"><strong>Date :
        ...
        Please transfer TK =
        <?=number_format($grand_total,0)?>
        /- <b>(In Word:<? echo convertNumberMhafuz($grand_total);?>)</b> to our following employees bank accounts by debiting our Current A/C No:<b>105.110.19663</b> in the name of Alin Food Products Ltd. maintained with you.<br>
        <br>
...
$leave_name[$leave_data->id]=$leave_data->type;
 ...
 $dept_sql="select DISTINCT a.JOB_LOC_ID,a.PBI_ID,a.DEPT_ID,a.define_offday,dept.DEPT_DESC from personnel_basic_info a,department dept   
...
if($leave[$dept_data->PBI_ID][$i]>0){
	if($leave_type[$dept_data->PBI_ID][$i]=='Full'){	
		echo $att_status = '<span style="color:#ef0fb4; font-weight:bold;">Full Leave</span><br>';
