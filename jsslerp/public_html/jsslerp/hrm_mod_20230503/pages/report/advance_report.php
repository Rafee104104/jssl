            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <div class="container n-form2">
						...
						<div class="form-group row m-0 pb-1">
                            <label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Employee Code IN</label>
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
...
<!--            table start hear-->
            <table class="table1  table-striped table-bordered table-hover table-sm">
                ...
                <tr>
                    <td><input type="radio" placeholder="test 2" id="1" id="report" name="report" value="1" checked="checked"/></td>
                    <td class="bold" align="left"> <label for="1">	Basic Information</label> </td>
					
					<td><input type="radio" placeholder="test 2" id="2" id="report" name="report" value="80"/></td>
                    <td class="bold" align="left"> <label for="2">Attendance Summary Portal-Remarks</label> </td>
                </tr>
				
				 <tr>
                    <td><input type="radio" id="5" placeholder="test 2" id="report" name="report" value="2"/></td>
				...
				<tr>
                    <td><input type="radio" placeholder="test 2" id="3" id="report" name="report" value="78" /></td>
				...
				<tr>
                    <td><input type="radio" id="6" placeholder="test 2" id="report" name="report" value="3"/></td>
                    <td class="bold" align="left"> <label for="6">Monthly Attendence Report</label> </td>
					
					<td><input type="radio" placeholder="test 2" id="7" id="report" name="report" value="61" /></td>
                    <td class="bold" align="left"> <label for="7">Leave Report</label> </td>
                </tr>
				<tr>
                    <td><input type="radio" id="8" placeholder="test 2" id="report" name="report" value="79"/></td>
