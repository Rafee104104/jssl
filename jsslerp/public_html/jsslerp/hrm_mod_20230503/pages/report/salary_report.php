...
<!--            table start hear-->
            <table class="table1  table-striped table-bordered table-hover table-sm">
                ...
                <tr>
                    <td><input type="radio" placeholder="test 2" id="1" id="report" name="report" value="202" checked="checked"/></td>
                    <td class="bold" align="left"> <label for="1">Salary Information</label> </td>
					
					<td><input type="radio" placeholder="test 2" id="2" id="report" name="report" value="78"/></td>
                    <td class="bold" align="left"> <label for="2">Salary Report</label> </td>
                </tr>
				
				 <tr>
                    <td><input type="radio" id="5" placeholder="test 2" id="report" name="report" value="8888"/></td>
                    <td class="bold" align="left"> <label for="5">Salary Summary Sheet (Cash Portion)</label> </td>
					
					<td><input type="radio" placeholder="test 2" id="4" id="report" name="report" value="9999" /></td>
                    <td class="bold" align="left"> <label for="4">Salary Summary Sheet (All)</label> </td>
                </tr>
				<tr>
                    <td><input type="radio" placeholder="test 2" id="3" id="report" name="report" value="776" /></td>
                    <td class="bold" align="left"> <label for="3">Salary Report (Cash Portion)</label> </td>
					
					<td><input type="radio" placeholder="test 2" id="6" id="report" name="report" value="4512"/></td>
                    <td class="bold" align="left"> <label for="6">Salary Advice</label> </td>
                </tr>
				<tr>
                    <td><input type="radio" id="6" placeholder="test 2" id="report" name="report" value="233332"/></td>
                    <td class="bold" align="left"> <label for="6">Yearly Individual Salary Statement</label> </td>
					
					<td><input type="radio" placeholder="test 2" id="7" id="report" name="report" value="21211212" /></td>
                    <td class="bold" align="left"> <label for="7">Individual Fiscal Salary Statement</label> </td>
                </tr>
				<tr>
                    <td><input type="radio" id="8" placeholder="test 2" id="report" name="report" value="5312021"/></td>
                    <td class="bold" align="left"> <label for="8">Salary Certificate</label> </td>
					
					<td><input type="radio" placeholder="test 2" id="9" id="report" name="report" value="5312029"/></td>
                    <td class="bold" align="left"> <label for="9">Salary Certificate Tax</label> </td>
                </tr>
				<tr>
                    <td><input type="radio" id="10" placeholder="test 2" id="report" name="report" value="4763"/></td>
                    <td class="bold" align="left"> <label for="10">Advance Salary Report</label> </td>
					
					<td><input type="radio" placeholder="test 2" id="11" id="report" name="report" value="551010" /></td>
                    <td class="bold" align="left"> <label for="11">Yearly Department Wise Salary Statement</label> </td>
                </tr>
				<tr>
                    <td><input type="radio" id="12" placeholder="test 2" id="report" name="report" value="144441"/></td>
