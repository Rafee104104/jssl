...
<?
	    ...
	    $str 	.= '<h2 style="font-size:24px; font-family:bankgothic; transform: uppercase;">QAF GROUP</h2>';
...
$leave_con .= ' and l.year="'.$_POST['year'].'"';
    ...
    $sqldd = 'select l.PBI_ID,p.PBI_NAME,p.PBI_CODE,p.PBI_DEPARTMENT,proj.PROJECT_DESC,p.PBI_SEX,p.PBI_DOJ,p.PBI_DESIGNATION,dept.DEPT_DESC,desg.DESG_DESC,
...
//$tr_con .= ' and t.TRANSFER_ORDER_DATE between "'.$_POST['year'].'-'.$_POST['mon'].'-1" and "'.$_POST['year'].'-'.$_POST['mon'].'-30"';
    ...
    $sqldd = 'select l.PBI_ID,p.PBI_NAME,p.PBI_CODE,p.PBI_DEPARTMENT,(select PROJECT_DESC from project where PROJECT_ID=p.JOB_LOCATION) as project,
	 ...
	 from hrm_od_info l,personnel_basic_info p,essential_info e,department dept,designation desg



	 where l.PBI_ID=p.PBI_ID and l.PBI_ID=e.PBI_ID and
