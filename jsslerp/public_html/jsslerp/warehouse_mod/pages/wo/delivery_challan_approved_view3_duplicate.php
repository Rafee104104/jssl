...
<table width="1000" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0"  style="font-size:12px">
  	...
  	<tr height="30">
  	  ...
  	  <td width="50%"  style="text-align:center; color:#FFF; font-size:18px; padding:0px 0px 10px 0px; color:#000000; font-weight:bold;"><span style="text-decoration:underline">DELIVERY CHALLAN </span> </td>
		    ...
		    <td width="100%" valign="top">
		      ...
		      <table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:12px">
		        ...
		        <tr>
	              ...
	              <td width="18%">: &nbsp;<?=$ch_data->chalan_no;?></td>
	              <td>Order No</td>
	              <td>: &nbsp;<?php echo $ch_data->do_no;?></td>
		        </tr>
		        <tr>
		          <td align="left" valign="middle">Custodian Name</td>
		          <td>:	&nbsp;
		            <?= $ch_data->rec_name;?></td>
	              <td>Booking No </td>
	              <td>: 
		        ...
		        <tr>
		          <td align="left" valign="middle">Name of the booker</td>
		          <td>:	&nbsp;
    ...
    <td><div id="pr">
      ...
      <table width="100%" border="1" cellpadding="5" cellspacing="0" bordercolor="#000000" class="tabledesign"  style="font-size:12px">
        <tr>
          ...
          <th width="9%" bgcolor="#CCCCCC">SR No </th>
		  <th width="10%" bgcolor="#CCCCCC">Unit Price </th>
          <th width="10%" bgcolor="#CCCCCC">Qty</th>
          
          <th width="10%" bgcolor="#CCCCCC">Store Rent </th>
          <th width="10%" bgcolor="#CCCCCC">Labour Charge </th>
          <th width="10%" bgcolor="#CCCCCC">Seeds Loan </th>
          <th width="9%" bgcolor="#CCCCCC">Bag Loan </th>
          <th width="10%" bgcolor="#CCCCCC">Farmer Loan </th>
          <th width="10%" bgcolor="#CCCCCC">SR Loan </th>
          <th width="10%" bgcolor="#CCCCCC">Others Loan </th>
          <th width="21%" bgcolor="#CCCCCC">Total Days </th>
          <th width="21%" bgcolor="#CCCCCC">Total Interest </th>
...
$total_amount = $total_amount + $data->total_amt;
        ...
        <tr>
          <td colspan="11"><div align="right"><strong>Discount(
            <?=$master->discount?>
            %):</strong></div></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
		...
		<?php if($master->vat>0){ ?>
        <tr>
          <td colspan="11"><div align="right"><strong>VAT(
                  <?=$master->vat?>
            %):</strong></div></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <tr>
          <td colspan="11"><div align="right"><strong>Advance Paid:</strong></div></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td><strong>
...
?>
        <tr>
          <td colspan="11"><div align="right"><strong> Grand Total:</strong></div></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td><strong>
  ...
  <tr>
	...
	<table width="100%" cellspacing="0" cellpadding="0"  >
		...
		<tr>
		 ...
		 $aprroved_by1=find_a_field('sale_do_chalan','aprroved_by1','chalan_no="'.$chalan_no.'"');
		   echo find_a_field('user_activity_management','fname','user_id="'.$aprroved_by1.'"')?>		  </td>
		  <td align="center"> <?php
		  
		 $aprroved_by2=find_a_field('sale_do_chalan','aprroved_by2','chalan_no="'.$chalan_no.'"');
		   echo find_a_field('user_activity_management','fname','user_id="'.$aprroved_by2.'"')?></td>
		   <td align="center"> <?php
		  
		 $uid3=find_a_field('sale_do_chalan','aprroved_by3','chalan_no="'.$chalan_no.'"');
		   echo find_a_field('user_activity_management','fname','user_id="'.$uid3.'"')?></td>
		  </tr>
		...
		<tr style="font-size:12px">
            <td align="center" width="20%"><strong>Work Order By</strong></td>
			 <td  align="center" width="20%"><strong>Store Officer</strong></td>
		    <td  align="center" width="20%"><strong>1st Approved</strong></td>
		   
		    <td  align="center" width="20%"><strong>2nd 1st Approved</strong></td>
			<td  align="center" width="20%"><strong>3rd  Approved</strong></td>
		    </tr>
		<tr style="font-size:12px">
		  <td align="center">&nbsp;</td>
		  <td  align="center">&nbsp;</td>
		  ...
		  if($_GET['v_no']>0)
		  {
			...
			$row=mysql_fetch_object($sql_query);
			  ...
			  $tot_cr_amt=$amount;
			   ...
			   //DR cash ledger
				add_to_sec_journal($proj_id, $jv_no, $jv_date, $cash_ledger, $dnarr, $total_paid_cash, '0', $tr_from, $tr_no,'',$tr_id,$cc_code,'',$user_id,'',$r_from, $bank,$c_no,$cheq_date,$issue_from_ac,$checked,$type,$employee,$remarks,$reference_id);
				
				//Agent DR
				add_to_sec_journal($proj_id, $jv_no, $jv_date, $cr_agent, $dnarr,  $total_store_rent_actual,'0', $tr_from, $tr_no,'',$tr_id,$cc_code,'',$user_id,'',$r_from, $bank,$c_no,$cheq_date,$issue_to_ac,$checked,$type,$employee,$remarks,$reference_id);
				
			   //CR Sapce Rent
				add_to_sec_journal($proj_id, $jv_no, $jv_date, $cr_ledger, $dnarr, '0', $total_store_rent_actual,  $tr_from, $tr_no,'',$tr_id,$cc_code,'',$user_id,'',$r_from, $bank,$c_no,$cheq_date,$issue_from_ac,$checked,$type,$employee,$remarks,$reference_id);
		  ...
		  <tr>
		    ...
		    <td width="100%" valign="top">
		      ...
		      <table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:12px">
		        ...
		        <tr>
		          <td width="13%" align="left" valign="middle" style="font-size:12px; font-weight:700;">ক্রেতার নাম</td>
		          <td width="30%" style="font-size:12px; font-weight:700;">:	&nbsp;
...
$total_amount = $total_amount + $data->total_amt;
		...
		?>
        <tr>
          <td colspan="3"><div align="right"><strong>মোট:</strong></div></td>
        ...
        <?php 
			...
			$paid_booking_amt=find_a_field('sale_do_chalan','sum(store_rent)','booking_no="'.$ch_data->booking_no.'" and chalan_no="'.$ch_data->chalan_no.'"');
		
		if($paid_booking_amt>0 && $btype=='Paid Booking'){ ?>
        <tr>
          <td colspan="10"><div align="right"><strong>অগ্রিমবাদ:</strong></div></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td><strong>
            <?=number_format($paid_booking_amt,2);?>
		...
		<?php if($master->vat>0){ ?>
        <tr>
          <td colspan="10"><div align="right"><strong>VAT(
                  <?=$master->vat?>
            %):</strong></div></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
        ...
        <?php if($ch_data->transport_cost>0){ ?>
        <tr>
          <td colspan="10"><div align="right"><strong>Advance Paid:</strong></div></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td><strong>
            <?=number_format($trans_cost=$ch_data->transport_cost,2);?>
...
?>
        <tr>
          <td colspan="10"><div align="right"><strong>সর্বমোট:</strong></div></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td><strong>
            <?
			...
			{
			echo number_format($net_amt=$grand_total-$paid_booking_amt,2);
			
			}
			else
			{
			echo number_format($net_amt=$grand_total,2);
			}
			?>
          </strong></td>
        </tr>
