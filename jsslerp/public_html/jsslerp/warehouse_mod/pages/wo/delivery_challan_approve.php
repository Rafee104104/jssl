        ...
        <div class="container-fluid pt-5 p-0 ">
            <table class="table1  table-striped table-bordered table-hover table-sm">
				...
				where 
				 ...
				 m.group_for=u.id and c.approved_status=''  and m.dealer_code=d.dealer_code and m.do_no=c.do_no ".$group_for_con.$con.$dealer_con.$job_no_con.$chalan_con."  group by c.chalan_no order by  c.chalan_date DESC, m.do_no,c.chalan_no ";
				...
				<td><a title="Challan Preview" target="_blank" href="delivery_challan_approved_view.php?v_no=<?=$data->chalan_no?>" style=" font-weight:700; color:#000000" >View</a></td>
				</tr>
				<?
