...
$con .= ' and m.do_no in ('.$_POST['do_no'].') ';*/
 ...
 $res="select  m.do_no,d.booking_no,d.sr_no, m.job_no, m.dealer_code, m.do_date,  m.status, sum(d.total_unit) as wo_qty,m.status,m.customer
...
//echo link_report($res,'po_print_view.php');
		...
		?>
          ...
          <tr>
            ...
            <td><?=$row->status?></td>
            <td><input type="button" value="Complete SR" onClick="custom(<?=$row->do_no;?>);" class="btn1 btn1-bg-submit" / >
            </td>
          </tr>
          <?
						}
