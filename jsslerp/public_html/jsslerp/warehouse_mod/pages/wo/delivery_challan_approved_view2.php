		  ...
		  <tr>
		    ...
		    <td width="100%" valign="top">
		      ...
		      <table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:12px">
		        ...
		        <tr>
		          <td width="13%" align="left" valign="middle" style="font-size:12px; font-weight:700;">কাস্টমারের নামঃ</td>
		        ...
		        <tr>
		          <td align="left" valign="middle">সংরক্ষণকারীর নামঃ</td>
		          <td>:	&nbsp;
		            <?= $ch_data->rec_name;?></td>
	              <td>Booking No </td>
	              <td>: 
		        ...
		        <tr>
		          <td align="left" valign="middle">বুকিংকারীর নামঃ</td>
		          <td>:	&nbsp;
    ...
    <td><div id="pr">
      ...
      <table width="100%" border="1" cellpadding="5" cellspacing="0" bordercolor="#000000" class="tabledesign"  style="font-size:12px">
        <tr>
          ...
          <th width="10%" bgcolor="#CCCCCC">কৃষক লোন </th>
          <th width="10%" bgcolor="#CCCCCC">অনন্যা লোন </th>
          <th width="21%" bgcolor="#CCCCCC">দিন </th>
          <th width="21%" bgcolor="#CCCCCC">সুদের পরিমান </th>
...
$total_amount = $total_amount + $data->total_amt;
        ...
        <tr>
          <td colspan="10"><div align="right"><strong>অগ্রিম বাদ(
            <?=$master->discount?>
            %):</strong></div></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
...
?>
        <tr>
          <td colspan="10"><div align="right"><strong> সর্বমোট:</strong></div></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td><strong>
  ...
  <tr>
	...
	<table width="100%" cellspacing="0" cellpadding="0"  >
		...
		<tr style="font-size:12px">
		  ...
		  $update="update sale_do_chalan set aprroved_by2='".$_SESSION['user']['id']."',aprroved_at2='".date('Y-m-d h:i:sa')."',approved_status='Sec App' where chalan_no='".$_GET['v_no']."' ";
		 ...
		 if($update_success==true)
		 {
		  ...
		  ?>
		  <? $id=find_a_field('sale_do_chalan','aprroved_by2','chalan_no="'.$chalan_no.'"');  ?>
