      ...
      <table class="table1  table-striped table-bordered table-hover table-sm">
        ...
        <tbody class="tbody1">
          ...
          <tr>
            ...
            <td align="center"><? echo number_format($stock_qty=find_a_field('journal_item','sum(item_in)-sum(item_ex)','item_id="'.$row->item_id.'" and barcode="'.$row->sr_no.'"' ),2);?>
            ...
            <td align="center"><input name="loan_days_<?=$row->id?>" type="text" id="loan_days_<?=$row->id?>" value="" readonly /></td>
             ...
             <td align="center"><input type="text" name="total_interest_<?=$row->id?>" id="total_interest_<?=$row->id?>" value="" /></td>
             <td align="center">
