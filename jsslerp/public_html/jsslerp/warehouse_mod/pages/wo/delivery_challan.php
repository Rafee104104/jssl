        ...
        <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
          <div class="container n-form2">
			...
			<div class="form-group row m-0 pb-1">
              ...
              <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                <input  name="rec_intest" type="text" style="color:#007bff;" value="<?=find_a_field('sale_do_chalan c,journal j','sum(c.total_interest)','c.chalan_no=j.tr_no and c.booking_no ="' . $booking . '" and tr_from="Sales" and j.ledger_id="'. $acc_ledger.'" and j.cr_amt>0');?>" id="rec_intest" />
              </div>
            </div>
...
function calculateDays(val) {
	...
	document.getElementById('others_loan_'+val).value=tot_others_loan;
	 ...
	 var actual_interest= document.getElementById('total_interest_' + val).value = 
    (totinterest % 1 >= 0.51) ? Math.ceil(totinterest) : Math.floor(totinterest);
	
	   totAmount = ((totinterest % 1 >= 0.51) ? Math.ceil(totinterest) : Math.floor(totinterest)) 
    + tot_seeds_loan 
    + tot_bag_loan 
    + tot_farmer_loan 
    + tot_sr_loan 
	...
	//var totAmount = actual_interest + tot_seeds_loan + tot_bag_loan + tot_farmer_loan + tot_sr_loan + tot_others_loan + tot_labour_charge + tot_store_rent;
   ...
   document.getElementById('total_amt_' + val).value =(totAmount % 1 >= 0.51) ? Math.ceil(totAmount) : Math.floor(totAmount);
	...
	var loanDate = new Date(document.getElementById('loan_date_'+val).value);
		...
		document.getElementById('total_interest_' + val).value = 
    (totinterest % 1 >= 0.51) ? Math.ceil(totinterest) : Math.floor(totinterest);
