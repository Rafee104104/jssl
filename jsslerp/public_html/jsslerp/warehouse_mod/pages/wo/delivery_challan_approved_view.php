...
$total_amount = $total_amount + $data->total_amt;
        ...
        <tr>
          <td colspan="10"><div align="right"><strong>Discount(
            <?=$master->discount?>
            %):</strong></div></td>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
  ...
  <tr>
	...
	<table width="100%" cellspacing="0" cellpadding="0"  >
		...
		<tr>
		 ...
		 $uid=$aprroved_by1=find_a_field('sale_do_chalan','aprroved_by2','chalan_no="'.$chalan_no.'"');
		   echo find_a_field('user_activity_management','fname','user_id="'.$uid.'"')?></td>
		  </tr>
		  <td align="center"> <?php
		  
		 $uid3=$aprroved_by1=find_a_field('sale_do_chalan','aprroved_by3','chalan_no="'.$chalan_no.'"');
		...
		<tr style="font-size:12px">
		  ...
		  $update="update sale_do_chalan set aprroved_by1='".$_SESSION['user']['id']."',aprroved_at1='".date('Y-m-d h:i:sa')."',approved_status='First App' where chalan_no='".$_GET['v_no']."' ";
		 ...
		 if($update_success==true)
		 {
		  ...
		  ?>
		  <? $id=find_a_field('sale_do_chalan','aprroved_by1','chalan_no="'.$chalan_no.'"');  ?>
