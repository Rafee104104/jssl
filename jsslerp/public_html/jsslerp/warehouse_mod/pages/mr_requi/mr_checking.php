...
if(isset($_POST['confirmm']))
{
		...
		//NOW
		$_POST['status']='PRE-CHECKED';
		$_POST['dept_head_id']=$_SESSION['user']['id'];
		$_POST['take_at']=date('Y-m-d h:s:i');
  ...
  <tr>
    ...
    <? $field='req_date'; if($req_date=='') $req_date =date('Y-m-d');?>
      <div>
        ...
        <input  name="<?=$field?>" type="date" id="<?=$field?>" value="<?=$$field?>" readonly="readonly" />
      </div>
