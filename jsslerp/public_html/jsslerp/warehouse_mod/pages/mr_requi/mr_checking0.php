...
if(isset($_POST['return']))
{
 ...
 $update="update requisition_master_stationary set status='MANUAL' where req_no='".$$unique."'";
 mysql_query($update);
...
if(isset($_POST['confirmm']))
{
		...
		$_POST['first_approved_by']=$_SESSION['user']['id'];
		$_POST['first_approved_at']=date('Y-m-d h:s:i');
		...
		$msg='Successfully Forwarded to Relevant Department.';
				header("Location: select_unapproved_mr2.php");
...
<form action="select_unapproved_mr.php" method="post" name="codz" id="codz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
...
<br /><br /><br /><br />
<? 
///$res='select a.id,concat(b.item_name," :: ",b.item_description) as item_name,a.item_for as remarks,a.qoh as stock_qty,a.last_p_qty as last_pur_qty,a.last_p_date as last_pur_date,a.qty,b.unit_name,"x" from requisition_order_stationary a,item_info b where b.item_id=a.item_id and a.req_no='.$req_no;
?>
...
SELECT 
    a.id,
    CONCAT(b.item_name," :: ",b.item_description) AS item_name,
    a.item_for AS remarks,
    a.qoh AS stock_qty,
    a.last_p_qty AS last_pur_qty,
    a.last_p_date AS last_pur_date,
    a.qty,
    "x" 
FROM requisition_order_stationary a
...
<form action="" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
  <table width="100%" border="0">
    <tr>
      ...
      <input name="delete"  type="submit" class="btn1 btn1-bg-cancel" value="DELETE AND CANCEL REQUSITION" style="width:270px; font-weight:bold; font-size:12px;color:#ffff; height:30px" />

      </td>
	  <td align="center">

      <input name="return"  type="submit" class="btn1 btn1-bg-help" value="RETURN TO USER" style="width:270px; font-weight:bold; font-size:12px;color:#ffff; height:30px" />

      </td>
      <td align="center">

      <input name="confirmm" type="submit" class="btn1 btn1-bg-submit" value="CONFIRM AND FORWARD REQUSITION" style="width:280px; font-weight:bold; font-size:12px; height:30px; color:#ffff" />
