    ...
    <div class="row m-0 p-0">
      <div class="col-sm-5">
        ...
        <div class="form-check">
          <input name="report" type="radio" class="radio1" id="report1-btn" value="11125" checked="checked" tabindex="1"/>
          <label class="form-check-label p-0" for="report1-btn">SR Loan Report </label>
        </div>
        <div class="form-check">
          <input name="report" type="radio" class="radio1" id="report2-btn" value="11126" tabindex="1"/>
          <label class="form-check-label p-0" for="report2-btn"> Bag Loan Report </label>
        </div>
      ...
      <div class="col-sm-7">
		...
		<div class="form-group row m-0 mb-1 pl-3 pr-3">
          ...
          <div class="col-sm-8 p-0"> <span class="oe_form_group_cell">
            <select name="rec_year" id="rec_year" onchange="getData2('booking_ajax2.php', 'sub_class', this.value, document.getElementById('rec_year').value);">
              <option value=""></option>
