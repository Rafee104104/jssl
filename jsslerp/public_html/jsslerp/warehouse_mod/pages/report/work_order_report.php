    ...
    <div class="row m-0 p-0">
      <div class="col-sm-5">
        ...
        <!--<div class="form-check">
          ...
          <label class="form-check-label p-0" for="report1-btn"> Warehouse Transection Report(1) </label>
        </div>-->
		
		<div class="form-check">
          <input name="report" type="radio" class="radio1" id="report1-btn" checked="checked" value="90725"  tabindex="2"/>
          <label class="form-check-label p-0" for="report1-btn"> Warehouse Transection Report(90725) </label>
        </div>
		
        <div class="form-check">
          <input name="report" type="radio" class="radio1" id="report2-btn" value="2" tabindex="1"/>
          <label class="form-check-label p-0" for="report2-btn"> Stock Position Report(Closing)(2) </label>
        </div>
        <div class="form-check">
          <input name="report" type="radio" class="radio1" id="report2-btn" value="20022" tabindex="1"/>
          <label class="form-check-label p-0" for="report2-btn"> Stock Position Alert Report(20022) </label>
        </div>
        <div class="form-check">
          <input name="report" type="radio" class="radio1" id="report2-btn" value="20025" tabindex="1"/>
          <label class="form-check-label p-0" for="report2-btn"> FG Cost Alert Report(20025) </label>
        </div>
		<div class="form-check">
          <input name="report" type="radio" class="radio1" id="report5-btn" value="4002"  tabindex="1"/>
          <label class="form-check-label p-0" for="report5-btn"> Consumption Compare Report  (4002) </label>
        </div>
		
        <div class="form-check">
          <input name="report" type="radio" class="radio1" id="report3-btn" value="113"  tabindex="1"/>
          <label class="form-check-label p-0" for="report3-btn"> Group Wise Item Opening Report</label>
        </div>
		<div class="form-check">
          <input name="report" type="radio" class="radio1" id="report3-btn" value="1133"  tabindex="1"/>
          <label class="form-check-label p-0" for="report3-btn"> Item Opening Report All </label>
        </div>
        <div class="form-check">
          <input name="report" type="radio" class="radio1" id="report4-btn" value="401"  tabindex="1"/>
          <label class="form-check-label p-0" for="report4-btn"> Undelivered SO (401) </label>
        </div>
        <div class="form-check">
          <input name="report" type="radio" class="radio1" id="report5-btn" value="402"  tabindex="1"/>
          <label class="form-check-label p-0" for="report5-btn"> Undelivered PO (402) </label>
        </div>
        <div class="form-check">
          <input name="report" type="radio" class="radio1" id="report5-btn" value="403"  tabindex="1"/>
          <label class="form-check-label p-0" for="report6-btn"> Store Receive Report (403) </label>
        </div>
        <div class="form-check">
          <input name="report" type="radio" class="radio1" id="report5-btn" value="404"  tabindex="1"/>
          <label class="form-check-label p-0" for="report6-btn"> Master Roll Report (404) </label>
        </div>
		<div class="form-check">
          <input name="report" type="radio" class="radio1" id="report5-btn" value="405"  tabindex="1"/>
          <label class="form-check-label p-0" for="report6-btn"> Booking Details Report (405) </label>
        </div>
		<div class="form-check">
          <input name="report" type="radio" class="radio1" id="report5-btn" value="4005"  tabindex="1"/>
          <label class="form-check-label p-0" for="report6-btn"> Booking Details All Report (4005) </label>
        </div>
		<div class="form-check">
          <input name="report" type="radio" class="radio1" id="report5-btn" value="40005"  tabindex="1"/>
          <label class="form-check-label p-0" for="report6-btn"> Booking Details Official Report (40005) </label>
        </div>
      </div>
      <div class="col-sm-7">
        ...
        <div class="form-group row m-0 mb-1 pl-3 pr-3">
		  ...
		  <input list="item" name="item_id" id="item_id" class="form-control" autocomplete="off">
            <datalist  id="item">
              <option>All</option>
		...
		<div class="form-group row m-0 mb-1 pl-3 pr-3">
          ...
          <div class="col-sm-8 p-0"> <span class="oe_form_group_cell">
            <select name="rec_year" id="rec_year" onchange="getData2('booking_ajax.php', 'sub_class', this.value, document.getElementById('rec_year').value);">
              <option value=""></option>
        ...
        <div class="form-group row m-0 mb-1 pl-3 pr-3">
          ...
          <div class="col-sm-8 p-0">
		  <span id="sub_class">
            <input type="text" name="booking_number" id="booking_number" list="booking_numbers">
			            <datalist id="booking_numbers">

              <? foreign_relation('paid_booking','booking_number_eng','booking_number_eng');?>
			  </datalist>
        ...
        <div class="form-group row m-0 mb-1 pl-3 pr-3">
          <label for="group_for" class="col-sm-4 m-0 p-0 d-flex align-items-center">SR Number:</label>
          <div class="col-sm-8 p-0">
		  <span id="sub_class2">
		   <input type="text" value="" name="sr_number" list="sr_numbers" id="sr_number" />
            <datalist id="sr_numbers">
              <? foreign_relation('sr_token','sr_number','sr_number','','1');?>
            </datalist>
            </span>
          </div>
        </div>
        ...
        <div class="form-group row m-0 mb-1 pl-3 pr-3">
          <label for="group_for" class="col-sm-4 m-0 p-0 d-flex align-items-center">Agent Name :</label>
          <div class="col-sm-8 p-0"> <span class="oe_form_group_cell">
            <input type="text" value="" name="dealer_name_e" list="dealer_codes" id="dealer_name_e" />
            <datalist id="dealer_codes">
              <? foreign_relation('dealer_info','dealer_name_e','dealer_code','',' 1 AND  `group_for` ="'.$_SESSION['user']['group'].'"');?>
              <?php /*?><? foreign_relation('dealer_info','dealer_name_e','concat(0dealer_code," : ",dealer_name_e)',$cc,' 1 AND  `group_for` ="'.$_SESSION['user']['group'].'"');?>
<?php */?>
            </datalist>
            </span> </div>
        </div>
        <div class="form-group row m-0 mb-1 pl-3 pr-3">
          <label for="group_for" class="col-sm-4 m-0 p-0 d-flex align-items-center">Farmer Name:</label>
          <div class="col-sm-8 p-0">
                    <input type="text" value="" name="farmer" list="farmers" id="farmer" />
            <datalist id="farmers">
              <? foreign_relation('sr_token','farmer_name','village','','1 group by farmer_name');?>
            </datalist>
             </div>
        </div>
		<div class="form-group row m-0 mb-1 pl-3 pr-3">
          <label for="group_for" class="col-sm-4 m-0 p-0 d-flex align-items-center">Village:</label>
          <div class="col-sm-8 p-0">
                    <input type="text" value="" name="village" list="villages" id="village" />
            <datalist id="villages">
              <? foreign_relation('sr_token','village','area','','1');?>
            </datalist>
             </div>
        </div>
        <div class="form-group row m-0 mb-1 pl-3 pr-3">
