             ...
             <div class="company-title">
              <div class="d-flex justify-content-around">
                <div class="d-flex align-items-center">
					<h4> <img src="../../../logo/<?=$_SESSION['proj_id']?>.png"/></h4>
                </div>
                <div class="company-header">
                  <h2 class="text-uppercase text-center" style="font-family:Tahoma;"><?=$group_data->group_name?></h2>
...
?>
    <tr class="text-center">
      ...
      <td style="text-align:right;">
		  ...
		  <?
		  $item_Weight = find_a_field('item_info','secondary_unit_quantity','item_id='.$data->item_id);
		  $total_weight_Qty = $item_Weight * $data->total_unit;
		  ?>
...
<td style="text-align:right;font-weight:bold;"><?=number_format($grand_total_weight,2);?></td>
...
<?php } ?>
<tr class="text-center">
<td colspan="4" style="text-align:left;font-weight:bold;">Gross Total</td></td><td></td><td></td><td></td><td></td>
