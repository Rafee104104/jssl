...
echo  $res='select pr_no,pr_no,pr_date,remarks,(select warehouse_name from warehouse where warehouse_id=warehouse_from) as warehouse_from,carried_by,received_by,status,entry_at,entry_by,production_for,goods_type from production_floor_return_master where status="COMPLETE" '.$con.'';
