...
<a target="_blank" href="../../warehouse_mod/pages/pr/chalan_view2.php?v_no=<?=$ch->pr_no?>"></a></div><? }?>
      ...
      <tr>
        ...
        <td class="tabledesign_text">Prepared by :
  ...
  <tr>
    ...
    || Store Receive SR : <?=$ch->manual_oi_no?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
...
<?php }?>
  ...
  <tr>
    <td class="tabledesign_text"><table width="100%" border="0" cellspacing="0" cellpadding="0">
	   <tr>
        <td align="center" valign="bottom"><? if($jv->checked=='YES') echo find_a_field('user_activity_management','fname','user_id='.$jv->checked_by); else echo 'Not Checked';?></td>
