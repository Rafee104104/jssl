  ...
  <form action="?<?=$unique?>=<?=$$unique?>" method="post" name="cloud" id="cloud">
    ...
    <div class="container-fluid pt-5 p-0 ">
      <table class="table1  table-striped table-bordered table-hover table-sm">
        ...
        <tbody class="tbody1">
          <tr>
            <td><input  name="<?=$unique?>"i="i" type="hidden" id="<?=$unique?>" value="<?=$$unique?>"/>
              <input  name="warehouse_id" type="hidden" id="warehouse_id" value="<?=$warehouse_id?>"/>
              <input  name="req_date" type="hidden" id="req_date" value="<?=$req_date?>"/>
              <input  name="item_id" list="item_ids" type="text" id="item_id" value="<?=$item_id?>" required="required" onblur="getData2('mr_ajax.php', 'mr', this.value, document.getElementById('warehouse_id').value);"/>
            ...
            <td colspan="4"><div align="right"> <span id="mr">
                <table style="width:100%;" border="1">
                  <tr>
                    ...
                    <td width="23%"><input name="unit_name" type="text" id="unit_name"  maxlength="100" class="form-control" onfocus="focuson('qty')" /></td>
					                    <td width="23%"><input name="last_pur_rate" type="hidden" id="last_pur_rate"  class="input3"  onfocus="focuson('qty')" />
                    </td>
                  </tr>
                </table>
                </span> </div></td>
            <td><input name="qty" type="text" class="input3" id="qty" required /></td>
            <td><input name="est_price" id="est_price" type="number" />
            </td>
            <td><input name="remarks" id="remarks" type="text" />
            </td>
      ...
      <table class="table1  table-striped table-bordered table-hover table-sm">
        ...
        <tbody class="tbody1">
          <?
						...
						$res='select a.id,b.unit_name,b.item_name as item_name,a.qoh as stock_qty,a.last_p_qty as last_pur_qty,a.last_p_date as last_pur_date,a.qty,a.unit_name,a.est_price,"x" from requisition_order a,item_info b where b.item_id=a.item_id and a.req_no='.$req_no;
