...
$unique = 'req_no';
$status = 'APPROVAL5';
$target_url = '../mr/mr_checking5.php';
/*if($_POST[$unique]>0)
{
  ...
  <div class="form-container_large">
    <form action="" method="post" name="codz" id="codz">
      ...
      <div class="container-fluid pt-5 p-0 ">
        ...
        $res='select  	a.req_no,a.req_no, a.req_date, a.req_for, b.warehouse_name as warehouse, a.req_note as note, a.need_by, c.fname as entry_by, a.entry_at,a.status from requisition_master a,warehouse b,user_activity_management c where a.warehouse_id='.$_SESSION['user']['depot'].' and a.warehouse_id=b.warehouse_id and a.entry_by=c.user_id '.$con.' and a.status in ("APPROVAL5") order by a.req_no';
