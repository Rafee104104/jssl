...

{
		...
		$_POST['approve4_at']=date('Y-m-d H:i:s');

		$_POST['status']='APPROVAL4';
		...
		header('location:select_approval3_mr.php');
		...
		<form action="" method="post" name="cloud" id="cloud">
			...
			?>
					...
					<tr>
						...
						<td><?=$row->qty; $tot_qty+=$row->qty;?></td>
						<td><?=$row->est_price?></td>
						<td><?=$amount=$row->est_price*$row->qty; $tot_amt+=$amount;?></td>
