...

{
		...
		$_POST['approve3gm_at']=date('Y-m-d H:i:s');

		$_POST['status']='APPROVAL3_gm';
		...
		header('location:select_approval2_mr_gm.php');
  ...
  document.getElementById("req_date").focus();
    ...
    <div class="d-flex justify-content-center pt-5">
		...
		<form action="" method="post" name="cloud" id="cloud">
			...
			$res='select a.id,b.item_name as item_name,a.remarks as remarks,b.unit_name,a.qoh as stock_qty,a.last_p_qty as last_pur_qty,a.last_p_date as last_pur_date,a.qty,a.est_price,"x" from requisition_order a,item_info b where b.item_id=a.item_id and a.req_no='.$req_no;
