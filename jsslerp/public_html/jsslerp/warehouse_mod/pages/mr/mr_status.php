...
<div class="form-container_large">
    ...
    <form action="" method="post" name="codz" id="codz">
                    ...
                    <div class="form-group row m-0">
                        ...
                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
						  <select name="status" id="status" >
							...
							<option <?=($_POST['status']=='APPROVAL3')?'selected':''?>>APPROVAL3</option>
							<option <?=($_POST['status']=='APPROVAL4')?'selected':''?>>APPROVAL4</option>
							<option <?=($_POST['status']=='APPROVAL5')?'selected':''?>>APPROVAL5</option>
		...
		<? 
					...
					$res='select  	a.req_no,a.req_no, a.req_date, a.req_for, b.warehouse_name as warehouse, a.req_note as note, a.need_by, c.fname as entry_by, a.entry_at,a.status from requisition_master a,warehouse b,user_activity_management c where a.warehouse_id='.$_SESSION['user']['depot'].' and a.warehouse_id=b.warehouse_id and a.entry_by=c.user_id '.$con.' and a.status in ("UNCHECKED","CHECKED","MANUAL","APPROVAL0","APPROVAL1","APPROVAL2","APPROVAL3","APPROVAL3_gm","APPROVAL4","APPROVAL5") order by a.req_no';
