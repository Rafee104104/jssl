...

{
		...
		$_POST['approve0_at']=date('Y-m-d H:i:s');

		$_POST['status']='APPROVAL0';
		...
		header('location:select_unapproved_mr0.php');
  ...
  document.getElementById("req_date").focus();
    ...
    <div class="d-flex justify-content-center pt-5">
		...
		<form action="" method="post" name="cloud" id="cloud">
			...
			$res='select a.id,b.item_name as item_name,b.unit_name,a.remarks as remarks,a.qoh as stock_qty,a.last_p_qty as last_pur_qty,a.last_p_date as last_pur_date,a.qty,a.est_price,"x" from requisition_order a,item_info b where b.item_id=a.item_id and a.req_no='.$req_no;
