...
{$$unique_master=find_a_field('warehouse_other_received_master_details','oi_no','id='.$_GET['del']); $del = $_GET['del'];}
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <div class="container n-form2">
                        <div class="form-group row m-0 pb-1">
                            <label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">OR No:</label>
						...
						<input name="group_for" type="hidden" id="group_for" required readonly="" style="width:250px;" value="<?=$_SESSION['user']['group']?>" tabindex="105" />
						 ...
						 <input type="hidden" name="issue_type" id="issue_type" value="Inventory Other Receive" />
                            </div>
                        </div>
						...
						<div class="form-group row m-0 pb-1">
                            ...
                            <label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">OR Date:</label>
...
<input name="total_unit" type="hidden"    id="total_unit" readonly/>
  ...
  $res='select s.*,i.item_name,i.unit_name from warehouse_other_received_master_details s left join item_info i on i.item_id=s.item_id where s.oi_no="'.$$unique_master.'"';
