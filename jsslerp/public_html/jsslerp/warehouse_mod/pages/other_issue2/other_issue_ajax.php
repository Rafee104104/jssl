...
$stock = (int)(warehouse_product_stock($item_id ,$warehouse_id));
 $item_price=find_a_field('journal_item','final_price','tr_from in ("Opening","Purchase")
				 AND item_id="'.$item_all->item_id.'" order by id desc');
				 }
?>
...
<td width="33%"><input name="rate" type="text" class="input3" id="rate"  maxlength="100" style="width:98%;" onchange="count()" value="<?=$item_price?>"   required /></td>
</tr></table>