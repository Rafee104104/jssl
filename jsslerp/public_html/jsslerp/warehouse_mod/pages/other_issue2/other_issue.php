...
$table_details='warehouse_other_received_master_details';
...
if(isset($_GET['oi_no'])){
	$oi_no=$_SESSION[$unique]= $_GET['oi_no'];
...
if(isset($_POST['confirmm']))
{
    ...
    header('Location: other_issue.php');
    exit; 
}
...
if($$unique>0) $btn_name='Update OR Information'; else $btn_name='Initiate OR Information';
...
auto_complete_from_db('item_info','finish_goods_code','concat(item_name,"#>",item_id)','1');
$tr_from="Warehouse";
?>
					...
					<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
						<div class="container n-form2">
							...
							<div class="form-group row m-0 pb-1">
								<label for="req_note" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">OR No :</label>
								<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
									<input   name="oi_no" type="text" class="form-control" id="oi_no" value="<? if($$unique>0) { echo $$unique; } else { echo (find_a_field($table_master,'max('.$unique.')','1')+1); } ?>" readonly/>
							...
							<div class="form-group row m-0 pb-1">
								<label for="req_note" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">OR Date :</label>
								<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
							...
							<div class="form-group row m-0 pb-1">
								<label for="req_note" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Receive  From :</label>
								<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
				...
				<table class="table1  table-striped table-bordered table-hover table-sm">
					...
					<tr>
						...
						<td align="center">
							...
							<input list="item" name="item_id" type="text" id="item_id" value="<?=$item_id?>" style="width:98%;" required onblur="getData2('<?=$ajax_page?>', 'po',this.value,document.getElementById('warehouse_id').value);"/>
		...
		<td width="33%"><input name="price" type="text" class="input3" id="price" readonly="readonly"/></td>
			...
			<div class="container-fluid pt-5 p-0 ">
				...
				<div class="tabledesign2 border-0">
					...
					$res='select a.id,b.item_name,a.rate as unit_price,a.qty ,a.unit_name,a.amount,"x" from warehouse_other_received_master_details a,item_info b where b.item_id=a.item_id and a.oi_no='.$oi_no;
