...
$sql1="select b.* from warehouse_other_received_master_details b where b.oi_no = '".$oi_no."'";
...
<? 
$info=find_all_field('warehouse_other_received_master','','oi_no='.$_GET['v_no']);
?>
</head>
  ...
  <tr>
	...
	<div class="header">
		...
		<td class="titel" style="font-size:11px">
				...
				<p class="text"><?=find_a_field('user_group','address','1')?></p>
				<p class="text"><?=find_a_field('user_group','factory_address','1')?></p>
...
<tr> <td><hr /></td></tr>
      ...
      <tr>
        ...
        <td bgcolor="#666666" style="text-align:center; color:#FFF; font-size:18px; font-weight:bold;"><?php echo $info->issue_type;?> Report</td>
		  ...
		  <tr>
		        ...
		        <tr>
		          ...
		          <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
		            ...
		            <tr>
		              ...
		              <td><strong><?php $info->requisition_from;?></strong>&nbsp;</td>
		        ...
		        <!--<tr>
		          ...
		          <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
                      ...
                      <tr>
                        ...
                        <td><?php echo $info->requisition_from;?></td>
		        ...
		        <tr>
		          ...
		          <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
		            ...
		            <tr>
		              ...
		              <td><?php echo $info->oi_subject;?></td>
			...
			<td width="30%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px">
			  ...
			  <tr>
                ...
                <td width="47%" align="right" valign="middle">Receive No :</td>

			    <td width="53%"><table width="100%" border="1" cellspacing="0" cellpadding="3">

                    <tr>

                      <td>&nbsp;<strong><?php echo $info->oi_no;?></strong></td>
				...
				<td align="right" valign="middle">Receive Date : </td>

			    <td><table width="100%" border="1" cellspacing="0" cellpadding="3">

                    <tr>

                      <td>&nbsp; <?=date("d M, Y",strtotime($info->oi_date))?></td>
...
<? for($i=0;$i<$pi;$i++){?>
	...
	<td align="right" valign="top"><?=$unit_qty[$i]; $tot_qty+=$unit_qty[$i];?></td>
        <td align="right" valign="top"><?=$rate[$i]?></td>
        <td align="right" valign="top"><?=$amount[$i]; $tot_amt+=$amount[$i];?></td>
        </tr>

<? }?>
<tr>
	<td colspan="4" align="center"><strong>Total</strong></td>
	<td align="right"><strong><?=number_format($tot_qty,2)?></strong></td>
	<td align="right">&nbsp;</td>
	<td align="right"><strong><?=number_format($tot_amt,2)?></strong></td>
</tr>
  </table></td>
