...
{$to_date=$t_date; $fr_date=$f_date; $date_con=' and a.po_date between \''.$fr_date.'\' and \''.$to_date.'\'';}
	...
	break;
	case 6158:
	$report="Inventory Receive Report";
...
where m.status in ('CHECKED','COMPLETED') and m.oi_no=s.oi_no and m.warehouse_id=w.warehouse_id and i.item_id=s.item_id
...
from warehouse_other_received_master m,warehouse_other_received_master_details s, warehouse w, item_info i
