...
$target_url = '../wo_golden/delivery_challan_demo.php';
...
$con .= ' and m.do_no in ('.$_POST['do_no'].') ';
 ...
 $res="select  m.do_no, m.job_no, m.dealer_code, m.do_date, m.po_no,  m.status, sum(d.total_unit) as wo_qty,m.status
