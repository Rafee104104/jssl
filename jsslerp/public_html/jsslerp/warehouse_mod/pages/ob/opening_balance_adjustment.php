          ...
          <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
            ...
            <div class="form-group row m-0">
              ...
              <div class="col-sm-7 col-md-7 col-lg-7 col-xl-7 p-0">
                <input name="odate" type="text" id="odate" style="width:100px;" value="<?=$odate?>" />
          ...
          <div class="col-sm-7 col-md-7 col-lg-7 col-xl-7">
            <div class="row">
              <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                <div class="form-group row m-0">
                  <label class="col-sm-6 col-md-6 col-lg-6 col-xl-6 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Select Product Sub Group:</label>
