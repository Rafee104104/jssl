...
<table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="5" style="font-size: 14px;">
       ...
       <tr bgcolor="aqua">
			...
			<td align="center"><strong>Rec Qty(BAG)</strong></td>
			<td align="center"><strong>Rec Qty(KG)</strong></td>
...
<? for($i=0;$i<$pi;$i++){?>
      ...
      <tr>
		...
		<td align="right" valign="top"><?=$bag_qty[$i]?></td>
...
<? }?>
<tr>
  <td colspan="6" align="right" valign="top">Sub Total: </td>
