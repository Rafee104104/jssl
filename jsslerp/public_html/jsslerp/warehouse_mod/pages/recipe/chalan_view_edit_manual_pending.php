...
//		mysql_query("INSERT INTO `journal` (`id`, `proj_id`, `jv_no`, `jv_date`, `ledger_id`, `narration`, `dr_amt`, `cr_amt`, `tr_from`, `tr_no`, `sub_ledger`, `cc_code`, `user_id`, `tr_id`, `group_for`, `entry_at`) VALUES ( NULL, 'Alinfoods', '".$jv."', '".$st_date_1."', '".$roww->ledger_id_1."', '(PI#".$row->st_no.") sub group id-".$sub_group_id." item id-".$roww->item_id."', '0.00','".$roww->total_amt."',  'Production Receive', '".$row->st_no."', '', '0', '".$_SESSION['user']['id']."', '', '2', '".date('Y-m-d H:i:s')."')");
