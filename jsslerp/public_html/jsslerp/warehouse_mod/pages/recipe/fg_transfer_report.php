...
<tr>
		...
		<td rowspan="3" width="30% px" height="" align="right"><img src="../../../logo/alin_logo.png" style="width:73%;height:63 px;"/></td>
      ...
      <tr>
        ...
        <td bgcolor="" style="text-align:center; color:; font-size:18px; font-weight:bold;" colspan="2"><?php echo 'FG Transfer';?> Report</td>
      </tr>
    </table></td>
  ...
  <tr>
    ...
    <td colspan="2" align="center"><strong><br />
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td align="center"><?=find_a_field('user_activity_management','fname','user_id='.$entry_by)?>
		  <br />
		  <?=$entry_at;?>
		  </td>
          <td align="center"><?=find_a_field('user_activity_management','fname','user_id='.$received_by)?>
		  <br />
		  <?=$received_at;?>
		  </td>
			<td>&nbsp;</td>
