...
while($row=mysql_fetch_object($query)){
	...
	$agent_name_get[$row->booking_number]=$row->agent_name;
	   ...
	   $td='select sum(b.amount) as tot_amount,b.interest_amt,b.booking_number from  sr_loan b where 1 group by b.booking_number';
...
$avg=($data->tot_amount/$get_tot_qty[$data->booking_number]);
    ...
    ?>
        <tr>
          ...
          <td><?= $get_tot_qty[$data->booking_number];   $t_qty+=$get_tot_qty[$data->booking_number];?></td>
