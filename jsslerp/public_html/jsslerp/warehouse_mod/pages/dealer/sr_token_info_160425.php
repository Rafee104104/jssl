...
<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return check()">
  <div class="container-fluid bg-form-titel">
	...
	<div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
       ...
       <input name="dealer_code_eng" required="required" value="<?=$dealer_code_eng?>" list="agent_ids" id="dealer_code_eng" style="width:95%; font-size:12px;" onblur="getData2('agent_name_ajax.php', 'agent_info', this.value,  document.getElementById('dealer_code_eng').value);" tabindex="1"/>
	  ...
	  <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
        <div class="form-group row m-0">
          ...
          <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
            <input name="serial_number" type="text" id="serial_number" tabindex="3" value="<?=$serial_number?>" />
	  ...
	  <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
          <div class="form-group row m-0">
            ...
            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
              <input name="booking_number" type="text" id="booking_number" tabindex="4" value="<?=$booking_number?>" />
            </div>
          </div>
        </div>
      <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
        <div class="form-group row m-0">
          ...
          <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
            <input name="agent_name" type="text" id="agent_name" readonly="readonly" tabindex="5" value="<?=$agent_name?>" />
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
        <div class="form-group row m-0">
          ...
          <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
            <input name="area" type="text" id="area" readonly="readonly" value="<?=$area?>" />
          </div>
        </div>
      </div>
	   ...
	   <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
        <div class="form-group row m-0">
          ...
          <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
            <input name="quantity" type="text" id="quantity" tabindex="6" value="<?=$quantity?>" />
          </div>
        </div>
      </div>
        <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
  ...
  <div class="n-form-btn-class">
    <? if($token_nos>0){ ?>
	  <a href="../other_receive/or_receive.php?token_no=<?=$token_nos?>" class="btn1 btn1-bg-submit" >Store Receive</a>
	<? }else{ ?>
  ...
  <table id="" class="table1  table-striped table-bordered table-hover table-sm">
    ...
    <tbody class="tbody1">
      <?php
				...
				$td='select * from sr_token where 1 order by entry_at desc,serial_number desc limit 50';
