    ...
    <div class="row" id="agent_info">
        ...
        <div class="form-group row m-0">
          ...
          <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
            <input name="booking_number" type="text" id="booking_number" value="<?=$booking_number?>" list="serial_numbers" tabindex="2" onblur="getData2('sr_loan_return_ajax2.php', 'agent_info', this.value,  document.getElementById('dealer_code_eng').value);" value="<?=$sr_all->booking_number_eng ;?>" />
...
<!--<button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#loanDetailsModal">
    <i class="bi bi-eye"></i> Show Loan Details
</button>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content shadow-lg rounded">
            ...
            <div class="modal-header bg-primary text-white">
                <h5 class="modal-title" id="loanDetailsModalLabel"><i class="bi bi-cash-coin"></i> Loan Details</h5>
            ...
            <div class="modal-body bg-light">
                ...
                <div class="text-end p-2">
                    <h5 class="fw-bold text-danger">Total Interest Till Today: <?php echo number_format($tot_interest, 2); ?> TK</h5>
                </div>
            </div>
...
function cal(val){
 ...
 function calculateDays() {
	...
	var paidAmount = parseFloat(document.getElementById('total_paid').value);
	var intPercent = parseFloat(document.getElementById('intPercentage').value);
