   ...
   <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
      ...
      <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
        <div class="form-group row m-0">
          ...
          <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
            <input name="farmer_name" type="text" id="farmer_name" tabindex="2" value="<?=$dealerAll->dealer_name_e?>" />
          </div>
        </div>
      </div>
      ...
      <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
        <div class="form-group row m-0">
          ...
          <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
            <input name="area" type="text" id="area" tabindex="4" value="<?=$dealerAll->address_e?>" />
          </div>
        </div>
      </div>
