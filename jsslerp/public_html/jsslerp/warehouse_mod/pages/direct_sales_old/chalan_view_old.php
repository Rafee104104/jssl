...
$datas  =find_all_field('warehouse_other_issue','','oi_no='.$oi_no);
$group  =find_all_field('user_group','','id="'.$_SESSION['user']['group'].'"');
$data   =findall("select b.* from warehouse_other_issue b where b.oi_no = '".$oi_no."'");
$dealer =findall("select * from dealer_info where dealer_code='".$data->vendor_id."'");
$winfo  =findall("select * from warehouse where warehouse_id='".$_SESSION['user']['depot']."'");

$oi_date            =$data->oi_date;
$entry_by           = find_a_field('user_activity_management','fname','user_id="'.$data->entry_by.'"');

$sql1="select b.*,i.finish_goods_code 
from warehouse_other_issue_detail b, item_info i 
where i.item_id=b.item_id and b.oi_no = '".$oi_no."'";
...
$pi++;
    ...
    $fg_code[]      = $info->finish_goods_code;
    $rate[]         = $info->rate;
    $amount[]       = $info->amount;
    $unit_qty[]     = $info->qty;
    $dis_per[]      = $info->dis_per;
            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><table  width="80%" border="0" align="center" cellpadding="3" cellspacing="0">
                  <tr>
                    <td bgcolor="#FFFFCC" style="text-align:center; color:#000000; font-size:14px; font-weight:bold;"><span class="style4">MEP Group<br />
                          <span class="style6"><?=$winfo->address?></span></span></td>
                  </tr>
		  ...
		  <tr>
		    <td valign="top">
		      <table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px">
		        <tr>
		          <td width="40%" align="right" valign="middle">Party Name: </td>
		          <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
		            <tr>
		              <td><?php echo $datas->customer_name;?>&nbsp;, Mobile: <?=$datas->customer_mobile;?></td>
		              </tr>
		            </table></td>
		          </tr>
			...
			<td width="30%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px">
			  <tr>
                <td align="right" valign="middle">Sales No:</td>
			    <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
                    <tr>
			  ...
			  <tr>
                <td align="right" valign="middle"> Sales Date</td>
			    <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
                    <tr>
...
<table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="5">
       <tr>
        ...
        <td align="center" bgcolor="#CCCCCC"><strong>Dis%</strong></td>
...
<tr>
        ...
        <td align="left" valign="top"><?=$fg_code[$i]?></td>
        ...
        <td align="right" valign="top"><?=$dis_per[$i]?></td>
        <td align="right" valign="top"><?=$amount[$i]; $t_amount = $t_amount + $amount[$i];?></td>
</tr>
<? }?>
<tr> 
  <td colspan="7" align="center" valign="top"><div align="right"><strong>Product Amount: </strong></div></td>
        <td align="right" valign="top"><span class="style1"><?=$t_amount?></span></td>
</tr>    
    

<tr>
    <td colspan="7" align="center" valign="top"><div align="right"><strong>Discount Amount: </strong></div></td>
    <td align="right" valign="top"><span class="style1"><?=$datas->discount_amt?></span></td>
</tr>

<tr>
    <td colspan="7" align="center" valign="top"><div align="right"><strong>Grand Total: </strong></div></td>
    <td align="right" valign="top"><span class="style1"><?=$t_amount-$datas->discount_amt?></span></td>
</tr>
