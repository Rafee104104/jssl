...
echo $do_sql = "select a.*, m.sr_no,m.depot_id, m.sr_date from sale_return_master m, sale_return_details a where m.do_no=a.do_no and a.sr_no='".$or_no."' ";

$doSql=mysql_query($do_sql);
while($data=mysql_fetch_object($doSql)){
...
mysql_query('update sale_return_master set status="CHECKED" where sr_no="'.$or_no.'"');
$tr_type="Complete";
}
