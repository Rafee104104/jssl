...
$title='Unapproved cfr List';

$table = 'requisition_master_cfr';
$unique = 'req_no';
$status = 'approve3gm_id';
$target_url = '../cfr/cfr_checking3.php';
  ...
  <tr>
    ...
    <td ><strong>
      <select  style="width: 280px;" name="<?=$unique?>" id="<?=$unique?>">
        <? foreign_relation($table,$unique,$unique,$$unique,'status="'.$status.'" and req_from = "HRM" '); ?>
      </select>
    </strong></td>
    <td><strong>
