...
$title='New Cash Fund Requisition Create';


do_calander('#need_by');

$table_master='requisition_master_cfr';
$table_details='requisition_order_cfr'; 
$unique='req_no';
...
{
		$update="update requisition_master_cfr set status='MANUAL' where req_no='".$$unique."'";
	mysql_query($update);
	header('Location: select_unapproved_cfr3_gm.php');
}
...
if(isset($_POST['confirmm']))
{
		...
		//NOW
		$_POST['status']='approve3gm_id';
		$_POST['approve3gm_id']=$_SESSION['user']['id'];
		$_POST['approve3gm_at']=date('Y-m-d h:s:i');
...
<form action="cfr_create.php" method="post" name="codz" id="codz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
...
<table width="40%" border="1" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
  ...
  <tr>
    ...
    <td rowspan="2" align="center" bgcolor="#CCFF99"><a href="cfr_print_view.php?req_no=<?=$req_no?>" target="_blank"><img src="../../images/print.png" width="26" height="26" /></a></td>
  </tr>
  <tr>
...
<table  width="100%" border="1" align="center"  style="border-collapse:collapse; border:1px solid #caf5a5;" cellpadding="2" cellspacing="2">
                                <tr>
                        <td width="34%" align="center" bgcolor="#0099FF"><strong>Particulars</strong></td>
                       <td width="12%" align="center" bgcolor="#0099FF"><strong>Need Amount</strong></td>
                        <td width="16%" align="center" bgcolor="#0099FF"><strong>Amount</strong></td>
						<td width="12%" align="center" bgcolor="#0099FF"><strong>Estimate Value</strong></td>
                        <td width="17%" align="center" bgcolor="#0099FF"><strong>Last Receive Date </strong></td>
                        <td width="17%" align="center" bgcolor="#0099FF"><strong>Present Balance </strong></td>
						 <td width="10%" align="center" bgcolor="#0099FF"><strong>Remraks</strong></td>
                      ...
                      <tr>
                        <td align="center" bgcolor="#CCCCCC"><input  name="<?=$unique?>"i="i" type="hidden" id="<?=$unique?>" value="<?=$$unique?>"/>
                            ...
                            <input  name="particulars"  type="text" id="particulars" value="<?=$particulars?>" style="width:300px;" required="required" onblur="getAjaxData(this.value)"/>
							
						</td>
         
                          <td  align="center" bgcolor="#CCCCCC">
						<span id="mr">
							<input name="need_amnt" type="text" class="input3" id="need_amnt" style="width:106px;"  />
						  </td>
                        <td  align="center" bgcolor="#CCCCCC">
						<span id="mr">
							<input name="amount" type="text" class="input3" id="amount" style="width:106px;"  />
						  </td>
						  <td  align="center" bgcolor="#CCCCCC">
						<span id="mr">
							<input name="est_value" type="text" class="input3" id="est_value" style="width:106px;"  />
						  </td>
						<td  align="center" bgcolor="#CCCCCC">
						<input name="last_rec_date" type="date" class="input3" id="last_rec_date"  maxlength="100" style="width:80px;"  />
						</span></td>
						<td align="center" bgcolor="#CCCCCC"><input name="present_balance" type="text" class="input3" id="present_balance"   style="width:60px;" /></td>
...
<br /><br /><br /><br />
<? 
$res='select a.id, a.particulars, a.need_amnt, a.amount, a.est_value, a.last_rec_date ,a.present_balance,a.item_for as remarks,"x" 

from requisition_order_cfr a

where 1 and a.req_no='.$req_no;
?>
...
<form action="" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
  <table width="100%" border="0">
    <tr>
      ...
      <input name="unfinished"  type="submit" class="btn1" value="UNFINISHED REQUSITION" style="width:270px; font-weight:bold; font-size:12px;color:#F00; height:30px" />
