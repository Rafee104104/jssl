...
$emp=find_all_field('user_activity_management','','user_id='.$_SESSION['user']['id']);
...
<input  name="req_for" type="text" id="<?=$field?>" value=" "/>
...
<table  width="100%" border="1" align="center"  style="border-collapse:collapse; border:1px solid #caf5a5;" cellpadding="2" cellspacing="2">
                      ...
                      <tr>
                        <td align="center" bgcolor="#CCCCCC"><input  name="<?=$unique?>"i="i" type="hidden" id="<?=$unique?>" value="<?=$$unique?>"/>
							...
							<input  name="entry_b" type="hidden" id="entry_b" value="<?=$_SESSION['employee_selected'];?>"/>
...
function getAjaxData(val){
	...
	var val = item_id.split('#>#>');
	
	var warehouse_id = document.getElementById('warehouse_id').value;
	var entry_by = document.getElementById('entry_b').value;
	var data = entry_by;
