...
<div class="row" id="agent_name_find">
  ...
  <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
    <div class="form-group row m-0">
      ...
      <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
        <input name="booking_number_eng" type="text" id="booking_number_eng" readonly=""  value="<? echo $dealerAll->dealer_code_eng.'/'.date('y').'/'.$fc.'-'.(find_a_field('paid_booking','count(booking_id)','booking_type="'.$booking_type.'" and agent_id='.$dealerAll->dealer_code_eng)+1);?>" />
      </div>
    </div>
  </div>
  <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
...
<div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
  <div class="form-group row m-0">
    ...
    <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
      <input name="booking_rate" type="text" id="booking_rate" tabindex="14" value="<?=$booking_rate?>" />
    </div>
  </div>
</div>
<div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
  <div class="form-group row m-0">
    ...
    <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
      <input name="bag_quantity" type="text" id="bag_quantity" tabindex="14"  value="<?=$bag_quantity?>" />
    </div>
  </div>
</div>
