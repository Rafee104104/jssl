        ...
        <div class="row m-0 p-0">
            <div class="col-sm-5">
                ...
                <div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="100" checked="checked" tabindex="1"/>
                    <label class="form-check-label p-0" for="report1-btn">
                        RM Consumption Receive Report
                    </label>
                </div>
...
<!--                <div class="form-group row m-0 mb-1 pl-3 pr-3">
				...
				<div class="form-group row m-0 mb-1 pl-3 pr-3">
                    <label for="group_for" class="col-sm-4 m-0 p-0 d-flex align-items-center">Batch No:</label>
                    <div class="col-sm-8 p-0">
