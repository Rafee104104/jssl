...
{
$status = $_POST['status'];
$sql_data = "UPDATE rm_consumption SET status ='".$status."' WHERE batch_no='".$pr_no."'";
mysql_query($sql_data);
?>
<script>location.href='../production_dailyrice/fg_receive_status.php';</script>

<? }

$target_url = '../production_dailyrice/fg_receive_status.php';
...
<h3 style="text-align:center; padding: 5px;">			
	Batch NO: <span style="font-weight: bold; font-size: 1.75rem;"> <?=$pr_no?> </span>
</h3>
<?
...
<div class="form-group row m-0 pl-3 pr-3">
  <form id="form1" name="form1" method="post" action="">
	...
	<div class="col-sm-9 col-form-label pl-0" style=" padding-left: 0px; ">
		<input name="update" type="submit" id="update" value="Update" style=" padding: 0px 15px; border: 1px solid #333; border-radius: 3px; background-color: #09a52b; color: #fff; "/>
	</div>
...
<h3 style="text-align:center; padding: 5px;"> Raw Material Comsumption</h3>
...
<br />
<h3 style="text-align:center;"> Finish Goods Receive</h3>
...
<table width="100%;"  id="ExportTable" cellspacing="0" cellpadding="2" border="0" >
	...
	<?php
		 ...
		 $sql='SELECT fg.item_id, fg.receive_qty, fg.batch_no, fg.cost_price, fg.total_amt, i.item_id ,i.item_name, i.unit_name FROM fg_production fg, item_info i WHERE fg.item_id=i.item_id and i.sub_group_id=200010000 and fg.batch_no="'.$pr_no.'"';
...
<br />
<h3 style="text-align:center;"> Wastage Entry</h3>
...
<table width="100%;"  id="ExportTable" cellspacing="0" cellpadding="2" border="0" >
	...
	<?php
		 ...
		 $sql1='SELECT fg.item_id, fg.receive_qty, fg.batch_no, fg.cost_price, fg.total_amt, i.item_id ,i.item_name, i.unit_name FROM fg_production fg, item_info i WHERE fg.item_id=i.item_id and i.sub_group_id !=200010000 and fg.batch_no="'.$pr_no.'"';
...
$query1=mysql_query($sql1);
	...
	$opening1 = $open_new[$row->item_id];
	
	$item_in1 = $item_in_new[$row->item_id];
	$item_out1 = $item_out_new[$row->item_id];
	
	$open_sum1 = $opening1 + $item_in1;
	
	$Balance1 = $open_sum1 - $item_out1;
	
	$total_receive1 = $total_receive1+$row->receive_qty;
	$total_receive_amt1 = $total_receive_amt1+$row->total_amt;
	?>
		...
		<tr align="center" style="font-weight:bold;">
			<td colspan="3">TOTAL</td>
			<td align="center"><?=number_format( $total_receive1,2)?></td>
			<td></td>
			<td align="center"><?=number_format( $total_receive_amt1,2)?></td>
		</tr>
	</tbody>
</table>
...
<br />
<h3 style="text-align:center;">Finish Goods Costing Ratio</h3>
