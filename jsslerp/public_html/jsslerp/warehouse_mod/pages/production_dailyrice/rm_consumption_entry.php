...
$issue_no = next_transection_no($group_for,$data_found,'rm_consumption','issue_no');
...
//   		$chalan_no=''.$yer.''.$month.''.$cy_id;
...

		{
...

			{
				...
				$bag_qty=$_POST['bag_qty_'.$data->item_id];


   $ins_invoice = 'INSERT INTO rm_consumption (issue_no,batch_no,batch_type, issue_date, group_for, warehouse_id, item_id, unit_name, issue_qty, avg_price, total_amt, remarks, entry_at, entry_by,bag_qty)

  

  VALUES("'.$issue_num.'","'.$batch_no.'","'.$batch_type.'", "'.$issue_date.'", "'.$group_for.'", "'.$warehouse_id.'", "'.$item_id.'", "'.$data->unit_name.'", "'.$issue_qty.'", "'.$avg_price.'", "'.$total_amt.'", "'.$remarks.'",  "'.$entry_at.'", "'.$entry_by.'","'.$bag_qty.'")';
				...
				<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 pt-1 pb-1">
						...
						<div class="form-group row m-0">
							...
							<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
								...
								<input name="issue_num" type="text" id="issue_num"  readonly="" value="<?=$issue_no?>"   required />
					...
					<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6  pt-1 pb-1">
						...
						<div class="form-group row m-0">
							...
							<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">BATCH NO</label>

							<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">

								<input name="batch_no" type="text" id="batch_no"  value="<?='BATCH-'.$issue_no?>"   />
						...
						while($data=mysql_fetch_object($query)){$i++;
							...
							<tr bgcolor="<?=($i%2)?'#E8F3FF':'#fff';?>">
								...
								<td  >
									...
									<input name="bag_qty_<?=$data->item_id?>" id="bag_qty_<?=$data->item_id?>" type="text"  value=""    />								</td>
		<td  >
									...
									<input name="issue_qty_<?=$data->item_id?>" id="issue_qty_<?=$data->item_id?>" type="text"  value=""  onkeyup="EXPcalculation(<?=$data->item_id?>)" />								</td>
