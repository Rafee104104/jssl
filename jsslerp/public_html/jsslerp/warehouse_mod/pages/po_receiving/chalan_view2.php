...
<div class="container">
	...
	<div class="row">
      <div class="col-6">
			...
			<div class="input-group mb-3 input-group-sm">
			  <div class="input-group-prepend">
				<span class="input-group-text"  style="font-weight:bold;">Remarks: </span>
			  </div>
			  <input type="text" disabled class="form-control" id="ch_no" value="<?php echo $remarks;?>">
			</div>
...
<td><a href="../../../purchase_mod/pages/po/po_print_view.php?po_no=<?=$po_no; ?>" target="_blank"><?=$po_no; ?></a></td>
</tr>
...
<? for($i=0;$i<$pi;$i++){?>
      ...
      <tr style="text-align:center;">
        ...
        <td><?=$i+1?></td>
        <td><?=find_a_field('item_info','item_id','item_id='.$item_id[$i]);?></td>
