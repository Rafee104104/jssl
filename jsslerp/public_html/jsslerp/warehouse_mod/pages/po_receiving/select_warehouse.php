      ...
      <div class="col-sm-9 col-md-9 col-lg-9 col-xl-9">
        <div class="form-group row m-0">
          ...
          <div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0">
            <input name="booking_number" id="booking_number" list="booking_numbers"  autocomplete="off"  >
    ...
    <table class="table1  table-striped table-bordered table-hover table-sm">
      ...
      <tbody class="tbody1">
        ...
        <tr>
          ...
          <td><input name="account_code_<?=$data->tr_no?>" id="account_code_<?=$data->tr_no?>" type="hidden"  value="<?=$data->ledger_id?>"  />
            <input name="tr_no_<?=$data->tr_no?>" id="tr_no_<?=$data->tr_no?>" type="hidden"  value="<?=$data->tr_no?>"  />
            <input name="payment_amt_<?=$data->tr_no?>" id="payment_amt_<?=$data->tr_no?>" type="text" size="10"  value=""   />
          </td>
          <td align="center"><center>
              <button onclick="sum_sum(<?=$data->tr_no ?>)" type="button" class="btn1 btn1-bg-submit" >Full</button>
            </center></td>
        </tr>
        <? } }?>
      </tbody>
