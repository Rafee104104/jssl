...
if(isset($_POST['confirm'])){
		...
		if($_FILES['upload_chalan_1']['tmp_name']!=''){
			...
			$field = 'upload_chalan_1';  //'PBI_PICTURE_ATT_PATH';
	...
	if($_FILES['upload_chalan_2']['tmp_name']!=''){
			...
			$field = 'upload_chalan_2';  //'PBI_PICTURE_ATT_PATH';
		
			$file_name = $folder.'-'.$pr_no;
		
			if($_FILES['upload_chalan_2']['tmp_name']!=''){
		$_POST['upload_chalan_2']=upload_file($folder,$field,$file_name);
			}
...
//		}
		...
		while($data=mysql_fetch_object($query)){
			...
			if(($_POST['chalan_'.$data->id]>0)){
				...
				$real_price=$_POST['real_price_'.$data->id];
				$item_id =$_POST['item_id_'.$data->id];
				$unit_name =$data->unit_name;
				$amount = round(($qty*$rate),0);
				$total = $total + $amount;
				
				$real_amt = round(($qty*$real_price),0);
...
`entry_at`,ch_no, transport_charge, other_charge, remarks, avg_price,status,upload_chalan_1,upload_chalan_2,upload_chalan_3,is_complete,real_price,real_amt)

 VALUES('".$pr_no."', '".$group_for."', '".$po_no."', '".$data->id."', '".$rec_no."','".$rec_date."',".$vendor_id.", ".$item_id.",".$warehouse_id.", ".$rate.", '".$qty."', '".$unit_name."',  '".$amount."', '".$qc_by."',  '".$_SESSION['user']['id']."', '".$now."', '".$ch_no."', '".$transport_charge."', '".$other_charge."', '".$remarks."', '".$final_avg_price."', 'Received','".$_POST['upload_chalan_1']."','".$_POST['upload_chalan_2']."','".$_POST['upload_chalan_3']."','".$balCheck."','".$real_price."','".$real_amt."')";
...
header('Location: sec_journal_purchase.php?pr_no='.$pr_no.'');
		//auto_insert_purchase_secoundarys($pr_no);
...
<div class="container-fluid bg-form-titel">
                    ...
                    <div class="container n-form2">
                        ...
                        <div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
								...
								<input type="file" name="upload_chalan_1" id="upload_chalan_1" accept="image/jpeg" class="form-control"  />
				...
				<div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
                    ...
                    <div class="container n-form2">
                        ...
                        <div class="form-group row m-0 pb-1">
                            ...
                            <label  class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Manual Rec Num</label>

                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">

        						<input type="text" name="rec_no" id="rec_no" value="<?=$rec_no= find_a_field('purchase_receive','max(rec_no)','1')+1;?>" />
        ...
        <div class="container-fluid pt-5 p-0 ">
				...
				<? if($$unique>0){
					...
					$sql='select a.id,a.item_id,b.item_name,b.unit_name,a.qty,a.rate,a.vat_with_price,a.is_complete from purchase_invoice a,item_info b where b.item_id=a.item_id and a.po_no='.$$unique;
            ...
            <table class="table1  table-striped table-bordered table-hover table-sm">
				...
				<td><?=$row->item_id?>
				  ...
				  <td align="left"><?=$row->item_name?>
					...
					<input  type="hidden" name="real_price_<?=$row->id?>" id="real_price_<?=$row->id?>" value="<?=$row->rate?>" style="width:90px; float:none" />
