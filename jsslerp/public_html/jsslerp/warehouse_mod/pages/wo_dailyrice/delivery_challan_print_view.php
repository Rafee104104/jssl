    ...
    <td><div class="header">
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="60%"><table  width="80%" border="0" align="center" cellpadding="3" cellspacing="0">
                            <tr>
                              <td style="text-align:center; color:#000; font-size:15px; font-weight:bold;">
								...
								<p style="font-size:15px; font-weight:300; color:#000000; margin:0; padding:0;"><?=$group_data->address?></p>
								<p style="font-size:15px; font-weight:300; color:#000000; margin:0; padding:0;">Phone No. : <?=$group_data->mobile?>,  Email : <?=$group_data->email?></p>                              </td>
                            </tr>
                            <tr>
        ...
        <!--<td bgcolor="#666666" style="text-align:center; color:#FFF; font-size:18px; font-weight:bold;">WORK ORDER </td>-->
					...
					<tr>
					  ...
					  <td align="center"><h4 style="font-size:16px; margin: 1px;">Customer's Copy</h4></td>
					  </tr>
						...
						<tr>
							<td><span style="font-size:15px; padding: 3px 0 0 10px; letter-spacing:7px;"><?=$chalan_no?></span></td>
						</tr>
 ...
 <tr> <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
		    ...
		    <td width="100%" valign="top">
		      ...
		      <table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:16px">


		        <tr>
		          <td width="13%" align="left" valign="middle" style="font-size:15px; font-weight:700;">Customer Name</td>
		          <td width="25%" style="font-size:15px; font-weight:700;">:	&nbsp;
		            <?= find_a_field('dealer_info','dealer_name_e','dealer_code="'.$master->dealer_code.'"');?></td>
	              <td width="10%" style="display: none;">Job No </td>
	              <td width="18%" style="display: none;">: &nbsp;<?=$ch_data->job_no;?></td>
			...
			<!--<tr>
		        ...
		        <tr>
					<td align="left" valign="middle">Mobile No </td>
					<td>:	&nbsp; <?= find_a_field('dealer_info','contact_no','dealer_code="'.$master->dealer_code.'"');?></td>
					
					<td width="10%">PO Date </td>
	             	<td width="18%">: &nbsp;<?php $po_date=find_a_field('sale_do_master','po_date','po_no="'.$master->po_no.'"');  echo  $newDate3 = date("d-m-Y", strtotime($po_date)); ?>
					</td>
  ...
  <tr>
    <td><div id="pr">
        <div align="left">
          ...
          <nobr>
          <!--<a href="chalan_bill_view.php?v_no=<?=$_REQUEST['v_no']?>">Bill</a>&nbsp;&nbsp;--><!--<a href="do_view.php?v_no=<?=$_REQUEST['v_no']?>" target="_blank"><span style="display:inline-block; font-size:15px; color: #0033FF;">Bill Copy</span></a>-->
          </nobr>
		  <nobr>
      ...
      <table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="5"  style="font-size:15px">
       
       
<tr>

<th width="5%" bgcolor="#CCCCCC">SL</th>
<th width="10%" bgcolor="#CCCCCC">Item Code </th>
<th width="30%" bgcolor="#CCCCCC">Item Description </th>
<th width="15%" bgcolor="#CCCCCC">Gluteen</th>
<th width="5%" bgcolor="#CCCCCC">Unit</th>
<th width="10%" bgcolor="#CCCCCC">Quantity(BAG)</th>
<th width="10%" bgcolor="#CCCCCC">Weight</th>
<th width="15%" bgcolor="#CCCCCC">Total Weight</th>
</tr>
...
$res='select  item_id,unit_price, sum(total_unit) as total_unit,sum(total_amt) as total_amt,qty_bag,bag_size,gluteen
...
<td style="text-align:center;"><?=$data->qty_bag?></td>
...
<?=$data->total_unit?>
        ...
        <?
$total_quantity = $total_quantity + $data->qty_bag;
$total_weight = $total_weight + $data->total_unit;
...
<td></td>
			<td style="text-align:right;"><strong><?=number_format($total_weight,0);?></strong></td>
</tr>
      </table>      </td>
  </tr>
  ...
  <tr>
	...
	<table width="100%" cellspacing="0" cellpadding="0"  >
		...
		<tr style="font-size:15px">
			...
			<td>&nbsp;</td>
			<td  align="center" width="20%"><strong>Buyer Signature</strong></td>
	...
	<?php /*?><tr>
		  ...
		  <tr>
			 <td colspan="3" style="border:0px;border-color:#FFF; color: #000;  font-size:15px; " align="center" >Head Office: 238, Tejgaon Industrial Area, Gulshan Link Road, Dhaka -1208.</td>
		</tr>
		  <tr>
			 <td colspan="3" style="border:0px;border-color:#FFF; color: #000; font-size:15px; " align="center" >Phone: 
			  88-02- 8878543-49. Cell :- +88 01401140030</td>
          </tr>
		  <tr>
			 <td colspan="3" style="border:0px;border-color:#FFF; color: #000; font-size:15px; " align="center" >Web: 
    ...
    <td><div class="header">
        ...
        <!--<td bgcolor="#666666" style="text-align:center; color:#FFF; font-size:18px; font-weight:bold;">WORK ORDER </td>-->
					...
					<tr>
					  ...
					  <td align="center"><h4 style="font-size:16px; margin: 1px;">Office Copy</h4></td>
					  </tr>
...
<?=$data->total_unit?>
        ...
        <?
$total_quantity1 = $total_quantity1 + $data->qty_bag;
$total_weight1 = $total_weight1 + $data->total_unit;
		 }
...
<td><strong>  Total:</strong></td>
<td style="text-align:center;"><strong>
  <?=number_format($total_quantity1,0);?>
</strong></td>
<td></td>
			<td style="text-align:right;"><strong><?=number_format($total_weight1,0);?></strong></td>
</tr>
      </table>      
