...
$unique = 'po_no';
$status = 'CHECKED';
$target_url = '../cash_sales_golden/local_sales_print_view.php';
...
$con .= 'and a.oi_date between "'.$_POST['fdate'].'" and "'.$_POST['tdate'].'"';
 ...
 $res='select  a.oi_no,a.oi_no as ls_no,a.oi_date as ls_date, a.vendor_name as sales_from,sum(amount) as Total,a.entry_at,c.fname as user,a.status from warehouse_other_issue a,warehouse_other_issue_detail b, user_activity_management c where a.oi_no=b.oi_no and a.entry_by=c.user_id and a.warehouse_id = "'.$_SESSION['user']['depot'].'" and a.issue_type = "CASH Sales" '.$con.' group by a.oi_no order by a.oi_no desc';
