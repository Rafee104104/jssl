...
('".$pr_no."',  '".$_POST['pr_date']."', '".$_POST['vendor_id']."',  '".$_POST['via_customer']."',  '".$item_id."', 
...
var total_amt = (document.getElementById('total_amt').value) = (unit_price*total_unit).toFixed(2);
...
<!--        top form start hear-->
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <div class="container n-form2">
                        <div class="form-group row m-0 pb-1">
                            <label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Purchase Return No:</label>
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <div class="container n-form2">
                        ...
                        <div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
                                <input name="return_type"  id="return_type" value="Purchase Return" type="text" readonly="readonly"  >
		...
		<input name="new2" type="submit" class="btn1 btn1-bg-submit" value="Update Entry"  tabindex="12" />
		...
		<? }else{?>
		<input name="new2" type="submit" class="btn1 btn1-bg-submit" value="Initiate Entry"  tabindex="12" />
...
<input  name="item_id" list="item_ids" type="text" id="item_id" value="<?=$item_id?>" style="width:320px;" required onblur="getData2('po_ajax.php', 'po',this.value,document.getElementById('item_id').value);"/>

	<datalist id="item_ids">
							<?
							 foreign_relation('item_info','item_id','concat(item_name,"#>",item_id)',$item_id, '1 order by item_id asc');
							?>
							</datalist>
