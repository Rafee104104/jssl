...
if(isset($_POST['confirmm']))
{
		...
		add_to_sec_journal($proj_id, $jv_no, $jv_date, $data->ledger_id, $narration, $data->amount,'0',  $tr_from, $tr_no,'',$tr_id,$cc_code,$group_for,'','','','','','','','YES');
		$total_amt +=$data->amount;
		}
		add_to_sec_journal($proj_id, $jv_no, $jv_date, $localPurchaseLedger, $narration, '0',$total_amt, $tr_from, $tr_no,'',$tr_id=0,$cc_code,$group_for,'','','','','','','','YES');
