...
<!--            <li style="display: block;"> <a class="oe_menu_toggler" data-action-id="" data-action-model="" data-menu="121" href="#menu_id=121&amp;action="> <span class="oe_menu_text"> Security </span> </a> </li>
          ...
          <div class="oe_systray">
            ...
            <div class="oe_topbar_item oe_topbar_compose_full_email" title="Compose new Message"> Welcome... Sajeeb Group ERP <a href="../main/logout.php"><img src="../../img/LogOut.png" height="20" alt="log Out"></a></div>
          </div></td></tr>
      <tr>
        <td style="display: table-cell;" class="oe_leftbar" valign="top"><a class="oe_logo" href="https://www.openerp.com/"> <img src="../../../logo/title.png" width="200px"> </a>
                ...
                <tr><td><div class="smartmenu">
                      ...
                      <div class="submenu">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr><td><a href="../hrm/employee_basic_information.php">Basic Info</a></td></tr>
                          <tr><td><a href="../hrm/employee_essential_information.php">Essential Info</a></td></tr>
                          <tr><td><a href="../hrm/edcation.php">Education</a></td></tr>
                          <tr><td><a href="../hrm/course_diploma.php">Course/Diploma</a></td></tr>
                          <tr><td><a href="../hrm/experience.php">Experience</a></td></tr>
                          <tr><td><a href="../hrm/posting_entey.php">Posting</a></td></tr>
                          <tr><td><a href="../hrm/training.php">Training</a></td></tr>
                          <tr><td><a href="../hrm/transfer.php">Transfer</a></td></tr>
                          <tr><td><a href="../hrm/promotion.php">Promotion</a></td></tr>
                          <tr><td><a href="../hrm/domotion.php">Demotion</a></td></tr>
                          <tr><td><a href="../hrm/increment_entry.php">Increment</a></td></tr>
                          <tr><td><a href="../hrm/leave.php">Leave</a></td></tr>
                          <tr><td><a href="../hrm/administration_action.php">Admin Action</a></td></tr>
                          <tr><td><a href="../hrm/pf_status.php">PF Check List</a></td></tr>
                        </table>
                      </div>
					...
					<!--<div class="silverheader"><a href="">Attendence Basic Information</a></div>
					  ...
					  <? if(
							...
							$_SESSION['user']['username']=='1111111111'
							){ ?>
					<div class="silverheader"><a href="">Upload</a></div>
                      <div class="submenu">
						...
						<tr><td><a href="../attendence/upload_attendence_sales.php">Upload Attendence(Sales)</a></td></tr>
						  <tr><td><a href="../attendence/upload_attendence_store.php">Upload Attendence(Store)</a></td></tr>
                      ...
                      <div class="submenu">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr><td><a href="../attendence/monthly_attendence.php">Monthly Attendance</a></td></tr>
                          <tr><td><a href="../attendence/individual_attendance_report.php">Indevidual Monthly Attendance</a></td></tr>
                        </table>
                      </div>
                      ...
                      <div class="submenu">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr><td><a href="../payroll/salary_information.php">Basic Salary & Allowance</a></td></tr>
                          <tr><td><a href="../payroll/advance_payment.php">Advance Salary</a></td></tr>
                          <tr><td><a href="../payroll/motorcycle_install.php">Motor-Cycle Install</a></td></tr>
                      ...
                      <div class="submenu">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <tr><td><a href="../payroll/monthly_attendence.php">Final Payroll Process</a></td></tr>
						  </table>
                      </div>
...
<div class="submenu">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr><td><a href="../setup/action_type.php">Action Type</a></td></tr>
<tr><td><a href="../setup/bank_type.php">Bank Type</a></td></tr>
<tr><td><a href="../setup/department_type.php">Department Type</a></td></tr>
<tr><td><a href="../setup/designation_type.php">Designation Type</a></td></tr>
<tr><td><a href="../setup/domain_type.php">Section Name</a></td></tr>
<tr><td><a href="../setup/edu_subject_type.php">Education Subject Type</a></td></tr>
<tr><td><a href="../setup/edu_qua_type.php">Education Qualification Type</a></td></tr>
<tr><td><a href="../setup/project_type.php">Project Type</a></td></tr>
<tr><td><a href="../setup/relation_type.php">Relation Type</a></td></tr>
<tr><td><a href="../setup/university_type.php">University Type</a></td></tr>
<tr><td><a href="../setup/demotion_reason.php">Demotion Reason</a></td></tr>
<tr><td><a href="../setup/profession_type.php">Profession Type</a></td></tr>
<tr><td><a href="../setup/institute_type.php">Institute Type(Location)</a></td></tr>
<tr><td><a href="../setup/holy_day.php">Holy Day</a></td></tr>
<tr><td><a href="../setup/cooperative_rate.php">Co-Operative Installment</a></td></tr>
<tr><td><a href="../setup/office_location_type.php">Job Location</a></td></tr>
