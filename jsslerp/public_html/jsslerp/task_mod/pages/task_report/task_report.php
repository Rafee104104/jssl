...
<select name="project" style="width:160px;" id="PBI_ORG" class="form-control" >
<option> </option>
<? foreign_relation('crm_project_org','id','name',$project);?>
</select>
</span></td>
<td align="right"><strong>Status :</strong></td>
<td align="left"><span class="oe_form_group_cell">
<select name="status" style="width:160px;" id="status" class="form-control">
<option></option>
...
<!--<tr>
<td width="4%" align="center"><input name="report" type="radio" class="radio" value="999"/></td>
<td width="44%" align="left"><strong>Task Report</strong></td>
</tr>-->
<tr>
<td width="4%" align="center"><input name="report" type="radio" class="radio" value="606"  /></td>
<td width="44%" align="left"><strong>Project Issue Report</strong></td>
</tr>
<tr>
<td width="4%" align="center"><input name="report" type="radio" class="radio" value="404" checked="checked" /></td>
<td width="44%" align="left"><strong>Task Manage Report</strong></td>
</tr>
</tbody>
</table>
