...
<div class="row mt-3">
    ...
    <div class="col-md-4">
        ...
        <div class="form-group pt-3">
                <input type="radio" name="report" id="lead_report" value="2">
                <label for="lead_report" style="cursor:pointer;"> Lead Report</label>
        </div>
    ...
    <div class="col-md-4">
        ...
        <div class="form-group pt-3">
                <input type="radio" name="report" id="camp_report" value="4">
                <label for="camp_report" style="cursor:pointer;">Campaign Report</label>
        </div>
