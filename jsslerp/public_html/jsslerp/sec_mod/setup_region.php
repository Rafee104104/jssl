...
<div class="row mb-10 form-group">
	<label class="control-label col-md-6 col-sm-6" for="group_name">Region name<span class="required"></span></label>
...
?>                  	
                    <tr>
                      ...
                      <td>
	<a href="setup_region.php?edit_id=<?=$data->BRANCH_ID;?>">Edit</a> || 
	<a href="setup_region.php?delid=<?=$data->BRANCH_ID;?>" onClick="return confirm('Do you want to delete')">Delete</a>
					</td>
                    </tr>
<? } ?>                    
                  </tbody>
