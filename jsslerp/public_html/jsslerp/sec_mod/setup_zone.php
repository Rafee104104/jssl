...
?>                  	
                    <tr>
                      ...
                      <td>
	<a href="setup_zone.php?edit_id=<?=$data->ZONE_CODE;?>">Edit</a> || 
	<a href="setup_zone.php?delid=<?=$data->ZONE_CODE;?>" onClick="return confirm('Do you want to delete')">Delete</a>
					</td>
                    </tr>
<? } ?>                    
                  </tbody>
