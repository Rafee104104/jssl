...
<!--R=<?=$_SESSION['region_id']?>, Z=<?=$_SESSION['zone_id']?>, A=<?=$_SESSION['area_id']?>          -->
<!--           <div class="col-sm-6">
...
<br>
<div class="radio"><label>
<input type="radio" id="optionsRadios1" name="report" value="899"> Item List Details(899)
</label></div>
...
<div class="radio"><label><input type="radio" id="optionsRadios1" name="report" value="51"> Item Wise Order/Sales (51)</label></div>
<div class="radio"><label><input type="radio" id="optionsRadios1" name="report" value="52"> Outlet Wise Order/Sales (52)</label></div>

<div class="radio"><label><input type="radio" id="optionsRadios1" name="report" value="53"> NSP Report Chalan wise(53)</label></div>
<div class="radio"><label><input type="radio" id="optionsRadios1" name="report" value="54"> NSP Report Outlet wise(54)</label></div>
<div class="radio"><label><input type="radio" id="optionsRadios1" name="report" value="55"> NSP Report Details(55)</label></div>



<div class="radio"><label><input type="radio" id="optionsRadios1" name="report" value="101"> Item Wise Target/Sales (101)</label></div>
...
<label class="control-label col-md-4" for="">Product Company</label>
<div class="col-md-8">
    <select class="form-control col-md-12" name="group_for" id="group_for">
        <option></option>
<? optionlist('select id,company_short_code from user_group where 1 order by group_name');?>
    </select>
</div>
</div>
...
<? optionlist('select id,group_name from product_group where 1 order by group_name');?>
  ...
  <div class="form-group row">
    <label for="inputPassword3" class="col-md-4 col-form-label mb-10">Date</label>
    <div class="col-md-3"><input type="date" class="form-control" id="f_date" name="f_date" autocomplete="off" value="<?=date('Y-m-01');?>"></div>
	<div class="col-md-2 text-center"> To </div>
	<div class="col-md-3"><input type="date" class="form-control" id="t_date" name="t_date" autocomplete="off" value="<?=date('Y-m-d');?>"></div>
  </div>  
...
<div class="row mb-10 form-group">
    <label class="control-label col-md-4" for="">Route</label>
    <div class="col-md-8">
