...
<div class="row mb-10 form-group">
<label class="control-label col-md-6 col-sm-6" for="">Dealer<span class="required"></span></label>
<div class="col-md-6 col-sm-6 col-xs-12">
...
<? } ?>
        ...
        <form class="mt-5 p-5" action="" method="post" data-parsley-validate class="form-horizontal form-label-left">
           
        <div class="row mb-10 form-group">
        	<label class="control-label col-md-6 col-sm-6" for="first-name">Old Employee Code<span class="required"></span></label>
        	<div class="col-md-6 col-sm-6 col-xs-12">
        	<input class="col-md-12" type="text" name="old_fo" required="required" value=""
        	class="form-control col-md-7 col-xs-12">
        	</div>
        </div> 
