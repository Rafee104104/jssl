  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Shop Information</h1> <? if ($_SESSION['username']=='faysal'){?> <a href="shop_pic_compress.php" target="_blank">Pic Compress</a> <? } ?>
          </div>
          <div class="col-sm-6">
...
<label class="control-label col-md-6 col-sm-6" for="first-name">Shop Name<span class="required"></span></label>
...
<div class="row mb-10 form-group">
<label class="control-label col-md-6 col-sm-6" for="first-name">Owner Name<span class="required"></span></label>
<div class="col-md-6 col-sm-6 col-xs-12">
...
<div class="row mb-10 form-group">
<label class="control-label col-md-4" for="">Route<span class="required"></span></label>
<div class="col-md-8">
...
<div class="row mb-10 form-group">
<label class="control-label col-md-6 col-sm-6" for="first-name">SO CODE<span class="required"></span></label>
<div class="col-md-6 col-sm-6 col-xs-12">
