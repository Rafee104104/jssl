...
if(isset($_POST['hold'])){
		...
		?><script>window.location.href='maintenance_expense.php?pal=2';</script><?php 
}
...
<form action="maintenance_expense.php" method="post" name="codz" id="codz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">


<div class="form-group row">
            <div class="col-3"><label for="expense_no" class="col-form-label">Bill No. :</label></div> <!--sk-->
...
<form action="?<?=$unique?>=<?=$$unique?>" method="post" name="cloud" id="cloud" enctype="multipart/form-data">
<table  width="100%" border="1" align="left"  style="border-collapse:collapse; border:1px solid #caf5a5;" cellpadding="2" cellspacing="2">


<tr>
    <td colspan="2" align="center"><span class="style1">Expense Details:</span></td>
    <td colspan="2" align="center" bgcolor="#CCCCCC">
    <input  name="<?=$unique?>" type="hidden" id="<?=$unique?>" value="<?=$$unique?>"/>
    <input  name="expense_date" type="hidden" id="expense_date" value="<?=$expense_date?>"/>
    
    <input class="form-control border border-info" list="items" name="item_id" id="item_id" tabindex="1" onChange="getData()" autocomplete="off"/>
    <datalist id="items">
    	<?php optionlist('select concat(expense_name,"#",id) from expense_head where 1 order by expense_name asc');?>
    </datalist>
    </td>
    <td></td>
    <td></td>
...
<tr>
    ...
    <td align="center" bgcolor="#0099FF"><span class="style1"><strong>Amount</strong></span></td> <!--SK-->
    <td align="center" bgcolor="#0099FF"><span class="style1"><strong>Attc</strong></span></td>
    <td></td>
    <td></td>
</tr>
...
<tr>
    ...
    <input name="qty" type="text" class="input3" id="qty" tabindex="2" style="width:50px;" required/>
    </td>
    
    <td align="center" bgcolor="#CCCCCC">
    <input name="rate" type="text" class="input3" id="rate" tabindex="4" style="width:80px;"  onChange="count()" autocomplete="off" required/>
    </td>
    
    
    <td align="center" bgcolor="#CCCCCC"><input name="amount" tabindex="5" type="number" class="input3" id="amount"  maxlength="100" style="width:60px;" onChange="count()" required autocomplete="off"/></td>
    <td align="center" bgcolor="#CCCCCC"><input name="att_file" tabindex="6" type="file" class="input3" id="att_file" style="width:90px;" readonly="readonly" required/></td>
