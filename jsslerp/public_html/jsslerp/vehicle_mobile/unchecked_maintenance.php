...
$sql = "select m.* from maintenance_expense m where 1 and m.status='UNCHECKED' ".$con." order by m.expense_no asc";
...
<div class="col-12">
    <div class="card shadow-sm mb-2">        
        ...
        <a href="maintenance_checking.php?expense_no=<?=$data->expense_no?>">   
