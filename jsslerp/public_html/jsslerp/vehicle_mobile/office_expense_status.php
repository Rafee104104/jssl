...
<!-- User list items  -->
<div class="row">
<div class="row text-center mb-2"><h4>Office Expense Status<br /><?=$_SESSION['msg'];unset($_SESSION['msg']);?></h4></div>    
...
$sql = "select m.* from office_expense m where 1 ".$con." order by m.expense_no asc";
