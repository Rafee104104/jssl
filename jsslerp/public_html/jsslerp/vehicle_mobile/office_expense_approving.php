...
mysqli_query($conn, "update office_expense set expense_date='".$_POST['expense_date']."' where expense_no='".$_POST['expense_no']."'");		
...
if(isset($_POST['hold'])){
		...
		?><script>window.location.href='unapproved_office_expense.php';</script><?php 
}
...
?><script>window.location.href='unapproved_office_expense.php';</script><?  
} // End confirm
...
<? 
$res='select a.id,a.items as name,a.qty as qty,a.rate as rate,a.expense_no,a.expense_date,a.amount as amt,a.att_file,"x" 
