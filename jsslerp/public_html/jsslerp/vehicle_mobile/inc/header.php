                ...
                <div class="col-12 profile-sidebar">
                    ...
                    <div class="row">
                        ...
                        <div class="col px-0 align-self-center">
                            ...
                            <p class="text-muted size-12">Dhaka,<br />BD</p>
                        ...
                        <li class="nav-item dropdown">
							...
							<ul class="dropdown-menu">
                                ...
                                <li>
                                    ...
                                    <a class="dropdown-item nav-link" href="attendance.php">
                                ...
                                <li>
                                    ...
                                    <a class="dropdown-item nav-link" href="att_report.php">
            ...
            <div class="row">
                ...
                <div class="col">
                    ...
                    <div class="logo-small">
                        ...
                        <h5>Vehicle<br /><span class="text-secondary fw-light">Management</span></h5>
