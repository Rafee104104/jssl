...
<!-- User list items  -->
<div class="row">
<div class="row text-center mb-2"><h4>Pending Approval..<br /><?=$_SESSION['msg'];unset($_SESSION['msg']);?></h4></div>    
...
$sql = "select m.* from maintenance_expense m where 1 and m.status='CHECKED' ".$con." order by m.expense_no asc";
...
<div class="col-12">
    <div class="card shadow-sm mb-2">        
        ...
        <a href="maintenance_approving.php?expense_no=<?=$data->expense_no?>">   
...
if(isset($_POST['show'])){
   ...
   $sql1 = "select   m.expense_date,  m.expense_no, m.status, m.entry_by,m.entry_at from maintenance_expense m
