...
$sql = "select m.* from office_expense m where 1 and m.status='UNCHECKED' ".$con." order by m.expense_no asc";
...
<div class="col-12">
    <div class="card shadow-sm mb-2">        
        ...
        <a href="office_expense_checking.php?expense_no=<?=$data->expense_no?>">   
