...
$sql = "select m.* from office_expense m where 1 and m.status='CHECKED' ".$con." order by m.expense_no asc";
...
<div class="col-12">
    <div class="card shadow-sm mb-2">        
        ...
        <a href="office_expense_approving.php?expense_no=<?=$data->expense_no?>">   
...
if(isset($_POST['show'])){
   ...
   $sql1 = "select   m.expense_date,  m.expense_no, m.status, m.entry_by,m.entry_at from office_expense m
