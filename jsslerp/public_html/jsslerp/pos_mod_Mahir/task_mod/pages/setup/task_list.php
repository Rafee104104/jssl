		...
		<div class="card-body" style="width:100%;overflow: scroll;">
			...
			<table class="table tabe-hover table-condensed" id="ac_ledger">
				...
				<tbody>
					...
					$sql="select t.*, i.PBI_NAME 

					from task_manage t , personnel_basic_info i 

					  where t.assign_person=i.PBI_ID order by t.task_start DESC";

					$query = mysql_query($sql);

					while($data=mysql_fetch_object($query)){

					$pio=find_a_field('mis_task_priority','priority','priority="'.$data->task_priority.'"');
					...
					<tr>
						...
						<td><b><?php echo $data->task_start .'<br> '.$data->task_end; ?></b></td>

						<td><b><?=date('h:i A', strtotime($data->task_start_time)) .'<br> '.date('h:i A', strtotime($data->task_end_time)); ?></b></td>
						...
						<td class="text-center">
			                    ...
			                    <a href="task_up.php?id=<?=$data->id?>" class="btn btn-info btn-sm">View</a>
