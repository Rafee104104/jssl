...
$con .= ' and batch_no in ('.$_POST['batch_no'].') ';
 		 ...
 		 $sql = "select pi_reference, pi_reference as pi_reference_no  from lc_purchase_master where 1 group by pi_reference";
		 $query = mysql_query($sql);
		 while($info=mysql_fetch_object($query)){
  		 $pi_reference_no[$info->pi_reference]=$info->pi_reference_no;
		}
