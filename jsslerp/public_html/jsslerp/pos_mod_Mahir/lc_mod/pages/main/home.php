...
//$target_url = '../main/dashboard_new.php';
 ...
 $ssql = "select sum(total_amt) as tot_amt from sale_do_master m, sale_do_chalan c where m.do_no=c.do_no and m.do_date BETWEEN '2021-04-14' AND '2022-04-13' and m.do_type not in ('ADVANCE')";
$sq = mysql_query($ssql);
$result1 = mysql_fetch_object($sq);
$sum_reg_sale = $result1->tot_amt;
$ssql2 = "select sum(total_amt) as tot_amt from sale_do_master m, sale_do_chalan c where m.do_no=c.do_no and m.do_date BETWEEN '2021-04-14' AND '2022-04-13' and m.do_type='ADVANCE'";
...
var options = {
	...
	data: [{
		...
		dataPoints: [
			...
			{ y: <?=number_format($second_percentage, 2)?>, label: "Advance Sale" },
		]
	}]
};
  ...
  <div id="content" class="main-content">
    <div class="layout-px-spacing">
      <div class="row layout-top-spacing">
          ...
          <div class="widget widget-one">
            ...
            <div class="w-chart">
              <div class="w-chart-section">
                <div class="w-detail">
                  <p class="w-title">Regular Sales</p>
                  <p class="w-stats">
              ...
              <div class="w-chart-section">
                <div class="w-detail">
                  <p class="w-title">Advance Sales</p>
                  <p class="w-stats">
			  ...
			  <div class="w-chart-section">
                <div class="w-detail">
                  ...
                  <p class="w-stats">
                    <?=number_format($tot_sales_value=($sum_reg_sale+$sum_pos_sale),2);?>
                  </p>
                </div>
              </div>
        ...
        <br>
        <?php /*?><div class="col-sm-12 col-xl-12 layout-spacing">
