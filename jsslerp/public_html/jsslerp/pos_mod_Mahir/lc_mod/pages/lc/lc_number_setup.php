...
$title='PI Number Setup';			// Page Name and Page Title
...
$table='lc_number_setup';		// Database Table Name Mainly related to this page

$unique='id';			// Primary Key of this Database table

$shown='lc_number';				// For a New or Edit Data a must have data field
...
//$con .='and a.category_name like "%'.$_POST['category_name'].'%" ';
 ...
 $td='select a.'.$unique.',  a.'.$shown.', a.ledger_id,  a.status from '.$table.' a where 1 order by a.id  ';
                                ...
                                <tr>
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td width="50%"><span class="style1" style="padding-top:5px;">*</span> PI Number:</td>

                                        <td width="50%">
										<input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                       					<input name="id" type="hidden" id="id" tabindex="1" value="<?=$id?>" readonly>
                        				<input name="lc_number" required type="text" id="lc_number" tabindex="1"  style="width:200px;" value="<?=$lc_number?>"  >	
									...
									<?php /*?>  <tr>
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>GL Configuration:</td>
									  ...
									  <tr>
										...
										<select name="commercial_licence" required id="commercial_licence" style="width:200px;"  tabindex="3">
