...
$p=0;
while($item_data=mysql_fetch_object($item_query)){
$p++;
...
while($data_p=mysql_fetch_object($query_p)){
  ...
  <tr>
  	<td colspan="2">
        ...
        <tr>
          ...
          <td  colspan="<?=$p*2?>" width="12%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Item Name </strong></td>     
        </tr>
		<tr>
			<? for($j=1;$j<=$p;$j++){ ?>
					<td colspan="2" width="12%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong><?=$item_name[$j]?></strong></td>
			
			<? } ?>
		</tr>
		<tr>
		<? for($k=1;$k<=$p;$k++){ ?>
			<td  width="12%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Actual</strong></td>
...
<?  
		...
		$sqlr = 'SELECT b.item_name, b.unit_name, a.rec_date, a.warehouse_id, a.qty from lc_purchase_receive a, item_info  b
		 where a.item_id=b.item_id and a.lc_no="'.$lc_no.'" group by a.id order by a.rec_date,b.item_name ';
			...
			while($datar = mysql_fetch_object($queryr)){
    ...
    <td colspan="2">
      ...
      <table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="5"  style="font-size:12px">
        ...
        <tr>
          ...
          <td width="9%" rowspan="2" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Provision Cost Price</strong></td>
          <td width="9%" rowspan="2" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Provision Value</strong></td>
...
$grn_amount_usd[$data->order_no]=$data->grn_amount_usd;
        ...
        <tr style="font-size:12px;">
          ...
          <td align="right" valign="top"><?=$provision_cost=$tot_pay_amt_out[$datac->id]/$grn_qty[$datac->id]; ?></td>
          <td align="right" valign="top"><?=number_format($tot_pay_amt_out[$datac->id],2); $tot_pro_amt_bdt +=$tot_pay_amt_out[$datac->id]; ?></td>
