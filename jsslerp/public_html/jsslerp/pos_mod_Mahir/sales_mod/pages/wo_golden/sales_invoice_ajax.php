...
<tr bgcolor="#CCCCCC">
	 ...
	 <td width="12%"><input name="unit_name" type="text" class="input3"  value="<?=$item_all->unit_name;?>" id="unit_name" style="width:90%; height:30px;" /></td>
	 <td width="12%" style="display:none;"><input name="pcs_stock" type="hidden" class="input3"  value="<?=(int)$stock_in_pcs;?>" id="pcs_stock" style="width:90%; height:30px;" /></td>
