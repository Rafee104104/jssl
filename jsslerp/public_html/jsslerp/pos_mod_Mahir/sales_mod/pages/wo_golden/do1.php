...
$module_name= 'sales_mod';
$folder='file_attached';
$field = 'file_attached'; 
$file_name = $folder.'-'.strtotime('now');

if($_FILES['file_attached']['tmp_name']!=''){
  $_POST['file_attached']=upload_file($folder,$field,$file_name);
				...
				<div class="row">
					...
					<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
						<div class="container n-form2">
							...
							<div class="form-group row m-0 pb-1">
								<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">PO Number</label>
								<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
							...
							<div class="form-group row m-0 pb-1">
								...
								<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
									<input name="po_date" type="date" id="po_date" value="<?=$po_date;?>"  required />
...
<? foreign_relation('dealer_info d,dealer_type t','d.dealer_code','concat(d.dealer_name_e,". #",t.dealer_type)',$dealer_code_combo,'d.dealer_type=t.id');?>
							...
							<div class="form-group row m-0 pb-1">
                            <label  for="<?=$field?>" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Attached File : (Image & PDF)</label>
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
								<input type="file" name="file_attached" id="file_attached" class="pt-1 pb-1 pl-1" value=""/>
								<?php if ($file_attached!=''){?>
								<a href="../../../assets/support/upload_view.php?name=<?=$data->file_attached?>&folder=file_attached&proj_id=<?=$_SESSION['proj_id']?>&mod=<?=$module_name?>" target="_blank">View Attachment</a>
								<?php } ?>
                            </div>
                        </div>
			...
			<div class="container-fluid pt-5 p-0 ">
				...
				<table class="table1  table-striped table-bordered table-hover table-sm">
					...
					<tr class="bgc-info">
						...
						<th style=" width: 325px;">Item Description</th>
					...
					<tr>
						<td id="sub">
							...
							auto_complete_from_db('item_info i,item_sub_group s','concat(i.item_id,"-> ",i.item_name)','i.item_id','i.product_nature="Salable" and i.sub_group_id=s.sub_group_id and s.group_id=200000000','item_id');
						 ...
						 <td id="so_data_found" colspan="3">
							...
							<tr>
								 <td width="60%"><input name="item_name" type="text" readonly=""  autocomplete="off"  value="" id="item_name" /> </td>
								 <td width="20%" style="display:none;"><input name="pcs_stock" type="hidden" readonly=""  autocomplete="off"  value="" id="pcs_stock" /></td>
