          ...
          <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5">
            <div class="form-group row m-0">
              ...
              <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
                          ...
                          <input name="area_id" list="depots" id="area_id" type="text" value="<?=$_POST['area_id'];?>">
						  <datalist id="depots">					  
							<option></option>
							<? foreign_relation('warehouse','warehouse_id','warehouse_name',$_POST['area_id'],' use_type="WH"');?>
						  </datalist>
