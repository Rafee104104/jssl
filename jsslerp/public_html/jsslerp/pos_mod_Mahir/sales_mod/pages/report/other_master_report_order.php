...
$sqlmon0 = mysql_fetch_row(mysql_query("select sum(c.pkt_unit) from sale_other_chalan c, dealer_info d where d.dealer_code=c.dealer_code and c.chalan_date between '".$f_mons0."' and '".$t_date."' and c.item_id=".$item->item_id.$pg_con));

$sqlmon1 = mysql_fetch_row(mysql_query("select sum(c.pkt_unit) from sale_other_chalan c, dealer_info d where d.dealer_code=c.dealer_code and c.chalan_date between '".$f_mons1."' and '".$f_mone1."' and c.item_id=".$item->item_id.$pg_con));

$sqlmon2 = mysql_fetch_row(mysql_query("select sum(c.pkt_unit) from sale_other_chalan c, dealer_info d where d.dealer_code=c.dealer_code and c.chalan_date between '".$f_mons2."' and '".$f_mone2."' and c.item_id=".$item->item_id.$pg_con));

$sqlmon3 = mysql_fetch_row(mysql_query("select sum(c.pkt_unit) from sale_other_chalan c, dealer_info d where d.dealer_code=c.dealer_code and c.chalan_date between '".$f_mons3."' and '".$f_mone3."' and c.item_id=".$item->item_id.$pg_con));
...
where i.item_brand!='Promotional' and i.sales_item_type!='' ".$item_con.$item_brand_con.$pg_con.' group by i.finish_goods_code';
	...
	$query = mysql_query($sql);
	while($item=mysql_fetch_object($query)){
$sqlmon0 = mysql_fetch_row(mysql_query("select sum(c.total_amt) from sale_other_chalan c, dealer_info d where d.dealer_code=c.dealer_code and c.chalan_date between '".$f_mons0."' and '".$t_date."' and c.item_id=".$item->item_id.$pg_con));
$sqlmon1 = mysql_fetch_row(mysql_query("select sum(c.total_amt) from sale_other_chalan c, dealer_info d where d.dealer_code=c.dealer_code and c.chalan_date between '".$f_mons1."' and '".$f_mone1."' and c.item_id=".$item->item_id.$pg_con));
$sqlmon2 = mysql_fetch_row(mysql_query("select sum(c.total_amt) from sale_other_chalan c, dealer_info d where d.dealer_code=c.dealer_code and c.chalan_date between '".$f_mons2."' and '".$f_mone2."' and c.item_id=".$item->item_id.$pg_con));
$sqlmon3 = mysql_fetch_row(mysql_query("select sum(c.total_amt) from sale_other_chalan c, dealer_info d where d.dealer_code=c.dealer_code and c.chalan_date between '".$f_mons3."' and '".$f_mone3."' and c.item_id=".$item->item_id.$pg_con));
...
$sqlmon0 = mysql_fetch_row(mysql_query("select sum(c.pkt_unit) from sale_other_chalan c,dealer_info d, area a where c.chalan_date between '".$f_mons0."' and '".$t_date."' and c.dealer_code=d.dealer_code and d.area_code=a.AREA_CODE and a.ZONE_ID='".$zone_code."' and c.item_id=".$item_info->item_id.$pg_con));

$sqlmon1 = mysql_fetch_row(mysql_query("select sum(c.pkt_unit) from sale_other_chalan c,dealer_info d, area a where c.chalan_date between '".$f_mons1."' and '".$f_mone1."' and c.dealer_code=d.dealer_code and d.area_code=a.AREA_CODE and a.ZONE_ID='".$zone_code."' and c.item_id=".$item_info->item_id.$pg_con));

$sqlmon2 = mysql_fetch_row(mysql_query("select sum(c.pkt_unit) from sale_other_chalan c,dealer_info d, area a where c.chalan_date between '".$f_mons2."' and '".$f_mone2."' and c.dealer_code=d.dealer_code and d.area_code=a.AREA_CODE and a.ZONE_ID='".$zone_code."' and c.item_id=".$item_info->item_id.$pg_con));

$sqlmon3 = mysql_fetch_row(mysql_query("select sum(c.pkt_unit) from sale_other_chalan c,dealer_info d, area a where c.chalan_date between '".$f_mons3."' and '".$f_mone3."' and c.dealer_code=d.dealer_code and d.area_code=a.AREA_CODE and a.ZONE_ID='".$zone_code."' and c.item_id=".$item_info->item_id.$pg_con));
...
$sql = "select * from zon where REGION_ID='".$region_id."' order by ZONE_NAME";
	...
	while($item=mysql_fetch_object($query)){
 $zone_code = $item->ZONE_CODE;
$sqlmon0 = mysql_fetch_row(mysql_query("select sum(c.total_amt) from sale_other_chalan c,dealer_info d, area a where c.chalan_date between '".$f_mons0."' and '".$t_date."' and c.dealer_code=d.dealer_code and d.area_code=a.AREA_CODE and a.ZONE_ID='".$zone_code."' and c.item_id=".$item_info->item_id.$pg_con));

$sqlmon1 = mysql_fetch_row(mysql_query("select sum(c.total_amt) from sale_other_chalan c,dealer_info d, area a where c.chalan_date between '".$f_mons1."' and '".$f_mone1."' and c.dealer_code=d.dealer_code and d.area_code=a.AREA_CODE and a.ZONE_ID='".$zone_code."' and c.item_id=".$item_info->item_id.$pg_con));

$sqlmon2 = mysql_fetch_row(mysql_query("select sum(c.total_amt) from sale_other_chalan c,dealer_info d, area a where c.chalan_date between '".$f_mons2."' and '".$f_mone2."' and c.dealer_code=d.dealer_code and d.area_code=a.AREA_CODE and a.ZONE_ID='".$zone_code."' and c.item_id=".$item_info->item_id.$pg_con));

$sqlmon3 = mysql_fetch_row(mysql_query("select sum(c.total_amt) from sale_other_chalan c,dealer_info d, area a where c.chalan_date between '".$f_mons3."' and '".$f_mone3."' and c.dealer_code=d.dealer_code and d.area_code=a.AREA_CODE and a.ZONE_ID='".$zone_code."' and c.item_id=".$item_info->item_id.$pg_con));
...
$sql = "select d.dealer_code, d.dealer_name_e, a.area_name from dealer_info d, area a where d.area_code=a.AREA_CODE and ZONE_ID='".$zone_id."' order by d.dealer_name_e";
	...
	while($item=mysql_fetch_object($query)){
 $zone_code = $item->ZONE_CODE;
$sqlmon0 = mysql_fetch_row(mysql_query("select sum(c.pkt_unit) from sale_other_chalan c,dealer_info d where c.chalan_date between '".$f_mons0."' and '".$t_date."' and c.dealer_code=d.dealer_code and d.dealer_code='".$item->dealer_code."' and c.item_id=".$item_info->item_id.$pg_con));

$sqlmon1 = mysql_fetch_row(mysql_query("select sum(c.pkt_unit) from sale_other_chalan c,dealer_info d where c.chalan_date between '".$f_mons1."' and '".$f_mone1."' and c.dealer_code=d.dealer_code and d.dealer_code='".$item->dealer_code."' and c.item_id=".$item_info->item_id.$pg_con));

$sqlmon2 = mysql_fetch_row(mysql_query("select sum(c.pkt_unit) from sale_other_chalan c,dealer_info d where c.chalan_date between '".$f_mons2."' and '".$f_mone2."' and c.dealer_code=d.dealer_code and d.dealer_code='".$item->dealer_code."' and c.item_id=".$item_info->item_id.$pg_con));

$sqlmon3 = mysql_fetch_row(mysql_query("select sum(c.pkt_unit) from sale_other_chalan c,dealer_info d where c.chalan_date between '".$f_mons3."' and '".$f_mone3."' and c.dealer_code=d.dealer_code and d.dealer_code='".$item->dealer_code."' and c.item_id=".$item_info->item_id.$pg_con));
...
$zone_code = $item->ZONE_CODE;
$sqlmon0 = mysql_fetch_row(mysql_query("select sum(c.total_amt) from sale_other_chalan c,dealer_info d where c.chalan_date between '".$f_mons0."' and '".$t_date."' and c.dealer_code=d.dealer_code and d.dealer_code='".$item->dealer_code."' and c.item_id=".$item_info->item_id.$pg_con));

$sqlmon1 = mysql_fetch_row(mysql_query("select sum(c.total_amt) from sale_other_chalan c,dealer_info d where c.chalan_date between '".$f_mons1."' and '".$f_mone1."' and c.dealer_code=d.dealer_code and d.dealer_code='".$item->dealer_code."' and c.item_id=".$item_info->item_id.$pg_con));

$sqlmon2 = mysql_fetch_row(mysql_query("select sum(c.total_amt) from sale_other_chalan c,dealer_info d where c.chalan_date between '".$f_mons2."' and '".$f_mone2."' and c.dealer_code=d.dealer_code and d.dealer_code='".$item->dealer_code."' and c.item_id=".$item_info->item_id.$pg_con));

$sqlmon3 = mysql_fetch_row(mysql_query("select sum(c.total_amt) from sale_other_chalan c,dealer_info d where c.chalan_date between '".$f_mons3."' and '".$f_mone3."' and c.dealer_code=d.dealer_code and d.dealer_code='".$item->dealer_code."' and c.item_id=".$item_info->item_id.$pg_con));
...
$sql = "select z.*,b.BRANCH_NAME from zon z,branch b where 1 and BRANCH_ID=REGION_ID ".$region_con." order by BRANCH_NAME,ZONE_NAME";
	...
	while($item=mysql_fetch_object($query)){
 $zone_code = $item->ZONE_CODE;
$sqlmon = mysql_fetch_row(mysql_query("select sum(c.total_amt),sum(c.total_unit),c.pkt_size from sale_other_chalan c,dealer_info d, area a where c.chalan_date between '".$f_date."' and '".$t_date."' and d.dealer_type='Distributor' and c.dealer_code=d.dealer_code and d.area_code=a.AREA_CODE and a.ZONE_ID='".$zone_code."' and c.item_id=".$item_id));
