...
<div class="header">
		...
		<td class="Qrl_code">
			...
			<p class="qrl-text">Q-<?php echo $all->do_no;?></p>
		</td>
	...
	<hr class="hr">
		<h5 class="report-titel">Sales Quotation</h5>
	<br>
	...
	<div class="row">
		...
		<div class="col-md-6 col-sm-6 col-lg-6 left">
			...
			<p class="p bold">Address : <span> <?=find_a_field('dealer_info','address_e','dealer_code='.$all->dealer_code)?> </span></p>
			<p class="p bold">Unit : <span> <?=$all->unit?></span></p>
...
<?php $uid=find_a_field('sale_requisition_master','entry_by','do_no="'.$req_no.'"');
        ...
        <tr>
          <td class="text-center"><strong><?=$all->quo_by?></strong></td>
