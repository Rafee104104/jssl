  ...
  <tr>
    <td><fieldset style="width:700px;">
      <div>
        ...
        <input style="width:155px;"  name="id" type="text" id="id" value="<? if($$unique_master>0) echo $$unique_master; else echo (find_a_field($table_master,'max('.$unique_master.')','1')+1);?>" readonly="readonly"/>
        </div>
      <div>
        <label style="width:150px;">Promotional Offer Name : </label>
        <input style="width:255px;"  name="offer_name" type="text" id="offer_name" value="<?=$offer_name?>"/>
      </div>
      <div>
        <label style="width:150px;">Dealer Type: </label>
        <select id="dealer_type_id" name="dealer_type_id" required>
			<option></option>
<? foreign_relation('dealer_type','id','dealer_type',$dealer_type_id,'1 order by dealer_type');?>
        </select>
      ...
      <div>
        ...
        <input style="width:155px;"  name="start_date" type="text" id="start_date" value="<?=$start_date;?>" autocomplete="off"/>
        
        </div>
      <div>
        <label style="width:150px;">End Date : </label>
        <input style="width:155px;"  name="end_date" type="text" id="end_date" value="<?=$end_date;?>" autocomplete="off"/>
        </div>
      <div>
        <label style="width:150px;">Product Item Name : </label>
        <input style="width:355px;"  name="item_id" type="text" id="item_id" value="<?=find_a_field('item_info','item_name','item_id="'.$item_id.'"').'#>'.$item_id?>"/>
      </div>
...
<label style="width:300px;"><strong>End Dump Range Qty Setup: </strong></label>
      ...
      <div>
        ...
        <input style="width:355px;"  name="gift_id" type="text" id="gift_id" value="<?=find_a_field('item_info','item_name','item_id="'.$gift_id.'"').'#>'.$gift_id?>"/>
      </div>
      <div>
...
<input name="new" type="submit" class="btn1 btn1-bg-update" value="Update Demand Order" tabindex="12" />
<input name="flag" id="flag" type="hidden" value="1" />
<input name="clear" id="clear" type="submit" value="CLEAR" style="width:200px;" class="btn1 btn1-bg-cancel" />
<? }else{?>
<input name="new" type="submit" class="btn1 btn1-bg-submit" value="Initiate Demand Order"  tabindex="12" />
<input name="flag" id="flag" type="hidden" value="0" />
<? }?>
