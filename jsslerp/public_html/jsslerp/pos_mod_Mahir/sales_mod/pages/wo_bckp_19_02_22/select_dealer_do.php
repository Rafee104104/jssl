...
$chalan_no = next_transection_no($do_master->group_for,$do_master->do_date,'sale_do_chalan','chalan_no');
...
mysql_query($ins_ch_sql);

$ins_id = mysql_insert_id() ;

	journal_item_control($do_data->item_id, $do_data->depot_id, $do_data->do_date,  0, $do_data->total_unit, 'Sales', $ins_id, $do_data->unit_price, '', $chalan_no, '', '',$do_master->group_for, $do_data->unit_price, '' );
...
?>
<script language="javascript">
window.location.href = "sales_invoice_print_view.php?v_no=<?=$chalan_no;?>";
</script>
<?
