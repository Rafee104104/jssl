...
<div class="container-fluid bg-form-titel">
      ...
      <input name="dealer_code" id="dealer_code" type="text" size="10" maxlength="10" value="<? echo $_POST['dealer_type']; ?>" />
...
<!--<div class="tabledesign2" style="width:100%">--><?php /*?><table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
