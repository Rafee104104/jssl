...
$ms_data=mysql_fetch_object(mysql_query($sql_ms));
...
<table width="800" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
   ...
   <td colspan="2" align="center"><h4 style="font-size:18px; width: 40%; padding:5px 0; margin:0; border:2px solid #000000; margin: 8px 0;  border-radius: 5px; font-family:  'MYRIADPRO-REGULAR'; letter-spacing:1px; text-transform:uppercase;">Bill of Materials (BOM)</h4></td>
		    ...
		    <td width="68%" valign="top">
		      ...
		      <table width="96%" border="0" cellspacing="0" cellpadding="3"  style="font-size:12px">
		        ...
		        <tr style=" line-height:15px;">
		          ...
		          <td style="font-size:16px;"><?= $ms_data->quantity;?> <?= $ms_data->unit_name;?></td>
			...
			<tr>
			    ...
			    <td width="42%"><table width="100%" border="1" cellspacing="0" cellpadding="1">
                    ...
                    <tr height="20">
                      ...
                      <td>&nbsp; <?=$ms_data->inv_type;?><?=$_GET['bom_no']?></td>
...
while($info2=mysql_fetch_object($data3)){ 
...
while($info4=mysql_fetch_object($data4)){ 
