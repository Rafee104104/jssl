...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
        	...
        	<tr>
            	...
            	<td width="13%" align="right"><img src="../../../logo/<?=$_SESSION['proj_id'];?>.png" width="150px" height="63" /></td>

                <td width="72%"  align="center">

                	<h1><?=$company=find_a_field('project_info','proj_name','1');
					
					 if($_SESSION['user']['depot']>0)

					  $warehouse =  find_all_field('warehouse','warehouse_name','warehouse_id='.$_SESSION['user']['depot']);?></h1>

                    <h3>Warehouse/Store: <?=$warehouse->address;?></h3>
...
<? }?>
    ...
    <td width="135" align="center"><?=find_a_field('user_activity_management','fname',' user_id='.$entry_by) ;?><br/>
