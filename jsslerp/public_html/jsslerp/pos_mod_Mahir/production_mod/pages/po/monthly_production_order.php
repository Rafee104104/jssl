...
<div class="form-container_large">
	<form action="" method="post">
		...
		<table class="table1  table-striped table-bordered table-hover table-sm">
			...
			$res='select  i.item_id, i.item_id, i.finish_goods_code as fg_code,i.item_name, w.warehouse_name, i.sales_item_type as product_group,i.item_brand,
...
where i.item_id=f.fg_item_id and w.warehouse_id=f.line_id '.$con.'  order by i.finish_goods_code,i.item_id';
			$sql = mysql_query($res);
...
<table width="60%" border="1" align="center" cellpadding="5" cellspacing="0">
  <tr bgcolor="#CCCCCC">
    <td bgcolor="#FFCCFF"><div align="right">Production Year: </div></td>
    <td bgcolor="#FFCCFF">
		<label>
      <select name="year" id="year" required>
	  <option>2016</option>
  ...
  <tr bgcolor="#CCCCCC">
    <td bgcolor="#FFFFFF"><div align="right">Production Month: </div></td>
    <td bgcolor="#FFFFFF">
<select name="mon" id="mon" required>
	<option value="<?=$_REQUEST['mon']?>" selected="selected"><?=($_REQUEST['mon']!='')?date('F',mktime(12,30,30,$_REQUEST['mon'],1,2015)):'';?></option>
	<option value="1">January</option>
  ...
  <tr>
    <td bgcolor="#FFCCFF"  style="text-align:center;"><div align="right">Product Group: </div></td>
    <td bgcolor="#FFCCFF"  style="text-align:center;"><div align="left">
      <select name="product_group" id="product_group">
	  	<option value="<?=$_REQUEST['product_group']?>" selected="selected"><?=$_REQUEST['product_group']?></option>
        <option value="A">A</option>
		<option value="B">B</option>
  ...
  <tr>
    <td colspan="2" bgcolor="#FFCCFF"  style="text-align:center;">
<table width="1%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td><input type="submit" name="Submit" value="Submit" style="width:120px; height:25px;text-align:center;"/></td>
  </tr>
</table>		</td>
    </tr>
</table>
...
<tr>
  <td><?=$sl;?></td>
	...
	<td><?=$data->item_brand?></td>
	<td><div align="center">
	  <input type="text" name="qty_<?=$data->item_id?>" style="width:100px;" id="qty_<?=$data->item_id?>" value="<?=$order_qty;?>" />
	  </div></td>
    <td><span id="divi_<?=$data->item_id?>">
<?
			  if(($order_qty>0))
