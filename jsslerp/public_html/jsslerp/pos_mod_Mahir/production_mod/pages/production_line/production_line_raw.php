...
{
	mysql_query("delete from production_line_raw where fg_item_id='".$_GET['id']."' and line_id='".$line_id."'");
	//mysql_query("delete from production_line_fg_raw where fg_custom_id='".$_GET['id']."' and line_id='".$_GET['line_id']."'");
}
