...
$con .='and a.warehouse_name like "%'.$_POST['warehouse_name'].'%" ';
 ...
 $td='select a.'.$unique.',  a.'.$shown.', a.acc_class, a.acc_sub_class,  a.ledger_group_id, a.acc_sub_sub_class from '.$table.' a where ledger_group_id=411010  '.$con.' order by a.ledger_id  ';
                ...
                <div class="form-group row m-0 pl-3 pr-3">
                    ...
                    <div class="col-sm-8 p-0">
										...
										<select name="ledger_group_id" required id="ledger_group_id"  tabindex="2">
                      						...
                      						<? foreign_relation('ledger_group','group_id','CONCAT(group_id, ": ", group_name)',$ledger_group_id,'group_id=411010');?>
                    					</select></span>
                    </div>
                </div>
