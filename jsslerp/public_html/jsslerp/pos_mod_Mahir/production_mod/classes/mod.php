...
///////////////////// VOUCHER FUNCTIONS /////////////////////////
/////////////////////////////////////////////////////////////////
function auto_insert_sales($sdate,$ledger,$sales_ledger,$order_id,$amt){
...
VALUES ('NETRO', '$jv', '$sdate', '$sales_ledger', 'Order No# $order_id', '0', '$amount_bdt', 'AUTO')";
mysql_query($journal);
...
VALUES ('NETRO', '$jv', '$sdate', '$sales_ledger', 'Order No# $order_id', '0', '$amount_usd', 'AUTO')";
mysql_query($journal);
...
VALUES ('NETRO', '$jv', '$sdate', '$ledger', 'Order No# $order_id', '$amount_bdt', '0', 'AUTO')";
mysql_query($journal);
...
VALUES ('NETRO', '$jv', '$sdate', '$ledger', 'Order No# $order_id', '$amount_usd', '0', 'AUTO')";
mysql_query($journal);
}
...
function warehouse_product_stock($item_id ,$warehouse_id)
{
	return find_a_field('journal_item','final_stock','warehouse_id = "'.$warehouse_id.'" and item_id = "'.$item_id .'" order by id desc');
}

function journal_item_control($item_id ,$warehouse_id,$ji_date,$item_in,$item_ex,$tr_from,$tr_no)
{
	$pre_stock=find_a_field('journal_item','final_stock','warehouse_id = "'.$warehouse_id.'" and item_id = "'.$item_id .'" order by id desc');
	$final_stock=($pre_stock+$item_in)-$item_ex;
	$sql="INSERT INTO `journal_item` (`ji_date`, `item_id`, `warehouse_id`, `pre_stock`, `item_in`, `item_ex`, `final_stock`, `tr_from`, `tr_no`, `entry_by`, `entry_at`) VALUES ('".$ji_date."', '".$item_id."', '".$warehouse_id."', '".$pre_stock."', '".$item_in."', '".$item_ex."', '".$final_stock."', '".$tr_from."', '".$tr_no."', '".$_SESSION['user']['id']."', '".date('Y-m-d h:i:s')."')";
	mysql_query($sql);
}
?>