...
<link rel="icon" type="image/x-icon" href="../../../assets/images/login/robi_favicon-32x32.png">
                        ...
                        <div class="AppFormLeft">
                            ...
                            <div style="text-align:center;  margin-bottom: 22px; margin-top: 12px;">
							   <?
								...
								?>
							<img src="<?=$show_logo?>" style=" width: 100%; height: 100%; ">
...
<!--                            <p>Lorem ipsuing elit. Molomos totam est voluptatum i omos totam est voluptatum i ure sit consectetur ill</p>-->
                            <img src="../../../assets/images/login/erp01.png" width="100%" height="100%">
                        </div>
                    </div>
                </div>
            </div>
