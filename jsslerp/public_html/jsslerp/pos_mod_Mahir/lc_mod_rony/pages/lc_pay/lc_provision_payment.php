...
//   		$chalan_no=''.$yer.''.$month.''.$cy_id;
   ...
   $ins_invoice = 'INSERT INTO lc_provision_payment (payment_no, payment_date, payment_method, lc_no, lc_number, lc_ledger, bank_pay_id, lc_part, lc_part_no, group_for, bill_type, bill_category, category_view, cr_ledger_id, pay_amt_in, pay_amt_out, remarks, note, r_no, r_date, status, entry_by, entry_at, boe_no, boe_date)
				...
				<td><input name="company" type="text" id="company"  readonly="" style="width:220px; height:32px;" value="<?=find_a_field('user_group','group_name','id='.$lc_data->group_for); ?>"   tabindex="105" />	</td>
					...
					<? if ($_POST['bill_type']==1) {?>
								 ...
								 <td>Item Name </td>
									...
									<td>
										<select name="item_id" id="item_id" required="required" style="width:220px;">
									  <option></option>
