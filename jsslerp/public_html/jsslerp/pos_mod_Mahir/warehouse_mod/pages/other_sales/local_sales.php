...
if(isset($_POST['confirmm']))
{
		...
		$oi_no = $_POST['oi_no'];
        $sql = 'select w.*,s.item_ledger from warehouse_other_issue_detail w, item_info i, item_sub_group s where i.item_id=w.item_id and s.sub_group_id=i.sub_group_id and w.oi_no="'.$oi_no.'" and w.issue_type="Local Sales"';
		$qry = mysql_query($sql);
		$page_for = 'LocalSales';
		...
		add_to_sec_journal($proj_id, $jv_no, $jv_date, $data->item_ledger, $narration, '0',$data->amount,  $tr_from, $tr_no,'',$tr_id,$cc_code,$group_for);
