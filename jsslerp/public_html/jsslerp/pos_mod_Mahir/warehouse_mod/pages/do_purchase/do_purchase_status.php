...
$title='Do Purchase Status';

do_calander('#fdate');
do_calander('#tdate');

$table = 'do_purchase_master';
$unique = 'or_no';
$status = 'CHECKED';
$target_url = '../do_purchase/chalan_view2.php';
        ...
        <div class="container-fluid pt-5 p-0 ">
            ...
            if(isset($_POST['submitit'])){
                ...
                if($_POST['fdate']!=''&&$_POST['tdate']!='')
                 ...
                 $res='select  a.or_no,a.or_no as lp_no,a.do_no,a.or_date as lp_date, a.req_no,  a.vendor_id, a.vendor_name as purchase_from,a.requisition_from,sum(amount) as Total,a.entry_at,c.fname as user,a.status 
				 from do_purchase_master a,do_purchase_detail b, user_activity_management c 
				 
				 where a.or_no=b.or_no and a.entry_by=c.user_id  '.$con.' group by a.or_no order by a.or_no desc';
