...
$sql = "select m.do_no,m.do_date,m.dealer_code,m.po_no, i.item_id,i.unit_name,i.pack_size, o.unit_price, o.total_unit,d.product_group as grp,concat(i.finish_goods_code,'- ',item_name) as item_name, o.id from 
