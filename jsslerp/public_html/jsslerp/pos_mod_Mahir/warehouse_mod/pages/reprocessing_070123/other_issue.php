...
<span id="po">
<input name="unit" type="text" class="input3" id="unit" style="width: 50% !important; float: left;" readonly="readonly"/>
<input name="price" type="text" class="input3" id="price" style="width: 50% !important; float: right;"  readonly="readonly"/>
</span></td>
