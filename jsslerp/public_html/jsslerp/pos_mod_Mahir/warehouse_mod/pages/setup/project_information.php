					...
					<tbody>
						...
						<tr<?=$cls?> onclick="DoNav('<?php echo $rp[0];?>');">
						  <td><?=$rp[0];?></td>
                            ...
                            <td><img src="../../../logo/<?=$_SESSION['proj_id']?>.png" style="width:75px;" height="50px"> </td>
							
                            <td><img src="../../../logo/bg_image/<?=$_SESSION['proj_id']?>.png" style="width:75px;" height="50px"> </td>
							
<!--						  <td><img src="../../../logo/--><?//=$rp[0]?><!--.png" style="width:80px;" /></td>-->
