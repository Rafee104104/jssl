...
$bag_qty=$_POST['bag_qty_'.$data->item_id];
   ...
   $ins_invoice = 'INSERT INTO rm_consumption (issue_no, issue_date, group_for, warehouse_id, item_id, unit_name, issue_qty, avg_price, total_amt, remarks, entry_at, entry_by,bag_qty)

  

  VALUES("'.$issue_no.'", "'.$issue_date.'", "'.$group_for.'", "'.$warehouse_id.'", "'.$item_id.'", "'.$data->unit_name.'", "'.$issue_qty.'", "'.$avg_price.'", "'.$total_amt.'", "'.$remarks.'", "'.$entry_at.'", "'.$entry_by.'","'.$bag_qty.'")';
