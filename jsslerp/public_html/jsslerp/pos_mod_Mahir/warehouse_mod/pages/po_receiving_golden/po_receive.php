...
`entry_at`,ch_no, transport_charge, vehicle_no, other_charge, remarks, avg_price, status,qty_bag )

 VALUES('".$pr_no."', '".$group_for."', '".$po_no."', '".$data->id."', '".$rec_no."','".$rec_date."',".$vendor_id.", ".$item_id.",".$warehouse_id.", ".$rate.", '".$qty."', '".$unit_name."',  '".$amount."', '".$qc_by."',  '".$_SESSION['user']['id']."', '".$now."', '".$ch_no."', '".$transport_charge."', '".$vehicle_no."', '".$other_charge."', '".$remarks."', '".$final_avg_price."', 'Received','".$qty_bag."')";
									...
									<thead>
										...
										?>
												...
												<tr>
												  ...
												  <td ><a target="_blank" href="../po_receiving_golden/chalan_view.php?v_no=<?=$aaa->pr_no?>"><img src="print.png" width="100%" height="100%" /></a></td>
                ...
                <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
                    ...
                    <div class="container n-form2">
						...
						<div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
								<input  name="vehicle_no" type="text" id="vehicle_no" value=""/>
                            </div>
                        </div>
            ...
            <table class="table1  table-striped table-bordered table-hover table-sm">
				...
				<td><?=$row->item_id?>
				  ...
				  <? if($unrec_qty>0){$cow++;?>
					...
					<input name="qty_bag_<?=$row->id?>" type="text" id="qty_bag_<?=$row->id?>"  class="text-center" value=""   style="width:50%"  />
