...
('".$chalan_date."',  '".$_SESSION['user']['group']."',   '".$do->do_no."', '".$chalan_no."', '".$do->dealer_code."', 'CHECKED', 

'".$_SESSION['user']['depot']."', '".$master->vat."', '".$master->discount."',  '".$master->cash_discount."',  '".$entry_at."', '".$entry_by."',
...
('".$m_id ."', '".$chalan_date."', '".$_SESSION['user']['group']."', '".$data->do_no."', '".$chalan_no."',  '".$data->id."', '".$data->item_id."', '".$data->dealer_code."',

 '".$data->unit_price."', '".$data->pkt_size."', '".$unit_qty."', '".$unit_qty."', '".$total_amt."', '".$_SESSION['user']['depot']."', 'CHECKED', 
  ...
  '".$entry_at."', '".$entry_by."', '".$received_status."','".$c_amt."')";
				...
				journal_item_control($data->item_id,$_SESSION['user']['depot'],$_POST['chalan_date'],$unit_qty,0,'Sales Return',$ch_id, $data->cost_price,'',$m_id);
          ...
          <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5">
            <div class="container n-form2">
              ...
              <div class="form-group row m-0 pb-1">
                ...
                <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
                 <input name="group_for" type="text" id="group_for" value="<?=find_a_field('user_group','group_name','id='.$_SESSION['user']['group'])?>" tabindex="10" />
                </div>
              </div>
					  ...
					  <tbody class="tbody1">
							...
							?>
									...
									<tr>
									  ...
									  <td align="center">
										  <a target="_blank" href="sales_return_print_view.php?v_no=<?=$aaa->sr_no?>">
...
<? 
 ...
 $sql='select a.id,a.order_no,a.item_id,b.finish_goods_code,b.item_name,a.pkt_unit,a.dist_unit,a.total_unit,a.pkt_size, a.unit_price, a.total_amt from sale_do_chalan a,item_info b where b.item_id=a.item_id and a.chalan_no='.$chalan_no;
