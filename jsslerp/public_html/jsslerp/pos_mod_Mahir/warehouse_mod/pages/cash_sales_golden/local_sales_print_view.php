            ...
            <td>
              ...
              <tr>
				...
				<table width="60%" border="0" align="center" cellpadding="5" cellspacing="0">
                    <tr>
                        <td bgcolor="#666666" style="text-align:center; color:#FFF; font-size:18px; font-weight:bold;">CASH SALES </td>
                    </tr>
                </table>
                </td>
              </tr>
	    ...
	    <td>
		  ...
		  <tr>
			...
			<td width="30%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px">
			  <tr>
                <td align="right" valign="middle"><strong>CS No:</strong></td>
			    <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
                    <tr>
			  ...
			  <tr>
                <td align="right" valign="middle"> <strong>CS Date</strong></td>
			    <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
                    <tr>
...
<table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="5">
       <tr bgcolor="wheat">
        ...
        <td align="center"><strong>Sale Qty</strong></td>
