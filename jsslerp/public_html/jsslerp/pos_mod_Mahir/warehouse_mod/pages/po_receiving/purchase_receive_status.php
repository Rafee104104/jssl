        ...
        <div class="container-fluid pt-5 p-0 ">
                ...
                <table class="table1  table-striped table-bordered table-hover table-sm">
                    ...
                    if(isset($_POST['submitit'])){
                        ...
                        $sql = 'select pr.pr_no,pr.po_no,pr.entry_at,pr.status,v.vendor_name,u.fname from purchase_receive pr left join vendor v on v.vendor_id=pr.vendor_id left join user_activity_management u on u.user_id=pr.entry_by where 1 '.$con.' group by pr.pr_no  DESC';
