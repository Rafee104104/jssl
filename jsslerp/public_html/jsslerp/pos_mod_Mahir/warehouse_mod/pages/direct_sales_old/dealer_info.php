		...
		<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return check()">
			...
			<div class="container-fluid bg-form-titel">
				...
				<div class="row">
						...
						<div class="form-group row m-0">
							...
							<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
								<select name="dealer_type" required id="dealer_type" tabindex="3">
									<? foreign_relation('dealer_type','id','dealer_type',$dealer_type,'1 and id=1');?>
								</select>
					...
					<div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
						<div class="form-group row m-0">
							<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 vendor_label_text d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Mobile No:</label>
							<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
					...
					<div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
						<div class="form-group row m-0">
							<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 vendor_label_text d-flex justify-content-end align-items-center pr-1 bg-form-titel-text req-input">A/C Configuration (GL):</label>
							<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">

											<? if ($account_code==0) {?>
											<select name="ledger_group" required="required" id="ledger_group" style="width:95%; font-size:12px;" tabindex="9">
											  <option></option>
                                              <? foreign_relation('ledger_group','group_id','group_name',$ledger_group,'acc_class=1 and group_id in("10307")');?>
                                            </select>
											<? }?>
...
if($_POST['depot']!="") $con .= 'and a.depot="'.$_POST['depot'].'"';


$td='select a.'.$unique.',  a.'.$shown.',   a.address_e, a.account_code 
from '.$table.' a, user_group u
where a.group_for=u.id  and a.group_for="'.$_SESSION['user']['group'].'" 
'.$con.' and a.dealer_type=1
