    ...
    <div class="container-fluid">
              ...
              <div class="card card-stats" style="border: 1px solid red;">
                ...
                <div class="card-header card-header-primary card-header-icon">
                  ...
                  <h3 class="card-title font-siz">
                   ...
                   <span id="localsales7day" class="loader">120</span>
                ...
                <div class="card-footer" style="border-top:1px solid red">
				  ...
				  <h5 class="m-0 font-weight-bold">TOTAL COMPANY</h5>
              ...
              <div class="card card-stats" style="border: 1px solid red;">
                ...
                <div class="card-header card-header-warning card-header-icon">
                  ...
                  <h3 class="card-title font-siz">
                   ...
                   <span id="localsales7day" class="loader">12</span>
                ...
                <div class="card-footer" style="border-top:1px solid red">
				  ...
				  <h5 class="m-0 font-weight-bold">PENDING LIST</h5>
              ...
              <div class="card card-stats" style="border: 1px solid red;">
                ...
                <div class="card-header card-header-success card-header-icon">
                  ...
                  <h3 class="card-title font-siz">
                   ...
                   <span id="localsales7day" class="loader">3</span>
                ...
                <div class="card-footer" style="border-top:1px solid red">
				  ...
				  <h5 class="m-0 font-weight-bold">Audit Complete</h5>
              ...
              <div class="card card-stats" style="border: 1px solid red;">
                ...
                <div class="card-header card-header-danger card-header-icon">
                  ...
                  <h3 class="card-title font-siz">
                   ...
                   <span id="localsales7day" class="loader">1</span>
                ...
                <div class="card-footer" style="border-top:1px solid red">
				  ...
				  <h5 class="m-0 font-weight-bold">Finding Issue</h5>
		...
		<div class="drophere ui-droppable mt-2 mb-2">
			<div class="col-12 shadow1 draghere ui-draggable ui-draggable-handle" style="position: relative;">
						<div class="row add">
							<div class="col-9 new_left p-2" align="left"><p class="bold m-0"> System Daily Error Log Stock Status</p></div>
...
<div class="drophere ui-droppable mt-2 mb-2">
			<div class="col-12 shadow1 draghere ui-draggable ui-draggable-handle" style="position: relative;">
						<div class="row add">
							<div class="col-9 new_left p-2" align="left"><p class="bold m-0"> System Daily Error Log Finance Status</p></div>
							<div class="col-3 new_right p-2">
	...
	<div class="drophere ui-droppable mt-2 mb-2">
			<div class="col-12 shadow1 draghere ui-draggable ui-draggable-handle" style="position: relative;">
						<div class="row add">
							<div class="col-9 new_left p-2" align="left"><p class="bold m-0"> System Daily Error Log Account Status</p></div>
							<div class="col-3 new_right p-2">
