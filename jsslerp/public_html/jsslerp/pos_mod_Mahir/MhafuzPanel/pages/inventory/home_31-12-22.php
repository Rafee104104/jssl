...
<form action="" method="post">
  <div class="row">
    <div class="col-md-3 form-group">
      <label class="label success" for="PBI_ID">CID Name : </label>
    ...
    <div class="col-md-3 form-group">
      <label class="label success" for="PBI_ID">Status: </label>
    ...
    <div class="col-md-3 form-group">
      <label class="label success" for="PBI_ID">Active Status: </label>
