...
<div class="drophere ui-droppable mt-2 mb-2">
	<div class="col-12 shadow1 draghere ui-draggable ui-draggable-handle" style="position: relative;">
		<div class="row add">
			<div class="col-9 new_left p-2" align="left"><p class="bold m-0"> Information About Company</p></div>
  ...
  <div class="row">
    <div class="col-md-3 form-group">
      ...
      <input name="cid" type="text" id="cid" value="<?= $data->cid; ?>" class="form-control req" required />
    </div>
    <div class="col-md-3 form-group">

      <label class="label success bmd-label-static" for="PBI_ID">Project Name : </label>

      <input name="company_name" type="text" id="company_name" value="<?= $data->company_name; ?>" class="form-control req" required />
    </div>

    <div class="col-md-3 form-group">
      <label class="label success bmd-label-static" for="PBI_ID">Contact Person: </label>

      <input name="contact_person" type="text" id="contact_person" value="<?= $data->contact_person ?>" class="form-control req1" />
    </div>

    <div class="col-md-3 form-group">
      <label class="label success bmd-label-static" for="PBI_ID">Sign Up date: </label>

      <input name="signup_date" type="date" id="signup_date" value="<?= $data->signup_date; ?>" class="form-control req1" />
    </div>

    <div class="col-md-3 form-group">
      <label class="label success bmd-label-static" for="PBI_ID">Register date: </label>

      <input name="register_date" type="date" id="register_date" value="<?= $data->register_date; ?>" class="form-control req1" />
    </div>

    <div class="col-md-3 form-group">
      <label class="label success bmd-label-static" for="PBI_ID">Email: </label>

      <input name="email" type="text" id="email" value="<?= $data->email; ?>" class="form-control req1" />
    </div>
    <div class="col-md-3 form-group">
      <label class="label success bmd-label-static" for="PBI_ID">Website: </label>

      <input name="website" type="text" id="website" value="<?= $data->website; ?>" class="form-control req1" />
    </div>

    <div class="col-md-3 form-group">
      <label class="label success bmd-label-static" for="PBI_ID">Contact No: </label>

      <input name="contact_no" type="text" id="contact_no" value="<?= $data->contact_no; ?>" class="form-control req1" />
    </div>

    <div class="col-md-3 form-group">
      <label class="label success bmd-label-static" for="PBI_ID">Address: </label>

      <input name="address" type="text" id="address" value="<?= $data->address; ?>" class="form-control req1" />
    </div>

    <div class="col-md-3 form-group">
      <label class="label success bmd-label-static" for="PBI_ID">Country: </label>

      <input name="country" type="text" id="country" value="<?= $data->country; ?>" class="form-control req1" />
    </div>

    <div class="col-md-3 form-group">
      <label class="label success bmd-label-static" for="PBI_ID">Type: </label>

      <select name="type" type="text" id="type" class="form-control req1">
	...
	<div class="col-md-3 form-group">
      ...
      <input name="server_name" type="text" id="server_name" value="<?= $data->server_name; ?>" class="form-control req1" />
    </div>

    <div class="col-md-3 form-group">
      <label class="label success bmd-label-static" for="PBI_ID">Status: </label>

      <select type="text" name="status" id="status" class="form-control req" required>
    ...
    <div class="col-md-3 form-group">
      ...
      <select type="text" name="active" id="active" class="form-control req" required>
  ...
  <div class="container-fluid p-0 ">
				...
				<div class="n-form-btn-class">
					...
					<? }
					if ($_SESSION['cid'] != '') { ?>
					  <input type="submit" name="update" value="Update" class="btn1 btn1-bg-update">
					<? } ?>
