...
//$difference = ($diff)*(10000);
	...
	//mysql_query($sql11);mysql_query($sql12);mysql_query($sql1);mysql_query($sql2);mysql_query($sql3);mysql_query($sql4);
	//mysql_query($sql5);mysql_query($sql6);mysql_query($sql7);mysql_query($sql8);mysql_query($sql9);
...
echo $sql13 = 'delete from sub_sub_ledger where sub_sub_ledger_id like "'.$old_ledger.'%" ;<br>';
	//mysql_query($sql5);mysql_query($sql6);mysql_query($sql7);
//	}
}
?>
