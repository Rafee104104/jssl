...
if(isset($_POST['project_id']))
{
	...
	$name		= mysql_real_escape_string($_REQUEST['task']);
				...
				<div class="card-body p-0">
					...
					<table class="table table-condensed m-0 table-hover">
						...
						<tbody>
							...
							$task_query = mysql_query($task_sql);
							while($task_data=mysql_fetch_object($task_query)){
							?>
								<tr>
		...
		<div class="col-md-12">
			<div class="card">
				...
				<div class="card-body">
					...
					$activity_query = mysql_query($activity_sql);
					while($activity_data=mysql_fetch_object($activity_query)){
