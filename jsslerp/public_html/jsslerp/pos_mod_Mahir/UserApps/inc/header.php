      ...
      <div class="col-12 profile-sidebar">
        ...
        <div class="row">
          ...
          <div class="col px-0 align-self-center">
            ...
            <p class="text-muted size-12">Desg: <?=find_a_field('personnel_basic_info','PBI_DESIGNATION','PBI_ID="'.$PBI_ID.'"');?><br />

             Dep: <?=find_a_field('personnel_basic_info','PBI_DEPARTMENT','PBI_ID="'.$PBI_ID.'"');?></p>
