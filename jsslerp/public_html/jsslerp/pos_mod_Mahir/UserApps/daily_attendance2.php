...
function showError(error) {
  ...
  switch(error.code) {
    ...
    case error.PERMISSION_DENIED:
      ...
      x.innerHTML = "<span style='color: red; font-weight: bold;' class='alert alert-danger'>User denied the request for Geolocation. Please Activate your location from your device and reload this page again.</span>";
