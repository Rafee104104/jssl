...
$roneyQuery=mysql_query($ronysql);
while($ronData=mysql_fetch_object($roneyQuery)){
...
while($uRow=mysql_fetch_object($uQuery)){
...
$lolqu=mysql_query($lol);
$ccvf=1;
while($lolData=mysql_fetch_object($lolqu)){
...
var myChart = new Chart(ctx, {
    ...
    data: {
		...
		$fry=mysql_query($fql);
		while($vv=mysql_fetch_object($fry)){
