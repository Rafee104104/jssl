...
if($chalan_no>0)
{
$found = find_a_field('journal','tr_no','1 and tr_no = "'.$chalan_no.'" and tr_from = "Purchase" ');
if($found<1){


	$sql3 = "DELETE FROM `secondary_journal` WHERE tr_from='Purchase' and  tr_no=".$chalan_no."";
...
<div class="oe_form_sheetbg" style="min-height:10px;">
  ...
  <tr>
    ...
    <td align="center" valign="middle" ><input name="search" type="submit" class="btn1 btn1-submit-input" id="search" value="Confirm" /></td>
  </tr>
