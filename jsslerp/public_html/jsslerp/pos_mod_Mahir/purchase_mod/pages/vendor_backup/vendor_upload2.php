  ...
  if(in_array($_FILES["file"]["type"],$allowedFileType)){
        ...
        for($i=0;$i<$sheetCount;$i++)
        {
            ...
            foreach ($Reader as $Row)
            {
                ...
                $PBI_ID = "";
                if(isset($Row[0])) {
                    $PBI_ID_R = mysql_real_escape_string($Row[0]);
				...
				$PBI_ID2 = "";
                if(isset($Row[0])) {
                    $PBI_ID_R2 = mysql_real_escape_string($Row[0]);
                ...
                $salary_type = "";
                if(isset($Row[1])) {
                    $salary_type =mysql_real_escape_string($Row[1]);
                }
				
				$basic_salary = "";
                if(isset($Row[2])) {
                    $basic_salary =mysql_real_escape_string($Row[2]);
                }
				
				$consolidated_salary = "";
                if(isset($Row[3])) {
                    $consolidated_salary =mysql_real_escape_string($Row[3]);
                }
				
				$house_rent = "";
                if(isset($Row[4])) {
                    $house_rent =mysql_real_escape_string($Row[4]);
                }
				
				$special_allowance = "";
                if(isset($Row[5])) {
                    $special_allowance =mysql_real_escape_string($Row[5]);
                }
				
				$ta_type = "";
                if(isset($Row[6])) {
                    $ta_type =mysql_real_escape_string($Row[6]);
                }
				
				$ta = "";
                if(isset($Row[7])) {
                    $ta =mysql_real_escape_string($Row[7]);
                }
				
				$da = "";
                if(isset($Row[8])) {
                    $da =mysql_real_escape_string($Row[8]);
                }
				...
				$basic_percent = "";
                if(isset($Row[9])) {
                    $basic_percent =mysql_real_escape_string($Row[9]);
                }
				
				$house_rent_percent = "";
                if(isset($Row[10])) {
                    $house_rent_percent =mysql_real_escape_string($Row[10]);
                }
				$conveyance_percent = "";
                if(isset($Row[11])) {
                    $conveyance_percent =mysql_real_escape_string($Row[11]);
                }
				
				$medical_percent = "";
                if(isset($Row[12])) {
                    $medical_percent =mysql_real_escape_string($Row[12]);
                }
				
				$food_allowance = "";
                if(isset($Row[13])) {
                    $food_allowance =mysql_real_escape_string($Row[13]);
                }
				
				$mob_alw_app = "";
                if(isset($Row[14])) {
                    $mob_alw_app =mysql_real_escape_string($Row[14]);
                }
				
				$mobile_allowance = "";
                if(isset($Row[15])) {
                    $mobile_allowance =mysql_real_escape_string($Row[15]);
                }
				
				$medical_allowance = "";
                if(isset($Row[16])) {
                    $medical_allowance =mysql_real_escape_string($Row[16]);
                }
                
				$transport_allowance = "";
                if(isset($Row[17])) {
                    $transport_allowance =mysql_real_escape_string($Row[17]);
                }
				$other_allowance = "";
                if(isset($Row[18])) {
                    $other_allowance =mysql_real_escape_string($Row[18]);
                }
				$mobile_ceiling = "";
                if(isset($Row[19])) {
                    $mobile_ceiling =mysql_real_escape_string($Row[19]);
                }
				
				$mobile_deduction = "";
                if(isset($Row[20])) {
                    $mobile_deduction =mysql_real_escape_string($Row[20]);
                }
                $bonus_applicable = "";
                if(isset($Row[21])) {
                    $bonus_applicable =mysql_real_escape_string($Row[21]);
                }
				$bonus_percent = "";
                if(isset($Row[22])) {
                    $bonus_percent =mysql_real_escape_string($Row[22]);
                }
				
				$bonus_amount = "";
                if(isset($Row[23])) {
                    $bonus_amount =mysql_real_escape_string($Row[23]);
                }
				
				$overtime_applicable = "";
                if(isset($Row[24])) {
                    $overtime_applicable =mysql_real_escape_string($Row[24]);
                }
				$overtime_hr_rate = "";
                if(isset($Row[25])) {
                    $overtime_hr_rate =mysql_real_escape_string($Row[25]);
                }
				$extra_allowance = "";
                if(isset($Row[26])) {
                    $extra_allowance =mysql_real_escape_string($Row[26]);
                }
				$pf = "";
                if(isset($Row[27])) {
                    $pf =mysql_real_escape_string($Row[27]);
                }
				$income_tax = "";
                if(isset($Row[28])) {
                    $income_tax =mysql_real_escape_string($Row[28]);
                }
				
				$group_insurance = "";
                if(isset($Row[29])) {
                    $group_insurance =mysql_real_escape_string($Row[29]);
                }
				
				$cfund = "";
                if(isset($Row[30])) {
                    $cfund =mysql_real_escape_string($Row[30]);
                }
				
				$cash_amt = "";
                if(isset($Row[31])) {
                    $cash_amt =mysql_real_escape_string($Row[31]);
                }
				$bank_amt = "";
                if(isset($Row[32])) {
                    $bank_amt =mysql_real_escape_string($Row[32]);
                }
				$cash_bank = '';
                if(isset($Row[33])) {
                    $cash_bank =mysql_real_escape_string($Row[33]);
                }
				$cash = "";
                if(isset($Row[34])) {
                    $cash =mysql_real_escape_string($Row[34]);
                }
				$card_no = "";
                if(isset($Row[35])) {
                    $card_no =mysql_real_escape_string($Row[35]);
                }
				$branch_info = "";
                if(isset($Row[36])) {
                    $branch_info =mysql_real_escape_string($Row[36]);
                }
				$security_amount = "";
                if(isset($Row[37])) {
                    $security_amount =mysql_real_escape_string($Row[37]);
                }
				$cooperative_share = "";
                if(isset($Row[38])) {
                    $cooperative_share =mysql_real_escape_string($Row[38]);
                }
				$motorcycle_install = "";
                if(isset($Row[39])) {
                    $motorcycle_install =mysql_real_escape_string($Row[39]);
                }
				$security_amnt = "";
                if(isset($Row[40])) {
                    $security_amnt =mysql_real_escape_string($Row[40]);
                }
				$security_amnt_till_date = "";
                if(isset($Row[41])) {
                    $security_amnt_till_date =mysql_real_escape_string($Row[41]);
                }
				
				$gross_salary = "";
                if(isset($Row[42])) {
                    $gross_salary =mysql_real_escape_string($Row[42]);
                }
				$loan_or_advance = "";
                if(isset($Row[43])) {
                    $loan_or_advance =mysql_real_escape_string($Row[43]);
                }
				$cash_amt_applicable = "";
                if(isset($Row[44])) {
                    $cash_amt_applicable =mysql_real_escape_string($Row[44]);
                }  
				$bank_percent = "";
                if(isset($Row[45])) {
                    $bank_percent =mysql_real_escape_string($Row[45]);
                }  
				$bank_amount = "";
                if(isset($Row[46])) {
                    $bank_amount =mysql_real_escape_string($Row[46]);
                }  
				$Wallet_percent = "";
                if(isset($Row[47])) {
                    $Wallet_percent =mysql_real_escape_string($Row[47]);
                }  
				$Wallet_amount = "";
                if(isset($Row[48])) {
                    $Wallet_amount =mysql_real_escape_string($Row[48]);
                }  
