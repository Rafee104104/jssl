...
$query_avr = mysql_query($sql_avr);
while($data_avr=mysql_fetch_object($query_avr)){
...
//mysql_query($ins_avr_sql);
		...
		where item_id ="'.$data_avr->item_id.'" and pr_no="'.$pr_no.'" ';
		 mysql_query($purchase_avr_update);
