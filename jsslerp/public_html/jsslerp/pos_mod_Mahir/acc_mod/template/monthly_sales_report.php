...
<table id="grp"  class="tabledesign" width="100%" cellspacing="0" cellpadding="2" border="0">
	...
	$d_where = " and d.account_code=a.ledger_id and d.dealer_type='".$_POST['dealer_type']."' ";
	}
	$p="select DISTINCT a.ledger_name, a.ledger_id from accounts_ledger a ".$d_table." where a.ledger_group_id=1016  ".$d_where." and a.group_for=".$_SESSION['user']['group']." order by a.ledger_id";
	//echo $p;
	$sql=mysql_query($p);
