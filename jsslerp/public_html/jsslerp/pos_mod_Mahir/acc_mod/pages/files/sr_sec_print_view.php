...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
  <tr>
	...
	<? if($chalan_no>0){?>
	<a target="_blank" href="../../../warehouse_mod/pages/sales_return_invoice/sales_return_print_view.php?v_no=<?=$ch->sr_no?>">SR-<?=$ch->sr_no?></a>
		<? } else{?>
			<a target="_blank" href="../../../warehouse_mod/pages/sales_return/sales_invoice_print_view.php?v_no=<?=$ch->sr_no?>">SR-<?=$ch->sr_no?></a>
		<? }?>
...
<a target="_blank" href="../../warehouse_mod/pages/pr/chalan_view2.php?v_no=<?=$ch->pr_no?>"></a></div><? }?>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000" class="tabledesign" style="font-size:12px">
	  ...
	  <?
$sql2="SELECT a.ledger_id,a.ledger_name,cr_amt,dr_amt,narration FROM accounts_ledger a, secondary_journal b where b.jv_no='$jv_no' and a.ledger_id=b.ledger_id and b.tr_from='Goods Return'";
...
<?php }?>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000" class="tabledesign" style="font-size:12px">
	  ...
	  <?
$sql23="SELECT a.ledger_id,a.ledger_name,cr_amt,dr_amt,narration FROM accounts_ledger a, secondary_journal b where b.jv_no='$jv_no' and a.ledger_id=b.ledger_id and b.tr_from='GoodsReturnCOGS'";
$data23=mysql_query($sql23);
while($info3=mysql_fetch_object($data23)){		  
	  ?>
      <tr>
        <td align="left"><div align="center">
          <?=++$s;?>
