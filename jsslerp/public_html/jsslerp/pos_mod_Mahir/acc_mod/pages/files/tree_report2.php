...
while($grp=mysql_fetch_object($query)){
...
while($sb_cls=mysql_fetch_object($query3)){
...
while($ldg_grp=mysql_fetch_object($query4)){
...
while($acc_ledger=mysql_fetch_object($query5)){
