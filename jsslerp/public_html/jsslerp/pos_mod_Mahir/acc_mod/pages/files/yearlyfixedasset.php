...
$open=mysql_fetch_row(mysql_query("select SUM(dr_amt)-SUM(cr_amt) from journal where ledger_id='$data[1]' and jv_date<'$fdate'"));

$add=mysql_fetch_row(mysql_query("select SUM(dr_amt)-SUM(cr_amt) from journal where ledger_id='$data[1]' and jv_date between '$fdate' and '$tdate'"));
