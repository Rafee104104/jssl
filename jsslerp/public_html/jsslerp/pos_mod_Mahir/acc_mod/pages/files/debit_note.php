...
<div class="form-container_large">
				...
				<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
					<div class="container n-form2">
							...
							<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 pr-0">
								<div class="form-group row m-0 pb-1">
									...
									<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
										...
										<input name="receipt_no" type="text" id="receipt_no" size="15" value="<?=$tr_no?>" <? if($jv->tr_no>0) echo 'disabled'?> class="form-control"/>
							...
							<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 pl-0">
								<div class="form-group row m-0 pb-1">
									...
									<div class="col-sm-7 col-md-7 col-lg-7 col-xl-7 p-0 pr-2 ">
										...
										<input name="jv_date" type="text" id="jv_date" value="<?php if($jv->jv_date==""){echo $today=date('Y-m-d');}else{ echo $jv->jv_date; } ?>" size="10" <?php /*?><? if($jv->tr_no>0) echo 'disabled'?><?php */?>  tabindex="1"required class="form-control" />
						...
						<div class="row pb-1">
							<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 pr-0">
								<div class="form-group row m-0 pb-1">
									<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text req-input font-size12">Paid To:</label>
									<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">

										<input name="r_from" type="text" id="r_from" value="<?php echo $jv->received_from?>" class="form-control"  tabindex="1" required <? if($jv->tr_no>0) echo 'readonly'?> />
							...
							<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 pl-0">
								<div class="form-group row m-0 pb-1">
									<label class="col-sm-5 col-md-5 col-lg-5 col-xl-5 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text req-input font-size12">Type:</label>
									<div class="col-sm-7 col-md-7 col-lg-7 col-xl-7 p-0 pr-2 ">

										<? if($jv->tr_no>0){ ?><input type="text" name="type" id="type" value="<?=$jv->type?>" readonly="readonly" class="form-control" /><? }else{?><select name="type" id="type" required onChange="check_type()" class="form-control">
	...
	<?php 
							...
							$cash_ledg_group_id=126001;
							$bank_ledg_group_id=126002;
							}
							?>
						...
						<div id="cash_check" class="form-group row m-0 pb-1">
							...
							<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0 pr-2 ">
								...
								<? } else{?>
									<select name="c_id" id="cash_disable_id"  tabindex="2"  >
						...
						<div id="bank_check" class="form-group row m-0 pb-1">
							...
							<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0 pr-2">
								...
								<? if($jv->tr_no>0){ ?><input type="text" name="b_id_name" id="bank_disable_id"  tabindex="2" value="<?=find_a_field('accounts_ledger','ledger_name','ledger_id="'.$jv->relavent_cash_head.'"');?>" readonly="readonly" /><input type="hidden" name="b_id" value="<?=$jv->relavent_cash_head?>" /><? }else{?><select name="b_id" id="bank_disable_id"  tabindex="2" <? if($jv->tr_no>0) echo 'readonly'?> >
						...
						<div id="check_date_check" class="form-group row m-0 pb-1">
							...
							<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0 pr-2">
								...
								<input name="c_date" type="text" id="c_date" value="<?=$jv->cheq_date?>" size="12" maxlength="15" tabindex="5" <? if($jv->tr_no>0) echo 'disabled'?> class="form-control" autocomplete="off"/>
						...
						<div id="of_bank_check" class="form-group row m-0 pb-1">
							...
							<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0 pr-2">
								...
								<input name="bank" type="text" id="bank" value="<?php echo $jv->bank?>"  tabindex="6" <? if($jv->tr_no>0) echo 'readonly'?> class="form-control"/>
				...
				<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
					<div class="container n-form2">
						<table  class="table1  table-striped table-bordered table-hover table-sm" border="0" cellspacing="0" cellpadding="0">
							...
							$sql2="select a.tr_no, a.cr_amt, a.narration,a.jv_date , a.jv_no,a.checked from  secondary_journal a where a.tr_from='Payment' and  SUBSTRING(a.tr_no,5,1)='0' and  a.cr_amt>0 group by a.tr_no order by a.id desc limit 5";
		...
		<div class="container-fluid pt-4 p-0 ">
			...
			<table class="table1  table-striped table-bordered table-hover table-sm">
				...
				<tr>
					...
					<td>
							<span id="acc_reference">
								<table width="100%" border="1" align="center" cellpadding="2" cellspacing="2">
									<tr>
										<td>
											<input type="text" id="ledger_name" name="ledger_id" class="form-control" value="<?=$jv_data->ledger_name?>" />
					...
					<td><select name="cc_code" id="cc_code"  class="form-control"  tabindex="3">
							<option></option>
							<? foreign_relation('cost_center','id','center_name',$jv_data->cc_code,"1");?>
						</select></td>
					<td>
						<input name="detail" type="text" id="detail" class="form-control"  tabindex="4"/>
					</td>

					<td><input name="amount" type="text" id="amount" size="5" class="form-control" tabindex="11"/></td>
