...
$led=mysql_fetch_row(mysql_query("select MAX(ledger_id) from accounts_ledger LIMIT 1"));
...
/*$report=mysql_query("select customer_id, customer_name, customer_company, customer_type from customer where 1 order by customer_name asc");*/
