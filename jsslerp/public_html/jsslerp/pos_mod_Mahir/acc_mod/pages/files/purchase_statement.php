...
<?php
	if(isset($_REQUEST['show'])){
  $total=mysql_fetch_row(mysql_query("select sum(dr_amt),sum(cr_amt) from journal where tr_from='Purchase' and jv_date>'$fdate' and jv_date<'$tdate' and ledger_id like '$ledger_id' and 1"));
