...
$led=mysql_query("select ledger_id,ledger_name from accounts_ledger where group_for=".$_SESSION['user']['group']." and ledger_group_id='$cash_and_bank_balance' order by ledger_name");
...
$cash=mysql_fetch_row(mysql_query("select b.ledger_id from accounts_ledger b where ".$ledger_con." and b.group_for=".$_SESSION['user']['group']." and b.ledger_name like '%ash%'"));
...
//echo $op_c1;
  ...
  $op_c=mysql_fetch_row(mysql_query($op_c1));
  ...
  $cl_c=mysql_fetch_row(mysql_query($cl_c));
  ...
  <tr>
    ...
    <td><div class="left_report">
		   				 ...
		   				 Period : </td>
                                        ...
                                        <td width="32%"  align="left"><input name="fdate" type="text" id="fdate" size="12" style="max-width:250px;" value="<?php echo $_REQUEST['fdate'];?>" /> 
                                      </td>
                                           <td width="46%" align="left"> <input name="tdate" type="text" id="tdate" size="12" style="max-width:250px;" value="<?php echo $_REQUEST['tdate'];?>"/></td>
                                      ...
                                      <tr>
                                        ...
                                        <td align="left"><select name="ledger_id" id="ledger_id" class="form-control" style="float:left"  >

                                                             <option value="%">All</option>

  <? foreign_relation('accounts_ledger','ledger_id','ledger_name',$ledger_id,' group_for='.$_SESSION['user']['group'].' and ledger_group_id="$cash_and_bank_balance"  order by ledger_name'); ?>
...
<thead>
 ...
 $opb=mysql_query($op_b1);

 $op_to=$op_c[0];

 while($op_b=mysql_fetch_row($opb)){
  ...
  <?php
...

	{
...

		{
			...
			$p = "select DISTINCT(group_name),SUM(cr_amt),b.ledger_group_id from journal a,accounts_ledger b,ledger_group c where a.ledger_id = b.ledger_id and b.ledger_group_id=c.group_id and a.jv_date>='$fdate' and a.jv_date<='$tdate' and a.ledger_id!=a.relavent_cash_head and ".$ledger_conx." and a.tr_from='Receipt' and b.group_for=".$_SESSION['user']['group']." AND a.cc_code=$cc_code GROUP BY group_name";
...

		{
			...
			$p = "select DISTINCT(group_name),SUM(cr_amt),b.ledger_group_id from journal a,accounts_ledger b,ledger_group c where a.ledger_id = b.ledger_id and b.ledger_group_id=c.group_id and a.jv_date>='$fdate' and a.jv_date<='$tdate' and a.tr_from='Receipt' and a.ledger_id!=a.relavent_cash_head and ".$ledger_conx." and b.group_for=".$_SESSION['user']['group']." GROUP BY group_name";
...
// Start new code
...

	{
		...
		$Lg="select DISTINCT(b.ledger_name),SUM(cr_amt),b.ledger_id from journal a,accounts_ledger b where a.ledger_id = b.ledger_id and a.jv_date>='$fdate' and a.jv_date<='$tdate' and b.ledger_group_id='$data[2]' and a.tr_from='Receipt' and b.group_for=".$_SESSION['user']['group']." and a.ledger_id!=a.relavent_cash_head and ".$ledger_conx." AND a.cc_code=$cc_code GROUP BY ledger_name";
...

	{
		...
		$Lg="select DISTINCT(b.ledger_name),SUM(cr_amt),b.ledger_id from journal a,accounts_ledger b where a.ledger_id = b.ledger_id and a.jv_date>='$fdate' and a.jv_date<='$tdate' and b.ledger_group_id='$data[2]' and a.tr_from='Receipt' and b.group_for=".$_SESSION['user']['group']." and a.ledger_id!=a.relavent_cash_head and ".$ledger_conx." GROUP BY ledger_name";
...
//$re_to=0;
  ...
  while($Ldata=mysql_fetch_row($Lsql)){
...
<thead>
  ...
  <?php
...

	{
		...
		$p = "select DISTINCT(group_name),SUM(dr_amt), b.ledger_group_id from journal a,accounts_ledger b,ledger_group c where a.ledger_id = b.ledger_id and b.ledger_group_id=c.group_id and a.jv_date>='$fdate' and a.jv_date<='$tdate'  and a.ledger_id!=a.relavent_cash_head and ".$ledger_conx." and a.tr_from='Payment' and ".$ledger_conx." and b.group_for=".$_SESSION['user']['group']." AND a.cc_code=$cc_code GROUP BY group_name";
...

		{
			...
			$p ="select DISTINCT(group_name),SUM(dr_amt), b.ledger_group_id from journal a,accounts_ledger b,ledger_group c where a.ledger_id = b.ledger_id and b.ledger_group_id=c.group_id and a.jv_date>='$fdate' and a.jv_date<='$tdate' and a.tr_from='Payment' and ".$ledger_conx." and b.group_for=".$_SESSION['user']['group']." GROUP BY group_name";
...
<table width="100%" cellspacing="0" cellpadding="2" border="0" id="grp"  class="tabledesign table-bordered table-condensed">
...
<thead>
 ...
 $clb=mysql_query($cl_b);

 $cl_to=$cl_c[0];

 while($cl_b=mysql_fetch_row($clb)){
