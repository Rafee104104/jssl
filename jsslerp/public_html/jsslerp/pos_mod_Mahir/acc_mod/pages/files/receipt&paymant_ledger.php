...
<?php $led1=mysql_query("SELECT id, center_name FROM cost_center WHERE 1 ORDER BY center_name");
...
$cash=mysql_fetch_row(mysql_query("select ledger_id from accounts_ledger where ledger_group_id='$cash_and_bank_balance' and group_for=".$_SESSION['user']['group']." and ledger_name like '%ash%'"));
