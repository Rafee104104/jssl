...
if(isset($_REQUEST['proj_id'])||isset($_REQUEST['vat_percentage']))
{
		...
		//common part.............
		$vat_percentage			= mysql_real_escape_string($_REQUEST['vat_percentage']);
		$voucher_format			= mysql_real_escape_string($_REQUEST['voucher_format']);
		$extended_module_no		= mysql_real_escape_string($_REQUEST['extended_module_no']);
		$under_group_calculation= mysql_real_escape_string($_REQUEST['under_group_calculation']);
		$inventory_module		= mysql_real_escape_string($_REQUEST['inventory_module']);
		$payroll_module			= mysql_real_escape_string($_REQUEST['payroll_module']);
		$budget_module			= mysql_real_escape_string($_REQUEST['budget_module']);
		$advance_reporting_module= mysql_real_escape_string($_REQUEST['advance_reporting_module']);
		$invoice_auto_voucher	= mysql_real_escape_string($_REQUEST['invoice_auto_voucher']);
...
$data=mysql_fetch_row(mysql_query("select * from config where 1"));
}
?>
