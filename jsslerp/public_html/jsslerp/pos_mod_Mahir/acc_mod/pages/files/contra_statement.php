		    ...
		    Period :                                       </td>
                                      ...
                                      <tr>
                                        ...
                                        <select name="ledger_id" id="ledger_id"><option selected value="%">All</option>
	  									<?php 
				                       $led=mysql_query("select ledger_id,ledger_name from accounts_ledger   where 1 and ledger_group_id='$cash_and_bank_balance' order by ledger_name");
	                                   while($ledg=mysql_fetch_row($led)){
...
<?php
	if(isset($_REQUEST['show'])){
  $total=mysql_fetch_row(mysql_query("select sum(dr_amt),sum(cr_amt) from journal where tr_from='Contra' and jv_date>'$fdate' and jv_date<'$tdate' and ledger_id like '$ledger_id' and 1"));
