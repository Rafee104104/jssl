...
$g="select a.ledger_id,c.group_id,SUM(dr_amt) dr_amt,SUM(cr_amt) cr_amt
  ...
  $g="select c.group_name,c.group_id FROM ledger_group c where 1 ".$grp_con." and  c.group_id in (1016,1024,1032,1051,1070,1086,1092,1109,2032,2063,2067,2065,2069,1091,3025
