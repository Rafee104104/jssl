...
for($i=0;$i<($c/6);$i++)
{
    ...
    $query_UpItem=mysql_query($UpItem);
...
<?php
    ...
    $led1=mysql_query("select customer_id,customer_name from stu_student_info where 1 order by customer_name");
      $data1 = '[';
    ...
    $led2=mysql_query("select a.item_id, a.item_name from  stu_course a,stu_course_category b where a.group_id=b.group_id order by item_name");
      $data2 = '[';
