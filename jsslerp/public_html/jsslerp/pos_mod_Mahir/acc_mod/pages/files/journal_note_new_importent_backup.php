...
if($_GET['del']>0){
 ...
 $condition='id ='.$_GET['del'];
  ...
  header('Location:journal_note_new.php');
}
...
if($jv_config=="Yes"){
             ...
             $condition='DELETE FROM `journal` WHERE tr_from like "Journal" and jv_no ='.$j_data->jv_no;
...

{
  ...
  var type = document.getElementById('t_type').value;
	...
	var difference = document.getElementById('t_amount').value;
   	if(difference==""){  document.getElementById("receipt_varify").style.visibility = "hidden"; }
}
...
if(res[1]!=0){ 
   document.getElementById("receipt_varify").style.visibility = "hidden";
}else{
...
<th bgcolor="#45777B">&nbsp;</th>
 ...
 $sql2="select a.tr_no, sum(a.dr_amt), a.narration,a.jv_date , a.jv_no,a.checked



from  secondary_journal a where a.tr_from='Journal' and a.group_for='".$_SESSION['user']['group']."' and SUBSTRING(a.tr_no,5,1)='0' and  a.dr_amt>0 and a.checked in ('NO','YES') group by a.tr_no order by a.tr_no desc limit 6";
        ...
        <tr>
		  ...
		  <table width="100%" border="1" align="center"  style="border-collapse:collapse; border:1px solid #C1DAD7;" cellpadding="2" cellspacing="2">
            ...
            <tr>
              ...
              <td width="7%" align="center" bgcolor="#45777B"><span class="style3">Type</span></td>



              <td width="11%" align="center" bgcolor="#45777B"><span class="style3">GL Code </span></td>
              <td width="30%" align="center" bgcolor="#45777B"><span class="style3">GL Name </span></td>
              ...
              <td width="20%" align="center" bgcolor="#45777B"><span class="style3">Narration</span></td>



              <td width="8%" align="center" bgcolor="#45777B"><span class="style3">Debit</span></td>
			  
			  <td width="8%" align="center" bgcolor="#45777B"><span class="style3">Credit</span></td>
              ...
              <td width="6%" rowspan="2" bgcolor="#45777B" align="center">
                ...
                <input name="add_new" class="btn" type="button" id="add_new" value="Add New" onclick="insert_item()" style="width:60px;" />
...
<table width="100%" border="1" align="center"  style="border-collapse:collapse; border:1px solid #C1DAD7;" cellpadding="2" cellspacing="2">
    ...
    <? foreign_relation('acc_reference','id','reference_name',$_POST['reference_id'],"1");?>
              ...
              <td align="center"><select name="cc_code" id="cc_code"  style="width:100px;"  tabindex="3">
  <option></option>
  <? foreign_relation('cost_center','id','center_name',$_POST['cc_code'],"1");?>
              ...
              <td align="center">
              	...
              	<input name="detail" type="text" id="detail" class="input1" onfocus="getBalance('../../common/cur_bal.php', 'cur', document.getElementById('ledger_id').value);" tabindex="10" style="width:100px;"/>              </td>
