...
include('../../engine/configure/db_connect_scb_main.php');
	...
	{
$old_pass		= mysql_real_escape_string($_REQUEST['old_pass']);
$new_pass1		= mysql_real_escape_string($_REQUEST['new_pass1']);
$new_pass2		= mysql_real_escape_string($_REQUEST['new_pass2']);
...
$s="select 1 from scb_login where 1 and user_id='$user_id' and pass='$old_pass' limit 1";
	$check_old_pass	= mysql_query($s);
	if(mysql_num_rows($check_old_pass)>0)
	{
