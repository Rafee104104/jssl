...
move_uploaded_file($_FILES['logo']['tmp_name'],$root);
	...
	$proj_name				= mysql_real_escape_string($_REQUEST['proj_name']);
	$proj_address			= mysql_real_escape_string($_REQUEST['proj_address']);
	$proj_phone				= mysql_real_escape_string($_REQUEST['proj_phone']);
	$proj_fax				= mysql_real_escape_string($_REQUEST['proj_fax']);
	$proj_email				= mysql_real_escape_string($_REQUEST['proj_email']);
	$proj_url				= mysql_real_escape_string($_REQUEST['proj_url']);
	$proj_type				= mysql_real_escape_string($_REQUEST['proj_type']);
	$proj_password			= mysql_real_escape_string($_REQUEST['proj_password']);
	$company_name			= mysql_real_escape_string($_REQUEST['company_name']);
	$voucher_mode			= mysql_real_escape_string($_REQUEST['voucher_mode']);
	$voucher_mode_type		= mysql_real_escape_string($_REQUEST['voucher_mode_type']);
	$ledger_id_separator	= mysql_real_escape_string($_REQUEST['ledger_id_separator']);
	//for Modify..................................
...
$data=mysql_fetch_row(mysql_query("select * from project_info limit 1"));
?>
