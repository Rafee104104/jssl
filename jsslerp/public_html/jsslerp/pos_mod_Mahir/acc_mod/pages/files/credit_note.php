				...
				<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
					<div class="container n-form2">
						...
						<div class="row pb-1">
							<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 pr-0">
								<div class="form-group row m-0 pb-1">
									<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text req-input font-size12">Received From:</label>
									<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
	...
	<?php 
						...
						<div id="bank_check" class="form-group row m-0 pb-1">
							...
							<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0 pr-2">
								...
								<? if($jv->tr_no>0){ ?>
									<input type="text" name="b_id_name" id="bank_disable_id" style="float:left" tabindex="2" value="<?=find_a_field('accounts_ledger','ledger_name','ledger_id="'.$jv->relavent_cash_head.'"');?>" readonly="readonly" class="form-control" />
									<input type="hidden" name="b_id" value="<?=$jv->relavent_cash_head?>" /><? }else{?>
									<select name="b_id" id="bank_disable_id" style="float:left" tabindex="2" <? if($jv->tr_no>0) echo 'readonly'?>  class="form-control" >
						...
						<div id="check_no_check" class="form-group row m-0 pb-1">
							...
							<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0 pr-2">
								<input name="c_no" type="text" id="c_no" value="<?php echo $jv->cheq_no?>" class="form-control" size="20" maxlength="25" tabindex="4" <? if($jv->tr_no>0) echo 'readonly'?> />
							</div>
						</div>
						...
						<div  id="check_date_check" class="form-group row m-0 pb-1">
							...
							<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0 pr-2">
								<input name="c_date" type="text" id="c_date" value="<?=$jv->cheq_date?>" class="form-control" size="12" maxlength="15" tabindex="5" <? if($jv->tr_no>0) echo 'disabled'?>  autocomplete="off"/>
							</div>
						</div>
				...
				<tr>
					...
					<td>
							...
							<table border="1" align="center" cellpadding="2" cellspacing="2">
								<tr>
									<td>
										<input type="text" class="form-control" id="ledger_name" name="ledger_id"  value="<?=$jv_data->ledger_name?>"/>
					...
					<td>
						<select name="cc_code" id="cc_code" tabindex="3">
							<option></option>
					...
					<td>
						<input name="detail" type="text" id="detail" tabindex="4"/>
					</td>

					<td align="center">
						<input name="amount" type="text" id="amount" size="5" tabindex="11"/>
					</td>
