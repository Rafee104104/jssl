...
$title='Purchase Return Varification';
$now=time();
		...
		<div class="container-fluid pt-5 p-0 ">
			...
			<table class="table1  table-striped table-bordered table-hover table-sm">
				...
				if($_POST['do_date_fr']!=''){
					...
					$qry = mysql_query($return_sql);
					$t=0;
					while($rd=mysql_fetch_object($qry)){
						if($t>0){
							$return_type .= ',';
						}
						$return_type .="'";
				...
				group by  j.tr_no";
					...
					while($data=mysql_fetch_object($query)){
						...
						<tr <?=($i%2==0)?'class="alt"':'';?>>
							...
							<td><a target="_blank" href="prr_sec_print_view.php?jv_no=<?=$data->jv_no ?>"><img src="../images/print_hover.png" width="20" height="20" /></a></td>
							<td>
