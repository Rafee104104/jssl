		...
		<div class="container-fluid pt-4 p-0 ">
			...
			<table class="table1  table-striped table-bordered table-hover table-sm">
				...
				<tr>
					...
					<td>
						<select name="t_type" id="t_type" onchange="mytype()" class="form-control">
							<option>Debit</option>
...
document.getElementById('ledger_id').value);" tabindex="1"  value="<?=$jv_data->ledger_id?>" />
					...
					<td><input name="detail" type="text" id="detail"  tabindex="10" class="form-control"/></td>

					<td><input name="d_amount" type="text" id="d_amount" size="10" class="form-control" tabindex="11"/></td>

					<td><input name="c_amount" type="text" id="c_amount" size="10" class="form-control" tabindex="11"/></td>
