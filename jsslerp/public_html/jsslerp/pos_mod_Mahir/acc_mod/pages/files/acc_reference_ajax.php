...
<table width="100%" border="1" align="center"  style="border-collapse:collapse; border:1px solid #C1DAD7;" cellpadding="2" cellspacing="2">
	<tr> 
		<td width="51%"><input type="text" class="form-control" id="ledger_name" name="ledger_name"  value="<?=find_a_field('accounts_ledger','ledger_name','ledger_id='.$ledger_id);?>" style="width:250px;" />
