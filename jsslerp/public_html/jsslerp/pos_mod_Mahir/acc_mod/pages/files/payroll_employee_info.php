...
if(isset($_REQUEST['emp_name'])||isset($_REQUEST['id']))
{
	...
	$emp_name=mysql_real_escape_string($_REQUEST['emp_name']);
...
$serch_count=mysql_num_rows(mysql_query($search_sql));
if($serch_count==0)
{
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>    <td width="66%" style="padding-right:5%">
	...
	{
		$src_emp_name	= mysql_real_escape_string($_REQUEST['src_emp_name']);
		$src_emp_id	= mysql_real_escape_string($_REQUEST['src_emp_id']);
