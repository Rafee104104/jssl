...
// $query22 = mysql_query($select22);
// while($rows22 = mysql_fetch_object($query22)){
...
// $query33 = mysql_query($select33);
// while($rows33 = mysql_fetch_object($query33)){
                        ...
                        ?>
                            <div class="panel panel-default ">
                                <div class="panel-heading two accordion-toggle question-toggle collapsed">
                                    <table border="1" cellspacing="0" cellpadding="0" class="table" style="margin-bottom: 0px;;">
                                        <tr>
                                            <td  class="sr-ledger-name">&emsp;&emsp;<span style="font-size: 14px; font-weight: bold; letter-spacing: 5px;">-</span><?=$row2->sub_class_name?><span style="color: darkgray;">(<?=$row2->id?>)</span></td>
                                            ...
                                            <tr>
                                                ...
                                                <td>Action</td>
                                                      ...
                                                      ?>
                                                          <div class="panel panel-default ">
                                                              <div class="panel-heading three accordion-toggle question-toggle collapsed">
                                                                  <table border="1" cellspacing="0" cellpadding="0" class="table" style="margin-bottom: 0px;;">
                                                                      <tr>
                                                                          <td  class="sr-ledger-name">&emsp;&emsp;&emsp;&emsp;<span style="font-size: 14px; font-weight: bold; letter-spacing: 5px;">--</span><?=$row3->group_name?> <span style="color: darkgray;">(<?=$row3->group_id?>)</span></td>
                                                      ...
                                                      ?>
                                                                      ...
                                                                      <tr>
                                                                              <td  class="sr-ledger-name">&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<span style="font-size: 14px; font-weight: bold; letter-spacing: 5px;">---</span><?=$row4->ledger_name?><span style="color: darkgray;">(<?=$row4->ledger_id?>)</span></td>
