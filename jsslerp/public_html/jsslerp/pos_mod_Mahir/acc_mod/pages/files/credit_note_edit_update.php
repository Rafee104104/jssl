...
foreign_relation('accounts_ledger','ledger_id','ledger_name',$jv->relavent_cash_head,"ledger_group_id=126001 order by ledger_id");
...
foreign_relation('accounts_ledger','ledger_id','ledger_name',$jv->relavent_cash_head,"ledger_group_id=126002 order by ledger_id");
