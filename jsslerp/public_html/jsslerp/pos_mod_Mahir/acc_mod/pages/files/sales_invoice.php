...
$item = $ledger2;
    ...
    $lid=mysql_fetch_row(mysql_query($ppp));
    ...
    $query_coutra = mysql_query($recept);
    ...
    //echo $journal1;
    $query_journal1=mysql_query($journal1);
}
...
<?php
    ...
    $led2=mysql_query("select a.item_id, a.item_name from item_info a,item_group b where b.inventory_type='Sales' and a.group_id=b.group_id order by item_name");
      $data2 = '[';
					...
					<td><table width="100%" border="0" cellspacing="2" cellpadding="2">
                      ...
                      <tr>
                        ...
                        <td colspan="3"><select name="vendor" style="text-align:left; width:200px; float:left;"    tabindex="1">
                          <?
    $led1=mysql_query("select customer_id,customer_name from customer where 1 order by customer_name");
           ...
           <table border="2" style="border:1px solid #C1DAD7; border-collapse:collapse"  align="center">
            ...
            <tr>
                ...
                <td align="center"><select name="warehouse" id="warehouse" style="width:80px"  onblur="cost_price();"    tabindex="7" >
                  <?
	$led11=mysql_query("select warehouse_id, warehouse_name FROM warehouse WHERE warehouse_type!='Purchase' ORDER BY warehouse_id ASC");
	if(mysql_num_rows($led11) > 0)
	{
	  while($ledg11 = mysql_fetch_row($led11)){
