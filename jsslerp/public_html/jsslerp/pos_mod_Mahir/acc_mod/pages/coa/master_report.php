...
elseif($_POST['report']==251022002)
{
		...
		<th width="5%" bgcolor="#d6eaf8" style="text-align:center">CLASS</th>
		<th width="8%" bgcolor="#d6eaf8" style="text-align:center">SUB CLASS </th>
		<th width="15%" bgcolor="#d6eaf8" style="text-align:center">SUB SUB CLASS   </th>
		<th width="12%" bgcolor="#d6eaf8" style="text-align:center">GL Group </th>
		...
		<th width="12%" bgcolor="#d6eaf8" style="text-align:center">Available Balance</th>
		</tr>
		</thead><tbody>
		<? $sl=1;
		...
		<td ><?=$b_amt=find_a_field('budget_balance','dr_amt','ledger_id="'.$row->ledger_id.'"');?></td>
		<td >
		...
		<td><?=number_format($b_amt-$e_amt,2)?></td>
		</tr>
<?  } ?>
