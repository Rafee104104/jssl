...
$total_paid = find_a_field('pos_payment','sum(paid_amt)','pos_id="'.$pos_id.'"');//$_REQUEST['left_amt'];
$left_amt = $total_amt-($total_paid+$paid_amt);
...
$datas[$o]['payment_method'] = find_a_field('pos_payment_method','payment_method','id="'.$payment_method.'"');
$o++;
}	
}else{
