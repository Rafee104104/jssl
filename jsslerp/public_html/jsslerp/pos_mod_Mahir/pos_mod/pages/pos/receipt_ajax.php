...
while($datass = mysql_fetch_assoc($qi)){
    ...
    $datas['details_info'][$i]['discount'] = number_format($discount_amt, 2, '.', '');
...
while($datasss = mysql_fetch_assoc($rr)){
    ...
    $datas['payment_history'][$j]['payment_method'] = find_a_field('pos_payment_method','payment_method','id="'.$payment_method.'"');
