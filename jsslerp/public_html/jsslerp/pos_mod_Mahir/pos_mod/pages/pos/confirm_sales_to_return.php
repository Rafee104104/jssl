...
$allsql ="select sale_pos_master.pos_id, sale_pos_master.pos_date, dealer_pos.contact_no ,dealer_pos.dealer_name, sale_pos_master.comments  from sale_pos_master left join dealer_pos on dealer_pos.dealer_code = sale_pos_master.dealer_id where sale_pos_master.status = 'CHECKED' order by sale_pos_master.pos_id desc ";
