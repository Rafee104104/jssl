...
$unique='id';
$unique_field='name';
$table='pos_sales_agent';
$page="sales_agent.php";
$crud      =new crud($table);
$$unique = $_GET[$unique];
		...
		<div class="col-sm-7">
			...
			<div class="container n-form1">
				...
				<table id="table_head" class="table table-bordered table-bordered table-striped table-hover table-sm" cellspacing="0">
					...
					$rrr = "select * from pos_sales_agent where 1";
		...
		<div class="col-sm-5">
			<form id="form1" class="n-form" name="form1" method="post" action="" onsubmit="return check()">
				...
				<div class="form-group row m-0 pl-3 pr-3">
					<label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label">Agent Name </label>
					<div class="col-sm-9 p-0">
						<input name="<?=$unique?>" type="hidden" id="<?=$unique?>" value="<?=$$unique?>"  />
						<input name="name" type="text" id="name" value="<?php echo $name;?>" class="required" />
...
$con .= 'and b.group_for="'.$_POST['group_for'].'"';
	...
	$rrr = "select b.id,  b.group_name, b.description from pos_sales_agent b, user_group a where a.id=b.group_for  ".$con." ";
