...
<tr bgcolor="#CCCCCC">
	 ...
	 <td width="15%"><input name="unit_price" type="text" class="input3" id="unit_price"  style="width:90%; height:30px;" required="required" onkeyup="count()"  value="<?=$item_all->cost_price;?>"   /></td>
</tr>
</table>
