        ...
        <div class="row m-0 p-0">
            <div class="col-sm-5">
                ...
                <div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn8888" value="88888" checked="checked" tabindex="1"/>
                    <label class="form-check-label p-0" for="report1-btn8888">
                        MRP Price Setup Report (88888)
                    </label>
                </div>
				
				<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn12023" value="12023" checked="checked" tabindex="1"/>
                    <label class="form-check-label p-0" for="report1-btn12023">
                        Item Wise Barcode Generate (12023)
                    </label>
                </div>
				
				<!--<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn2019" value="2019" checked="checked" tabindex="1"/>
                    <label class="form-check-label p-0" for="report1-btn2019">
                        All Item Barcode (2019)
                    </label>
                </div>-->
