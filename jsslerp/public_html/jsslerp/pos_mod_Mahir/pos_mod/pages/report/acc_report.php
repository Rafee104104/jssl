        ...
        <div class="row m-0 p-0">
            <div class="col-sm-5">
                ...
                <div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn1111" value="1111" checked="checked" tabindex="1"/>
                    <label class="form-check-label p-0" for="report1-btn1111">
                        Sales Details Report (1111)
                    </label>
                </div>
                
                <div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn1105" value="1105" checked="checked" tabindex="1"/>
                    <label class="form-check-label p-0" for="report1-btn1105">
                        Purchase Details Report (1105)
                    </label>
                </div>
