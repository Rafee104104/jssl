...
<textarea class="form-control" id="adresssss" style="height: 120px"></textarea>
        <input type="text" name="latitude" id="latitude" class="form-control" required value="<?=$_POST['latitude']?>" readonly/>

        <input type="text" name="longitude" id="longitude" class="form-control" required value="<?=$_POST['longitude']?>"  readonly/>
