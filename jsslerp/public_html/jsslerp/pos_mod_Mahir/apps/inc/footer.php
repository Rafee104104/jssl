    ...
    <footer class="footer">
        <div class="container">
            <ul class="nav nav-pills nav-justified">
                ...
                <li class="nav-item">
                    <a class="nav-link <? if($page=='sales_return'){ echo 'active';}?>" href="att_report.php">
                        <span>
                ...
                <li class="nav-item centerbutton">
                    <a href="daily_attendance2.php" class="nav-link" id="centermenubtn">
                ...
                <li class="nav-item">
                    <a class="nav-link <? if($page=='attendance'){ echo 'active';}?>" href="daily_attendance2.php">
                        <span>
                ...
                <li class="nav-item">
                    <a class="nav-link <? if($page=='report_list'){ echo 'active';}?>" href="att_location_report.php">
                        <span>
