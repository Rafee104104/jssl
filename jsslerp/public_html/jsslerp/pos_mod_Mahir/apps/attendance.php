...
if(isset($_REQUEST['in_time'])){
   ...
   //$insert_id=@insert('hrm_attdump');
    ...
    $sql = 'insert into hrm_attdump(`ztime`,`bizid`,`EMP_CODE`,`time`,`xtime`,`xdate`,`xenrollid`,`latitude`,`longitude`) 
  value("'.date('Y-m-d H:i:s').'","'.$PBI_ID.'","'.$PBI_ID.'","'.$time.'","'.date('Y-m-d H:i:s').'","'.date('Y-m-d').'","'.$PBI_ID.'","'.$_POST['latitude'].'","'.$_POST['longitude'].'")';
...
$_POST['attendance_type']='OUT TIME';
    ...
    //$insert_id=@insert('hrm_attdump');
	 ...
	 $insert = 'insert into hrm_attdump (`ztime`,`bizid`,`EMP_CODE`,`time`,`xtime`,`xdate`,`xenrollid`,`latitude`,`longitude`) 
	value("'.date('Y-m-d H:i:s').'","'.$PBI_ID.'","'.$PBI_ID.'","'.$time.'","'.date('Y-m-d').'","'.date('Y-m-d').'","'.$PBI_ID.'","'.$_POST['latitude'].'","'.$_POST['longitude'].'")';
