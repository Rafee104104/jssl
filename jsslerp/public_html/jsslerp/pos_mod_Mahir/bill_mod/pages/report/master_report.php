...
$rec='select j.jv_date,j.tr_no, sum(j.cr_amt) as received_amt,d.customer_name from journal j,service_customer d where d.ledger_id=j.ledger_id '.$con.' group by j.ledger_id,j.tr_no';
