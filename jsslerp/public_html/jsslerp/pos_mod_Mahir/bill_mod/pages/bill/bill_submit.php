...
$sqql = 'select b.*,c.short_name from bill_assign b,service_customer c where b.customer=c.customer_id and b.billing_cycle<="'.$today.'" and b.cycle="monthly" group by b.customer order by b.customer';

$qrry = mysql_query($sqql);

if(mysql_num_rows($qrry)>0){
...
$qqrryy=mysql_query($ssqqll);

while($details=mysql_fetch_object($qqrryy)){
...
mysql_query($billing_cycle_update);
