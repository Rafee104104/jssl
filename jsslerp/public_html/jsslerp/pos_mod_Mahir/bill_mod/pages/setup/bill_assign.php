		...
		<div class="col-sm-7">
			...
			<div class="container n-form1">
				...
				<table id="table_head" class="table table-bordered table-bordered table-striped table-hover table-sm" cellspacing="0">
					...
					$rrr = "select b.id,c.customer_name,a.type,b.service_charge,b.billing_cycle from bill_assign b left join service_customer c on c.customer_id=b.customer left join acc_bill_type a on a.id=b.service_id where 1";
