...
<table width="700" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <td><h2 style="text-align: center; display:none;" ><img src="http://chemtrekerp.com/8080/logo/title.png" alt="chemtrek_logo"></h2></td>
  ...
  <tr>
    ...
    </strong>Renaissance House-14, Lake Drive Road, Nikunja-1, Dhaka-1229<br />
  ...
  <tr>
	...
	<td>	<div align="center"><span class="style4"></span><br />
...
<table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="0">
       ...
       <tr>
        ...
        <td width="48%"><div align="center"><strong>Description of the Goods </strong></div></td>
...
<? }?>
          ...
          <td colspan="3" align="left"><p><strong>Terms &amp; Conditions: </strong></p>
            ...
            <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" style="font-size:9px">
              ...
              <tr>
                ...
                <td width="3%" align="right" valign="top">:&nbsp </td>

                <td align="left" valign="top">Delivery must be completed within <? if($data->delivery_within>0) echo $data->delivery_within.' ('.CLASS_Numbertoword::convert(((int)$data->delivery_within),'en').') '; else echo ' 3 (Three)'?>  Days after the date of purchase order</td>
			  ...
			  <tr>
                ...
                <td align="left" valign="top">Qality must be assured as per approved sample</td>
              ...
              <tr>
                ...
                <td align="left" valign="top">  <?=$data->payment_details?></td>
             ...
             <?php /*?><tr>
			  ...
			  <tr>
                ...
                <td align="left" valign="top">Chemtrek Industries BD ltd reserve the right to cancle/revision the po at any time.</td>
        ...
        <tr>
          ...
          <td colspan="12" align="left" style="font-size:10px" >

            <table width="100%" border="0" cellspacing="0" cellpadding="0">

              <tr>

                <td width="20%" valign="top"><strong><?=find_a_field('user_activity_management','fname','user_id='.$data->entry_by);?></strong>
