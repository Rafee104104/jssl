...
if(isset($_POST['confirmm']))
{
		...
		$_POST['checked_by']=date('Y-m-d h:s:i');
...
<input  name="item_id" type="text" id="item_id" value="<?=$item_id?>" style="width:320px;" required="required" onblur="getData2('po_ajaxx.php', 'po', this.value, document.getElementById('warehouse_id').value);"/>		</td>
      <td align="center" bgcolor="#CCCCCC">
      ...
      <td align="center" bgcolor="#CCCCCC"><input name="unit_name" type="text" class="input3" id="unit_name"  maxlength="100" style="width:50px;"  readonly="readonly" required="required"/></td>
