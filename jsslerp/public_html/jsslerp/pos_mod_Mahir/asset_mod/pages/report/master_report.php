...
$prQuery=mysql_query($pr);
while($pData=mysql_fetch_object($prQuery)){
...
$crQuery=mysql_query($cr);
while($cData=mysql_fetch_object($crQuery)){
...
while($pData=mysql_fetch_object($pQuery)){
	...
	if($pData->tr_from=="Issue"){
		...
		$crQuerys=mysql_query($crb);
		while($cData=mysql_fetch_object($crQuerys)){
