...
and "'.date('Y-m-d').'"';}
	  ...
	  $res ='select m.*,d.department_name from fixed_asset_issue_master m,asset_department d where m.department_id=d.id and m.status="MANUAL"'.$con;
          ...
          ?>
            ...
            <tr>
              ...
              <td class="text-center">
                ...
                <a href="department.php?old_do_no=<?=$data->id?>">
