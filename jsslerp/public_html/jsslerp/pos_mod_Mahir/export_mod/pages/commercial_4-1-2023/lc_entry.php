...
<td valign="top" width="60%"><div class="left">
		  	...
		  	<tr>
				...
				<td>&nbsp;&nbsp; %(+/-)</td>
								  ...
								  <tr>
								    <td>Bangladesh Bank DC No</td>
								    <td><input name="bangladesh_bank_dc_no" type="text" id="bangladesh_bank_dc_no" style="width:220px;" value="<?=$bangladesh_bank_dc_no?>"  tabindex="105" /></td>
								    <td>Exp. Date<br /></td>
