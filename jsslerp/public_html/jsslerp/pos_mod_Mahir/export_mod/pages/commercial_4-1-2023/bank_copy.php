...
<table width="900" border="0" cellspacing="0" cellpadding="0" align="center">
 ...
 <tr> <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0"  style="font-size:12px">
  	...
  	<tr style="font-size:16px">
		<td width="33%" valign="top">Date: <?php echo date('d-m-Y',strtotime($lc_data->lc_date));?></td>
	  ...
	  <tr>
		...
		We have the pleasure to inform you that we are submitting the following documents against captioned BB L/C to you for acceptance:		</td>
	    </tr>
	  <tr>
	    <td colspan="3" valign="top" style="font-size:14px; padding: 5px 0px 0px 0px; letter-spacing: .3px; line-height:20px; " >&nbsp;</td>
	    </tr>
	  ...
	  <tr>
	    <td colspan="3" valign="top" style="font-size:14px; padding: 5px 0px 0px 0px; letter-spacing: .3px; line-height:20px; " >
			...
			We therefore request you to kindly send the documents to the L/C issuing bank for acceptance and after getting acceptance. <br /> Account No. 
		    <?=$seller_bank->account_no;?>.		</td>
	    </tr>
	  <tr>
	    <td colspan="3" valign="top" style="font-size:14px; padding: 5px 0px 0px 0px; letter-spacing: .3px; line-height:20px; " >	We undertake to repay you the negotiated amount plus up to date interest in the event of non-payment/short payment/delay by the L/C opening bank on first demand.   </td>
	    </tr>
	  <tr>
	    <td colspan="3" valign="top" style="font-size:14px; padding: 5px 0px 0px 0px; letter-spacing: .3px; line-height:20px; " >&nbsp;</td>
	    </tr>
