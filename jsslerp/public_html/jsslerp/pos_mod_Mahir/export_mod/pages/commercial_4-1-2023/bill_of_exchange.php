...
<table width="900" border="0" cellspacing="0" cellpadding="0" align="center">
 ...
 <tbody>
  ...
  <tr>
   <td colspan="2" align="center"><h4 style="font-size:18px; padding:10px 0; margin:0; font-family:  'MYRIADPRO-REGULAR'; letter-spacing:1px;text-decoration:underline;">BILL OF EXCHANGE</h4></td>
  </tr>
	...
	<tr>
	 ...
	 echo ' Only';
		...
		?>
		 ...
		 </strong>. Value received and charge the same to account of <b><?=$dealer->dealer_name_e?>. <?=$dealer->address_e?>.</b> Drawn Under <?=$buyer_bank->bank_name;?>,  <?=$buyer_bank->branch_name;?>. <b>L/C No. <?=$lc_data->export_lc_no;?> Dated <?php echo date('d-m-Y',strtotime($lc_data->export_lc_date));?></b>
