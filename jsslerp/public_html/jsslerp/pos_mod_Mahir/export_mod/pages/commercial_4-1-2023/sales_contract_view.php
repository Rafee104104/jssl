                      ...
                      <tr>
                        <td width="68%">
                       		<table  width="97%" border="0" cellspacing="0" cellpadding="0"  style="font-size:15px">
								<tr>
					    <td width="50%" align="left" style="padding-bottom:0px;"><img src="../../../logo/<?=$_SESSION['user']['depot']?>.png"  width="35%" /></td>
    ...
    <td colspan="2">
	  ...
	  style="font-size:12px; text-transform:uppercase;">
        ...
        <tr style="font-size:12px;">
		  ...
		  <?  $pi_data_sql="SELECT sum(d.total_unit) as pi_qty, sum(d.total_amt) as pi_value
		  FROM sales_contract_master a, sales_contract b, pi_details c,  sale_do_details d  
		   WHERE a.sc_no=b.sc_no and b.pi_id=c.pi_id and c.do_no=d.do_no and a.sc_no='".$sc_no."' GROUP by b.sc_no ";
