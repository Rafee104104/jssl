...
//		}
  ...
  while($data2=mysql_fetch_object($query2)){$i++;
...
//		}
  ...
  while($data31=mysql_fetch_object($query31)){$i++;
...
//		}
  ...
  while($data3=mysql_fetch_object($query3)){$i++;
...
//		}
  ...
  while($data4=mysql_fetch_object($query4)){$i++;
...
//		}
  ...
  while($data5=mysql_fetch_object($query5)){$i++;
