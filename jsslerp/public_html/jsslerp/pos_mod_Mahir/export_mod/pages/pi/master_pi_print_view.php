...
$sale_master_po = find_a_field('sale_do_master_foreign','customer_po_no','do_no='.$pi_d->do_no); 
...
$vl_sql = 'SELECT  sum(s.total_amt) as pi_value FROM pi_master a, pi_details b, sale_do_details_foreign s WHERE  a.id=b.pi_id and b.do_no=s.do_no and b.pi_id="'.$pi_no.'" GROUP by b.pi_id ';
                      ...
                      <tr>
                        <td width="68%">
                       		<table  width="97%" border="0" cellspacing="0" cellpadding="0"  style="font-size:15px">
								<tr>
					    <td width="50%" align="left" style="padding-bottom:0px;"><img src="../../../logo/rahimgroup.png"  width="27%" /></td>
		  ...
		  <tr>
		    ...
		    <td width="68%" valign="top">
		      ...
		      <table width="97%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px; letter-spacing:.3px;">
		        ...
		        <tr>
		          <td colspan="2" align="left" valign="middle" style=" font-size:12px; text-transform: uppercase; font-weight:500;"><?= find_a_field('dealer_info_foreign','dealer_name_e','dealer_code='.$master->dealer_code);?> </td>
	            </tr>
		        <tr>
		        ...
		        <tr>
		          <td align="left" valign="middle" style=" text-transform:capitalize;" width="60%" ><?= find_a_field('dealer_info_foreign','address_e','dealer_code='.$master->dealer_code);?></td>
	...
	<tr>
	  <td colspan="3" valign="top" style="font-size:13px; padding: 5px 0px 0px 0px; letter-spacing: .3px; line-height:20px" ><div align="justify">This Proforma Invoice (PI) has been issued in relation to the Purchase Order (PO) number 
	    <b>  
	      <?  
$o=0;
		$po_sql = 'SELECT m.customer_po_no, m.customer_po_date, m.job_no FROM pi_details p, sale_do_master_foreign m WHERE p.do_no=m.do_no and p.pi_id="'.$pi_no.'" GROUP by p.do_no ';
  ...
  <tr>
    ...
    <td colspan="2">
      ...
      <table width="100%" class="tabledesign"   border="1" bordercolor="#CCCCCC" cellspacing="0" cellpadding="5"  style="font-size:12px">
		...
		$sqlc = 'select s.*, i.item_name, i.unit_name from pi_details p, sale_do_details_foreign s, item_info i  where p.do_no=s.do_no and i.item_id=s.item_id and p.pi_id='.$pi_no.' group by s.id order by s.item_id ';
  ...
  <tr>
	 ...
	 echo ' Only';
		...
		$tc_sql = 'select * from pi_terms_condition where pi_id="'.$pi_no.'" group by id order by sl_no ';
			$tc_query=mysql_query($tc_sql);
			while($tc_data= mysql_fetch_object($tc_query)){
	...
	<table width="100%" cellspacing="0" cellpadding="0"  >
		...
		<tr style="font-size:12px">
		  <td align="center" style="font-size:14px; text-transform: capitalize; font-weight:700;">For <?= find_a_field('dealer_info_foreign','dealer_name_e','dealer_code='.$master->dealer_code);?></td>
		  <td  align="center">&nbsp;</td>
		  <td  align="center">&nbsp;</td>
