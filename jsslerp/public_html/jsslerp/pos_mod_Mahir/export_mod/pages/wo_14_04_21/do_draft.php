...
<td><input type="text" name="<?='final_price#'.$data->id?>" id="<?='final_price#'.$data->id?>" value="<?=$data->final_price?>" onchange="TRcalculation(<?=$data->id?>)"  style="width:70px; height:25px;"/>  </td>
