...
$title='Work Order Unhold Approval';
...
if(isset($_POST['confirm'])){
 ...
 $sql = 'update sale_do_master set status="CHECKED", unhold_by="'.$entry_by.'", unhold_at="'.$entry_at.'" where do_no = '.$do_no;
	mysql_query($sql);
...
<input name="confirm" type="submit" class="btn1" value="WO UNHOLD APPROVE" style="width:270px; font-weight:bold; float:right; font-size:12px; height:30px; color:#090" /></td>
