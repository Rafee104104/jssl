...
$do_depot=mysql_query("select depot_id from sale_do_master where do_no=".$master_do);
$do_depott=mysql_fetch_object($do_depot);
...
<? //if($do_date==date('Y-m-d')){?>



                      <tr>

                        <td width="18%" align="center" bgcolor="#0099FF"><strong>Item Code</strong></td>

                        <td width="77%" align="center" bgcolor="#0099FF"><table width="100%" border="1" cellspacing="0" cellpadding="0">

                          <tr>

<td align="center" bgcolor="#0099FF" width="40%"><strong>Item Name</strong></td>

<td align="center" bgcolor="#0099FF" width="12%"><strong>In Stk</strong></td>
...
<td align="center" bgcolor="#0099FF" width="12%"><strong>Total</strong></td>
                        ...
                        <td width="5%"  rowspan="2" align="center" bgcolor="#FF0000"><div class="button">
...
<input name="item" type="text" class="input3" id="item"  style="width:70px;" required onblur="grp_check(this.value);" tabindex="1"/>
...
<td bgcolor="#CCCCCC">
  ...
  <td><input name="item2" type="text" class="input3" id="item2"  style="width:250px;" required="required" tabindex="3" value="<?=$item_all->item_name?>" onfocus="focuson('pkt_unit')"/></td>
  ...
  <td bgcolor="#CCCCCC"><table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
	 ...
	 <td><input name="dist_unit" type="text" class="input3" id="dist_unit" style="width:55px;" value="0" onkeydown="count()" readonly="readonly"/></td>
