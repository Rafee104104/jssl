...
<table width="70%" border="0" align="center">
  ...
  <tr>
	...
	<?
	 ...
	 $query ="select a.do_no,a.dealer_code,d.team_name,d.dealer_name_e from sale_do_master a,dealer_info d where d.dealer_code=a.dealer_code  and a.status='MANUAL'";
