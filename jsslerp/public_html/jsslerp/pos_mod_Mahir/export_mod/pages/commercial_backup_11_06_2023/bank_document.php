  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0"  style="font-size:12px">
	  ...
	  <tr>
	    <td colspan="3" valign="top" style="font-size:14px;   " >MS </td>
	  	  ...
	  	  <tr>
	    <td colspan="3" valign="top" style="font-size:14px;   " ><?=find_a_field('dealer_info_foreign','dealer_name_e','dealer_code='.$lc_data->dealer_code);?></td>
	    </tr>
			  <tr>
	    <td  valign="top" style="font-size:14px;   " ><?= find_a_field('dealer_info_foreign','address_e','dealer_code='.$lc_data->dealer_code);?></td>
		<td></td>
		<td></td>
	    </tr>
		<tr>
