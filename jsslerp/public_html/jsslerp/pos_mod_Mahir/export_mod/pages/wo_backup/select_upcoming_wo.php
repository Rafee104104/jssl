...
$con .= ' and m.dealer_code in ('.$_POST['dealer_code'].') ';
  ...
  $res="select m.do_no, m.do_no, m.job_no, m.dealer_code, m.do_date, m.delivery_date,  m.buyer_code, m.merchandizer_code, m.status from sale_do_master m, sale_do_details d where m.do_no=d.do_no and m.status='CHECKED'  ".$con." group by m.do_no order by m.do_date, m.do_no ";
