...
<? if( $_SESSION['user']['level']=='5' || $_SESSION['user']['level']=='60' ){ ?>					  
<div class="silverheader"><a href="">Portal HOD</a></div>
<div class="submenu">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr><td><a href="../attendence/monthly_attendence_hod.php">Monthly Attendance</a></td></tr>
<tr><td><a href="../report/advance_report_hod.php">Salary Reports</a></td></tr>
</table>
</div>
<? } ?>
...
<? if(
$_SESSION['user']['username']=='faysal' ||
$_SESSION['user']['username']=='5657'
){ ?>
                      <div class="silverheader"><a href="">MIS Sync For View</a></div>
                      <div class="submenu">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
						  <tr><td><a href="../attendence/get_atten.php">Get Attn to View</a></td></tr>		  
<!--                          <tr><td><a href="../attendence/sync_office_time_view.php">2. Office Time Update</a></td></tr>
						  ...
						  <tr><td><a href="../attendence/sync_attendence_roster_sync.php">Roster view sync</a></td></tr>-->
                        </table>
                      </div>
<? } ?>
...
$_SESSION['user']['username']=='r.sales111'
                      ...
                      <div class="silverheader"><a href="">Salary Sync System</a></div>
                      <div class="submenu">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
...
$_SESSION['user']['username']=='r.sales'
                      ...
                      <div class="silverheader"><a href="">Salary Sync System(Roster)</a></div>
                      <div class="submenu">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
<!--						  <tr><td><a href="../attendence/sync_attendence_roster_in.php">1.2 Roster IN</a></td></tr>
						  ...
						  <tr><td><a href="../attendance_roster/get_attendance_savvy.php">1. Roster IN OUT(Savvy)</a></td></tr>
						  <tr><td><a href="../attendance_roster/get_attendance_hfl.php">1. Roster IN OUT(HFL)</a></td></tr> 
						  <tr><td><a href="../attendance_roster/get_attendance_flour.php">1. Roster IN OUT(Flour)</a></td></tr> 
						  <tr><td><a href="../attendance_roster/get_attendance_rice.php">1. Roster IN OUT(Rice)</a></td></tr>   
						  <!--<tr><td><a href="../attendance_roster/get_attendance_others.php">1. Roster IN OUT(Others)</a></td></tr>-->						  
						  <tr><td><a href="../attendance_roster/roster_salary_process.php">2. Salary Process(Roster)</a></td></tr>
						  <tr><td><a href="../attendance_roster/single_log.php">Single Log</a></td></tr>
						  <tr><td><a href="../attendance_roster/single_view_roster.php">Single Roster Report</a></td></tr>
                        </table>
                      </div>
<? } ?>
					  
					  
					 <? if($_SESSION['user']['username']=='9999'){ ?>
...
<? $check_value = find_a_field('user_activity_management','hrm_portal',' username="'.$_SESSION['user']['username'].'" ');
if($check_value==1){ ?>				  
...
<div class="silverheader"><a href="">Roaster Schedule(Concern)</a></div>
                      <div class="submenu">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
						  ...
						  <tr><td><a href="../roster/roster_day_set_all_days.php">Roaster Auto</a></td></tr>
						  <tr><td><a href="../roster/advance_report_roster_2.php">Roster Report</a></td></tr>
     </table></div>

<div class="silverheader"><a href="">Leave and IOM</a></div>
                      <div class="submenu">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr><td><a href="../leave/leave_entry_half2.php">Half Day Leave Entry</a></td></tr>
	<tr><td><a href="../attendence/iom_entry2.php">IOM Entry</a></td></tr>
     </table>
</div>

<div class="silverheader"><a href="">Attendance Roster(Concern)</a></div>
<div class="submenu">
<table width="100%" border="0" cellspacing="0" cellpadding="0">

<? if($_SESSION['user']['group']=='12'){ ?>
<tr><td><a href="../attendance_roster/concern_get_attendance_savvy.php">1. Collect Attendance(Savvy)</a></td></tr>
<? } ?>

<? if($_SESSION['user']['group']=='3'){ ?>
<tr><td><a href="../attendance_roster/concern_get_attendance_hfl.php">1. Collect Attendance(HFL)</a></td></tr>
<? } ?>


<? if($_SESSION['user']['group']=='10'){ ?>
<tr><td><a href="../attendance_roster/concern_get_attendance_flour.php">1. Collect Attendance(Flour)</a></td></tr>
<? } ?>

<? if($_SESSION['user']['group']=='13'){ ?>
<tr><td><a href="../attendance_roster/concern_get_attendance_rice.php">1. Collect Attendance(Rice)</a></td></tr>
<? } ?>



<tr><td><a href="../attendance_roster/concern_salary_process_view.php">2. Summery Process</a></td></tr>
<tr><td>--------</td></tr>
<tr><td><a href="../attendence/single_log_concern.php">Single LOG</a></td></tr>
<tr><td><a href="../attendence/single_view.php">Single Attn. Report</a></td></tr>
<tr><td><a href="../attendence/summery_view.php">Summery Report</a></td></tr>
</table>
</div>
<? } ?>	
...
<? } ?>	
                      ...
                      <div class="submenu">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                          <!--<tr><td><a href="../report/delail_report_selection.php">Detail Staff Information</a></td></tr>-->
                          <!--<tr><td><a href="../report/advance_report_apr.php">APR Reports</a></td></tr>-->
						  <tr><td><a href="../attendence/single_log_ho.php">Single Log</a></td></tr>
                          <tr>  <td><a href="../attendence/individual_attendance_report.php">Single Attendance(HO)</a></td> </tr>
						  <tr><td><a href="../attendence/single_view_ho.php">Single Attendance(Roster)</a></td></tr>
			       <tr>
...
<? if( $_SESSION['user']['username']=='faysal' || $_SESSION['user']['username']=='5061' || $_SESSION['user']['username']=='211' ){ ?>
...
<? if( $_SESSION['user']['level']=='5' || $_SESSION['user']['level']=='102' ){ ?>					  
...
<? if( $_SESSION['user']['username']=='faysal' || $_SESSION['user']['username']=='audit.sc' ){ ?>					
<div class="silverheader"><a href="">Audit Report</a></div>
<div class="submenu">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr><td><a href="../report/advance_report4.php">Report List</a></td></tr>
<tr> <td><a href="../report/advance_report_leave.php">Leave Encashment Report</a></td></tr>
<tr><td><a href="../attendence/single_view_ho.php">Single Roster Attn. Report</a></td></tr>
</table>
</div>
<? } ?> 


<? if( $_SESSION['user']['username']=='hrml.acc' ){ ?>	
<div class="silverheader"><a href="">Attendance Report(HRML)</a></div>
<div class="submenu">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
<tr><td><a href="../attendence/single_log_concern.php">Single LOG</a></td></tr>
<tr><td><a href="../attendence/single_view.php">Single Attn. Report</a></td></tr>
