...
if(isset($_POST['save']))
{
		...
		$entry_by = $_SESSION['user']['id'];
			...
			mysql_query('insert into hrm_roster_allocation (PBI_ID,roster_date,point_1,shedule_1,point_2,shedule_2,job_location,group_for,entry_by) values("'.$_POST['PBI_ID'].'","'.$s_date.'","'.$point_1.'",
