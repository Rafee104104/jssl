...
if(isset($_POST['done'])){
		...
		$pbi_id = find_a_field('personnel_basic_info','PBI_ID','PBI_CODE="'.$getData[0].'"');
...
<div class="card">
				  <div style="font-weight:bold; font-size:16px;" class="card-header bg-info "><center>File Upload</center></div>
							...
							<div class="row">
								<div class="col-md-12 form-group"><center>
									...
									<form method="post"  enctype="multipart/form-data">
										 ...
										 <input style="width:300px; " type="file" name="att_file" id="att_file" required/>
										
										 <input style="width:100px" type="submit" name="done" id="done" class="btn1 btn1-bg-submit" value="Upload" />
