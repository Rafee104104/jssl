...
('".$datas->PBI_ID."','".$thisDate."', '".$value[$datas->PBI_ID][$thisDate]['in_time']."','".$value[$datas->PBI_ID][$thisDate]['out_time']."',dayname('".$thisDate."'), '".$value[$datas->PBI_ID][$thisDate]['sch_in_time']."','".$value[$datas->PBI_ID][$thisDate]['sch_mid_time']."','".$value[$datas->PBI_ID][$thisDate]['sch_out_time']."','".$value[$datas->PBI_ID][$thisDate]['sch_id']."')";
