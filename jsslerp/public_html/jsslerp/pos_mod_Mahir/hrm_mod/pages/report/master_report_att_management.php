...
?>
      ...
      <tr>
		...
		<td><? $cl_bl=find_a_field('hrm_leave_rull_manage','sum(CL)','1'); echo $cl_bl-$cl?></td>

		<td><? $sl_bl=find_a_field('hrm_leave_rull_manage','sum(SL)','1'); echo $sl_bl-$sl?></td>

		<td><? $al_bl=find_a_field('hrm_leave_rull_manage','sum(AL)','1'); echo $al_bl-$al?></td>

		<td><? $ml_bl=find_a_field('hrm_leave_rull_manage','sum(ML)','1'); echo $ml_bl-$ml?></td>

		<td><? $mlv_bl=find_a_field('hrm_leave_rull_manage','sum(MLV)','1'); echo $mlv_bl-$mlv?></td>

		<td><? $pl_bl=find_a_field('hrm_leave_rull_manage','sum(MLV)','1'); echo $pl_bl-$pl?></td>
