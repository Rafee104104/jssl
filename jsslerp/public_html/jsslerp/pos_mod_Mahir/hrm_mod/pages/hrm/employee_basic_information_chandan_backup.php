...
<div class="oe_view_manager oe_view_manager_current" style="padding-left:100px">
    ...
    <? include('../../common/title_bar.php');?>
        ...
        <a href="home2.php" rel = "gb_page_center[940, 600]"><?=$title?></a>
          ...
          </h1>--><table width="1000" border="0" cellpadding="0" cellspacing="0" class="oe_form_group ">
            <tbody><tr class="oe_form_group_row">
            <td colspan="1" class="oe_form_group_cell" width="100%"><table width="1050" border="0" cellpadding="0" cellspacing="0" class="oe_form_group ">
              <tbody>
                <tr class="oe_form_group_row">
                  ...
                  <td bgcolor="#E8E8E8" width="23" colspan="2" class="oe_form_group_cell">
                    ...
                    <input name="PBI_ID" type="text" value="<?=$PBI_ID?>" id="inputSuccess" class="form-control" readonly="readonly"/>
					<input name="PBI_CODE" type="text" id="PBI_CODE" value="<?=$$unique?>" class="form-control" readonly="readonly"/></td>
                  ...
                  <td bgcolor="#E8E8E8" width="23%" class="oe_form_group_cell"><select name="PBI_ORG">
...
<td colspan="2" bgcolor="#E8E8E8" class="oe_form_group_cell"><input type="file" name="pic" id="pic" /></td>
<td bgcolor="#E8E8E8" class="oe_form_group_cell">&nbsp;</td>
<td bgcolor="#E8E8E8" class="oe_form_group_cell">&nbsp;</td>
                </tr>
                </tbody></table>
