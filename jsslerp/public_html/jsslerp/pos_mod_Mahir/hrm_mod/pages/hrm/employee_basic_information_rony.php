...
<textarea name="PBI_PRESENT_ADD" type="text" id="PBI_PRESENT_ADD" class="form-control" rows="1" value="<?=$PBI_PRESENT_ADD?>"></textarea>
</div>

<div class="col-md-6 form-group">
<label class="label" for="PBI_PERMANENT_ADD">Permanent Add :</label>
<textarea name="PBI_PERMANENT_ADD" type="text" id="PBI_PERMANENT_ADD" class="form-control" rows="1" value="<?=$PBI_PERMANENT_ADD?>"></textarea>
</div>
...
<label class="label" for="PBI_POB">Sale Division :</label>
...
<div class="col-md-4 form-group">
<label class="label" for="PBI_POB">Sale Zone :</label>
...
<div class="col-md-4 form-group">
<label class="label" for="PBI_POB">Sale Area :</label>
...
<img src="../../../assets/support/upload_view.php?name=<?=$row->PBI_PASSPORT_ATT_PATH?>&folder=hrm_passport_pic" width="120" height="152" /></a>
<? }else{ ?>
