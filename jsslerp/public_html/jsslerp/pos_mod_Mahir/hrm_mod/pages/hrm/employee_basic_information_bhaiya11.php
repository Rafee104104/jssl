                      ...
                      <div class="card-body">
                        ...
                        <div class="row ">
                          ...
                          <div class="col-md-3 form-group">
                            ...
                            <label class="label" for="PBI_PHONE">Office Num :</label>
    ...
    <div class="card-body">
        ...
        <div class="form-row">
            ...
            <div class="col-md-3 form-group">
                ...
                <label class="label" for="par_po_name">Post Office :</label>
            ...
            <div class="col-md-3 form-group">
                ...
                <label class="label" for="par_ps">Police Station :</label>
...
value="<?=$PBI_SERVICE_LENGTH?>" readonly="readonly">
                          ...
                          <div class="col-md-2 form-group">
							...
							<div class="col-md-2 form-group">
							  ...
							  <label class="label" for="PBI_DURATION">Duration (months) :</label>
						...
						<div class="col-md-2 form-group">
                            ...
                            <label class="label" for="PBI_GROUP">Group :</label>
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-2 form-group">
							...
							<div class="col-md-2 form-group">
							  ...
							  <label class="label" for="PBI_DOR">Resign Date :</label>



							  <input name="PBI_DOR" type="date" id="PBI_DOR" value="<?=$PBI_DOR?>" class="form-control"/>
...
?>
					...
					<div class="col-md-3 mt-5 form-group">
						...
						<div class="col-md-3 mt-5 form-group">													
							  ...
							  <a href="../../../assets/support/upload_view.php?name=<?=$image_path->PBI_CV_ATT_PATH?>&folder=hrm_cv" target="_blank" download> 
							    ...
							    <img src="../../../assets/support/upload_view.php?name=<?=$image_path->PBI_CV_ATT_PATH?>&folder=hrm_cv" width="120" height="152"/>
