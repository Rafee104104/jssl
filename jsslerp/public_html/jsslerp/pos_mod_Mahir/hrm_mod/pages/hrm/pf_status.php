...
<!--<td><iframe src="../../../assets/support/upload_view.php?name=<?=$data->file_path?>&folder=hrm_pf_status&proj_id=<?=$_SESSION['proj_id']?>&mod=<?=$module_name?>" width="100" height="100"></iframe></td>
-->
      ...
      <!--<td>
        ...
        <div class="d-flex align-items-center">
                       <? if($data->file_path!=""){  ?>
						  <a href="../../../assets/support/upload_view.php?name=<?=$data->file_path?>&folder=hrm_pf_status&proj_id=<?=$_SESSION['proj_id']?>&mod=<?=$module_name?>" target="_blank" download> 

						   <img src="../../../assets/support/upload_view.php?name=<?=$data->file_path?>&folder=hrm_pf_status" width="70px" height="40px" class="img-fluid img-thumbnail" />
					   	</a>
	   ...
	   <td align="center"> <a href="../../../assets/support/upload_view.php?name=<?=$data->file_path?>&folder=hrm_pf_status&proj_id=<?=$_SESSION['proj_id']?>&mod=<?=$module_name?>" target="_blank" download> 
