...
$lv_days_casual =find_a_field('hrm_leave_info','sum(total_days)','type=1 and leave_status="GRANTED" and s_date between "'.$g_s_date.'" and "'.$g_e_date.'" and PBI_ID='.$_SESSION['employee_selected']);
$lv_days_sick   =find_a_field('hrm_leave_info','sum(total_days)','type=2 and leave_status="GRANTED" and s_date>="'.$g_s_date.'" and e_date<="'.$g_e_date.'" and PBI_ID='.$_SESSION['employee_selected']);
$lv_days_annual   =find_a_field('hrm_leave_info','sum(total_days)','type=3 and leave_status="GRANTED" and s_date>="'.$g_s_date.'" and e_date<="'.$g_e_date.'" and PBI_ID='.$_SESSION['employee_selected']);
$lv_days_marrage  =find_a_field('hrm_leave_info','sum(total_days)','type=4 and leave_status="GRANTED" and s_date>="'.$g_s_date.'" and e_date<="'.$g_e_date.'" and PBI_ID='.$_SESSION['employee_selected']);
...
if($old_leave>0){
$msggg= "<h4 class='alert alert-info'>You Can't Add Duplicate Leave</h4>";
}
elseif(($_POST['type']==1) && ($_POST['total_days'])> $leave_rule->CL){
$msggg= "<h4 class='alert alert-info'>You Can't apply Casual Leave (CL) more than the limit</h4>";
}
elseif(($_POST['type']==1) && (($lv_days_casual+$_POST['total_days'])>$leave_rule->CL)) {
$msggg= "<h4 class='alert alert-info'>Your Casual Leave (CL) already completed </h4>";

}elseif(($_POST['type']==2) && ($_POST['total_days'])> $leave_rule->MED){
$msggg= "<h4 class='alert alert-info'>You Can't apply Sick Leave (SL) more than the limit</h4>";

}elseif(($_POST['type']==2) && (($lv_days_sick+$_POST['total_days'])>$leave_rule->MED)) {
$msggg= "<h4 class='alert alert-info'>Your Sick Leave (SL) already completed </h4>";

}elseif(($_POST['type']==3) && ($_POST['total_days'])> $leave_rule->ANU){
$msggg= "<h4 class='alert alert-info'>You Can't apply Annual Leave (SL) more than the limit</h4>";

}elseif(($_POST['type']==3) && (($lv_days_annual+$_POST['total_days'])>$leave_rule->ANU)) {
$msggg= "<h4 class='alert alert-info'>Your Annual Leave (AL) already completed </h4>";

}elseif(($_POST['type']==4) && ($_POST['total_days'])> $leave_rule->ML){
$msggg= "<h4 class='alert alert-info'>You Can't apply Marriage Leave (ML) more than the limit</h4>";

}elseif(($_POST['type']==4) && (($lv_days_marrage+$_POST['total_days'])>$leave_rule->ML)) {
$msggg= "<h4 class='alert alert-info'>Your Marriage Leave (ML) already completed </h4>";

}elseif(($_POST['type']==5) && ($_POST['total_days'])> $leave_rule->MTR){
$msggg= "<h4 class='alert alert-info'>You Can't apply Maternity Leave (MLV) more than the limit</h4>";

}elseif(($_POST['type']==5) && (($lv_days_maternity+$_POST['total_days'])>$leave_rule->MTR)){
$msggg= "<h4 class='alert alert-info'>Your Maternity Leave (MLV) already completed </h4>";

}elseif(($_POST['type']==6) && ($_POST['total_days'])> $leave_rule->PL){
$msggg= "<h4 class='alert alert-info'>You Can't apply Paternity Leave (PL)more than the limit</h4>";

}elseif(($_POST['type']==6) && (($lv_days_paternity+$_POST['total_days'])>$leave_rule->PL)){
$msggg= "<h4 class='alert alert-info'>Your Paternity Leave (PL) already completed </h4>";

}elseif(($_POST['type']==7) && ($_POST['total_days'])> $leave_rule->HL){
$msggg= "<h4 class='alert alert-info'>You Can't apply Hajj Leave (HL) more than the limit</h4>";

}elseif(($_POST['type']==7) && (($hj_days_paternity+$_POST['total_days'])>$leave_rule->HL)){
$msggg= "<h4 class='alert alert-info'>Your Hajj Leave (HL) already completed </h4>";
...
?>
                          ...
                          <tr style="background:#f1f1f0" height="60">
                            ...
                            <?php /*?><td width="98" align="center" valign="middle"><div align="center" style="margin-top:13px"><strong><span class="style10">
                                <div align="center">Annual Leave (AL)</div>
                                </span></strong></div></td><?php */?>
                            ...
                            <?php /*?><td width="127" align="center" valign="middle"><div align="center" style="margin-top:15px"><strong><span class="style10">
...
if($PBI->PBI_SEX=="Female"){
 ?>
                            ...
                            <? } else{?>
                            <?php /*?><td width="125" align="center" valign="middle"><div align="center" style="margin-top:15px"><strong><span class="style10">Paternity Leave (PL)</span></strong></div></td><?php */?>
                            <? } ?>
                            <?php /*?><td width="127" align="center" valign="middle"><div align="center" style="margin-top:15px"><strong><span class="style10">Hajj Leave </span></strong></div></td><?php */?>
                            <td width="103" align="center" valign="middle"><div align="center"><strong><span class="style10">
                                <div align="center">Leave <br>
                                  Without Pay (LWP)</div>
                                </span></strong></div></td>
                            <?php /*?><td width="125" align="center" valign="middle"><div align="center"><strong><span class="style10">
              ...
              <tr>
                            ...
                            <td width="101" align="center" valign="middle"><div align="center"><span class="style9"><?=$leave_rule->CL;?></span></div></td>
                            <td width="130"  ><div align="center"><span class="style9"><?=$leave_rule->MED;?></span></div></td>
                            <td width="98" align="center"><span class="style9"><?=$leave_rule->ANU;?></span></td>
                            <td width="109"><span class="style9"></span></td>
                            <td width="103" align="center"><span class="style9"><?=$leave_rule->ML;?></span></td>
                            <?php /*?><td width="127" align="center"><?=$leave_rule->PL;?></td>
                            <td width="127" align="center"><?=$leave_rule->HL;?></td>
                            <td width="125" >&nbsp;</td>
                            <td width="125"  >&nbsp;</td><?php */?>
                          </tr>
              ...
              <tr>
						...
						if($PBI->PBI_SEX=="Female"){
                          ...
                          <tr>
                            ...
                            <td width="98" height="25" align="center" valign="middle"  bgcolor="#FFFFFF"><div align="center" ><span class="style4">
                                <?=$leave_rule->ANU-$leave_days_annual?>
                                </span></div></td>
                            <td width="109" height="25" align="center" valign="middle"  bgcolor="#FFFFFF"><div align="center" >
                                <?=$leave_days_half?>
                              </div></td>
                            <td width="125" align="center" valign="middle"  bgcolor="#FFFFFF"><div align="center" >
                                <?=$leave_rule->ML-$leave_days_marrige?>
                              </div></td>
                            <?
                   if($PBI->PBI_SEX=="Female"){
