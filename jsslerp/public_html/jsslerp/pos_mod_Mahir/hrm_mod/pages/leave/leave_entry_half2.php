...
<form action=""  method="post">		 
              ...
              <tr>
                ...
                <td bgcolor="#EBEBEB"><select name="type" id="type" class="form-control">
                    <option></option>
              ...
              <tr>
                ...
                <td><input type="hidden" name="total_days" id="total_days" style="width:100px;"  value=".5"/>
                    <input type="text" name="s_date" id="s_date" style="width:100px;" required="required"/ class="form-control">                </td>
                <td>&nbsp;</td>
              </tr>
              <tr>
                <td bgcolor="#EBEBEB"><div align="right">Reason :</div></td>
                <td bgcolor="#EBEBEB"><label>
                  <input name="reason" type="text" id="reason" required="required"/ class="form-control">
                </label></td>
                <td bgcolor="#EBEBEB">&nbsp;</td>
              </tr>
              <tr>
