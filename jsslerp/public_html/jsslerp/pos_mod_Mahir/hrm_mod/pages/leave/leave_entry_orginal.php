...
$title='Leave Entry';     // Page Name and Page Title
...
$_POST['mon'] = date('m', strtotime($_REQUEST['s_date']));
...
$ins_query="INSERT INTO hrm_att_summary( att_date, emp_id, leave_id, leave_type, leave_reason, leave_duration,leave_approved_by, leave_entry_at, leave_entry_by) 


VALUES ('".$att_date."','".$full_leave->PBI_ID."', '".$full_leave->id."', '".$full_leave->half_or_full."', '".$full_leave->reason."','".$leave_duration."', 


'".$_SESSION['user']['id']."', '".$full_leave->entry_at."', '".$full_leave->PBI_ID."')";
...
<td  colspan="4" bgcolor="#00FF00"><div align="center" style="font-size:24px">Leave Information  Entry </div></td>
...
<td><input type="text" value="<?=$emp->PBI_NAME.' - '.$emp->PBI_ID;?>" readonly="readonly"/>
...
<td><input type="text" name="s_date" id="s_date"  class="form-control"/></td>


<td align="right" ><div align="right"> End Date :</div></td>


<td ><input type="text" name="e_date" id="e_date"  class="form-control"/></td>
...
<td><input type="text" name="total_days" id="total_days" readonly="" required="required"  class="form-control"/></td>
