...
<td colspan="3">&nbsp;</td>
              ...
              <tr>
<td colspan="5"><div align="center"><input name="view" type="submit" id="view" value="View" /></div></td>
<td width="10%" colspan="4"><div align="center"><input name="delete" type="submit" id="delete" value="All Delete" /></div></td>
                </tr>
            </table>     
