...
<tr class="oe_list_header_columns">
  ...
  <tr  class="alt">
    ...
    <td><span class="oe_form_group_cell">
      <select name="PBI_GROUP" style="width:160px;" id="PBI_GROUP" required="required">
  ...
  <tr >
    ...
    <td><span class="oe_form_group_cell">
	  ...
	  <select required name="branch" id="branch" style="width:160px;" onchange="getData2('ajax_zone_rsm.php', 'loc', this.value,  this.value)">
