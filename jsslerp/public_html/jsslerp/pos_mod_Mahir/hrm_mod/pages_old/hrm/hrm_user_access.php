...
<tr><th scope="row">Code</th>
    <td><input type="text" name="emp_id" style="width:200px;" /></td>
</tr>
<tr><th scope="row">Password</th><td><input type="text" name="password" style="width:200px;" /></td></tr>
<tr><th scope="row">&nbsp;</th><td><input name="update" type="submit" value="Update" /></td></tr>
</form>
...
<tr>
    ...
    <td><strong><input type="text" name="emp_id2" id="emp_id2" style="width:200px;" value="<?=($_POST['emp_id2']!='')?$_POST['emp_id2']:'';?>"/></strong></td>
