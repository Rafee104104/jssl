                          ...
                          <tbody>
                            ...
                            <tr >
                              ...
                              <td align="right"><div align="left"><span class="oe_form_group_cell"> </span><span class="oe_form_group_cell">
                                <input name="roster_date" type="text" id="roster_date" value="<?=$_POST['roster_date']?>" autocomplete="off" required />
                              </span></div></td>
                            </tr>
...
<? foreign_relation('hrm_schedule_info','id','schedule_name',$shedule[$info->PBI_ID][$rp2_date],'group_for = "'.$_POST['group_for'].'"');?></select></td>
