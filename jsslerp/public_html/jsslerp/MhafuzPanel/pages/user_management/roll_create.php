...
<input  name="user_id2" type="hidden" id="user_id2" value="<?=$user_id2?>"/>
...
<? } else {?>
<input name="new" type="submit"  value="Save" style="width:100px; font-weight:bold; font-size:12px;" / class="form-control">
<? } ?>
