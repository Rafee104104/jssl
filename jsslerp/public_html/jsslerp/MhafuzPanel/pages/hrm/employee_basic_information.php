...
<div style="font-weight:bold; font-size:16px; background-color:#E74386; z-index:0px; text-transform:uppercase; color:#fff" class="card-header">
...
<option selected="selected"><?=$punch_type?></option>
