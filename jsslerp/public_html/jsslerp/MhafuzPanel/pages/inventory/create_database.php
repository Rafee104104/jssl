...
<div class="drophere ui-droppable mt-2 mb-2">
	<div class="col-12 shadow1 draghere ui-draggable ui-draggable-handle" style="position: relative;">
		<div class="row add">
			<div class="col-9 new_left p-2" align="left"><p class="bold m-0"> Add Company Database </p></div>
	...
	<div class="n-form-btn-class">
      <input type="submit" name="add" value="Save" class="btn1 btn1-bg-submit">
...
<div class="drophere ui-droppable mt-2 mb-2">
	<div class="col-12 shadow1 draghere ui-draggable ui-draggable-handle" style="position: relative;">
		<div class="row add">
			<div class="col-9 new_left p-2" align="left"><p class="bold m-0"> List Of Not Assign Database </p></div>
			<div class="col-3 new_right p-2">
