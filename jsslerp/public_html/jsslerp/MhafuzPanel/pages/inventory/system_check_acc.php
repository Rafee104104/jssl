...
system_acc_error_log($_POST['fdate'],$pushData->db_user,$pushData->db_pass,$pushData->db_name);
...
<div class="drophere ui-droppable mt-2 mb-2">
	<div class="col-12 shadow1 draghere ui-draggable ui-draggable-handle" style="position: relative;">
		<div class="row add">
			<div class="col-9 new_left p-2" align="left"><p class="bold m-0"> View Account Position </p></div>
			<div class="col-3 new_right p-2">
...
<?  $sql="select * from system_acc_lock_master where 1 and cid=".$_SESSION['cid']."";
...
<td><?=$data->difference_cr;?></td>

<td><?=$data->difference_dr;?></td>

<td><?=$data->difference_cr>0 || $data->difference_dr>0 ? "Problem" : "OK";?> </td>
