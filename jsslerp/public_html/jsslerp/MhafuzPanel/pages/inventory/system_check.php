...
<div class=" col-sm-6 drophere ui-droppable mt-2 mb-2">
	<div class="col-12 shadow1 draghere ui-draggable ui-draggable-handle" style="position: relative;">
		<div class="row add">
			<div class="col-9 new_left p-2" align="left"><p class="bold m-0"> Stock Check  for: <b><u><?= find_a_field('company_info', 'company_name', 'id="' . $_SESSION['cid'] . '"');  ?></u></b> </p></div>
...
<div class="drophere ui-droppable mt-2 mb-2">
	<div class="col-12 shadow1 draghere ui-draggable ui-draggable-handle" style="position: relative;">
		<div class="row add">
			<div class="col-9 new_left p-2" align="left"><p class="bold m-0"> View Stock Position</p></div>
			<div class="col-3 new_right p-2">
...
<tbody class="tbody1">
<?  $sql="select * from system_stock_lock_master where 1 and cid=".$_SESSION['cid']." ";
