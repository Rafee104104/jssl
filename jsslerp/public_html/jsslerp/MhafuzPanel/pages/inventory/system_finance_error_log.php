...
$title = "System Finance Error Log";
...
<div class="drophere ui-droppable mt-2 mb-2">
	<div class="col-12 shadow1 draghere ui-draggable ui-draggable-handle" style="position: relative;">
		<div class="row add">
			<div class="col-9 new_left p-2" align="left"><p class="bold m-0"> View Finance Error Log</p></div>
		...
		<? if ($_SESSION['cid'] != '') { ?>
				...
				<table class="table1  table-striped table-bordered table-hover table-sm">
					...
					<tbody class="tbody1">
						...
						<? $sql = "select l.*,c.company_name from system_daily_error_log_finance l,company_info c where c.id=l.cid and l.cid=" . $_SESSION['cid'] . " and  difference!=0";
...
<tr style="cursor: pointer;" onclick="window.open('system_finance_error_log_details.php?date=<?= $data->date ?>&&cid=<?= $_SESSION['cid'] ?>');">
								...
								<td><?= date('Y-m-d 00:00:00', strtotime($data->date)); ?></td>
