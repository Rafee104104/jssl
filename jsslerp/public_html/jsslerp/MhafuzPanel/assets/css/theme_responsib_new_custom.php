...
<?php /*?>    --theme-color-bgc: <?=$base_color?>;
    ...
    --table-hover-bg: <?=$table_hover_bg?>;<?php */?>
	
	--theme-color-bgc: #104383;
    --table-top-color: #104383;
    --table-top-text-color: #fff;
    --table-child-odd-color: #ffffff;
    --table-child-even-color: #d9edf7;
    --table-hover-bg: #fffc99;
...
body, h1, h2, h3, h4, h5, h6, p, a, samp, span, table, .table1, .thead1, .bgc-info, label, .form-control{
...
.thead1 tr:hover,#table_head tr:hover,.tbody1 tr:hover,#grp tr:hover{
