...
<form action="po_create.php" method="post" name="codz" id="codz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
  ...
  <div class="container-fluid bg-form-titel">
    ...
    <div class="row pt-3">
      <div class="col-md-12">
        <textarea name="terms_condition"  id="terms_condition"><? if($terms_condition != '') echo $terms_condition; else echo find_a_field('purchase_master','terms_condition','terms_condition !="" ');?>
</textarea>
      </div>
    </div>
  </div>
    ...
    <table class="table1  table-striped table-bordered table-hover table-sm">
      ...
      <tbody class="tbody1">
        <tr>
          ...
          <td colspan="3"><div align="right"> <span id="po">
              <table style="width:100%;" border="1">
                <tr>
								<td width="20%"><input name="stk" type="text" class="input3" id="stk" readonly="readonly"/></td>
