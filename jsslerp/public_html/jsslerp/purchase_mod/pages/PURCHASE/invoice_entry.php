...
<input name="rfq_qty_<?=$datafg->id?>" type="text" id="rfq_qty_<?=$datafg->id?>" value="<?=$datafg->rfq_qty; ?>" onkeyup="TRcalculationpo(<?=$data->id?>)" readonly="" style="width:100px; height:30px; " /></td>
    <td bgcolor="#99CCFF"><input name="unit_price_<?=$datafg->id?>" type="text" id="unit_price_<?=$datafg->id?>" value="<?=$datafg->unit_price; ?>"  readonly="" style="width:100px; height:30px; "/></td>
    <td bgcolor="#99CCFF"><input name="total_unit_<?=$datafg->id?>" type="text" id="total_unit_<?=$datafg->id?>" value="" style="width:100px; height:30px; "/></td>
  </tr>
