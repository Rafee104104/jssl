...
if($status=="No" && $_GET['status']=="No"){ mysql_query('update requisition_master set vendor_status="Yes" where req_no='.$_GET['vStatus'].'');}

if($status=="Yes" && $_GET['status']=="Yes"){ mysql_query('update requisition_master set vendor_status="Expired" where req_no='.$_GET['vStatus'].'');}
...
<div class="form-container_large">
 ...
 where  a.warehouse_id=b.warehouse_id and  a.status="CHECKED" and a.entry_by=c.user_id '.$con.$con2.'  order by a.req_no desc';
