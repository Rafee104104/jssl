...
<div class="body">
	<div class="header">
		...
		<td class="Qrl_code">
			...
			<p class="qrl-text"><?php echo $all->req_no;?></p><?php */?>
		</td>
...
<div class="main-content">
	...
	<table class="table1">
		...
		<? }?>
			  ...
			  <tr>
				<td align="right" colspan="7" style="text-align:right;"><strong>Total Amount </strong></td>
...
<div class="footer"  id="footer">
	<table class="footer-table">
        ...
        <tr>
		  ...
		  <p style="font-size:11px; margin: 0;"><?php /*?>(<?=find_a_field('user_activity_management','designation','user_id='.$all->entry_by);?>) <br/><?php */?> <?=$all->entry_at?></p>
		  </td>
		  ...
		  <p style="font-size:11px; margin: 0;"><?php /*?>(<?=find_a_field('user_activity_management','designation','user_id='.$all->checked_by);?>) <br/><?php */?> <?=$all->checked_at?></p>
		  </td>
        </tr>
        <tr>
