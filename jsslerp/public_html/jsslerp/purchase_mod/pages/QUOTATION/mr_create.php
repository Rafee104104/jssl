...
$vendor_query=mysql_query($vendor_sql);
while($row=mysql_fetch_object($vendor_query)){
?>
    ...
    <form action="" method="post" name="cloud" id="cloud">
        ...
        <div class="container-fluid pt-5 p-0 ">
            ...
            <table class="table1  table-striped table-bordered table-hover table-sm">
				...
				<?
					$s=0;
					   echo  $res='select a.id,   concat(b.item_name) as item_name, a.brand, a.origin, b.unit_name,  a.qty as qty , a.remarks, a.quotation_price, a.quotation_brand, a.remarks, "x" from quotation_detail a,item_info b where b.item_id=a.item_id and a.quotation_no='.$quotation_no;
