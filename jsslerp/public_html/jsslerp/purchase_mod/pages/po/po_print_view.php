...
<div class="body">
	<div class="header">
		...
		<td class="titel">
				...
				<p class="text"><?=$group_data->factory_address?></p>
				<?php /*?><p class="text">Cell: <?=$group_data->mobile?>. Email: <?=$group_data->email?> <br> <?=$group_data->vat_reg?></p><?php */?>
		</td>
		...
		<td class="Qrl_code">
			...
			<p class="qrl-text"><?php echo $master->po_no;?></p><?php */?>
		</td>
	...
	<div class="row">
		...
		<div class="col-md-6 col-sm-6 col-lg-6 right">
			...
			<p class="right-text">RFQ No: <span><?php /*?><?php echo $master->quotation_no;?>  <?php */?></span></p>
			<p class="right-text">Purchaser Code: <span><?php /*?>[<?php echo $master->entry_by;?>] 
			<?=find_a_field('user_activity_management','fname','user_id='.$master->entry_by)?>  <?php */?></span></p>
			<p class="right-text">Purchaser Email ID: <span> <?php /*?><?=find_a_field('user_activity_management','email','user_id='.$master->entry_by)?> <?php */?> </span></p>
...
<div class="main-content">
	...
	<table class="table1">
		...
		<? }?>
			  ...
			  <? if($master->vat>0) {?>
			  <tr  align="right">
				<td colspan="6" style="text-align:right;"><strong>VDS (BDT):</strong></td>
				<td align="right" style="text-align:right;"><strong>
				  <?  echo number_format($tax_total=$master->vat,2);?>
				</strong></td>
			  </tr>
			  <? }?>
			  ...
			  <? if($master->tax>0) {?>
			  <tr  align="right">
				<td colspan="6" style=" text-align:right;"><strong>TDS (BDT):</strong></td>
				<td align="right" style="text-align:right;"><strong>
				  <?  echo number_format($ait_total=$master->tax,2);?>
				</strong></td>
			  </tr>
			  <? }?>
...
<div class="footer"  id="footer">
	<table class="footer-table">
        ...
        <tr>
		  ...
		  <p style="font-size:11px; margin: 0;"><?php /*?>(<?=find_a_field('user_activity_management','designation','user_id='.$master->entry_by);?>) <br/> <?php */?><?=$master->entry_at?></p>
		  </td>
