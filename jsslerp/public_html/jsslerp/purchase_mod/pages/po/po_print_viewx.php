...
<table width="800" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
   <td colspan="2" align="center"><h4 style="font-size:18px; padding:10px 0; margin:0; font-family:  'MYRIADPRO-REGULAR'; letter-spacing:1px;text-decoration:underline; text-transform:uppercase;">Inter Purchase Receive Report</h4></td>
  </tr>
