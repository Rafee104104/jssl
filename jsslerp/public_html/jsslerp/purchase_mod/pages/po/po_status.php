                ...
                <table class="table1  table-striped table-bordered table-hover table-sm">
					...
					<? 
                        ...
                        <tr>
                            ...
                            <td>
							<? if($row->quotation_pic!='') { ?>
							<a href="../../../assets/support/upload_view.php?name=<?=$row->quotation_pic?>&folder=quotation&proj_id=<?=$_SESSION['proj_id']?>&mod=purchase_mod" target="_blank" dawnload> PO View</a>
							<? } else { echo ''; } ?>
							</td>
