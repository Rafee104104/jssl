...
personnel_basic_info a where 1 " . $con . " order by a.PBI_DOJ asc";
			...
			if ($_POST['report'] == 404) { // Task List
				...
				if ($_POST['status'] != '') {
				 ...
				 $sql = 'select i.PBI_NAME as name,t.task_name,t.task_des,concat(t.task_start,"(",t.task_start_time,")") as start_time,concat(t.task_end,"(",t.task_end_time,")") as end_time,(select priority from mis_task_priority where id=t.task_priority) as task_priority,t.status from task_manage t,personnel_basic_info i where t.assign_person=i.PBI_ID and t.assign_person!=0 ' . $conV . '';
			}
