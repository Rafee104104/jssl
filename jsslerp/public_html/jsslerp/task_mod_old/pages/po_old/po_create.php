...
<input  name="<?=$field?>" type="text" id="<?=$field?>" value="15" required />
...
<td colspan="3" align="center" bgcolor="#CCCCCC">
  ...
  <div align="right"><span id="po">
    <span id="po">
    <input name="stk" type="text" class="input3" id="stk" style="width:104px;float:left;" readonly/>
    </span>
...
<td align="center" bgcolor="#CCCCCC"><input name="amount" type="text" class="input3" id="amount" style="width:130px;" readonly required/></td>
      </tr>
    </table>
