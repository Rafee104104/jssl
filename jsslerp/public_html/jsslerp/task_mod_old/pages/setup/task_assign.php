...
echo "<script>window.top.location='not_assign_task.php'</script>";
}
...
<div class="modal-body">
        ...
        <form action="" method="post" style="text-align:left">
		  ...
		  <div class="form-group">
            ...
            <input type="text" class="form-control" name="task_name" value="<?=$taskAll->task_name;?>"  id="recipient-name">
		  ...
		  <div class="form-group">
            ...
            <input type="date" class="form-control" name="task_start"  value="<?=$taskAll->task_start;?>" id="recipient-name">
...
<div class="col-6">
		  <div class="form-group">
            ...
            <input type="date" class="form-control" name="task_end" value="<?=$taskAll->task_end;?>" id="recipient-name">
		  ...
		  <div class="form-group">
            ...
            <input type="time" style="width:30%" class="form-control" name="task_start_time" value="<?=$taskAll->task_start_time;?>" id="recipient-name">

			<span>End Time:</span>

            <input type="time" class="form-control" style="width:30%" name="task_end_time" value="<?=$taskAll->task_end_time;?>" id="recipient-name">
		  ...
		  <select type="time" class="form-control" style="width:30%" name="task_priority" value="<?=$taskAll->task_priority;?>" id="recipient-name">
		  <option></option>
