...
<div class="container">
  <h2 class="text-center">Systems Reports</h2><br><br>
  <table class="table table-bordered" id="grp">
    <thead>
      <tr>
        <th>CID Code</th>
        <th>CID Name</th>
    ...
    <tbody>
      <?php
      $query = mysql_query('select c.id,c.cid,d.db_name,d.db_user,db_pass from company_info c,database_info d where c.id=d.company_id');
