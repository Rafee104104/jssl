...
<h6 style="background-color:#4f64a5;color:white;padding:10px;text-align:center;"><a href="../../../MhafuzPanel/pages/inventory/home.php?cid=<?= $data->id ?>" style="color:white!important;"><?= $_SESSION['proj_id']; ?></a></h6>
...
<div class="menu_bg">
    ...
    <div class="silverheader mhafuz2" headerindex="1h"><a href="#"><i class="fas fa-cogs" aria-hidden="true"></i> Company Setup<span></span></a></div>
...
<? }?><?php */ ?>
    ...
    <div class="silverheader mhafuz1" headerindex="3h"><a href="#"><i class="fa fa-sign-out-alt" aria-hidden="true"></i> Exit Program<span></span></a></div>
