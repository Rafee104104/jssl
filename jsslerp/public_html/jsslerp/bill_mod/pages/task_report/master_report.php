...
$queryd=mysql_query($res);
while($data2 = mysql_fetch_object($queryd)){
?>
...
$jl_query1= mysql_query($jl_sql1 );while($jl1_result1 = mysql_fetch_object($jl_query1)){
...
$jl_query= mysql_query($jl_sql );while($jl_result = mysql_fetch_object($jl_query)){
