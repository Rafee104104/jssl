...
<tr>
        ...
        <td align="left" valign="top"><?=$sku_code?><br /><?=$item?></td>
...
<? }?>
      ...
      <tr  align="right">
        <td colspan="7"><strong>VAT (<?=number_format($data->tax,0)?>%):</strong></td>
