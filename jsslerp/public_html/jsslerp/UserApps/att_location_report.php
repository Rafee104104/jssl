...
<div class="form-container_large">
  ...
  <div class="row m-0">
    ...
    <div class="col-md-12 p-0 mob">
      ...
      <p style=" text-align: center; font-weight: bold; background-color:aquamarine; padding: 5px 0px;  text-decoration: underline;">Attendance Statistics For :
                ...
                for($i=1;$i<=$end_day;$i++){
                    ...
                    <tr>
                        ...
                        <td><? $in_time = find_a_field('hrm_attdump','min(xtime)','xenrollid="'.$PBI_ID.'" and xdate="'.$date.'" group by xdate');
                            ...
                            if($in_time!=''){ echo $in_time;}else{ if($off_day=='Fri'){ echo '<span class="btn btn-success btn-xs">Day Off</span>';
                        ...
                        <td><? $in_latitute =  find_a_field('hrm_attdump','latitude','bizid="'.$PBI_ID.'" and xdate="'.$date.'" and xtime="'.$in_time.'"'); 
                        ...
                        <td><?
                            ...
                            if($out_time!=''){ echo $out_time;}else{ if($off_day=='Fri'){ echo '<span class="btn btn-success btn-xs">Day Off</span>';
