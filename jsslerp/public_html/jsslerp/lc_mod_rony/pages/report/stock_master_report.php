...
echo '<img src="../../../logo/title.png" style="width:220px;" />';
...
if(isset($t_date)) 
		...
		<!--<table class="table table-bordered">
			...
			<?php 
				...
				$query=mysql_query($sql);
				while($l_row=mysql_fetch_object($query)){
			?>
				<tr>
...
echo '<img src="../../../logo/1.png" style="width:130px;" />';
...
<h2>
		...
		$dm_query=mysql_query($dm_sql);
		while($data=mysql_fetch_assoc($dm_query)){
