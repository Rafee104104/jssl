...
$con .= ' and batch_no in ('.$_POST['batch_no'].') ';
   ...
   $res="select l.*, m.pi_no from lc_pi_reference_setup l, lc_purchase_master m where l.id=m.pi_reference and l.status='CHECKED'  order by m.po_date, m.po_no";
