...
$con .= ' and a.id in ('.$_POST['lc_no'].') ';
   ...
   $res="select b.*, c.pi_no, c.bank_lc_no from lc_number_setup a, lc_bank_payment b, lc_bank_entry c  where a.id=b.lc_no and b.tr_no=c.tr_no and b.status!='COMPLETED' ".$con."  group by b.id order by a.id, b.id";
