...
// sec = (1/''), min = 2, hour = 3, day = 4, mon = 5, year = 6
	if($diff<2) return $difference = ($str2 - $str1);
	elseif($diff<3) return $difference = (int)(($str2 - $str1)/60)+1;
	elseif($diff<4) return $difference = (int)(($str2 - $str1)/3600)+1;
	elseif($diff<5) return $difference = (int)(($str2 - $str1)/86400)+1;
	elseif($diff<6) return $difference = (int)(($str2 - $str1)/2592000)+1;
	elseif($diff<7) return $difference = (int)(($str2 - $str1)/31536000)+1;
	else return NULL;
