...
<input  type="image" src="../../../assets/images/xls_hover.png" width="40" height="40" style="width:40px; height:40px;">
...
<input  type="image" src="../../../assets/images/pdf.jpg" width="40" height="40" style="width:40px; height:40px;">
...
<input  type="image" src="../../../assets/images/print.png" width="40" height="40" style="width:40px; height:40px;">
