...
<div class="box" style="width:100%;">
			...
			<input style="width:220px; height:32px;"  name="invoice_date" type="text" id="invoice_date"  value="<?=$_POST['invoice_date']?>"   required />									</td>
									...
									<? $pi_data = find_all_field('lc_number_setup','','id='.$pi_reference_no); 
			...
			<input name="lc_number" type="text" id="lc_number"  readonly="" style="width:220px; height:32px;" value="<?=$pi_data->lc_number;?>"  required tabindex="105" />	
