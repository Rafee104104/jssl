...
$con .= ' and batch_no in ('.$_POST['batch_no'].') ';
    ...
    $res="select l.*, m.pi_no from lc_number_setup l, lc_purchase_master m,lc_purchase_invoice d where m.po_no=d.po_no and l.id=m.pi_reference and l.status='CHECKED' group by m.po_no  order by m.po_date, m.po_no";
