				...
				<table class="table1  table-striped table-bordered table-hover table-sm">
					...
					<? if ($due_amt=$data->invoice_amt-$receipt_amt[$data->account_code][$data->tr_no]+$return_amt[$data->account_code][$data->tr_no]>0) {?>
					  ...
					  <tr>
						...
						<td><strong><?  $due_amt=$data->invoice_amt-$receipt_amt[$data->account_code][$data->tr_no]+$return_amt[$data->account_code][$data->tr_no]; echo number_format($due_amt,2);?></strong>
