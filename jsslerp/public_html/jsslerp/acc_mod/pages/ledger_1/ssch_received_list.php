...
<!--                                    <tr>
                                        ...
                                        <tr>
                                          <td><div align="right"><strong>Acc Head : </strong></div></td>
									...
									<tr>
                                          ...
                                          <td colspan="3"><span class="oe_form_group_cell" style="padding: 2px 0 2px 2px;">
                                            <select name="ledger_id" id="ledger_id" style="width:250px;">
                                              <option value="<?=$_POST['ledger_id']?>">
                                                <?=$_POST['ledger_id']?>
                                              </option>
                                              <option value=""></option>
                                              <option value="1097000300040001">Flour</option>
                                              <option value="1097000300060001">Rice</option>
                                              <option value="1097000300070001">Homes</option>
                                              <option value="1097000300050001">Agro</option>
                                              <option value="1097000100380000">HFL Export</option>
											  <option value="1097000300030000">Savvy</option>
                                            </select>
                                          </span></td>
                                        </tr>
...
if($_POST['ledger_id']!='') {$ledger_id_con=' and l.ledger_id="'.$_POST['ledger_id'].'"';}
...
$sql="SELECT DISTINCT 
				...
				FROM
				  journal j,
				  accounts_ledger l
				WHERE j.ledger_id = l.ledger_id 
					AND j.tr_from = 'StaffSales' 
					AND j.dr_amt >0 
					AND j.jv_date between '".$day_from."' AND '".$day_end."' 
					
				  ".$group_s." ".$depot_con." ".$depot_con.$checked_con.$dealer_type_con.$dealer_group_con.$dealer_code_con.$ledger_id_con." 
				group by  j.tr_no";
      ...
      <td align="center"><div align="left"><a target="_blank" href="../../warehouse_mod/pages/ss/chalan_bill_corporate.php?v_no=<?=$data->tr_no?>"><? echo $data->tr_no;?></a></div></td>
