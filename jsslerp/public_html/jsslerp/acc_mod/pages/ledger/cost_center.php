...
$con .='and a.warehouse_name like "%'.$_POST['warehouse_name'].'%" ';
 ...
 $td='select a.'.$unique.',  a.'.$shown.', u.group_name, c.category_name from '.$table.' a, cost_category c, user_group u  	where   a.category_id=c.id  and a.group_for="'.$_SESSION['user']['group'].'" and a.group_for=u.id    '.$con.' order by a.id  ';
