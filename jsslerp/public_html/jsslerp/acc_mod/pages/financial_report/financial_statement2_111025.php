...
$pi++;
$sl=$pi;
 $asset_intangile2=$asset_amt2[$data1->id]+$asset_amortization;
...
$pi++;
$sl=$pi;
 $asset_plant2=$asset_amt2[$data1->id]+$tot_asset_amt_depre;
...
<?=number_format($tot_asset=$asset_amt[$data1->id]+$tot_asset_amt_depre,2).'<br>'; $tot_asset_amt2 +=$tot_asset; //echo $asset_amt[$data1->id].'<br>'; echo $tot_asset_amt_depre;?></a></td>
									  </tr>
...
?>
									...
									<tr>
									  ...
									  <td bgcolor="#E0FFFF" align="right"><?=number_format($tot_non_current=$tot_asset_amt+$tot_dr_closing124+$tot_dr_closing125,2);?></td>
										  <td bgcolor="#E0FFFF" align="right" <?php echo $show_compa;?>><?=number_format($tot_non_current2=$tot_asset_amt222+$tot_dr_closing1244+$tot_dr_closing1255,2); ?></td>
									  </tr>
									  <tr>
...
$equity_amt4=$tot_equity_amt+$net_retained_earnings2-$paid_up_capital2;
