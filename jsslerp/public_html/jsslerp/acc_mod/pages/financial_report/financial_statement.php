...
<? }?>	
										...
										<td bgcolor="#E0FFFF" align="right" <?php echo $show_compa;?> ><?=number_format($tot_cur_asset2=$tot_asset_amt2,2);  ?></td>   
									  </tr>
...
<?=number_format($asset_plant=$asset_amt[$data1->id]+$tot_asset_amt_depre,2); $tot_asset_amt +=$asset_amt[$data1->id];?></a></td>
...
<?=number_format($asset_amt2[$data1->id]-$asset_amortization,2); $tot_asset_amt2 +=$asset_amt2[$data1->id];?></a></td>
									  </tr>
...
$sql1="select ss.id, ss.sub_sub_class_name from acc_sub_sub_class ss where ss.id in (121,1213,1215,1225)  order by ss.id";
...
<? 
									...
									<tr>
										  ...
										  <td bgcolor="#E0FFFF">&nbsp;</td>
										  <td bgcolor="#E0FFFF" align="right"><?=number_format($tot_non_current=$tot_asset_amt+$tot_dr_closing124+$tot_dr_closing125,2);?></td>
										  <td bgcolor="#E0FFFF" align="right" <?php echo $show_compa;?>><?=number_format($tot_non_current2=$tot_asset_amt2+$tot_dr_closing1244+$tot_dr_closing1255,2);?></td>
									  </tr>
									  <tr>

										  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=find_a_field('acc_sub_sub_class','sub_sub_class_name','id=1214');?> Payment</td>
                                          <td align="right">&nbsp;</td>
...
<td align="right" <?php echo $show_compa;?>><a href="financial_transaction_group_closing.php?show=show&fdate=<?=$_REQUEST['cfdate']?>&tdate=<?=$_REQUEST['ctdate']?>&acc_sub_sub_class=225" target="_blank"><?  echo $tot_dr_closing22; ?>
</a></td>
									  </tr>
...
$equity_amt=$tot_equity_amt+$net_retained_earnings-$paid_up_capital;
?>	
...
?></td>  <td bgcolor="#D8BFD8" align="right" <?php echo $show_compa;?>><? echo ($equity_amt2 > 0) ? number_format($equity_amt2, 2) : '(' . number_format($equity_amt2 * -1, 2) . ')';
?></td>
									  </tr>
...
?>
		 ...
		 <? number_format($liability_amt2[$data3->id],2); $tot_liability_cur2 +=$liability_amt2[$data3->id]+$tot_cr_closing2;?>
...
?></td>
									  ...
									  <tr>
										  ...
										  <td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=find_a_field('acc_sub_sub_class','sub_sub_class_name','id=1214');?> Receipt</td>
                                          <td align="right">&nbsp;</td>
...
:</strong></td>
										  ...
										  <td align="right" <?php echo $show_compa;?>><strong>
									      <?=number_format($total_equity_liabilities2=$equity_amt2+$tot_liability_amt22+$tot_liability_cur2 ,2); ?>
										  </strong></td>
									</tr>
