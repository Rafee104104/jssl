...
$report_detail.='<br>Reporting Period: '.$_REQUEST['cfdate'].' to '.$_REQUEST['ctdate'].'';
    ...
    <td><div class="left_report">
		    ...
		    Period :                                       </td>
                                        ...
                                        <td width="23%" align="left"> <div align="right">
                                          ...
                                          <input name="cfdate" type="text" id="cfdate" size="12" maxlength="12" value="<?php echo $_REQUEST['cfdate'];?>" />
                                        ...
                                        <td width="50%" align="left"><input name="ctdate" type="text" id="ctdate" size="12" style="max-width:250px;" value="<?php echo $_REQUEST['ctdate'];?>"/></td>
...
$sql = "select l.group_id, sum(j.dr_amt-j.cr_amt) as opening_amt from acc_sub_sub_class s, ledger_group l, accounts_ledger a, journal j
 where s.id=l.acc_sub_sub_class and l.group_id=a.ledger_group_id and a.ledger_id=j.ledger_id and  j.jv_date<'".$cfdate."' group by l.group_id";
...
$opening_amt[$data->group_id]=$data->opening_amt;
 ...
 where s.id=l.acc_sub_sub_class and l.group_id=a.ledger_group_id and a.ledger_id=j.ledger_id and  j.jv_date between '".$cfdate."' and '".$ctdate."' group by l.group_id";
$query = mysql_query($sql);
while($data=mysql_fetch_object($query)){
...
$sql = "select l.group_id, sum(j.dr_amt-j.cr_amt) as closing_amt from acc_sub_sub_class s, ledger_group l, accounts_ledger a, journal j
 where s.id=l.acc_sub_sub_class and l.group_id=a.ledger_group_id and a.ledger_id=j.ledger_id and  j.jv_date<='".$ctdate."' group by l.group_id";
$query = mysql_query($sql);
while($data=mysql_fetch_object($query)){
...
<td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="financial_transaction_ledger_closing.php?show=show&fdate=<?=$_REQUEST['cfdate']?>&tdate=<?=$_REQUEST['ctdate']?>&group_id=<?=$data1->group_id?>" target="_blank" style="color:#000000;">
