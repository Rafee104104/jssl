...
$closing_amt[$data->group_id]=$data->closing_amt;
 ...
 $sql_sub1="select s.id, s.sub_sub_class_name from acc_sub_sub_class s where s.id in (".$_REQUEST['acc_sub_sub_class'].") group by s.id";
...
<?php
 ...
 echo $sql1="select l.group_id, l.group_name from ledger_group l where l.acc_sub_sub_class=".$info_sub1->id."  
group by l.group_id";
