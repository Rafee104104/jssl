...
@media print {
  img.logo {
    height: 30px !important; /* smaller height for printing */
...
<table width="90%" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
			...
			<img  src="../../../logo/1.png" class="logo" style=" height:50px; width:auto;" />
            </td>
...
echo $_SESSION['proj_name'];
              ...
              <tr>
                ...
                <td align="center" style="border:0px; padding-left:25px;"><? echo find_a_field('user_group','address',"id=".$_SESSION['user']['group']);?></td>
          ...
          <tr>
            ...
            <td  align="center" style="border:0px"><span>
