              ...
              <div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0 pr-2">
                <select name="group_class" id="group_class" width="50%">
                  ...
                  <option value="1" <?=($_REQUEST['group_class']==1?"selected":"")?>>Asset</option>
				   <option value="2" <?=($_REQUEST['group_class']==2?"selected":"")?>>Equity And Liabilities</option>
                  <option value="3" <?=($_REQUEST['group_class']==3?"selected":"")?>>Revenue</option>
      ...
      <div id="reporting">
        <div id="grp">
          ...
          <table class="table1  table-striped table-bordered table-hover table-sm">
            ...
            $aqry = mysql_query($a);
            while($adata=mysql_fetch_row($aqry)){?>
              ...
              $bqry = mysql_query($b);
              while($bdata=mysql_fetch_row($bqry)){?>
                <tr<? $i++; if($i%2==0)$cls=' class="alt"'; else $cls=''; echo $cls;?>>
                  <td>&nbsp;</td>
                  <td><?=$bdata[1];?></td>
                  <td>&nbsp;</td>
                ...
                $report_ssc = mysql_query($rrr_ssc);
                while($rpssc=mysql_fetch_row($report_ssc)){?>
                  <tr<? $i++; if($i%2==0)$cls=' class="alt"'; else $cls=''; echo $cls;?>>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                    <td><?=$rpssc[1];?>  </td>
