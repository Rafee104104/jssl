...

{
 ...
 $ssql='update secondary_journal set jv_date="'.$voucher_date.'",  checked_at="'.$time_now.'", checked_by="'.$_SESSION['user']['id'].'", checked="YES" where jv_no="'.$jv_no.'"';
	...
	sec_journal_journal($jv_no,$jv,$_POST['tr_from']);
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td width="180" align="right"><a target="_blank" href="../../../warehouse_mod/pages/wo/delivery_challan_print_view.php?v_no=<?=$ch->chalan_no?>">CH-
...
<input name="voucher_date" type="text" id="voucher_date" value="<?php echo $jv->jv_date;?>" />    </td>
    ...
    <td><? if($jv->checked=='NO'){?>
		...
		<input name="tr_from" type="hidden" id="tr_from" value="<?=$jv->tr_from;?>" style="font-size:12px; color:#990000" />
...
<a target="_blank" href="../../../warehouse_mod/pages/wo/delivery_challan_print_view.php?v_no=<?=$ch->chalan_no?>"></a></div><? }else{?>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#339900">
  ...
  <tr>
    ...
    <td width="200" align="right"><a target="_blank" href="../../../warehouse_mod/pages/wo/delivery_challan_print_view.php?v_no=<?=$ch->chalan_no?>">CH-
...
<a target="_blank" href="../../warehouse_mod/pages/pr/chalan_view2.php?v_no=<?=$ch->pr_no?>"></a></div><? }?>
 ...
 $sql2="SELECT a.ledger_id,a.ledger_name,cr_amt,dr_amt,b.narration FROM accounts_ledger a, secondary_journal b where b.jv_no='$jv_no' and a.ledger_id=b.ledger_id and b.tr_from in ('Contract Booking', 'Paid Booking', 'Normal Booking')";
