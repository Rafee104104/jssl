...
elseif($_POST['report']==210617002)
{
        ...
        <tr>
          <td colspan="15" align="center" style="font-size:14px;border:0px; border-color:white;"><strong> Group: <?=find_a_field('ledger_group','group_name','group_id='.$_POST['ledger_group'])?></strong></td>
         </tr>
		 <? }?>
        ...
        <tr>
          <td colspan="15" align="center" style="font-size:14px;border:0px; border-color:white;"><strong> GL Name: <?=$_POST['ledger_id']?> - <?=find_a_field('accounts_ledger','ledger_name','ledger_id='.$_POST['ledger_id'])?></strong></td>
         </tr>
		 <? }?>
		...
		if($_POST['ledger_group']) 		{$ledger_group_con=' and a.ledger_group_id="'.$_POST['ledger_group'].'"';}
		if($_POST['ledger_id']) 		{$ledger_id_con=' and a.ledger_id="'.$_POST['ledger_id'].'"';}
