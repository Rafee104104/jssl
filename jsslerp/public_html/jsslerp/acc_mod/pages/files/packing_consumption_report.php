...
$total_amt = $total_amt + ($info->qty*$info->rate);
}
...
<table width="800" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td bgcolor="#666666" style="text-align:center; color:#FFF; font-size:18px; font-weight:bold;">PACKING CONSUMPTION REPORT</td>
      </tr>
    </table></td>
              </tr>
            </table></td>
		  ...
		  <tr>
		    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px">
              ...
              <tr>
                ...
                <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
                  <tr>
                    <td><?php echo find_a_field('user_group','group_name','id='.$datas->issued_to);?></td>
                  </tr>
              ...
              <tr>
                <td width="40%" align="right" valign="middle"> Requisition From:</td>
                <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
                    <tr>
			...
			<td width="30%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px">
			  ...
			  <tr>
                ...
                <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
                    <tr>
                      <td>&nbsp;<?php echo $datas->manual_oi_no;?></td>
                    </tr>
                </table></td>
              </tr>
            </table></td>
...
<table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="5">
       <tr style="font-size:13px;">
        ...
        <td align="center" bgcolor="#CCCCCC">Remarks</td>
...
?>
      ...
      <tr style="font-size:12px; height:40px;" <?=($i%2)?'bgcolor="#F7F7F7"':'';?>>
        ...
        <td align="left" valign="top"><?=$remarks[$i];?></td>
        <td align="right" valign="top">
		<span id="po<?=$id[$i]?>"><input type="button" name="Submit" value="RESET" style="font-size:11px; color:#FF0000;" 
		onclick="getData2('pc_view_print_ajax.php', 'po<?=$id[$i]?>','<?=$id[$i]?>',document.getElementById('rate_<?=$id[$i]?>').value);" /></span></td>
        </tr>
