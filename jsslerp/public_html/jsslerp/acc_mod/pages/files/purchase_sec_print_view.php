...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
  <tr>
    ...
    <td width="130" align="left"><a href="../../../warehouse_mod/pages/po_receiving/chalan_view2.php?v_no=<?php echo $jv->tr_no; ?>"target="_blank">View GRN</a></td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#00CC00">
  <tr>
    <td width="42"><input name="button" type="button" onclick="hide();window.print();" value="Print" /></td>
    <td width="99" align="left"><a href="../../../warehouse_mod/pages/po_receiving/chalan_view2.php?v_no=<?php echo $jv->tr_no; ?>"target="_blank">View GRN</a></td>
