...
<?php
		...
		$led2=mysql_query("select a.item_id, a.item_name from item_info a,item_sub_group b where a.product_nature!='Salable' and a.	sub_group_id =b.	sub_group_id  order by item_name");
		$data2 = '[';
