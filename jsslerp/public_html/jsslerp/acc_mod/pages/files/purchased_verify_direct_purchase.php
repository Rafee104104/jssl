...
$title='Direct Purchase Varification';
$now=time();
...
j.cr_amt>0 and
				  ...
				  j.ledger_id = l.ledger_id ".$group_s.$checked_con.$depot_con." group by j.jv_no";
					...
					while($data=mysql_fetch_row($query)){
						...
						<tr>
							...
							<td><a target="_blank" href="direct_purchase_print_view.php?jv_no=<?=$data[10] ?>"><img src="../images/print.png" width="20" height="20" /></a></td>
			...
			if(($data[9]=='YES')){
				...
				<input type="button" name="Button" value="YES"  onclick="window.open('direct_purchase_print_view.php?jv_no=<?=$data[10] ?>');" class="btn1 btn1-bg-submit"/>
				...
				<input type="button" name="Button" value="NO"  onclick="window.open('direct_purchase_print_view.php?jv_no=<?=$data[10] ?>');" class="btn1 btn1-bg-cancel"/>
