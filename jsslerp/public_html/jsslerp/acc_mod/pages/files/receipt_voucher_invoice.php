...
<?php
    ...
    $led2=mysql_query("select  concat(ledger_name,'##>>',ledger_id), concat(ledger_name,'##>>',ledger_id) FROM accounts_ledger WHERE ledger_name not like '%cash%' and ledger_group_id='1086' and parent=0 order by ledger_id");
...

	{
	  ...
	  while($ledg2 = mysql_fetch_row($led2)){$data2 .= '{ name: "'.$ledg2[1].'", id: "'.$ledg2[0].'" },';}
...
$led2=mysql_query("select ledger_id, ledger_name from accounts_ledger where ledger_name like '%cash%' and parent=0 order by ledger_id");
