									...
									if($_POST['dealer_group']!='') {$dealer_group_con=' and d.product_group="'.$_POST['dealer_group'].'"';}
									 echo  $sql="SELECT DISTINCT 
											...
											WHERE
											  ...
											  j.tr_from in ('Contract Booking', 'Paid Booking', 'Normal Booking') AND 
											  j.tr_no = m.booking_id  and 
		  ...
		  ?>
						  ...
						  ?>
                            ...
                            <tr <?=($i%2==0)?'class="alt"':'';?> >
								  ...
								  <td align="center"><div align="left"><? echo $data->booking_number_eng;?></div></td>
								  ...
								  <td align="center"><div align="right"><?=$data->tr_from;?></div></td>
								  <td align="right"><?=number_format(($data->cr_amt),2);?></td>
								  <td align="center"><a target="_blank" href="booking_sec_print_view.php?jv_no=<?=$data->jv_no ?>">
							...
							if(($data->checked=='YES')){
							?>
							<input type="button" name="Button" value="YES"  onclick="window.open('booking_sec_print_view.php?jv_no=<?=$data->jv_no;?>');" class="btn1 btn1-bg-submit"/>
							<?
							}elseif(($data->checked=='NO')){
							?>
							<input type="button" name="Button" value="NO"  onclick="window.open('booking_sec_print_view.php?jv_no=<?=$data->jv_no;?>');" class="btn1 btn1-bg-cancel"/>
							<? }?>
          </span></td>
