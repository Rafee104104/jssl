...
$led=mysql_query("select ledger_id,ledger_name from accounts_ledger where group_for=".$_SESSION['user']['group']." and ledger_group_id in (1002,1003,1004) order by ledger_name");
