...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>    <td width="66%" style="padding-right:5%">
	...
	{
		$cus_name	= mysql_real_escape_string($_REQUEST['cus_name']);
		$cus_company	= mysql_real_escape_string($_REQUEST['cus_company']);
		$cus_type	= mysql_real_escape_string($_REQUEST['cus_type']);
