...
$item_name	= str_replace("&","",$item_name);
$item_name	= str_replace('"','',$item_name);
$cost_p		= mysql_real_escape_string($_REQUEST['cost_p']);
$sale_p		= mysql_real_escape_string($_REQUEST['sale_p']);
$reorder	= mysql_real_escape_string($_REQUEST['reorder']);
$fdate		= mysql_real_escape_string($_REQUEST["fdate"]);
$item_desc	= mysql_real_escape_string($_REQUEST["item_desc"]);
