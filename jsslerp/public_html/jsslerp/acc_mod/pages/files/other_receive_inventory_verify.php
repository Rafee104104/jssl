...
$title='Inv. Other Receive Verification';
$now=time();
	  ...
	  $i=0;
	    ...
	    $sql="SELECT DISTINCT 
				...
				WHERE
				  ...
				  j.tr_from = 'Inv. Other Receive' AND 
...
$received = $received + $data[1];
	...
	<tr>
      ...
      <td><a target="_blank" href="inv_other_receive_sec_print_view.php?jv_no=<?=$data[3] ?>"><img src="../images/print_hover.png" width="20" height="20" /></a></td>
		  ...
		  <span id="divi_<?=$data[0]?>">
            ...
            <? 
			  ...
			  if(($data[9]=='YES')){
					...
					<input type="button" name="Button" value="YES"  onclick="window.open('inv_other_receive_sec_print_view.php?jv_no=<?=$data[3] ?>');" class="btn1 btn1-bg-submit"/>
					...
					<input type="button" name="Button" value="NO"  onclick="window.open('inv_other_receive_sec_print_view.php?jv_no=<?=$data[3] ?>');" class="btn1 btn1-bg-cancel"/>
