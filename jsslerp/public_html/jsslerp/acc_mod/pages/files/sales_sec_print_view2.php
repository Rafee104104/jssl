...

{
 ...
 $ssql='update secondary_journal set jv_date="'.$voucher_date.'",  checked_at="'.$time_now.'", checked_by="'.$_SESSION['user']['id'].'", checked="YES" where jv_no="'.$jv_no.'"';
	...
	sec_journal_journal($jv_no,$jv,'Bag Sales');
...
echo $_SESSION['proj_name'];
              ...
              <tr>
				...
				<td style="text-align:center; font-size:12px; line-height: 17px !important;"><?=find_a_field('user_group','factory_address','1');?></td>
...
<a target="_blank" href="../../warehouse_mod/pages/pr/chalan_view2.php?v_no=<?=$ch->pr_no?>"></a></div><? }?>
 ...
 $sql2="SELECT a.ledger_id,a.ledger_name,cr_amt,dr_amt,b.narration FROM accounts_ledger a, secondary_journal b where b.jv_no='$jv_no' and a.ledger_id=b.ledger_id and b.tr_from='Bag Sales'";
