						...
						<div class="form-group row  m-0 mb-1 pl-3 pr-3">
							...
							<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0 pr-2">
								...
								<select name="ledger_id" id="ledger_id" class="form-control"  >
									...
									foreign_relation('accounts_ledger','ledger_id','ledger_name',$ledger_id,"1 and ledger_group_id=122001 order by ledger_id");
							...
							while($data=mysql_fetch_row($sql))
							{
								...
								<tr <?=($xx%2==0)?' bgcolor="#EDEDF4"':'';$xx++;?>>
									...
									<td align="center" >
										...
										?>	</td>
									<td style=" width: 9%; "><?php echo date('d-m-Y',strtotime($data[0]));?></td>
									<td align="left" style=" width: 25%;"><?=$data[1];?></td>
									...
									<td class="bg-table1">
<?php /*?>									<?php $blance = $blance+($data[2]-$data[3]); if($blance>0) echo '(Dr) '.number_format($blance,2); elseif($blance<0) echo '(Cr) '.number_format(((-1)*$blance),2);else echo "0.00"; ?><?php */?>
									
									<?php $blance = $blance+($data[2]-$data[3]); if($blance>0) echo number_format($blance,2); elseif($blance<0) echo number_format(((-1)*$blance),2);else echo "0.00"; ?>
									</td>
								</tr>
							<?php } ?>
							<tr >
