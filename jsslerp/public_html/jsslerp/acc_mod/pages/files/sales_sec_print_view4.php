...

{
 ...
 $ssql='update secondary_journal set jv_date="'.$voucher_date.'",  checked_at="'.$time_now.'", checked_by="'.$_SESSION['user']['id'].'", checked="YES" where jv_no="'.$jv_no.'"';
	...
	sec_journal_journal($jv_no,$jv,'SR Loan');
	//sec_journal_journal($jv_no,$jv,'COGS');
...
echo $_SESSION['proj_name'];
              ...
              <tr>
                ...
                <td style="text-align:center; font-size:12px;"><?=find_a_field('user_group','address','1');?></td>
				<tr style="line-height: 0px !important;">
					<td>&nbsp;</td>
				</tr>
				<td style="text-align:center; font-size:12px;"><?=find_a_field('user_group','factory_address','1');?></td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td width="180" align="right"><a target="_blank" href="../../../warehouse_mod/pages/wo/challan_invoice_print_view.php?v_no=<?=$ch->chalan_no?>">CH-
...
<a target="_blank" href="../../../warehouse_mod/pages/wo/challan_invoice_print_view.php?v_no=<?=$ch->chalan_no?>"></a></div><? }else{?>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#339900">
  ...
  <tr>
    ...
    <td width="200" align="right"><a target="_blank" href="../../../warehouse_mod/pages/wo/challan_invoice_print_view.php?v_no=<?=$ch->chalan_no?>">CH-
...
<a target="_blank" href="../../warehouse_mod/pages/pr/chalan_view2.php?v_no=<?=$ch->pr_no?>"></a></div><? }?>
      ...
      <tr>
        ...
        <td class="tabledesign_text">
          ...
          <?=date('d-m-Y',strtotime(find_a_field('secondary_journal','jv_date','jv_no='.$jv->jv_no)));  ?></td>
 ...
 $sql2="SELECT a.ledger_id,a.ledger_name,cr_amt,dr_amt,b.narration FROM accounts_ledger a, secondary_journal b where b.jv_no='$jv_no' and a.ledger_id=b.ledger_id and b.tr_from='SR Loan'";
...
<?php }?>
  ...
  <tr>
	...
	<tr>
        ...
        <td align="center" valign="bottom"><?=find_a_field('user_activity_management u,sr_loan l','u.username','u.user_id=l.entry_by and l.sr_loan_id='.$jv->tr_no);?></td>

        <td align="center" valign="bottom"></td>

        <td align="center" valign="bottom"><?=find_a_field('user_activity_management u,journal l','u.username','u.user_id=l.checked_by and l.tr_no='.$jv->tr_no);?></td>
