				...
				<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
					<div class="container n-form2">
						...
						<div class="form-group row m-0 pb-1">
							...
							<? 
									$cv_no = find_a_field('secondary_journal','cv_no','tr_from = "Contra" and entry_by="'.$_SESSION['user']['id'].'" and cv_no != "" order by jv_no desc ');
									$datas = explode("/",$cv_no);
									//$cv_no = $datas[0].'/'.($datas[1]+1);
									
									$checked = find_a_field('secondary_journal','checked','tr_from = "Contra"  and entry_by="'.$_SESSION['user']['id'].'" and cv_no != "" order by jv_no desc ');						if($checked=='YES')
									{
				...
				<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
					<div class="container n-form2">
						<table  class="table1  table-striped table-bordered table-hover table-sm" border="0" cellspacing="0" cellpadding="0">
							...
							$sql2="select a.tr_no, a.cr_amt, a.narration,a.jv_date , a.jv_no,a.checked,a.cv_no from  secondary_journal a where a.tr_from='Contra' and  SUBSTRING(a.tr_no,5,1)='0' and  a.cr_amt>0 and a.group_for=".$_SESSION['user']['group']." group by a.tr_no order by a.id desc limit 5";
		...
		<div class="container-fluid pt-4 p-0 ">
			...
			<table class="table1  table-striped table-bordered table-hover table-sm">
				...
				<tr>
					...
					<td><input type="text" class="form-control" tabindex="5" id="ledger_id" list="ledger_idss" name="ledger_id" onblur="getData2('acc_reference_ajax.php', 'acc_reference', this.value,
document.getElementById('ledger_id').value);" tabindex="1"  value="<?=$jv_data->ledger_id?>"  autocomplete="off" >

<datalist id="ledger_idss">
	<? foreign_relation('accounts_ledger','ledger_id','ledger_name',$ledger_id,'ledger_group_id in (1224001,1226001)');?>
</datalist>
</td>
					...
					<td>
						...
						<table width="100%" border="1" align="center"  cellpadding="2" cellspacing="2">
							<tr>
								<td><input type="text" tabindex="6" class="form-control" id="ledger_name" name="ledger_name" value="<?=$jv_data->ledger_name?>" />
					...
					<td>
						<input name="detail" type="text" id="detail" class="form-control"  tabindex="8" />
					</td>
...
?>
            ...
            <tr>
              ...
              <td width="5%" align="center" bgcolor="#45777B"><span class="style3">Type kkk</span></td>
            ...
            <tr>
              ...
              <td><input type="text" class="form-control" id="ledger_id" list="ledger_ids" name="ledger_id" onblur="getData2('acc_reference_ajax.php', 'acc_reference', this.value, 
