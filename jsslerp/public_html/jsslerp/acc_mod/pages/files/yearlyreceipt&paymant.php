...
$cash=mysql_fetch_row(mysql_query("select ledger_id from accounts_ledger where ledger_group_id='$cash_and_bank_balance' and 1 and ledger_name like '%ash%'"));
...
//echo $cl_c1;
$cl_c=mysql_fetch_row(mysql_query($cl_c1));
$closing_c=$cl_c[0];
...
$op_b=mysql_fetch_row(mysql_query($op_b1));
...
$cl_b=mysql_fetch_row(mysql_query($cl_b1));
