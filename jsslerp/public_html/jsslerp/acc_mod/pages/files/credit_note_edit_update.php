...
foreign_relation('accounts_ledger','ledger_id','ledger_name',$jv->relavent_cash_head,'ledger_group_id="'.$cash_ledg_group_id.'" order by ledger_id');
...
foreign_relation('accounts_ledger','ledger_id','ledger_name',$jv->relavent_cash_head,'ledger_group_id="'.$bank_ledg_group_id.'" order by ledger_id');
...
<td width="19%" style="text-align:right;"><input name="receipt_varify" class="btn btn-success" type="button" id="receipt_varify" value="Receipt Verified" onclick="this.form.submit()" />
