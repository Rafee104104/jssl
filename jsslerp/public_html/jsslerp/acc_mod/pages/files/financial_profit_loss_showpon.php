...
-->
				 ...
				 <tr>
				   ...
				   <td>&nbsp;</td>
				   <td align="right"><? $com_id = 1; $amount1 = sum_com($com_id,$fdate,$tdate); $total = $total - $amount; $total1 = $total1 + $amount; echo '<a href="trial_balance_periodical_group.php?fdate='.$_REQUEST["fdate"].'&tdate='.$_REQUEST["tdate"].'&cc_code=&show=Show&com_id='.$com_id.'">'.number_format(($amount1*(-1)),2).'</a>';?></td>
				   </tr>
				 ...
				 <tr>
				   ...
				   <td align="right" bgcolor="#FFCCFF"><strong><? $com_id = 3; $amount3 = sum_com($com_id,$fdate,$tdate); $total = $total - $amount; $total1 = $total1 + $amount; echo '<a href="trial_balance_periodical_group.php?fdate='.$_REQUEST["fdate"].'&tdate='.$_REQUEST["tdate"].'&cc_code=&show=Show&com_id='.$com_id.'">'.number_format($amount3,2).'</a>';?></strong></td>
				   </tr>
				 ...
				 <tr>
				   ...
				   <td bgcolor="#FF9999"><strong>Net Sale E=(C-D) </strong></td>
				 ...
				 <tr>
				   ...
				   <td>&nbsp;</td>
				   <td align="right"><strong>
				    <input type="hidden" name="name" id="id" value=" <? $com_id = 51; $amount51 = sum_com2($com_id,$fdate,$tdate); $total = $total - $amount; $total1 = $total1 + $amount; echo number_format($amount51,2);?>" />
				   </strong></td>
				 </tr>
				 <tr>
				   ...
				   <td><div align="center">a</div></td>
				   <td align="right"><strong>
				     <?= number_format($csrt_tot = (($amount5)-$amount51),2); ?>
				   </strong></td>
				   </tr>
				 <tr>
				   ...
				   <td><div align="center">b</div></td>
				   <td align="right"><strong>
				     <? $com_id = 52; $amount52 = sum_com($com_id,$fdate,$tdate); $total = $total - $amount; $total1 = $total1 + $amount; echo '<a href="trial_balance_periodical_group.php?fdate='.$_REQUEST["fdate"].'&tdate='.$_REQUEST["tdate"].'&cc_code=&show=Show&com_id='.$com_id.'">'.number_format($amount52,2).'</a>';?>
				   </strong></td>
				   </tr>
				 <tr>
				   ...
				   <td><div align="center">c</div></td>
				   <td align="right"><strong>
                     <? $com_id = 53; $amount53 = sum_com($com_id,$fdate,$tdate); $total = $total - $amount; $total1 = $total1 + $amount; echo '<a href="trial_balance_periodical_group.php?fdate='.$_REQUEST["fdate"].'&tdate='.$_REQUEST["tdate"].'&cc_code=&show=Show&com_id='.$com_id.'">'.number_format($amount53,2).'</a>';?>
                   </strong></td>
				   </tr>
				 <tr>
                   <td>Closing Stock of Finished Goods (Sylhet)</td>
				   <td><div align="center">d</div></td>
				   <td align="right"><strong>
                      <? $com_id = 54; $amount54 = sum_com($com_id,$fdate,$tdate); $total = $total - $amount; $total1 = $total1 + $amount; echo '<a href="trial_balance_periodical_group.php?fdate='.$_REQUEST["fdate"].'&tdate='.$_REQUEST["tdate"].'&cc_code=&show=Show&com_id='.$com_id.'">'.number_format($amount54,2).'</a>';?>
                   </strong></td>
				   </tr>
				 <tr>
				   <td>Closing Stock of Finished Goods (Dhaka)</td>
				   <td><div align="center">e</div></td>
				   <td align="right"><strong>
				     <? $com_id = 55; $amount55 = sum_com($com_id,$fdate,$tdate); $total = $total - $amount; $total1 = $total1 + $amount; echo '<a href="trial_balance_periodical_group.php?fdate='.$_REQUEST["fdate"].'&tdate='.$_REQUEST["tdate"].'&cc_code=&show=Show&com_id='.$com_id.'">'.number_format($amount55,2).'</a>';?>
				   </strong></td>
				   </tr>
				 <tr>
				   <td>Closing Stock of Finished Goods (Chittagong)</td>
				   <td><div align="center">f</div></td>
				   <td align="right"><strong>
				     <? $com_id = 56; $amount56 = sum_com($com_id,$fdate,$tdate); $total = $total - $amount; $total1 = $total1 + $amount; echo '<a href="trial_balance_periodical_group.php?fdate='.$_REQUEST["fdate"].'&tdate='.$_REQUEST["tdate"].'&cc_code=&show=Show&com_id='.$com_id.'">'.number_format($amount56,2).'</a>';?>
				   </strong></td>
				   </tr>
				 <tr>
                   <td>&nbsp;</td>
				   ...
				   <td align="right"><strong>
				     <?= number_format($closing_tot = ($csrt_tot+$amount52+$amount53+$amount54+$amount55+$amount56),2);?>
				     </strong></td>
				   </tr>
				 <tr>
				   <td>&nbsp;</td>
				 ...
				 <tr>
				   ...
				   <td bgcolor="#99CCFF">&nbsp;</td>
				   <td align="right" bgcolor="#99CCFF"><?= number_format($SGS_final = (($SGS_tot)-$closing_tot),2); ?></td>
				   </tr>
				 <tr>
				 ...
				 <!--<tr>
				   ...
				   <td bgcolor="#FFCCFF"><strong>Gross  Profit I=(E-F) </strong></td>
