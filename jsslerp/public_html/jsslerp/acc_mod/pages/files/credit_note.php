...
add_to_sec_journal($proj_id, $jv_no, $jv_date, $ledger_id, $dnarr,  '0', $amount, $tr_from, $tr_no,'','',$cc_code,'',$user_id,'',$r_from, $bank,$c_no,$cheq_date,$receive_ledger,$checked,$type,$employee,$remarks,$reference_id);
	 ...
	 $up = 'update secondary_journal set cv_no="'.$cv_no.'" where jv_no="'.$_SESSION['jv_no'].'"';
	mysql_query($up);
...
if($_SESSION['tr_no']>0){
	if($_SESSION['jv_no']>0){
		...
		$up = 'update secondary_journal set checked="NO", cv_no="'.$j_data->cv_no.'" where jv_no="'.$_SESSION['jv_no'].'"';
		mysql_query($up);
...
if($sa_config=="Yes"){
$cv_no=$_REQUEST['cv_no'];
 $sa_up='update secondary_journal set secondary_approval="Yes", om_checked_at="'.$time_now.'", om_checked="'.$_SESSION['user']['id'].'",cv_no="'.$j_data->cv_no.'" where jv_no="'.$j_data->jv_no.'" and tr_from="'.$tr_from.'"';
...
$time_now = date('Y-m-d H:i:s');
$cv_no=$_REQUEST['cv_no'];
 $up2='update secondary_journal set checked="YES",checked_at="'.$time_now.'", checked_by="'.$_SESSION['user']['id'].'",cv_no="'.$j_data->cv_no.'" where jv_no="'.$j_data->jv_no.'" and tr_from="'.$tr_from.'"';

mysql_query($up2);

 $sa_up2='update journal set secondary_approval="Yes", checked="YES", checked_by="'.$_SESSION['user']['id'].'", checked_at="'.$time_now.'", om_checked_at="'.$time_now.'" ,om_checked="'.$_SESSION['user']['id'].'",cv_no="'.$j_data->cv_no.'" where jv_no="'.$j_data->jv_no.'" and tr_from="'.$tr_from.'"';
mysql_query($sa_up2);
...
document.getElementById('trMode_check').style.display='none';
 ...
 document.getElementById('cv_no').value = "<?php 
									
									
									
									$cv_cash = find_a_field('secondary_journal','cv_no','tr_from = "Receipt" and type="CASH" and entry_by="'.$_SESSION['user']['id'].'" and cv_no != "" order by jv_no desc ');
									$datas_cash = explode("/",$cv_cash);
									$cv_cash = $datas_cash[0].'/'.($datas_cash[1]+1); echo $cv_cash; ?>";
...
document.getElementById('of_branch_check').style.display='';
 document.getElementById('trMode_check').style.display='';
  ...
  document.getElementById('cv_no').value = "<?php 
  $cv_nos = find_a_field('journal','cv_no','tr_from = "Receipt" and type="BANK" and entry_by="'.$_SESSION['user']['id'].'" and cv_no != "" order by jv_no desc ');
									$datass = explode("/",$cv_nos);
									$cv_nos = $datass[0].'/'.($datass[1]+1);
...
document.getElementById('cv_no').value = "<?php 
									...
									$cv_cash = find_a_field('journal','cv_no','tr_from = "Receipt" and entry_by="'.$_SESSION['user']['id'].'" and type="CASH" and cv_no != "" order by jv_no desc ');
									$datas_cash = explode("/",$cv_cash);
									$cv_cash = $datas_cash[0].'/'.($datas_cash[1]+1); echo $cv_cash; ?>";
...
<div class="form-container_large">
				...
				<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
					<div class="container n-form2">
								...
								<div class="form-group row m-0 pb-1">
									...
									<div class="col-sm-7 col-md-7 col-lg-7 col-xl-7 p-0 pr-2 ">
										...
										<input name="jv_date" type="text" id="jv_date" 
											 tabindex="2"  value="<?php if($jv->jv_date=="0000-00-00"){
						...
						<div class="row pb-1">
							<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 pr-0">
								<div class="form-group row m-0 pb-1">
									<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text font-size12">Received Through:</label>
									<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
								...
								<div class="form-group row m-0 pb-1">
									<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text font-size12">CV No:</label>	
													
									<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
										<input name="cv_no" type="text" id="cv_no" value="" class="form-control"  tabindex="3" <? //if($jv->tr_no>0) echo 'readonly'?> />
							...
							<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 pl-0">
								<div class="form-group row m-0 pb-1">
									<label class="col-sm-5 col-md-5 col-lg-5 col-xl-5 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text req-input font-size12">Receive Mode:</label>
									<div class="col-sm-7 col-md-7 col-lg-7 col-xl-7 p-0 pr-2 ">
	...
	<?php 
						...
						<div id="trMode_check" class="form-group row m-0 pb-1">
						...
						<div id="of_bank_check" class="form-group row m-0 pb-1">
							...
							<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0 pr-2">
								<input name="bank" type="text" id="bank" value="<?php echo $jv->bank?>" class="form-control"   tabindex="9" <? if($jv->tr_no>0) echo 'readonly'?> />

							</div>
						</div>
						
						<div id="of_branch_check" class="form-group row m-0 pb-1">
							...
							<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0 pr-2">
								...
								<input name="branch" type="text" id="branch" value="<?php echo $jv->branch?>"  tabindex="9" <? if($jv->tr_no>0) echo 'readonly'?> class="form-control"/>
				...
				<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
					<div class="container n-form2">
						<table  class="table1  table-striped table-bordered table-hover table-sm" border="0" cellspacing="0" cellpadding="0">
							...
							$sql2="select a.tr_no, a.cr_amt, a.narration,a.jv_date , a.jv_no,a.checked,a.cv_no from  secondary_journal a where a.tr_from='Receipt' and  SUBSTRING(a.tr_no,5,1)='0' and  a.cr_amt>0 and a.group_for=".$_SESSION['user']['group']." group by a.tr_no order by a.id desc limit 5";
		...
		<div class="container-fluid pt-4 p-0 ">
			...
			<table class="table1  table-striped table-bordered table-hover table-sm">
				...
				<tr>
					...
					<td>
						<input type="text" id="ledgerID"   name="ledger_id" list="ledger_ids" onblur="getData2('acc_reference_ajax.php', 'acc_reference', this.value,
								document.getElementById('ledgerID').value);" tabindex="11" autocomplete="off"  value="<?=$jv_data->ledger_id?>"/>
							<datalist id="ledger_ids">	
							 <?  
						foreign_relation('accounts_ledger a, ledger_group g, acc_sub_sub_class s','a.ledger_id','concat(a.ledger_id,"::",a.ledger_name,">>>",g.group_name,">>>",s.sub_sub_class_name)','',"a.ledger_group_id=g.group_id and g.acc_sub_sub_class=s.id and a.parent=0  and  a.balance_type IN ('Credit','Both') and  a.ledger_group_id not in (".$cash_ledg_group_id.",".$bank_ledg_group_id.") order by a.ledger_id");?>
							</datalist>
						<!-- id="ledger_id"<select name="ledger_idww" id="ledger_idww" onchange = "getBalance('../../common/cur_bal.php', 'cur', this.value);">
								<option></option>
