...
$title='Set Report Configuration';
		...
		$proj_id				= mysql_real_escape_string($_SESSION['proj_id']);
		//common part.............
		$transaction_list		= mysql_real_escape_string($_REQUEST['transaction_list']);
		$receipt_statement		= mysql_real_escape_string($_REQUEST['receipt_statement']);
		$payment_statement		= mysql_real_escape_string($_REQUEST['payment_statement']);
		$contra_statement		= mysql_real_escape_string($_REQUEST['contra_statement']);
		$purchase_statement		= mysql_real_escape_string($_REQUEST['purchase_statement']);
		$sales_statement		= mysql_real_escape_string($_REQUEST['sales_statement']);
		$purchase_invoice_report= mysql_real_escape_string($_REQUEST['purchase_invoice_report']);
		$invoice_report			= mysql_real_escape_string($_REQUEST['invoice_report']);
		$receiptpaymant			= mysql_real_escape_string($_REQUEST['receiptpaymant']);
		$incomeexpenditure		= mysql_real_escape_string($_REQUEST['incomeexpenditure']);
		$trial_balance			= mysql_real_escape_string($_REQUEST['trial_balance']);
		$book_statement			= mysql_real_escape_string($_REQUEST['book_statement']);
		$balance_sheet			= mysql_real_escape_string($_REQUEST['balance_sheet']);
		$budget_statement		= mysql_real_escape_string($_REQUEST['budget_statement']);
		$yearly_report			= mysql_real_escape_string($_REQUEST['yearly_report']);
	//for Modify..................................
...
$data=mysql_fetch_row(mysql_query("select * from config_report where 1"));
