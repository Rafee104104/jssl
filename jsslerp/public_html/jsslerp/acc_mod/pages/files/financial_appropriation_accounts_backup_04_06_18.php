...
<thead>
				 ...
				 <tr>
				   ...
				   <td align="right"><strong>
				     <? $com_id = 1108; $pl_accounts = sum_com2($com_id,$fdate,$tdate); $total = $total - $amount; $total1 = $total1 + $amount; echo '<a href="trial_balance_periodical_group.php?fdate='.$_REQUEST["fdate"].'&tdate='.$_REQUEST["tdate"].'&cc_code=&show=Show&com_id='.$com_id.'">'.number_format($pl_accounts,2).'</a>';?>
				   </strong></td>
				   </tr>
				 ...
				 <tr>
				   ...
				   <td align="right" bgcolor="#CCCCFF"><strong><?= number_format($balance_transfer = ($pl_accounts-$ait_paid),2); ?></strong></td>
				   </tr>
