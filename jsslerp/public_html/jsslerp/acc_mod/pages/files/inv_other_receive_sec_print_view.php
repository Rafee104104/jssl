...
echo $_SESSION['proj_name'];
              ...
              <tr>
                <td align="center" style="line-height: 8px !important;"><?=find_a_field('user_group','address','1');?></td>
              </tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
  <tr>
    ...
    <td width="130" align="left"><a href="../../../warehouse_mod/pages/other_issue2/other_issue_report.php?v_no=<?php echo $jv->tr_no; ?>"target="_blank">View Invoice</a></td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#00CC00">
  <tr>
    <td width="42"><input name="button" type="button" onclick="hide();window.print();" value="Print" /></td>
    <td width="99" align="left"><a href="../../../warehouse_mod/pages/other_issue2/other_issue_report.php?v_no=<?php echo $jv->tr_no; ?>"target="_blank">View Invoice</a></td>
    <td width="139" align="right">Voucher Date : <?=$jv->jv_date;?></td>
