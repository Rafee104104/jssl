...
echo $_SESSION['proj_name'];
              ...
              <tr>
                <td align="center" style="line-height: 10px !important;"><?=find_a_field('user_group','address','1');?></td>
              </tr>
			  
			  <tr>
                <td align="center"><?=find_a_field('user_group','factory_address','1');?></td>
              </tr>
              <tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
  <tr>
	...
	<? if($master_invoice>0){?>
		<a target="_blank" href="../../../warehouse_mod/pages/po_return/purchase_invoice_print_view.php?v_no=<?=$ch->pr_no?>">PR-<?=$ch->pr_no?></a>
	<? } else{?>
		<a target="_blank" href="../../../warehouse_mod/pages/purchase_return/purchase_invoice_print_view.php?v_no=<?=$ch->pr_no?>">PR-<?=$ch->pr_no?></a>
		<? }?>
...
<a target="_blank" href="../../../warehouse_mod/pages/purchase_return/purchase_invoice_print_view.php?v_no=<?=$ch->pr_no?>"></a></div><? }else{?>
<div align="left">
<form action="" method="post">
