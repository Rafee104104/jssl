...
if(isset($_REQUEST['ledger_name'])||isset($_REQUEST['ledger_id']))
{
	...
	$beneficiary_name	= mysql_real_escape_string($_REQUEST['beneficiary_name']);
	$accounts_number	= mysql_real_escape_string($_REQUEST['accounts_number']);
	$bank_name			= mysql_real_escape_string($_REQUEST['bank_name']);
	$branch_name		= mysql_real_escape_string($_REQUEST['branch_name']);
	$iban_no		= mysql_real_escape_string($_REQUEST['iban_no']);
	$swift_code		= mysql_real_escape_string($_REQUEST['swift_code']);
	$purpose		= mysql_real_escape_string($_REQUEST['purpose']);
