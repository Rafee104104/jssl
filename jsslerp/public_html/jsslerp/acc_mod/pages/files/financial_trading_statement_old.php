...
<thead>
				 ...
				 <tr>
				   ...
				   <td align="right"><? $com_id = 10; $amount = sum_com($com_id,$fdate,$tdate); $total = $total + $amount; $total1 = $total1 + $amount; echo '<a href="trial_balance_periodical_group.php?fdate='.$_REQUEST["fdate"].'&tdate='.$_REQUEST["tdate"].'&cc_code=&show=Show&com_id='.$com_id.'">'.number_format($amount,2).'</a>';?></td>
				 ...
				 <tr>
				   ...
				   <td align="right" bgcolor="#00FFCC"><strong><? echo number_format($total1,2); $total1 = 0;?></strong></td>
				 ...
				 <tr>
				   ...
				   <td align="right" bgcolor="#00FFCC"><strong><? echo number_format($total,2); $total1 = 0;?></strong></td>
