    ...
    <td><div class="left_report">
		    ...
		    From Date : </td>
                                      ...
                                      <tr>
                                        ...
                                        <td align="left"><select name="ledger_id" id="ledger_ids" onchange="sub_ledger(this.value)">
                          ...
                          $total=mysql_fetch_row(mysql_query($tt));
                            if($total[0]>$total[1])
                          {
                          $t_type="(Dr)";
						...
						//echo "select sum(dr_amt),sum(cr_amt) from journal where jv_date<'$fdate' and sub_ledger ='$sub_ledger' and 1";
						  $p=mysql_fetch_row(mysql_query("select sum(dr_amt),sum(cr_amt) from journal where jv_date<'$fdate' and sub_ledger ='$sub_ledger'"));
						  //echo $p;
						$pi=1;
						if($p[0]>$p[1])
						$debit=$p[0]-$p[1];
