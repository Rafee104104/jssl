...
<div class="body">
	<div class="header">
		...
		<tr>
		<td class="logo">
<?php /*?>			<img src="../../../logo/<?=$_SESSION['proj_id']?>.png" class="logo-img"/><?php */?>
		</td>
...
<div class="footer footer1"  id="footer">
	<table class="footer-table">
        <tr>
		 ...
		 <tr>
		  <td class="text-center"><strong>Received By</strong><br />
		  -------------------------------</td>
          <td class="text-center"><strong>Prepared By</strong><br />
		  -------------------------------</td>
          <td class="text-center"><strong>Verified By</strong><br />
		  -------------------------------</td>
        ...
        <tr>
		  <td class="text-center">
		  	...
		  	<p style="font-size:11px; margin: 0;"> <br/> </p>
		  </td>
