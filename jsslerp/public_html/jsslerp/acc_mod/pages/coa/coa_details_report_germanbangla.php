...
auto_complete_from_db('item_info i, item_sub_group s','i.item_name','i.item_id','i.product_nature="Salable"  and s.fg_sub_group="Yes" and i.sub_group_id=s.sub_group_id 
order by s.sub_group_sl, i.item_name','item_search');
...
<form class="n-form1 pt-4 fo-width" action="master_report_germanbangla.php" method="post" name="form1" target="_blank" id="form1">
        <div class="row m-0 p-0">
            ...
            <div class="col-sm-7">
                <div class="form-group row m-0 mb-1 pl-3 pr-3">
                    <label for="group_for" class="col-sm-4 m-0 p-0 d-flex align-items-center">Acc. Class: </label>
