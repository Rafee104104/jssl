...
if(isset($_REQUEST["PROJECT_ID"]) && !empty($_REQUEST["PROJECT_ID"])){
    //Get all state data
    echo $query = mysql_query('select l.*,p.PROJECT_DESC from crm_lead_master l, crm_project p where 1 and l.project_id=p.PROJECT_ID and l.project_id="'.$_REQUEST['PROJECT_ID'].'"');
