          ...
          <div class="tab-pane fade" id="nav-schedule-due" role="tabpanel1" aria-labelledby="nav-schedule-due">
              ...
              <table class="table">
                ...
                <?php
                    ...
                    $salaryHolidaysRslt = mysql_query($salaryHolidaysQry);
                    
                    while($salaryHolidays = mysql_fetch_object($salaryHolidaysRslt)){
              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <?php 
                    ...
                    $curTaskRslt = mysql_query($curTasksQry);

                    while($curTaskData = mysql_fetch_object($curTaskRslt)){
              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <?php 
                    ...
                    $upcomingTaskRslt = mysql_query($upcomingTasksQry);

                    while($upcomingTaskData = mysql_fetch_object($upcomingTaskRslt)){
              ...
              <table class="table">
                ...
                <tbody>
                  ...
                  <?php 
                    ...
                    $dueTaskRslt = mysql_query($dueTasksQry);

                    while($dueTaskData = mysql_fetch_object($dueTaskRslt)){
