...
?>
<div class="menu_bg" style="height:100%">
<table width="205" border="0" cellspacing="0" cellpadding="0" align="center" style="line-height:13px;">
                     ...
                     <div class="silverheader"><a href="#">Batch</a></div>
					  ...
					  <div class="submenu">
						  <table width="100%" border="0" cellspacing="0" cellpadding="0">
							<tr><td><a href="../recipe/select_prodiction_line.php?sr=1">Create New Batch</a></td></tr>
							<tr><td><a href="../recipe/select_unfinished_batch.php">Unfinished Batch 
							<? 

$tot_pi=find_a_field('production_floor_issue_master','count(pi_no)',' status="MANUAL"');

if($tot_pi){

?>

<span style="font-weight:bold; font-size: 12px; color:red;">(<? echo $tot_pi; ?>)</span>
...
<? if($user_id==10069 || $user_id==10048 || $user_id==10070 || $user_id==10096 || $user_id==10071 || $user_id==10073 || $user_id==10077 || $user_id==10078 || $user_id==10079 || $user_id==10080 || $user_id==10081 || $user_id==10091 || $user_id==10082 || $user_id==10052 || $user_id==10090 || $user_id==10097 || $user_id==10110 || $user_id==10136 ){ ?>
...
<td><a href="../local_req/daily_summery.php">Daily PR Summery</a></td>
					  ...
					  <div class="submenu">
						  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr><td><a href="../pr_req/mr_create.php?mhafuz=1">Create PR </a></td> <!--Pages Directory pr_req-->
                            </tr>
							<tr><td><a href="../pr_req/select_unfinished_mr.php">Unfinished PR 
							
							<? 

$tot_req=find_a_field('requisition_master','count(req_no)',' status="MANUAL"');

if($tot_req){

?>

<span style="font-weight:bold; font-size: 12px; color:red;">(<? echo $tot_req; ?>)</span>
...
<? } ?>
					  ...
					  <div class="submenu">
						  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr><td><a href="../mr/mr_create.php?mhafuz=2">Create New STR </a></td>
                            </tr>
					...
					<? } ?>
					  ...
					  <div class="submenu">
						 <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr><td><a href="../mr_req/mr_create.php?mhafuz=2">Create New STR </a></td>
                            </tr>
					...
					<?php /*?>   <? if($level==5||$level==2){?>
					  ...
					  <div class="submenu">
						  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr><td><a href="../mrr/mr_create.php?mhafuz=2">Create New (PR)</a></td>
                            </tr>
...
<? } ?>
					 ...
					 <div class="submenu">
						  <table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr><td><a href="../production_return/select_prodiction_line.php">New Production Line Return</a></td></tr>
							<tr><td><a href="../production_return/select_unfinished_pr.php">Unfinished Production Return 
...
<? } ?>
							...
							<tr><td><a href="../production_return/production_receive_status.php">Production Line Return Report</a></td></tr>
							
							<tr><td><a href="../production_return/production_return_receive_status.php">Production Line Return Receive
							<? 


$tot_ua=find_a_field('production_floor_return_master','count(pr_no)','status="RECEIVED"');
...
<? } ?>
					  ...
					  <div class="submenu" >
						  <table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr><td><a href="../report/work_order_report_warehouse.php">Advance Warehouse Reports</a></td></tr>
