...
<title>Production Costing <?=PROJECT?></title>
...
<div class="wrapper">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr>
				<td>				<img src="../../../logo/title.png"  height="35" border="0" /></td>
				<td valign="top"><div class="header2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    <td valign="top" class="title"><div align="right">
                      <p class="style1">
					  <? if(isset($_SESSION['company_name'])) echo $_SESSION['company_name']; else echo 'Costing and Production Solution';?>
					  </p>
                    </div></td>
                  </tr>
                  <tr>
