...
?>
		...
		$total_qty=0;
	    $s = mysql_query($t);
	    while($q=mysql_fetch_object($s)){ if($i>0) echo ','.'<a href="../pr/po_print_view.php?po_no='.$q->po_no.'" target="_blank">'.$q->po_no.'</a>'; else echo '<a href="../pr/po_print_view.php?po_no='.$q->po_no.'" target="_blank">'.$q->po_no.'</a>'; $i++; 
