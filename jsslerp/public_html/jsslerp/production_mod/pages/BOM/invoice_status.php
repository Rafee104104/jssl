...
<td  <?=(++$z%2)?'':'class="alt"';?>><?= find_a_field('item_info','finish_goods_code','item_id="'.$data->fg_item_id.'"');?></td>

<td <?=(++$z%2)?'':'class="alt"';?>><?= find_a_field('item_info','item_name','item_id="'.$data->fg_item_id.'"');?></td>

<td  <?=(++$z%2)?'':'class="alt"';?>><?= find_a_field('user_activity_management','fname','user_id="'.$data->entry_by.'"');?></td>

<td><a href="invoice_print_view.php?bom_no=<?=$data->bom_no?>" target="_blank" class="btn btn-info">View</a><a href="invoice_entry.php?request_no=<?=$data->bom_no?>" target="_blank" class="btn btn-danger">Edit</a></td>
