...
echo $res='select a.pr_no, a.pr_no, a.pr_date, a.remarks as batch_no, c.warehouse_name as production_line, a.carried_by,u.fname as entry_by,a.entry_at from production_floor_receive_master a,
