...
$data = array();
	...
	$sql="SELECT concat(a.room_name,' : ',b.room_type) FROM `hms_hotel_room` a,`hms_room_type` b WHERE b.id=a.room_type_id and a.id=".$data['service_id'];
...
<td width="60px"><a href="#" onclick="deletethis<?=$count;?>();"><img src="../../images/delete.png" width="16" height="16" /></a></td>
	</tr>		
</table>
