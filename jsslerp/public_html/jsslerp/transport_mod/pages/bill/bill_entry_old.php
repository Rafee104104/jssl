...
<div class="form-container_large">
  ...
  <form id="form1" name="form1" method="post">
      <div class="row m-0">
         <div class="card">
          <h5 class="text-center bg-info bold pt-2 pb-2">Bill Entry Process </h5>
          <div class="card-body">
            <div class="row m-0">
       ...
       <input type="text" list='eip_ids'  name="emp_code" id="emp_code"  value="<?=$emp_code;?>" required />
              ...
              <input name="conv_no" type="text" 
					 id="conv_no" value="<?=find_a_field('bills','bills_id','1 order by bills_id desc')+1;?>" class="form-control" readonly>
              </div>
...
<!--               <div class="col-md-2 form-group">
                <label class="label success" for="car_req4">Means of Bill:</label>
   ...
   /* crating new click event for save button*/
    ...
    $("#butsave").click(function() {
        ...
        $.ajax({
            ...
            window.location.href = 'bill_entry.php';
                }
        });
        });
});
