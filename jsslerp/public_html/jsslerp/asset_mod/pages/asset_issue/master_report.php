...
$con .= 'and a.item_id="'.$_POST['item_id'].'"';}
 ...
 $res='select a.*,p.PBI_NAME,i.item_name,v.area_name
 
 
from fixed_asset_issue_details a,personnel_basic_info p,item_info i,asset_register r,asset_area v
 
 
where a.PBI_ID=p.PBI_ID and a.item_id=i.item_id and a.serial_no=r.sl_no and r.area_code=v.id  '.$con.'';
...
?>
	...
	<tr>
		 ...
		 <td valign="top"><?=$data->item_name;?></td>
	 	 <td valign="top"><?=$data->PBI_NAME;?></td>
