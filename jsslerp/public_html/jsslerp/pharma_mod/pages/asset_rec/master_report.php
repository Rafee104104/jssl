...
$con .= 'and a.item_id="'.$_POST['item_id'].'"';}
 ...
 $res='select a.*,p.PBI_NAME,i.item_name from fixed_asset_receive_details a,personnel_basic_info p,item_info i where a.PBI_ID=p.PBI_ID and a.item_id=i.item_id '.$con.'';
