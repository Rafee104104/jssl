...
<!--        top form start hear-->
        ...
        <div class="container-fluid pt-5 p-0 ">
            <table class="table1  table-striped table-bordered table-hover table-sm">
				...
				where c.status='COMPLETED' and c.api_trigger=0 and 
				...
				<td><span id="api"><button type="button" id="trigger" onclick="getData2('api_push_ajax.php', 'api',document.getElementById('chalan_no').value,document.getElementById('chalan_no').value)" class="btn btn-warning">Send</button></span></td>
				</tr>
				<?
