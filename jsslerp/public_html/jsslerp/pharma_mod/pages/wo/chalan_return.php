...
$target_url = '../wo/chalan_return_calculate.php';
...
$con .= ' and c.chalan_no='.$_POST['chalan_no'].'';
 ...
 where m.do_no=c.do_no and m.do_no=d.do_no and  c.status in ('CHECKED') and c.depot_id='".$_SESSION['user']['depot']."' ".$con." group by c.chalan_no order by c.chalan_date desc";
