...
$target_url = '../wo/old_chalan_cogs_rehit.php';
...
{
	window.open('<?=$target_url?>?chalan_no='+theUrl,'_self');
}
...
$con .= ' and c.chalan_no='.$_POST['chalan_no'].'';
 ...
 where m.do_no=c.do_no and m.do_no=d.do_no and c.cogs_rehit=0 ".$con." group by c.chalan_no order by c.chalan_date asc";
		...
		?>
					...
					?>
                        ...
                        <tr>
                            ...
                            <td>
							<input type="button" value="Complete Challan" onClick="custom(<?=$row->chalan_no;?>);" class="btn1 btn1-bg-submit" / >
