...
if($d_qty>$c_qty){
$master_update = 'update sale_do_master set status="CHECKED" where do_no="'.$data->do_no.'"';
...
$update = 'update sale_do_chalan set status="COMPLETED",chalan_att="'.$uploaded_file_name.'" where chalan_no="'.$chalan_no.'"';
mysql_query($update);
