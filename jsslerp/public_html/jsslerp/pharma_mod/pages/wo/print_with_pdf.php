...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <strong><font style="font-size:18px"> Challan </font></strong>
	</td>
	</tr>
...
<tr>
<td><div align=""><strong>Challan No: </strong> Q-'.$all->do_no.'</div></td>
...
<td colspan="4" ><div align=""><strong>Unit:- '.$all->unit.' </strong></div></td>
</tr>
<tr>
<td colspan="4"><div align=""><strong>Address: </strong>'.$all->delivery_address.'</div></td>

</tr>
<tr>

<td colspan="4" ><div align=""><strong>ATTN: </strong>'.$all->attn.'</div></td>
</tr>
<tr>
<td colspan="4" ><div align=""><strong>Requisition No: </strong>'.$all->ref_no.'</div></td>
    ...
    <thead>
       <tr>
		...
		{$html .=' colspan=2';}
		  ...
		  $html .='><strong>Item Name </strong></td>
        <td width="10%" align="center"><strong>Brand</strong></td>';
		
		 if($all->origin==1) {
		$html .=  '<td width="10%"  align="center" ><strong> Origin</strong></td>';
		}
         $html .='
		 
        <td width="10%" align="center"  ><strong>Qty </strong></td>
		 <td width="14%"  align="center" ><strong>'.$all->rate.' Rate</strong></td>
        <td width="15%"  align="center" ><strong>Total</strong></td>
		<td  width="10%" align="center" ><strong>Delivery</strong></td>
       </tr></thead>';

$sql2="select * from sale_requisition_details where  do_no='$req_no' order by id asc";
...
$html .= 
	'<tr>
        ...
        <td width="26%"  >'.$info->item_description.'</td>
        <td width="10%" align="center">'.$brand.'</td>';
		 if($all->origin==1) {
        $html .='<td width="10%"  align="center" valign="top">'.$info->origin_detail.'</td>';
		 } 
        $html .='
		
		<td width="10%"  align="center">'.number_format($info->dist_unit).' '.$info->unit_name.'</td>
		<td width="14%"  align="right">'.number_format($info->unit_price,2).'</td>
        <td  width="15%" align="right">'.number_format($info->total_amt,2).'</td>
		<td  width="10%" >'.$info->delivery.'</td>
...
$tot_amt +=$info->total_amt;
		...
		$html .= '<tr>
	  	<td   colspan="'.$col.'" style="text-align:right"><strong>Total &nbsp;</strong></td>
	  ...
	  $html .='<tr>
	  	<td colspan="'.$col.'" style="text-align:right">Discount ('.$all->discount . '%) &nbsp;</td>
	...
	<td></td>
	  ...
	  $html .='<tr>
	  	<td colspan="'.$col.'" style="text-align:right">Deduct &nbsp;</td>
	...
	$sub_total_amt=($tot_amt  - ($discount_amt+$deduct_amt));
	  $html .='<tr>
	  	<td colspan="'.$col.'" style="text-align:right"><strong>Sub Total  &nbsp;</strong></td>
	  ...
	  $html .='<tr>
	  	<td colspan="'.$col.'" style="text-align:right">VAT ('.$all->vat.'%) &nbsp;</td>
	   ...
	   if($all->ait >0){ 
		...
		$ait_amt=(($sub_total_amt * $all->ait)/100);
	  	...
	  	$html .=	'<tr>
	  	<td colspan="'.$col.'" style="text-align:right">AIT('.$all->ait.'%) &nbsp;</td>
	...
	$vat_ait_amt=(($sub_total_amt * $all->vat_ait)/100);
	  $html .='<tr>
	  	<td colspan="'.$col.'" style="text-align:right">VAT & AIT('.$all->vat_ait.'%) &nbsp;</td>
	  ...
	  $html .='<tr>
	  	<td colspan="'.$col.'" style="text-align:right">Transport Cost &nbsp;</td>
	  ...
	  $html .='<tr>
	  	<td colspan="'.$col.'" style="text-align:right"><b>Grand Total &nbsp;</b></td>
