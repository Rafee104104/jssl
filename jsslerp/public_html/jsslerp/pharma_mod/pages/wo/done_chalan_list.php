...
$target_url = '../wo/old_chalan_rehit.php';
...
$con .= ' and c.chalan_no='.$_POST['chalan_no'].'';
 ...
 where m.do_no=c.do_no and m.do_no=d.do_no and c.journal_status=0 ".$con." group by c.chalan_no order by c.chalan_date asc";
