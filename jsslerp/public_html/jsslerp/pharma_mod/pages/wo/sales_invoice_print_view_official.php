...
$data5=mysql_fetch_object($query);
  ...
  $sql1='SELECT  s.chalan_no,s.dealer_code,s.chalan_date,d.dealer_name_e,d.dealer_code,d.address_e, m.distributor_id,d.contact_no,d.contact_person_name,d.email,s.do_no, s.vat_no,m.po_no,m.po_date
