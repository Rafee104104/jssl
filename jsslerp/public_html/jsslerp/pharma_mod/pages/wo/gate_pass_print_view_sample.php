...
$destination_count= find_a_field('sample_do_chalan','COUNT(destination)','chalan_no="'.$chalan_no.'" and destination!=""');
$referance_count= find_a_field('sample_do_chalan','COUNT(referance)','chalan_no="'.$chalan_no.'" and referance!=""');
$sku_no_count= find_a_field('sample_do_chalan','COUNT(sku_no)','chalan_no="'.$chalan_no.'" and sku_no!=""');
$pack_type_count= find_a_field('sample_do_chalan','COUNT(pack_type)','chalan_no="'.$chalan_no.'" and pack_type!=""');
$color_count= find_a_field('sample_do_chalan','COUNT(color)','chalan_no="'.$chalan_no.'" and color!=""');
$size_count= find_a_field('sample_do_chalan','COUNT(size)','chalan_no="'.$chalan_no.'" and size!=""');

$do_no= find_a_field('sample_do_chalan','do_no','chalan_no='.$chalan_no);

$master= find_all_field('sample_do_master','','do_no='.$do_no);


$ch_data= find_all_field('sample_do_chalan','','chalan_no='.$chalan_no);
...
$ssql = 'select a.*,b.do_date, b.group_for, b.via_customer from dealer_info a, sample_do_master b where and b.do_no='.$do_no;
...
$to_ctn = find_a_field('sample_do_chalan','sum(pkt_unit)','chalan_no='.$chalan_no);

$to_pcs = find_a_field('sample_do_chalan','sum(dist_unit)','chalan_no='.$chalan_no); 



$ordered_total_ctn = find_a_field('sample_do_details','sum(pkt_unit)','dist_unit = 0 and do_no='.$do_no);

$ordered_total_pcs = find_a_field('sample_do_details','sum(dist_unit)','do_no='.$do_no); 
...
function print_pad(){
	...
	document.getElementById('marginTop2').style.marginTop = "80px";
	window.print();
}
  ...
  <tr>
    <td><div class="header"> 
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td width="60%"><table  width="80%" border="0" align="center" cellpadding="3" cellspacing="0">
                            <tr>
                              <td style="text-align:center; color:#000; font-size:14px; font-weight:bold;" id="company">
        ...
        <!--<td bgcolor="#666666" style="text-align:center; color:#FFF; font-size:18px; font-weight:bold;">WORK ORDER </td>-->
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" id="marginTop">
		  ...
		  <tr>
		    ...
		    <td width="100%" valign="top">
		      ...
		      <table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:12px">
		        ...
		        <tr>
		          <td width="13%" align="left" valign="middle" style="font-size:12px; font-weight:700;">User Name</td>
		          <td width="30%" style="font-size:12px; font-weight:700;">:	&nbsp;
		            <?= find_a_field('user_activity_management','fname','user_id="'.$master->dealer_code.'"');?></td>
				...
				<tr>
		          ...
		          <td>:	&nbsp;
	              <?= find_a_field('dealer_info','dealer_name_e','dealer_code="'.$master->distributor_id.'"');?></td>
	              <td></td>
	              <td></td>
	              <td></td>
	              <td></td>
  ...
  <tr>
    <td><div id="pr">
	  ...
	  <div id="pr1">
        <div align="left">
          <p>
            <input name="button" type="button" onclick="print_pad();window.print();" value="Pad Print" />
          </p>
          	    </div>
      </div>
...
<th width="10%" bgcolor="#CCCCCC">Ctn Factor </th>
<th width="10%" bgcolor="#CCCCCC">Ctn</th>
...
//, (a.init_pkt_unit*a.unit_price) as Total,(a.init_pkt_unit-a.inStock_ctn) as Shortage
  ...
  $res='select  s.sub_group_name,  b.item_name, b.finish_goods_code, b.unit_name, a.*
   from sample_do_chalan a, item_info b, item_sub_group s 
...
<td><?=$data->total_unit?></td>
        ...
        <?
$total_ctn_unit = $total_ctn_unit + $data->pkt_unit;		
...
<td>&nbsp;</td>
<td><strong>
<?=number_format($total_ctn_unit,0);?>
</strong></td>
<td><strong>
  ...
  <tr>
	...
	<table width="100%" cellspacing="0" cellpadding="0"  >
		...
		<tr>
		 ...
		 $uid=find_a_field('sample_do_chalan','checked_by','chalan_no="'.$chalan_no.'"');
		 ...
		 $uid=find_a_field('sample_do_chalan','entry_by','chalan_no="'.$chalan_no.'"');
		   echo find_a_field('user_activity_management','fname','user_id="'.$uid.'"')?></td>
		  <td align="center"></td>
		  </tr>
		<tr>
  ...
  <tr>
    <td><div class="header">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="15%" id="logo2">
                        <img src="../../../logo/<?=$master->group_for?>.png" style=" height:40px; width:auto;" />
                        <td width="60%"><table  width="80%" border="0" align="center" cellpadding="3" cellspacing="0">
                            <tr>
                              <td style="text-align:center; color:#000; font-size:14px; font-weight:bold;" id="company2">
        ...
        <!--<td bgcolor="#666666" style="text-align:center; color:#FFF; font-size:18px; font-weight:bold;">WORK ORDER </td>-->
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0" id="marginTop2">
...
$total_ctn2 = $total_ctn2 + $data->pkt_unit;
