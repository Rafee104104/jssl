                    ...
                    <div class="container n-form2">
                        ...
                        <div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
								...
								<? foreign_relation('sample_do_master','do_no','job_no',$_POST['do_no'],'1');?>
								</select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
                                <select name="chalan_no" id="chalan_no" >
									...
									<? foreign_relation('sample_do_chalan','chalan_no','chalan_no',$_POST['chalan_no'],'1 group by chalan_no');?>
									</select>
...
?>
        ...
        <div class="container-fluid pt-5 p-0 ">
            <table class="table1  table-striped table-bordered table-hover table-sm">
				...
				sample_do_master m, sample_do_chalan c, dealer_info d, user_group u where m.group_for=u.id  and m.do_no=c.do_no ".$group_for_con.$con.$dealer_con.$wh_con.$job_no_con.$chalan_con."  group by c.chalan_no order by c.chalan_no desc";
				...
				<td><?=$data->do_no;?></td>
				  ...
				  <a title="Invoice Preview" target="_blank" href="sales_invoice_print_view_sample.php?v_no=<?=$data->chalan_no?>" style=" font-weight:700; color:#000000" ><?=$data->chalan_no;?></a>
				  ...
				  <a title="Challan Preview" target="_blank" href="delivery_challan_print_view_sample.php?v_no=<?=$data->chalan_no?>" style=" font-weight:700; color:#000000" ><?=$data->chalan_no;?></a>
				   </td>
				  <td>
				  
				  <a title="Gate Pass Preview" target="_blank" href="gate_pass_print_view_sample.php?v_no=<?=$data->chalan_no?>"  style=" font-weight:700; color:#000000" ><?=$data->chalan_no;?></a>
				  </td>
