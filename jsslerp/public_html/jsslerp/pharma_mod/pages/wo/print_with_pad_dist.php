...
<table width="100%"  cellspacing="0" cellpadding="1">
    <thead>
           <tr>
                <td colspan="10" style="text-align: center; font-size:15px;"><strong>Delivery Challan</strong></td>
            </tr>

            <tr style="border: none">
                <td colspan="5" style="text-align: left; border: none;"><strong>Challan No:</strong><?php echo $ch_all->chalan_no;?></td>
       ...
       <tr style="font-weight: bold;">
        ...
        <th border="1px" align="center"> Ref#</th>
        <th border="1px" align="center"> Item Description</th>
        <th border="1px" align="center"> Ctn</th>
        <th border="1px" align="center"> Pcs</th>
        <th border="1px" align="center"> TQ</th>
        <th border="1px" align="center"> Q</th>
        <th border="1px" align="center"> S.Qty</th>
        <th border="1px" align="center"> A</th>
        <th border="1px" align="center"> Depot</th>
       ...
       <tr>
                <td border="1px" colspan="7" rowspan="2" style="text-align:left ;font-weight:bold;">Receiver Sign and Date </td>
                <td border="1px" colspan="3" style="text-align:left ;font-weight:bold;">
                        Remarks
                </td>
       </tr>

       <tr>
       		<td border="1px" colspan="3">If any mismatch, Please inform your SR/ASM/DSM.</td>
       </tr>
       </tbody>
</table>
...
<table width="100%"  cellspacing="0" cellpadding="1">
    <thead>
       <tr>
           <td colspan="9"><h5 style="text-align: center; font-weight: bold;">Undelivered Information</h5></td>
       </tr>
       <tr>
            ...
            <th border="1px" align="center">A </th>
            <th border="1px" align="center">Depot </th>
            <th border="1px" align="center">Note </th>
    ...
    <tbody class=" text-center table-striped">
       ...
       <tr>
		...
		<tr><td>&nbsp;</td></tr>
       <tr>
           <td align="center" colspan="9"><p class="m-0 p-0"><b>This is automated Generated Challan of RCL ERP System.</b></p></td>
       </tr>
       <tr>
           <td colspan="9"><p class="m-0 p-0">This Challan Generated by _____________ date is _____________ and time _____________ at place is _____________.</p></td>
       </tr>
