			...
			<div class="input-group mb-3 input-group-sm">
			  <div class="input-group-prepend">
				<span class="input-group-text"  style="font-weight:bold;">Customer Mobile No</span>
			     ...
			     <input type="text" disabled class="form-control" id="cell-tell" value="<?php echo $dealer->contact_no;?>">
			</div>
			<div class="input-group mb-3 input-group-sm">
			  <div class="input-group-prepend">
				<span class="input-group-text"  style="font-weight:bold;">Delivery Address</span>
			  </div>
			  <textarea class="form-control"><?php echo $dealer->delivery_address;?></textarea>
...
?>
                   ...
                   <td style="text-align:left;"><?=++$i?></td>
				    <td style="text-align:left;"><?=$item_all->finish_goods_code?></td>
					 <td style="text-align:left"><?=$item_all->item_name?></td>
					  <td style="text-align:right;"><?=number_format($row->total_unit,2)?></td>
				  ...
				  $tot_qty+=$row->total_unit;
					 ...
					 <td style="text-align:right;"><b><?php echo number_format($tot_qty,2); ?></b></td>
					 <td></td>
					 <td></td>
            ...
            <div class="row">
              ...
              <div class="col-3 text-center">
                ...
                <br>
               <p style="border-top:1px solid">  Customer Signature  </p>
		  ...
		  <div class="col-1"></div>
              <div class="col-3 text-center">
                ...
                <br>
                 <p style="border-top:1px solid">Authorized Signature  </p>
