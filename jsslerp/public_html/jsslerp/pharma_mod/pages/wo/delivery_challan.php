...
while($undel = mysql_fetch_object($res)){
...

			{
				...
				//$final_price = ((($pre_stock->final_price*$pre_stock->final_stock)+($item_price*$pqty))/($pre_stock->final_stock+$pqty));
...
document.getElementById('chalan_pcs_'+id).value = cqty*pack_size;
...
<div class="container-fluid bg-form-titel">
            <div class="row">
                ...
                <input name="chalan_date" type="text" id="chalan_date" required="required" value="<?=($ch_data->chalan_date!='')?$ch_data->chalan_date:date('Y-m-d')?>"/>
					  ...
					  <div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                        		<input  name="delivery_point" type="text" id="delivery_point" value="<?=find_a_field('dealer_info','address_e','dealer_code='.$dealer_code);?>" />
                ...
                <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4">
                    <div class="container n-form2">
                        <div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                        		<input  name="rec_name" type="text" value="<?=find_a_field('dealer_info','dealer_name_e','dealer_code='.$dealer_code);?>" id="rec_name" />
                    ...
                    <div class="container n-form2">
                        <div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
								...
								<input   name="rec_mob" value="<?=find_a_field('dealer_info','contact_no','dealer_code='.$dealer_code);?>"  type="text" id="rec_mob" />
 ...
 from sale_do_details a left join item_info_other o on o.item_id=a.c_item_id,item_info b, item_sub_group s where b.item_id=a.item_id 
...
?>
          ...
          <tr>
		    ...
		    <input type="hidden" name="pack_size_<?=$row->id?>" id="pack_size_<?=$row->id?>" value="<?=$row->pack_size?>" />	
              ...
              <td align="center"><input name="chalan_ctn_<?=$row->id?>" type="text" id="chalan_ctn_<?=$row->id?>" value="<?=$unso_qty_ctn?>"   onKeyUp="calculation(<?=$row->id?>)"<?=($unso_qty_ctn==0)?'readonly':''?> /></td>
 ...
 from sale_do_master m,sale_do_details a left join item_info_other o on o.item_id=a.c_item_id,item_info b, item_sub_group s where m.do_no=a.do_no and m.status="CHECKED" and b.item_id=a.item_id 
