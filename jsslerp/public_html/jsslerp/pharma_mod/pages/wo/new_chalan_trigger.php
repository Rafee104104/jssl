...
<!--        top form start hear-->
        ...
        <div class="container-fluid pt-5 p-0 ">
            <table class="table1  table-striped table-bordered table-hover table-sm">
				...
				where c.status='CHECKED' and c.api_trigger=0 and 
				
				 m.group_for=u.id  and m.dealer_code=d.dealer_code and m.do_no=c.do_no ".$group_for_con.$con.$dealer_con.$job_no_con.$chalan_con."  group by c.chalan_no order by c.chalan_no desc";
				...
				<td><?=$data->status;?><input type="hidden" id="chalan_no" name="chalan_no" value="<?=$data->chalan_no?>" /></td>
				<td><span id="api"><button type="button" id="trigger" onclick="getData2('chalan_push_ajax.php', 'api',document.getElementById('chalan_no').value,document.getElementById('chalan_no').value)" class="btn btn-warning">Send</button></span></td>
				</tr>
				<?
