...
<span id="ppp<?=$data->id?>"><? if ($data->edit_request==0) {?><input name="<?='edit#'.$data->id?>" type="button" id="Edit" value="Request" style="width:100px; height:30px; color:#000; font-weight:700" onclick="update_edit(<?=$data->id?>);start(this);"  /> <? }?>
