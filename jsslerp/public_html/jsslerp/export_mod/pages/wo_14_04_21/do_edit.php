...
<tr bgcolor="#CCCCCC">
  <td width="4%" align="center"><span class="style2">
<input   name="L_cm" type="text" class="input3" id="L_cm" style="width:35px; height:30px;"  value="<?=$_POST['L_cm'];?>"  autocomplete="off"  required="required"  onchange="count_formula()" tabindex="0"/>
</span></td>


  <td width="4%" align="center">
  <span class="style2">
<input  name="W_cm" type="text" class="input3" id="W_cm" style="width:35px; height:30px;"  value="<?=$_POST['W_cm'];?>"  autocomplete="off"  required="required"  onchange="count_formula()" tabindex="0"/>
</span>  </td>
  <td width="8%" align="center">
  <span class="style2">
<input name="H_cm" type="text" class="input3" id="H_cm" style="width:35px; height:30px;"  value="<?=$_POST['H_cm'];?>"  autocomplete="off"  required="required" onchange="count_formula()" tabindex="0"/>
</span>  </td>
  <td width="8%" align="center" ><span class="style2">
...
<td width="8%" align="center">
<span class="style2">
<input name="unit_price" type="text" class="input3" id="unit_price"  style="width:60px; height:30px;" required utocomplete="off"  onchange="negotiate_price()" />
 </span></td>
<td width="8%" align="center">
<span class="style2"> 
...
<th width="5%" rowspan="2"> Negotiate Price </th>
...
<td><input type="text" name="<?='additional_charge#'.$data->id?>" id="<?='additional_charge#'.$data->id?>" value="<?=$data->additional_charge?>" onchange="TRcalculation(<?=$data->id?>)"   style="width:60px; height:25px;"/></td>
<td><input type="text" name="<?='L_cm#'.$data->id?>" id="<?='L_cm#'.$data->id?>" value="<?=$data->L_cm?>" onchange="TRcalculation(<?=$data->id?>)"  style="width:30px; height:25px;"/></td>
<td><input type="text" name="<?='W_cm#'.$data->id?>" id="<?='W_cm#'.$data->id?>" value="<?=$data->W_cm?>"  onchange="TRcalculation(<?=$data->id?>)" style="width:30px; height:25px;"/></td>
<td><input type="text" name="<?='H_cm#'.$data->id?>" id="<?='H_cm#'.$data->id?>" value="<?=$data->H_cm?>"  onchange="TRcalculation(<?=$data->id?>)"  style="width:30px; height:25px;"/></td>
<td><input type="text" name="<?='ply#'.$data->id?>" id="<?='ply#'.$data->id?>" value="<?=$data->ply?>" onchange="TRcalculation(<?=$data->id?>)"  readonly="" style="width:30px; height:25px;"/></td>
<td><input type="text" name="<?='WL#'.$data->id?>" id="<?='WL#'.$data->id?>" value="<?=$data->WL?>"  onchange="TRcalculation(<?=$data->id?>)" style="width:30px; height:25px;"/></td>
<td><input type="text" name="<?='WW#'.$data->id?>" id="<?='WW#'.$data->id?>" value="<?=$data->WW?>" onchange="TRcalculation(<?=$data->id?>)"  style="width:30px; height:25px;"/></td>
<td><span id="ppp<?=$data->id?>"><input type="text" name="<?='sqm#'.$data->id?>" id="<?='sqm#'.$data->id?>" value="<?=$data->sqm?>" onchange="TRcalculation(<?=$data->id?>)"  style="width:60px; height:25px;"/></span>
<input type="hidden" name="<?='fr#'.$data->id?>" id="<?='fr#'.$data->id?>" value="<?=$data->formula_id?>" onchange="TRcalculation(<?=$data->id?>)"  style="width:60px; height:25px;"/></td>
<td><?=$data->paper_combination?></td>
<td><input type="text" name="<?='sqm_rate#'.$data->id?>" id="<?='sqm_rate#'.$data->id?>" value="<?=$data->sqm_rate?>" onchange="TRcalculation(<?=$data->id?>)"   style="width:60px; height:25px;"/></td>
<td><input type="text" readonly="" name="<?='final_price#'.$data->id?>" id="<?='final_price#'.$data->id?>" value="<?=$data->final_price?>" onchange="TRcalculation(<?=$data->id?>)"  style="width:70px; height:25px;"/>  </td>
...
<td><input type="text" name="<?='total_unit#'.$data->id?>" id="<?='total_unit#'.$data->id?>" value="<?=$data->total_unit?>" onchange="TRcalculation(<?=$data->id?>)"  style="width:60px; height:25px;"/></td>
<td>
<input type="text" name="<?='total_amt#'.$data->id?>" id="<?='total_amt#'.$data->id?>" value="<?=$data->total_amt?>" onchange="TRcalculation(<?=$TRcalculation->id?>)"   style="width:70px; height:25px;"/>
...
<td colspan="20"><div align="right"><strong> Grand Total:</strong></div></td>
