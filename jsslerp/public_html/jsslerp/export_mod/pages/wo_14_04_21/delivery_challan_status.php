...
where 
 ...
 m.group_for=u.id  and m.dealer_code=d.dealer_code and m.do_no=c.do_no ".$group_for_con.$con.$dealer_con.$job_no_con."  group by c.chalan_no order by  c.chalan_date, m.do_no,c.chalan_no ";
