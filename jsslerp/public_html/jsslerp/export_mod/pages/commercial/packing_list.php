...
if(isset($_POST['confirm'])){
		 ...
		 and r.lc_no='.$lc_no.' group by s.id order by s.item_id ';
			...
			mysql_query('update sale_do_details_foreign set pack="'.$packet.'" where id="'.$datac->id.'"');
...
//			while($datac = mysql_fetch_object($queryc)){
  ...
  <?
$cf= find_a_field('pi_details p,sale_do_details_foreign d','d.pack','p.do_no=d.do_no and p.pi_id="'.$lc_no.'"');
