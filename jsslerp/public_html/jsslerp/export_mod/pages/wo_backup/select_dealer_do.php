...
window.location.href = "select_concern_for_do_entry.php";
</script>
<?
}
...
if ($prevent_multi<1) {
		...
		$master = find_all_field_sql("select * from sale_do_master m, dealer_info d where d.dealer_code = m.dealer_code and m.do_no = '".$or_no."'");
		  ...
		  $sql3 = 'update sale_do_master set status="CHECKED" where do_no = '.$or_no;
		mysql_query($sql3);
...
?>
<script language="javascript">
window.location.href = "select_cbm_no_wo.php";
</script>
<?
