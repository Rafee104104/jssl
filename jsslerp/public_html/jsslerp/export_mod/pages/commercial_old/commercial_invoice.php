...
<table width="900" border="0" cellspacing="0" cellpadding="0" align="center">
 ...
 <tbody>
  ...
  <tr>
	  ...
	  <tr>
  	  <td valign="top"><?=find_a_field('dealer_info_foreign','dealer_name_e','dealer_code='.$lc_data->dealer_code);?></td>
  	  <td valign="middle" align="center"></td>
  	  <td valign="right" align="right">&nbsp;</td>
	  </tr>
	  <tr>
  	  <td valign="top"><?=find_a_field('dealer_info_foreign','address_e','dealer_code='.$lc_data->dealer_code);?></td>
  	  <td valign="middle" align="center">&nbsp;</td>
  	  <td valign="right" align="right">&nbsp;</td>
	  </tr>
  	<tr>
  ...
  <tr>
    ...
    <td colspan="2">
      ...
      <table width="100%" class="tabledesign"   border="1" bordercolor="#CCCCCC" cellspacing="0" cellpadding="5"  style="font-size:12px">
          ...
          <th   align="center"  bgcolor="#CCCCCC"> U.Price (USD)  </th>
          <th   align="center" bgcolor="#CCCCCC">Total Amount in USD </th>
        </tr>
...
//			while($datac = mysql_fetch_object($queryc)){
				 ...
				 $sqlc = 'select s.*, i.item_name, i.unit_name from lc_receive r, pi_details c, sale_do_details_foreign s, item_info i where r.pi_id=c.pi_id and i.item_id=s.item_id and c.do_no=s.do_no 
