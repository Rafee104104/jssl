...
$a=0;
		 ...
		 WHERE a.lc_no=b.lc_no  and b.pi_id=c.pi_id and a.lc_no="'.$lc_no.'" GROUP by c.pi_id ';
			...
			$a++;
			if ($a>1) echo ', ';
echo $pi_data->pi_no.' Date. '.date('d-m-Y',strtotime($pi_data->pi_date));}?></b>
  ...
  <tr>
	...
	<table width="100%" cellspacing="0" cellpadding="0"  >
		  ...
		  <tr style="font-size:12px">
		  <td align="left" style="font-size:16px; text-transform:uppercase;"><?=find_a_field('dealer_info_foreign','dealer_name_e','dealer_code='.$lc_data->dealer_code);?></td>
		  <td  align="center">&nbsp;</td>
		  <td  align="center">&nbsp;</td>
		  <td align="center">&nbsp;</td>
		  </tr>
		  <tr style="font-size:12px">
		  <td align="left" style="font-size:16px; text-transform:uppercase;"><?= find_a_field('dealer_info_foreign','address_e','dealer_code='.$lc_data->dealer_code);?></td>
		  <td  align="center">&nbsp;</td>
		  <td  align="center">&nbsp;</td>
		  <td align="center">&nbsp;</td>
		  </tr>
