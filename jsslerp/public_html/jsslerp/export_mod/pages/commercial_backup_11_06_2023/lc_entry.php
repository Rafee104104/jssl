...
$_POST['entry_at']=date('Y-m-d H:i:s');
 ...
 $YR = date('Y',strtotime($lc_date));
  ...
  $lc_id = find_a_field('lc_master','max(lc_id)','year="'.$YR.'"')+1;
   ...
   $_POST['dealer_group'] = find_a_field('dealer_info_foreign','dealer_group','dealer_code="'.$_POST['dealer_code'].'"');
							  ...
							  <td width="100%" colspan="2"><div class="box" style="width:100%;">
								...
								<? }?>									</td>
								 ...
								 <td> Date:</td>
									...
									<input style="width:220px;"  name="export_lc_date" type="text" id="export_lc_date" value="<?=($export_lc_date!='')?$export_lc_date:date('Y-m-d')?>"  required />																		</td>
									<td>Customer Name:</td>
									...
									<select name="dealer_code" id="dealer_code" required style="width:220px;"  onchange="getData2('find_dealer_bank_ajax.php', 'find_dealer_bank', this.value,document.getElementById('dealer_code').value);" >
										...
										<? foreign_relation('dealer_info_foreign','dealer_code','dealer_name_e',$dealer_code,'1 order by dealer_name_e');?>
									</select>
									<? }else {?>
									...
									<input name="dealer_name" type="text" id="dealer_name"  style="width:220px; " autocomplete="off"  readonly=""
									 value="<?=find_a_field('dealer_info_foreign','dealer_name_e','dealer_code="'.$dealer_code.'"')?>"/>	
				...
				<td>&nbsp;&nbsp; %(+/-)</td>
								  ...
								  <td>Applicant's TIN No</td>
								    <td><input name="applicants_tin_no" type="text" id="applicants_tin_no" style="width:220px;" value="<?=$applicants_tin_no?>"  tabindex="105" /></td>
								   							    <td>Export Sales Contract No</td>
								  ...
								  <tr>
								    ...
								    <td>Exp. Date<br /></td>
								    <td><input name="exp_date" type="text" id="exp_date" style="width:220px;" value="<?=$exp_date?>"  tabindex="105" /></td>
								    <td>&nbsp;</td>
								    <td>&nbsp;</td>
							      </tr>
...
<td><?=find_a_field('dealer_info_foreign','dealer_name_e','dealer_code='.$rp[4]);?></td>
</tr>
