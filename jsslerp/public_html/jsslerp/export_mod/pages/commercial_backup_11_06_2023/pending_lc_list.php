  ...
  <form action="" method="post" name="codz" id="codz">
    <table width="80%" border="0" align="center">
      <tr>
		...
		foreign_relation('dealer_info_foreign_foreign','dealer_code','dealer_name_e',$_POST['dealer_code'],'1 order by dealer_name_e');
...
$con .= ' and m.do_no in ('.$_POST['do_no'].') ';
 		...
 		$sql = "select d.do_no, count(d.revise_request) as revise_request  from sale_do_master_foreign m, sale_do_details_foreign d where m.do_no=d.do_no and d.revise_request=1 group by d.do_no ";
...
<td onClick="custom(<?=$data->lc_no;?>);" <?=(++$z%2)?'':'class="alt"';?>><?= find_a_field('dealer_info_foreign','dealer_name_e','dealer_code="'.$data->dealer_code.'"');?></td>
