...
<!--It is importent for bootstrap modele start--> 
<script type="text/javascript" src="../../../assets/js/bootstrap.min.js"></script>
<!--It is importent for bootstrap modele end-->


<!--custom css for task module start-->
<style>
...
/*.crm-top-sa .right .btn{
	padding: 1px 6px;
}*/
</style>
<!--custom css for task module end-->
...
tr:nth-child(even) {
	...
	<div class="row">
		<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 p-3" style="height:460px; overflow:scroll;">
					...
					<div class="crm-top-sa col-sm-12 col-md-12 col-lg-12 col-xl-12">
						...
						<div class="right" align="left">
						    ...
						    <!-- Button trigger modal start-->
									<button type="button" class="btn toggle" data-toggle="modal" data-target="#exampleModal">
						...
						<? /*		
							<!--dropdown start-->
								...
								<ul class="list1">
								  <li class="list-item1" style="--delay:0.2s">
								  <!-- Button trigger modal start-->
								  ...
								  <li class="list-item1" style="--delay:0.4s">
								  <!-- Button trigger modal start-->
						...
						<!--Schedule a call Modal 1st Start-->
						  ...
						  <div class="modal-dialog" role="document">
							<div class="modal-content">
							  ...
							  <div class="modal-body">
								...
								<div class="form-group row m-0 pt-1">
									<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-start align-items-center pr-1 bg-form-titel-text">Call Log:</label>
									<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
											<select class="form-control req" name="call_main" id="call_main" required>
												<option></option>
				...
				<? /*				
						...
						<div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
						  <div class="modal-dialog" role="document">
							<div class="modal-content">
							  <div class="modal-header">
								<h5 class="modal-title" id="exampleModalLabel">Log a call</h5>
								<button type="button" class="close" data-dismiss="modal" aria-label="Close">
								  <i class="fa-solid fa-xmark"></i>
								</button>
							  </div>
		...
		$i=1;
		 ...
		 if($exc==''){ echo "<span class='text-danger'>Data Not Found</span>";}
		
		while($pdata=mysql_fetch_object($pquery)){
		?>		
					...
					<div class="container-fluid pb-3 pt-3" style="cursor:pointer" onclick="window.location='schedule_call_up.php?id=<?=$pdata->id?>';">
						...
						<table>
							<tr>
								<td style=" width: 22%; ">Call type</td> <td>: <?=$pdata->call_type?></td>
							</tr>
							
							<tr>
								<td style=" width: 22%; "> Call time</td> <td>: <?=$pdata->date?> <?=date("h:i A", strtotime($pdata->time))?></td>
							</tr>
							
							<tr>
								<td style=" width: 22%; ">Call Purpose</td> <td>: <?=$pdata->subject?></td>
							</tr>
							
							<tr>
								<td style=" width: 22%; vertical-align: top; ">Note</td> <td>: <?=$pdata->details?></td>
							</tr>
		...
		$i=1;
		 ...
		 if($exv==''){ echo "<span class='text-danger'>Data Not Found</span>";}
		
		while($vdata=mysql_fetch_object($vquery)){
		?>				
					...
					<div class="container-fluid pb-3 pt-3">
						...
						<table>
							<tr>
								<td style=" width: 22%; ">Visit Location</td> <td>: <?=$vdata->location?></td>
							</tr>
							
							<tr>
								<td style=" width: 22%; "> Visit Purpose</td> <td>: <?=$vdata->subject?></td>
							</tr>
							
							<tr>
								<td style=" width: 22%; "> Visit time</td> <td>: <?=$vdata->date?> <?=date("h:i A", strtotime($vdata->time))?></td>
							</tr>
							
							<tr>
								<td style=" width: 22%; vertical-align: top; ">Note</td> <td>: <?=$vdata->details?></td>
							</tr>
...
<form method="post">
		...
		$i=1;
		 ...
		 if($mxv==''){ echo "<span class='text-danger'>Data Not Found</span>";}
		
		while($mdata=mysql_fetch_object($mquery)){
		?>				
					...
					<div class="container-fluid pb-3 pt-3">
						...
						<table>
							<tr>
								<td style=" width: 22%; ">Meeting Type</td> <td>: <?=$mdata->meeting_type?></td>
							</tr>
							
							<tr>
								<td style=" width: 22%; "> Meeting Subject</td> <td>: <?=$mdata->subject?></td>
							</tr>
							
							<tr>
								<td style=" width: 22%; ">Location</td> <td>: <?=$mdata->location?></td>
							</tr>
							
							<tr>
								<td>Date & Time</td> <td>: <?=$mdata->date?> <?=date("h:i A", strtotime($mdata->time))?></td>
							</tr>
							
							<tr>
								<td style=" width: 22%; vertical-align: top; ">Note</td> <td>: <?=$mdata->details?></td>
							</tr>
...
<?php */?>								
	...
	<?php
		...
		while($edata=mysql_fetch_object($equery)){
		?>			
					...
					<div class="container-fluid pb-3 pt-3">
						...
						<table>
						<tr>
								<td style=" width: 22%; ">Date & Time</td> <td>: <?=$edata->date?> <?=date("h:i A", strtotime($edata->time))?></td>
							</tr>
							<tr>
								<td style=" width: 22%; ">Email to</td> <td>: <?=$edata->call_to?></td>
							</tr>
							
							<tr>
								<td style=" width: 22%; "> Email Subject</td> <td>: <?=$edata->subject?></td>
							</tr>
							
							<tr>
								<td style=" width: 22%; ">Email Body</td> <td>: <?=$edata->details?></td>
							</tr>
	...
	<?php
		...
		$i=1;
		 ...
		 if($oxv==''){ echo "<span class='text-danger'>Data Not Found</span>";}
		
		while($odata=mysql_fetch_object($oquery)){
		?>				
					...
					<div class="container-fluid pb-3 pt-3">
						...
						<table>
							<tr>
								<td style=" width: 22%; ">Activities List</td> <td>: <?=$odata->activity_type?></td>
							</tr>
							...
							<tr>
								<td style=" width: 22%; vertical-align: top; ">Note</td> <td>: <?=$odata->details?></td>
							</tr>
