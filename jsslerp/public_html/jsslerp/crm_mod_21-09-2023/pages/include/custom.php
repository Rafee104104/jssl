...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-select/1.13.1/css/bootstrap-select.css"/>
    ...
    <?php    
        ...
        $WeekendRslt = mysql_query($WeekendQry);
        while($Weekend = mysql_fetch_object($WeekendRslt)){
        ...
        $partialWeekendRslt = mysql_query($partialWeekendQry);
        while($partialWeekend = mysql_fetch_object($partialWeekendRslt)){
...
<?php
    ...
    if(isset($_SESSION['user'])){
        ...
        function getLastInsertID($table, $id='id'){
            ...
            $lastID_rslt = mysql_query($lastID_qry);
            $lastID_data = mysql_fetch_object($lastID_rslt);
