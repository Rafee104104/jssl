...
?>
            ...
            <div class="card">
                ...
                ?>
                        ...
                        <div class="card-header" style="background:#f3f3f3;">
                            ...
                            <!--
                                It was in after Details
                            <span class="float-right" style="font-size:11.5px;">[Status:<b> <?//=find_a_field('crm_lead_status', 'status', 'id = "'.$rows->status.'"')?>
                            -->
                            <h3 class="text-center"><?=$CRMleadName?> Details</h3>
    ...
    <div class="row">
        <div class="col-md-12 col-xs-12">
            <h3 class="text-center">Lead List</h3>
            <div style="overflow-x:scroll;">
                <table class="table" id="example">
                    ...
                    $leadsQry = 'SELECT a.*,o.name FROM crm_project_lead a,crm_project_org o WHERE a.organization=o.id and a.organization ="'.$id.'" ';
                    ...
                    ?>
                        <tr>
                            ...
                            <td><a class="btn btn-success btn-sm" href="lead_view.php?view=<?=encrypTS($row->id)?>&tp='<?=encrypTS('lead')?>'">View</a></td>
                        </tr>
