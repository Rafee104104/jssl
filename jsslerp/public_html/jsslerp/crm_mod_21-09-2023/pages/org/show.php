...
$crud->update('id');
 mysql_query('delete from crm_org_contacts where project_id="'.$id.'"');
...
?>
          ...
          <h5 class=text-center>Update Customer Information</h5>
            <div class="row">
		...
		<?php
		$query=mysql_query('select * from crm_org_contacts where project_id="'.$id.'"');
		$i=1;
              ...
              <div class="col-md-6">
                <table class="table">
                  <tbody>
                    <tr>
                      <td>City</td>
                      <td><input type="text" name="city" id="city" value="<?=$city?>" style="border-left: 3.5px solid #aeddf7 !important;"  class="form-control"></td>
                    </tr>
                    <tr>
                      <td>Country</td>
                      <td>
