			...
			<div class="row">
				...
				<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
					...
					<div class="container-fluid p-0 drophere">
						<div class="col-12 shadow1 pb-3 draghere">
							<div class="row add">
								<div class="col-9 new_left p-2" align="left"><p> select option</p></div>
						...
						<div id="cash_check" class="col-12 m-0 p-0 pt-3">
								...
								<div class="form-group row m-0 pb-1">
									...
									<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
										<input name="r_from" type="text" id="r_from" value="" class="form-control req" tabindex="1" required="">
				...
				<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 drophere ">
					<div class="col-12 shadow1 draghere ">
						<div class="row add">
							<div class="col-9 new_left p-2" align="left"><p> View Data</p></div>
						...
						<table class="table1  table-striped table-bordered table-hover table-sm" border="0" cellspacing="0" cellpadding="0">
							...
							<tbody class="tbody1">
									...
									<tr>
										...
										<!--<td width="24" style="padding:1px;" onclick="DoNav('v_type=receipt&vdate=1970-01-01&v_no=23032201000001&view=Show&in=Journal_info');"><img src="../images/copy_hover.png" width="16" height="16" border="0"></td>-->
									...
									<tr>
										...
										<!--<td width="24" style="padding:1px;" onclick="DoNav('v_type=receipt&vdate=1970-01-01&v_no=23032101000001&view=Show&in=Journal_info');"><img src="../images/copy_hover.png" width="16" height="16" border="0"></td>-->
									...
									<tr>
										...
										<!--<td width="24" style="padding:1px;" onclick="DoNav('v_type=receipt&vdate=1970-01-01&v_no=23030701000001&view=Show&in=Journal_info');"><img src="../images/copy_hover.png" width="16" height="16" border="0"></td>-->
									...
									<tr>
										...
										<!--<td width="24" style="padding:1px;" onclick="DoNav('v_type=receipt&vdate=1970-01-01&v_no=23030501000003&view=Show&in=Journal_info');"><img src="../images/copy_hover.png" width="16" height="16" border="0"></td>-->
									...
									<tr>
										...
										<!--<td width="24" style="padding:1px;" onclick="DoNav('v_type=receipt&vdate=1970-01-01&v_no=23030501000002&view=Show&in=Journal_info');"><img src="../images/copy_hover.png" width="16" height="16" border="0"></td>-->
...
<div class="drophere">
					<div class="col-12 shadow1 mt-3 draghere ">
						<div class="row add">
							<div class="col-9 new_left p-2" align="left"><p> Add Information</p></div>
							<div class="col-3 new_right p-2"><p>&nbsp;</p></div>
						</div>
				...
				<tr>
					...
					<td>
						<input type="text" id="ledger_id" name="ledger_id" onblur="getData2('acc_reference_ajax.php', 'acc_reference', this.value,
								document.getElementById('ledger_id').value);" tabindex="1" value="" class="ui-autocomplete-input" autocomplete="off">
