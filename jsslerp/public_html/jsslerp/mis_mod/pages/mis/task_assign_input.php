                ...
                <tr class="oe_form_group_row">
				 ...
				 <input name="attached_file" type="file" id="attached_file" value="upload" style="height:auto; width:213px">				  </td>
				  ...
				  <tr class="oe_form_group_row">
				    ...
				    <td bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label"><textarea name="task_details" id="task_details" style="height:100px; width:600px"><?=$task_details?>
                  </textarea>                    </td>
				    </tr>
                <?if($_GET['id']>0){?>
                  <tr class="oe_form_group_row">
                    <td colspan="2" bgcolor="green" class="oe_form_group_cell oe_form_group_cell_label" style="padding-left:10px">&nbsp;</td>
                  </tr>
                  
                  <tr class="oe_form_group_row">
                    <td bgcolor="#E8E8E8" style="padding-left:10px" class="oe_form_group_cell oe_form_group_cell_label">Task Status:</td>
                    <td bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label">
                  ...
                  <tr class="oe_form_group_row">
                    <td bgcolor="#E8E8E8" style="padding-left:10px" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;</td>
