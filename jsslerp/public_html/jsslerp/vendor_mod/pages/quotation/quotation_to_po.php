...
$sql = 'select * from quotation_master where quotation_no="'.$quotation_no.'"';
 $pdata = mysql_fetch_object(mysql_query($sql));
 ...
 $master_insert = mysql_query($insert);
 $po_no = mysql_insert_id();
...
$update = mysql_query('update quotation_master set is_po=1 where quotation_no="'.$quotation_no.'"');
