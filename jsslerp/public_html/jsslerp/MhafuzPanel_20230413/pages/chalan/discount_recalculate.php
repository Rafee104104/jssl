...
// ::::: Start Edit Section ::::: 
$title='Chalan Discount Issue';			// Page Name and Page Title
...
//auto_recalculate_sales_discount($chalan_no);
	//if($chalan_type == 'L'){
//		auto_reinsert_sales_chalan_secoundary_new($chalan_no);
//		}
//	else{
//		auto_reinsert_sales_chalan_foreign_secoundary_new($chalan_no);
//		
//	}
