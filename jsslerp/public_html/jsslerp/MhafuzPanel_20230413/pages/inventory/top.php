...
<!--      <label class="label success" for="PBI_ID">Search With CID : </label>-->
	  ...
	  style="height: 40px !important; border-radius: 5px 0px 0px 5px; "/>
    ...
    <div class="col-md-1 form-group p-0" style="margin-top: 2.1% !important;">
      <button class="btn btn-info" type="submit" name="submit" style="height: 40px !important; border-radius: 0px 5px 5px 0px;">Search</button>
