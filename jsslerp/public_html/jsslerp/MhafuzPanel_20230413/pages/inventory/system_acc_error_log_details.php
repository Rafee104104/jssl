...
$title = "System Account Error Log Details";
...
<div class="container">
	...
	<table class="table table-bordered">
		...
		<tbody>
			...
			$query = mysql_query('select * from system_acc_lock_details where date="' . $_GET['date'] . '"');
			...
			?>
				...
				<tr>
					...
					<td><?= $data->difference_dr==0 && $data->difference_dr==0?'OK':'Problem' ?></td>
