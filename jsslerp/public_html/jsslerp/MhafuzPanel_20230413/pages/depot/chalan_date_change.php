...
if(isset($_REQUEST['change_date'])&&$_REQUEST['chalan_date']!='')
{
	...
	mysql_query($sql_chalan);mysql_query($sql_journal_item);mysql_query($sql_sec_journal);
...
<div class="oe_form_sheetbg" style="min-height:10px;">
  ...
  <tr>
    <td bgcolor="#33CCFF"><strong>Chalan No: </strong></td>
    ...
    <td bgcolor="#33CCFF" style="text-align:center"><strong>
      <label>
  ...
  <? if($chalan_no>0){?>
  <tr>
    <td bgcolor="#FFCCCC"><strong>Chalan Date : </strong></td>
    <td bgcolor="#FFCCCC"><input name="chalan_date" type="text" id="chalan_date" value="<?=find_a_field('sale_do_chalan','chalan_date','chalan_no='.$chalan_no);?>" / class="form-control"></td>
  ...
  <tr>
    <td bgcolor="#CC99CC"><strong>DO Date : </strong></td>
    <td bgcolor="#CC99CC"><input name="serial_no" type="text" id="serial_no" value="<?=find_a_field('sale_do_chalan','do_date','chalan_no='.$chalan_no);?>" / class="form-control"></td>

    <td bgcolor="#CC99CC" style="text-align:center">
...
<div class="oe_form_sheetbg" style="min-height:0px;">
        <div class="oe_form_sheet oe_form_sheet_width">
          ...
          <div  class="oe_view_manager_view_list"><div  class="oe_list oe_view">
		  <font size="+1" color="#003399"><u>Depot Information</u></font><br /><br />
          <? 	 
...
<div class="oe_form_sheetbg" style="min-height:0px;">
        <div class="oe_form_sheet oe_form_sheet_width">
          ...
          <div  class="oe_view_manager_view_list"><div  class="oe_list oe_view">
		  <font size="+1" color="#003399"><u>Accounts Information</u></font><br /><br />
          <? 	 
