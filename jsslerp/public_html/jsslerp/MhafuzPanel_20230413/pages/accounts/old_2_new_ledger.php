...
if(isset($_REQUEST['change_ledger'])&&$_REQUEST['old_ledger']>0&&$_REQUEST['new_ledger']>0&&$_REQUEST['new']!=''&&$_REQUEST['new_ledger']!='')
{
	...
	mysql_query($sql1);mysql_query($sql2);mysql_query($sql3);mysql_query($sql4);mysql_query($sql8);mysql_query($sql9);
	...
	mysql_query($sql5);mysql_query($sql6);mysql_query($sql7);mysql_query($sql8);
}
?>
