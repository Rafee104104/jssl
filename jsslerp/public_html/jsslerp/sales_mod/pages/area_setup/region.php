        ...
        <div class="col-sm-5">
            <form id="form1" name="form1" class="n-form" method="post" action="" enctype="multipart/form-data">
                ...
                <div class="form-group row m-0 pl-3 pr-3 p-1">
                    <label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label"> District Code:</label>
                    <div class="col-sm-9 p-0">
                ...
                <div class="form-group row m-0 pl-3 pr-3 p-1">
                    <label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label">District Name: </label>
                    <div class="col-sm-9 p-0">
