...
<table width="80%" border="0" align="center">
  ...
  <tr>
    ...
    <td bgcolor="#FF9966"><select name="vendor_id" id="vendor_id" style="width:220px;">
...
?>
  ...
  <tr>
    <td align="right" bgcolor="#FF9966"><strong>CR  Ledger  : </strong></td>
    <td bgcolor="#FF9966"><select name="cr_ledger_id" id="cr_ledger_id" required="required" style="width:220px;">
      <option></option>
...
<table width="100%" border="0" align="center" id="grp" cellpadding="0" cellspacing="0" >
  ...
  <tr style="font-size:14px;">
    ...
    <th width="26%"><strong>Vendor</strong>  Name </th>
    <th width="14%">Invoice No </th>

    <th width="15%" bgcolor="#99FFFF">Invoice Amt </th>
    <th width="13%" bgcolor="#CCCCCC">Due Amt </th>
    <th width="13%" bgcolor="#FFCCFF">Payment Amt </th>
