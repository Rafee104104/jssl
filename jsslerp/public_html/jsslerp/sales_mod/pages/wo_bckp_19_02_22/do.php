...
var ctn_tot_amt =  pkt_unit*crt_price;
var unit_tot_amt =  dist_unit*unit_price;

var total_amt = (document.getElementById('total_amt').value) = ctn_tot_amt+unit_tot_amt;
...
<label style="width:220px;">Sales Type: </label>
...
<input style="width:250px;"  name="cash_discount" type="text" id="cash_discount" value="<?=$cash_discount;?>" />
</div>
...
<td>
		...
		<input name="new" type="submit" class="btn1" value="Initiate Sales Order" style="width:200px; font-weight:bold; font-size:12px;" tabindex="12" />
...
<? 
  ...
  $res='select a.id,b.item_name,a.crt_price as ctn_price, a.pkt_unit as ctn, a.dist_unit as pcs, a.total_amt as Net_sale, a.discount, a.vat_amt, a.total_amt_with_vat from 
...
<? $data->total_amt_with_vat; $tot_total_amt_with_vat +=$data->total_amt_with_vat;?>
</td>
...
<td colspan="3"><div align="right"><strong> Cash Discount:</strong></div></td>
...
<? if($amount_including_vat = $tot_total_amt_with_vat-$cash_discount>0) {?>
<tr>
...
<td>&nbsp;</td>
<td>&nbsp;</td>
<td><?=number_format($amount_including_vat = $tot_total_amt_with_vat-$cash_discount,2);?></td>
<td>&nbsp;</td>
</tr>
