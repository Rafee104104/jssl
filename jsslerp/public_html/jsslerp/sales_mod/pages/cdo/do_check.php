        ...
        <div class="container-fluid pt-5 p-0 ">
            ...
            <table class="table1  table-striped table-bordered table-hover table-sm">
                ...
                <tbody class="tbody1">
					...
					$res='select a.id,b.finish_goods_code as code, a.sr_no, b.item_name,a.unit_price,a.pkt_unit as crt_qty,a.dist_unit as pcs ,a.total_amt,"X" from sale_do_details a,item_info b where b.item_id=a.item_id and a.do_no='.$$unique_master.' order by a.id';
