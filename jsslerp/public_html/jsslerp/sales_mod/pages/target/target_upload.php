                ...
                <div class="form-group row  m-0 mb-1 pl-3 pr-3">
                    ...
                    <div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0 pr-2">
                        ...
                        <select name="target_month" style="width:160px;" id="target_month" required="required">
                            <option value="1" <?=($target_month=='1')?'selected':''?>>January</option>
                            <option value="2" <?=($target_month=='2')?'selected':''?>>February</option>
                            <option value="3" <?=($target_month=='3')?'selected':''?>>March</option>
                            <option value="4" <?=($target_month=='4')?'selected':''?>>April</option>
                            <option value="5" <?=($target_month=='5')?'selected':''?>>May</option>
                            <option value="6" <?=($target_month=='6')?'selected':''?>>June</option>
                            <option value="7" <?=($target_month=='7')?'selected':''?>>July</option>
                            <option value="8" <?=($target_month=='8')?'selected':''?>>August</option>
                            <option value="9" <?=($target_month=='9')?'selected':''?>>September</option>
                            <option value="10" <?=($target_month=='10')?'selected':''?>>October</option>
                            <option value="11" <?=($target_month=='11')?'selected':''?>>November</option>
                            <option value="12" <?=($target_month=='12')?'selected':''?>>December</option>
                        </select>
