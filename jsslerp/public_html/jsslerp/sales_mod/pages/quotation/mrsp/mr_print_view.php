...
<td ><div align=""><strong><?=$all->unit?> </strong></div></td>
</tr>
<tr>
<td><div align=""><strong>Address: </strong><?=$all->delivery_address;?></div></td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td ><input name="button" type="button" onclick="hide();window.print();" value="Print (Client Copy)" /></td>
...
<table width="95%"  border="1px" bordercolor="grey" cellspacing="0" cellpadding="3">
       <tr>
...
?>
  ...
  <tr>
          ...
          <ul>
            ...
            <li>The Above price <? if($all->is_included==1){ echo "is included"; if(($all->vat || $all->vat_box)  > 0){ echo " Vat";} if(($all->ait || $all->ait_box)  > 0){ echo ",Ait";} if(($all->vat_ait || $all->vat_ait_box)  > 0){ echo " Vat & Ait";} }else { echo "is excluding of any Vat,Tax";}?></li>
...
<?php /*?><p><?=$entry_info->fname .', '.$entry_info->mobile;?></p><?php */?>	
<p><?=$all->quo_by?></p>
</div>
</div>
