...
{
mysql_query('delete from journal_stock where 1');
...
mysql_query("INSERT INTO journal_stock (stock_date, item_id, depot_id, stock_qty) VALUES ('".$stock_date."', '".$data->item_id."', '3', '".$dhaka."')");
mysql_query("INSERT INTO journal_stock (stock_date, item_id, depot_id, stock_qty) VALUES ('".$stock_date."', '".$data->item_id."', '6', '".$ctg."')");
mysql_query("INSERT INTO journal_stock (stock_date, item_id, depot_id, stock_qty) VALUES ('".$stock_date."', '".$data->item_id."', '9', '".$sylhet."')");
mysql_query("INSERT INTO journal_stock (stock_date, item_id, depot_id, stock_qty) VALUES ('".$stock_date."', '".$data->item_id."', '7', '".$bogura."')");
mysql_query("INSERT INTO journal_stock (stock_date, item_id, depot_id, stock_qty) VALUES ('".$stock_date."', '".$data->item_id."', '8', '".$borisal."')");
mysql_query("INSERT INTO journal_stock (stock_date, item_id, depot_id, stock_qty) VALUES ('".$stock_date."', '".$data->item_id."', '10', '".$jessore."')");
mysql_query("INSERT INTO journal_stock (stock_date, item_id, depot_id, stock_qty) VALUES ('".$stock_date."', '".$data->item_id."', '54', '".$gajipur."')");
}
...
while($info = mysql_fetch_object($queryq))
{
...
while($infop = mysql_fetch_object($queryp))
{
...
<tr style="border:none;">
    <th colspan="20" align="left" style="text-align:left">Contract Booking</th>
	</tr></thead><tbody>
<?

// Farmer Loan
//
//  $far_loan="select c.farmer_loan,c.loan_days,c.total_interest,c.sr_no,c.chalan_no
//from sale_do_chalan c
//where   1 ".$date_con."
//order by c.chalan_no";
//$far_query = mysql_query($far_loan);
//while($data_far=mysql_fetch_object($far_query)){
//
// $farmer_loan[$data_far->sr_no][$data_far->chalan_no]=$data_far->farmer_loan;
// $farmer_days[$data_far->sr_no][$data_far->chalan_no]=$data_far->loan_days;
// $farmer_interest[$data_far->sr_no][$data_far->chalan_no]=$data_far->total_interest;
// 
//}
...
//echo $sr_loan="select c.sr_loan,c.loan_days,c.total_interest,c.sr_no,c.chalan_no
//from sale_do_chalan c
//where   1  ".$date_con."
//order by c.chalan_no";
//$sr_query = mysql_query($sr_loan);
//while($data_loan=mysql_fetch_object($sr_query)){
// 
// $sr_loan[$data_loan->sr_no][$data_loan->chalan_no]=$data_loan->sr_loan;
// $sr_days[$data_loan->sr_no][$data_loan->chalan_no]=$data_loan->loan_days;
// $sr_interest[$data_loan->sr_no][$data_loan->chalan_no]=$data_loan->total_interest; 
//}
...
<td><?=$data->store_rent; $tot_con_rent+=$data->store_rent;?></td>
<td><?=$data->labour_charge; $tot_con_labour+=$data->labour_charge;?></td>
...
<td><?=$data->total_amt; $tot_con_amt+=$data->total_amt;?></td>
</tr>
<?
}
?><tr class="footer"><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td><?=number_format($tot_con_unit,2);?></td>
  <td>&nbsp;</td>
  <td><?=number_format($tot_con_kg,2);?></td>
  <td><?=number_format($tot_con_rent,2);?></td>
  <td><?=number_format($tot_con_labour,2);?></td><td><?=number_format($tot_con_seeds,2);?></td><td><?=number_format($tot_con_farmer,2);?></td>
<td></td>
...
<td><?=number_format($tot_con_amt,2);?></td>
...
<br /><br />
<table width="100%" cellspacing="0" cellpadding="2" border="0">
<thead><tr><td style="border:0px;" colspan="20"></td></tr>
...
<th>লাভ</th>
    ...
    <th colspan="20" align="left" style="text-align:left">Normal Booking</th>
...
$s=1;
  $sql_loan="select c.*
from sale_do_chalan c, paid_booking p
where c.booking_no=p.booking_number_eng and p.booking_type='Normal Booking'  and 1  ".$date_con."
order by c.chalan_no";
$loan_query = mysql_query($sql_loan);
while($data=mysql_fetch_object($loan_query)){
...
<td><?=$data->unit_price?></td>
<td><?=$data->challan_in_kg; $tot_paid_kg2+=$data->challan_in_kg;?></td>
<td><?=$data->store_rent; $tot_paid_rent2+=$data->store_rent;?></td>
<td><?=$data->labour_charge; $tot_paid_labour2+=$data->labour_charge;?></td>
<td><?=$data->seeds_loan; $tot_paid_seeds2+=$data->seeds_loan;?></td>
<td><?=$data->farmer_loan; $tot_paid_farmer2+=$data->farmer_loan;?></td>
<td><? if($data->farmer_loan>0) { echo $data->loan_days; } ?></td>
<td><? if($data->farmer_loan>0) { echo $data->total_interest; $tot_paid_interest2+=$data->total_interest; } ?></td>
<td><?=$data->bag_loan; $tot_paid_bag2+=$data->bag_loan;?></td>
<td><?=$data->sr_loan; $tot_paid_sr2+=$data->sr_loan;?></td>
<td><?  if($data->sr_loan>0) { echo $data->loan_days; } ?></td>
<td><? if($data->sr_loan>0) { echo $data->total_interest; $tot_paid_sr_interest2+=$data->total_interest;}  ?></td>
<td><?=$data->others_loan; $tot_paid_others2+=$data->others_loan;?></td>
<td><?=$data->total_amt; $tot_paid_amt2+=$data->total_amt;?></td>
</tr>
<?
}
?><tr class="footer"><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td><?=number_format($tot_paid_unit2,2);?></td>
  <td>&nbsp;</td>
  <td><?=number_format($tot_paid_kg2,2);?></td>
  <td><?=number_format($tot_paid_rent2,2);?></td>
  <td><?=number_format($tot_paid_labour2,2);?></td><td><?=number_format($tot_paid_seeds2,2);?></td><td><?=number_format($tot_paid_farmer2,2);?></td>
<td></td>
...
<td><?=number_format($tot_paid_amt2,2);?></td>
...
<th>লাভ</th>
    ...
    <th colspan="20" align="left" style="text-align:left">Paid Booking</th>
...
$s=1;
  $sql_loan="select c.*
from sale_do_chalan c, paid_booking p
where c.booking_no=p.booking_number_eng and p.booking_type='Paid Booking'  and 1  ".$date_con."
order by c.chalan_no";
$loan_query = mysql_query($sql_loan);
while($data=mysql_fetch_object($loan_query)){
...
<td><?=$data->store_rent; $tot_paid_rent+=$data->store_rent;?></td>
<td><?=$data->labour_charge; $tot_paid_labour+=$data->labour_charge;?></td>
...
<td><?=$data->labour_charge; $tot_paid_amt+=$data->labour_charge;?></td>
</tr>
<?
}
?><tr class="footer"><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td>&nbsp;</td><td><?=number_format($tot_paid_unit,2);?></td>
  <td>&nbsp;</td>
  <td><?=number_format($tot_paid_kg,2);?></td>
  <td><?=number_format($tot_paid_rent,2);?></td>
  <td><?=number_format($tot_paid_labour,2);?></td><td><?=number_format($tot_paid_seeds,2);?></td><td><?=number_format($tot_paid_farmer,2);?></td>
<td></td>
...
<td><?=number_format($tot_paid_amt,2);?></td>
...
";
$query1 = mysql_query($sqld1);
while($info1 = mysql_fetch_row($query1)){
$discount=$info1[0];
}
...
$query1 = mysql_query($sqld1);
while($spd = mysql_fetch_object($query1)){
