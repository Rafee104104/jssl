        ...
        <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
          <div class="container n-form2">
            ...
            <div class="form-group row m-0 pb-1">
              ...
              <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
			    ...
			    <input name="booking_no" id="booking_no" list="sr_nos" value="<?=$booking_no;?>"  autocomplete="off"  onchange="getData2('tkAjax.php', 'Shuvo', this.value)">
			       ...
			       <datalist id="sr_nos">
                  <? foreign_relation('sr_token','booking_number', 'sr_number',$master->booking_no,'1');?>
              </datalist>
            ...
            <div class="form-group row m-0 pb-1">
              ...
              <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 "><span id="Shuvo">
    ...
    <div class="container-fluid pt-5 p-0 ">
      <table class="table1  table-striped table-bordered table-hover table-sm">
        ...
        <tbody class="tbody1">
          <tr>
            <td>
			  <input name="sr_no" id="sr_no" list="sr_ar" value="<?=$_POST['sr_no'];?>"  autocomplete="off"  onchange="getData2('itemJournalAjaxList.php', 'tk47bd', this.value)" >
...
<?php */?>                </tr>
    ...
    <div class="container-fluid pt-5 p-0 ">
      <?
			  $res='select a.id,b.item_name,a.item_id,a.unit_name,a.pcs_stock, a.item_name, a.total_unit,a.dist_unit, a.total_amt as Net_sale, a.discount, a.vat_amt, a.total_amt_with_vat from
