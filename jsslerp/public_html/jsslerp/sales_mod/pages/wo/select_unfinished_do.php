    ...
    <form action="" method="post" name="codz" id="codz">
      ...
      <div class="container-fluid pt-5 p-0 ">
        ...
        <table class="table1  table-striped table-bordered table-hover table-sm">
          ...
          <tbody class="tbody1">
          <?
          if($_POST['fdate']!='') {$con=' and a.do_date between "'.$_POST['fdate'].'" and "'.$_POST['tdate'].'"';}else{$con=' and a.do_date between "'.date('Y-m-01').'"
and "'.date('Y-m-d').'"';}

          $res ='select a.do_no,a.entry_by,a.do_date,a.dealer_code,d.dealer_name_e,u.fname,a.booking_no,a.customer,a.entry_at
  ...
  where a.dealer_code=d.dealer_code and a.entry_by=u.user_id  and a.status="MANUAL" '.$con.' order by a.do_no desc';
          ...
          ?>
            <tr>
              ...
              <td class="text-center"><?=$data->booking_no?></td>
