      ...
      <div class="row">
        ...
        <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
          ...
          <?php /*?>  <div class="form-group row m-0 pb-1">
              ...
              <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
                <select name="booking_no" id="booking_no" onchange="getData2('tkAjax.php', 'Shuvo', this.value)">
                  <option>
                  <?=$master->booking_no;?>
                  </option>
    ...
    <div class="container-fluid pt-5 p-0 ">
      <table class="table1  table-striped table-bordered table-hover table-sm">
        ...
        <tbody class="tbody1">
          <tr>
            <td>
			  <input name="sr_no" id="sr_no" list="sr_nos" value="<?=$_POST['sr_no'];?>"  autocomplete="off"  onchange="getData2('itemJournalAjaxList.php', 'tk47bd', this.value)" >
