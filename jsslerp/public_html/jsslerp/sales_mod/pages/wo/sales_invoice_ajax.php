...
$item_all = find_all_field('item_info', '', 'item_id=100010001');
...
<tr bgcolor="#CCCCCC">
	 ...
	 <td width="12%"><input name="unit_price" type="text" class="input3" id="unit_price" onkeyup="count()"  style="width:90%; height:30px;" required="required"  value="<?=$item_sales_price?>"   /></td>
</tr>
</table>
