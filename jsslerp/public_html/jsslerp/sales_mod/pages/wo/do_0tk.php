  ...
  <form action="<?=$page?>" method="post" name="codz2" id="codz2">
    ...
    <div class="container-fluid pt-5 p-0 ">
      <table class="table1  table-striped table-bordered table-hover table-sm">
        ...
        <tbody class="tbody1">
          <tr>
            <td><select name="sr_no" id="sr_no" onchange="getData2('itemJournalAjaxList.php', 'tk47bd', this.value)">
                <option> </option>
            ...
            <td id="tk47bd" colspan="4"><table  width="100%" border="1" align="left" cellpadding="0" cellspacing="2">
                <tr>
