...
$info2 = mysql_fetch_row(mysql_query($sqld));
$rcv_t = $rcv_t+$data->rcv_amt;
$dp_t = $dp_t+$info[0];
$tp_t = $tp_t+$info2[0];
...
$sales = mysql_fetch_object(mysql_query($sqld));
if(isset($t_date)) {$to_date=$t_date; $fr_date=$f_date; $date_con=' and a.or_date between \''.$fr_date.'\' and \''.$to_date.'\'';}
...
$damage = mysql_fetch_object(mysql_query($sqld));
...
${'sqlmona'} = mysql_fetch_row(mysql_query($sqql));
...
${'sqlmonb'} = mysql_fetch_row(mysql_query($sqql));
...
${'sqlmonc'} = mysql_fetch_row(mysql_query($sqql));
...
${'sqlmond'} = mysql_fetch_row(mysql_query($sqql));
...
${'sqlmone'} = mysql_fetch_row(mysql_query($sqql));
...
${'sqlmonm'} = mysql_fetch_row(mysql_query($sqql));
...
${'dsqlmona'} = mysql_fetch_row(mysql_query($sqql));
...
${'dsqlmonb'} = mysql_fetch_row(mysql_query($sqql));
...
${'dsqlmonc'} = mysql_fetch_row(mysql_query($sqql));
...
${'dsqlmond'} = mysql_fetch_row(mysql_query($sqql));
...
${'dsqlmone'} = mysql_fetch_row(mysql_query($sqql));
...
${'dsqlmonm'} = mysql_fetch_row(mysql_query($sqql));
...
${'sqlmonco'} = mysql_fetch_row(mysql_query($sqql));
...
${'dsqlmonco'} = mysql_fetch_row(mysql_query($sqql));
  ?>
    <tr bgcolor="#<? echo (($i%2)==0)?'fff':'EBEBEB';?>">
      <td>&nbsp;</td>
...
${'sqlmonsu'} = mysql_fetch_row(mysql_query($sqql));
...
${'dsqlmonsu'} = mysql_fetch_row(mysql_query($sqql));
