...
$title='Agent Information Add';			// Page Name and Page Title
do_datatable('dealer_info');
$page="dealer_info.php";		// PHP File Name
do_datatable('agent_table');
...
$_POST['ledger_name'] = $_POST['dealer_name'].'('.$_POST['dealer_code_eng'].')';


$tr_type="Add";
$ledger_gl_found = find_a_field('accounts_ledger','ledger_id','ledger_name='.$_POST['ledger_name']);

if ($ledger_gl_found==0 && $_POST['ledger_group']==121007) {
   $acc_ins_led = 'INSERT INTO accounts_ledger (ledger_id, ledger_sl, ledger_name, ledger_group_id, acc_class, acc_sub_class, acc_sub_sub_class, opening_balance, balance_type, depreciation_rate, credit_limit, proj_id, budget_enable, group_for, parent, cost_center, entry_by, entry_at) VALUES ("'.$_POST['account_code'].'", "'.$_POST['ledger_sl'].'", "'.$_POST['ledger_name'].'", "'.$_POST['ledger_group_id'].'", "'.$gl_group->acc_class.'", "'.$gl_group->acc_sub_class.'", "'.$gl_group->acc_sub_sub_class.'", "0", "Both", "0", "0", "'.$proj_id.'", "YES", "'.$_POST['group_for'].'", "0", "0", "'.$_POST['entry_by'].'", "'.$_POST['entry_at'].'")';
mysql_query($acc_ins_led);
}
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////

$ledger_group_id='2229001';
$cy_id  = find_a_field('accounts_ledger','max(ledger_sl)','ledger_group_id='.$ledger_group_id)+1;

$ledger_sl = sprintf("%04d", $cy_id);
$_POST['advance_acc_code'] = $ledger_group_id.''.$ledger_sl;


$gl_group = find_all_field('ledger_group','','group_id='.$ledger_group_id); 
$_POST['ledger_name'] = $_POST['dealer_name'].'('.$_POST['dealer_code_eng'].')';
...
if ($ledger_gl_found==0 && $_POST['ledger_group']==2229001) {
   $acc_ins_led = 'INSERT INTO accounts_ledger (ledger_id, ledger_sl, ledger_name, ledger_group_id, acc_class, acc_sub_class, acc_sub_sub_class, opening_balance, balance_type, depreciation_rate, credit_limit, proj_id, budget_enable, group_for, parent, cost_center, entry_by, entry_at) VALUES ("'.$_POST['advance_acc_code'].'", "'.$ledger_sl.'", "'.$_POST['ledger_name'].'", "'.$ledger_group_id.'", "'.$gl_group->acc_class.'", "'.$gl_group->acc_sub_class.'", "'.$gl_group->acc_sub_sub_class.'", "0", "Both", "0", "0", "'.$proj_id.'", "YES", "'.$_POST['group_for'].'", "0", "0", "'.$_POST['entry_by'].'", "'.$_POST['entry_at'].'")';
mysql_query($acc_ins_led);
}
...
$_POST['ledger_name'] = $_POST['dealer_name'].'('.$_POST['dealer_code_eng'].')';
	  ...
	  $sql1 = 'update accounts_ledger set ledger_name="'.$_POST['ledger_name'].'" 
...
<div class="form-container_large" >
  ...
  <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return check()" dir="auto">
    <div class="container-fluid bg-form-titel">
      <div class="row">
        <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
          <div class="form-group row m-0">
            <label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 vendor_label_text d-flex justify-content-start align-items-center pr-1 bg-form-titel-text">
			 Agent ID(Eng): </label>
            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
              <input name="dealer_code_eng" type="text" id="dealer_code_eng" tabindex="2" value="<?=$dealer_code_eng?>" />
            </div>
          </div>
        </div>
        <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
		...
		<div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
          <div class="form-group row m-0">
            <label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 vendor_label_text d-flex justify-content-start align-items-center pr-1 bg-form-titel-text">Agent Name:(English)</label>
            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
              <input name="dealer_name" type="text" id="dealer_name" tabindex="2" value="<?=$dealer_name?>" />
            </div>
          </div>
        </div>
        <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
          <div class="form-group row m-0">
            <label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 vendor_label_text d-flex justify-content-start align-items-center pr-1 bg-form-titel-text">Father Name:</label>
            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
              <input name="father_name" type="text" id="father_name" tabindex="2" value="<?=$father_name?>" />
            </div>
          </div>
        </div>
        <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
        ...
        <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
          <div class="form-group row m-0">
            ...
            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
              <input name="nid" type="text" id="nid" tabindex="18" value="<?=$nid?>" />
            </div>
          </div>
        </div>
        <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
          <div class="form-group row m-0">
            ...
            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
              ...
              <select name="ledger_group" required="required" id="ledger_group" style="width:95%; font-size:12px;" tabindex="9">
                ...
                <? foreign_relation('ledger_group','group_id','group_name',$ledger_group,'group_id in("2229001","121007") and  group_for="'.$_SESSION['user']['group'].'"');?>
              </select>
              <? }?>
              <? if ($account_code>0) {?>
        ...
        <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
          <div class="form-group row m-0">
            <label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex vendor_label_text justify-content-start align-items-center pr-1 bg-form-titel-text"> Division:</label>
            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
  ...
  <div class="container-fluid pt-5 p-0 ">
			<table id="agent_table" class="table1  table-striped table-bordered table-hover table-sm">
      <thead class="thead1">
        <tr class="bgc-info">
          <th>ID</th>
		  <th>Agent Id Eng</th>
          <th>Customer Name</th>
		  <th>Customer Name ENG</th>
          <th>GL Code</th>
          <th>Address</th>
          <th>Action</th>
        </tr>
      ...
      <tbody class="tbody1">
        <?php
				...
				$td='select a.dealer_code, a.dealer_code2,  a.'.$shown.',  a.address_e, a.account_code, a.'.$unique.', a.dealer_code_eng,a.dealer_name from '.$table.' a, user_group u
				where   a.group_for=u.id  and a.group_for="'.$_SESSION['user']['group'].'"    '.$con.' order by a.dealer_code desc ';
        ...
        <tr<?=$cls?>  bgcolor="<?=($i%2)?'#E8F3FF':'#fff';?>">
		  ...
		  <td style="text-align:left"><?=$rp[7];?></td>
          <td><?=$rp[4];?></td>
