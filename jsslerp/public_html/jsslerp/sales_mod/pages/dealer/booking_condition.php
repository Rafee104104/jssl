...
$title='Booking Condition Setup';			// Page Name and Page Title

do_datatable('table_head');

$page="booking_condition.php";		// PHP File Name

$tr_type="Show";

$table='booking_condition_setup';		// Database Table Name Mainly related to this page

$unique='id';			// Primary Key of this Database table

$shown='booking_condition';				// For a New or Edit Data a must have data field
...
$con .='and a.dealer_type like "%'.$_POST['dealer_type'].'%" ';
  ...
  $td = "SELECT a.$unique, a.$shown, a.status,a.year FROM $table a ORDER BY a.id";
...
<tr<?=$cls?> >
	...
	<td><?=$rp[2];?></td>
	<td>
	<button type="button" onclick="DoNav('<?php echo $rp[0];?>');" class="btn2 btn1-bg-update"><i class="fa-solid fa-pen-to-square"></i></button>	</td>
</tr>
            ...
            <form class="n-form"   action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return check()">
                ...
                <div class="form-group row m-0 pl-3 pr-3 p-1">
                    ...
                    <div class="col-sm-9 p-0">
                        ...
                        <?php /*?><input class="m-0" name="year" required type="text" id="year" tabindex="1"  value="<?=$year?>"  ><?php */?>
						<?php
...
echo '<select name="year" id="year" type="text">';
...
?>
                ...
                <div class="form-group row m-0 pl-3 pr-3 p-1">
                    <label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label">Condition</label>
                    <div class="col-sm-9 p-0">
                       <input type="text" name="booking_condition" value="<?php echo $booking_condition; ?>" />

                      <?php /*?><? foreign_relation('user_group','id','group_name',$group_for,'
					  id="'.$_SESSION['user']['group'].'"');?><?php */?>
                    </select>
