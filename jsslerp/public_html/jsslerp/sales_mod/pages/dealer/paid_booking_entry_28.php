...
document.getElementById('total_amount').value=(rate*qty);
          ...
          <div class="form-group row m-0">
            ...
            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
              ...
              <select name="ledger_group" required="required" id="ledger_group" style="width:95%; font-size:12px;" tabindex="9">
                ...
                <? foreign_relation('ledger_group','group_id','group_name',$ledger_group,'acc_sub_sub_class in("1213") and  group_for="'.$_SESSION['user']['group'].'"');?>
              </select>
              <? }?>
              <? if ($account_code>0) {?>
