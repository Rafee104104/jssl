...
$title='Farmer Information Add';			// Page Name and Page Title
do_datatable('farmer_info');
$page="farmer_info.php";		// PHP File Name

$table='farmer_info';		// Database Table Name Mainly related to this page
      ...
      <div class="row">
        <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
          <div class="form-group row m-0">
            <label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 vendor_label_text d-flex justify-content-start align-items-center pr-1 bg-form-titel-text"> Agent ID:</label>
            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
              <input name="dealer_code2" type="text" id="dealer_code2" tabindex="2" value="<?=$dealer_code2?>" />
            </div>
          </div>
        </div>
        <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
          ...
          <div class="form-group row m-0">
            ...
            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
              ...
              <select name="ledger_group" required="required" id="ledger_group" style="width:95%; font-size:12px;" tabindex="9">
                ...
                <? foreign_relation('ledger_group','group_id','group_name',$ledger_group,'acc_sub_sub_class="1213" and group_for="'.$_SESSION['user']['group'].'"');?>
              </select>
              <? }?>
              <? if ($account_code>0) {?>
    ...
    <table id="vendor_table" class="table1  table-striped table-bordered table-hover table-sm">
      ...
      <tbody class="tbody1">
        <?php
				...
				$td='select a.dealer_code, a.dealer_code2,  a.'.$shown.',   a.address_e, a.account_code, a.'.$unique.'  from '.$table.' a, user_group u
