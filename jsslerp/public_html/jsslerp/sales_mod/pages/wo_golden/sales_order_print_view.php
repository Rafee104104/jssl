                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
						...
						<table width="100%" border="0" cellspacing="0" align="center" cellpadding="0" style="font-size:15px; margin:0; padding:0;">
									...
									<tr>
									<td>
						  	          <div align="left"><img src="../../../logo/<?=$_SESSION['proj_id']?>.png"   style=" width:50%; height: 100px;"  />
		        ...
		        <tr>
		          ...
		          <td><table width="100%" border="1" cellspacing="0" cellpadding="5">
		            ...
		            <tr>
		              ...
		              <td  valign="top"><span style="font-size:14px; " class="style8"><strong>PO No :</strong><?php echo $master->po_no?> &nbsp; &nbsp;</span></td>
		              </tr>
...
//, (a.init_pkt_unit*a.unit_price) as Total,(a.init_pkt_unit-a.inStock_ctn) as Shortage
  ...
  $res='select  s.sub_group_name,  b.item_name,b.secondary_unit_quantity,b.secondary_unit_name, a.*
...
<tr bgcolor="#ffdada">
 ...
 <?=number_format($invoice_amt= ($tot_amt_after_discount+$vat_amt),2); ?>
        ...
        <tr>
          <td colspan="6"><span class="style8" style="font-size:14px; font-weight:500; letter-spacing:.3px;">In Word:
             <?
