      ...
      <div class="col-12 profile-sidebar">
        <div class="row">
          ...
          <div class="col px-0 align-self-center">
            ...
            <p class="text-muted size-12">Dhaka,<br />
              BD</p>
          </div>
        </div>
      </div>
...
<header class="header position-fixed header-filled">
  <div class="row">
    ...
    <div class="col">
      <div class="logo-small"> <img src="assets/img/logo.png" alt="" class="rounded-circle" />
        <h5>Attendance<br />
          <span class="text-secondary fw-light">Management</span></h5>
      </div>
    </div>
    <div class="col-auto"> <a href="" target="_self" class="btn btn-light btn-44 btn-rounded"> <i class="bi bi-bell"></i> <span class="count-indicator"></span> </a> <a href="attendance.php" target="_self" class="btn btn-light btn-44 btn-rounded ms-2"> <i class="bi bi-person-circle"></i> </a> </div>
  </div>
</header>
<!-- Header ends -->
