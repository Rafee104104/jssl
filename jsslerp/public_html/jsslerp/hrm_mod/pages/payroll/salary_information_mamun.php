			...
			<div class="row">
				...
				<?php /*?>		<div class="form-group row m-0 pb-1">
						...
						<div class="form-group row m-0 pb-1">
							...
							<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
								<input name="income_tax" type="text" id="monthly_tax" min="0" value="<?= $income_tax; ?>"  oninput="calculateSalary()" class="form-control console" />
...
<script>
	...
	function calculateSalary() {
		...
		var basicSalary = grossSalary * 0.6;
		var houseRent = grossSalary * 0.2;
	    var convenience = grossSalary * 0.2;
		...
		var taxamount = document.getElementById('monthly_tax').value;
	...
	/*	if (taxStatus === 'YES') {
        ...
        if(taxamount>0){
		var monthly_tax = parseFloat(document.getElementById("monthly_tax").value);
		}else{
		var monthly_tax = 0;
		}
		
		var totalSalary = grossSalary;
		var totalPayable = grossSalary - (pf + (monthly_tax));
