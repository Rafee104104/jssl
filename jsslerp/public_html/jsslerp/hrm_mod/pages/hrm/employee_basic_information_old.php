        ...
        <a href="home2.php" rel = "gb_page_center[940, 600]"><?=$title?></a>
            ...
            <td colspan="1" class="oe_form_group_cell" width="100%"><table width="794" border="0" cellpadding="0" cellspacing="0" class="oe_form_group ">
              <tbody>
                ...
                <tr class="oe_form_group_row">
                  <td colspan="1" bgcolor="#FFFFFF" class="oe_form_group_cell oe_form_group_cell_label"><strong>&nbsp; <span class="style1">Initial Joining Date :</span></strong></td>
                ...
                <tr class="oe_form_group_row">
                  <td colspan="1" bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label"><strong>&nbsp; Confirmation Type:</strong></td>
                  <td colspan="2" bgcolor="#E8E8E8" class="oe_form_group_cell"><select name="PBI_CON_TYPE" id="PBI_CON_TYPE">
                  ...
                  <td bgcolor="#E8E8E8" class="oe_form_group_cell"><strong>&nbsp; Due Confirmation Date </strong></td>
                  <td bgcolor="#E8E8E8" class="oe_form_group_cell"><input name="PBI_DOC" type="hidden" id="PBI_DOC" value="<?=$PBI_DOC?>" />
                    <input name="PBI_DUE_DOJ" type="text" id="PBI_DUE_DOJ" value="<?=$PBI_DUE_DOJ?>" /></td>
                </tr>
                <tr class="oe_form_group_row">
                ...
                <tr class="oe_form_group_row">
                  ...
                  <td bgcolor="#FFFFFF" class="oe_form_group_cell"><strong><span class="oe_form_group_cell oe_form_group_cell_label">&nbsp;</span> <span class="oe_form_group_cell oe_form_group_cell_label">&nbsp;</span><span class="style1">Job Location :</span></strong></td>
                ...
                <tr class="oe_form_group_row">
                  ...
                  <td class="oe_form_group_cell"><strong><span class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;<span class="style1">Job Status Date :</span></span></strong></td>
