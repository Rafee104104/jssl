...
<form  action="" method="post" enctype="multipart/form-data">
        ...
        <div class="container-fluid pt-5 p-0 ">
				<? 	$res='select '.$unique.',TRAINING_NAME as Training_Name, TRAINING_SPONSOR_ORGANIZATION as Sponsor_Organization,TRAINING_LENGTH as Training_Length from '.$table.' where PBI_ID='.$_SESSION['employee_selected'];
