                          ...
                          <div class="card">
                            ...
                            <div class="card-body">
                              ...
                              <div class="form-row">
                                  ...
                                  <input name="sector_permanent" type="text" id="sector_permanent" class="form-control" value="<?=$sector_permanent ?>" />
                                </div>
                                <div class="col-md-2 form-group">
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                        <div class="row">
                          ...
                          <div class="col-md-3 form-group">
                            <label class="label req-input" for="PBI_DOJ">Date of Joining :</label>
...
<!--                         <div class="col-md-2 form-group">
                          ...
                          <div class="col-md-2 form-group">
                            <label class="label req-input" for="define_schedule">Default Shift :</label>
