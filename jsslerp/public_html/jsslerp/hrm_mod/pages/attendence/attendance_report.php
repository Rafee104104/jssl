			...
			<div class="form-group row m-0 mb-1 pl-3 pr-3">
                    ...
                    <div class="col-sm-8 p-0">
                        <select name="PBI_ORG" id="PBI_ORG"  >
                            <option></option>
                            <? foreign_relation('user_group','id','group_name',$PBI_ORG,' 1 order by group_name');?>
                        </select>
                    </div>
                </div>
            ...
            <div class="col-sm-7">
                <div class="form-group row m-0 mb-1 pl-3 pr-3">
					...
					//	foreign_relation('personnel_basic_info','PBI_ID','PBI_NAME',$_POST['PBI_ID'],'1');
					  foreign_relation('personnel_basic_info','PBI_CODE','concat(PBI_CODE,"-",PBI_NAME)',$PBI_CODE, '1') ;
						?>
