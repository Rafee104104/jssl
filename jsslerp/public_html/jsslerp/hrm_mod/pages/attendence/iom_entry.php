...
<table align="center" class="table table-bordered table-sm">
                          <tbody><tr>
                            <td colspan="4" bgcolor="#00FF00"><div align="center" style="font-size:24px">IOM Entry </div></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            <td>
                           	<input name="PBI_ID"  type="hidden" id="PBI_ID" size="10" onblur="" tabindex="1" value="<?=$_SESSION['employee_selected']?>" required />
						   ...
						   <select name="iom_type" id="iom_type" style="width:100px;" required> 
                            ...
                            <td><input name="iom_reason"  type="text" id="iom_reason" size="10" onblur="" tabindex="1" value="<?=$iom_reason?>" /> </td>
                            <td colspan="2"> </td>
                          ...
                          <tr>
                            <td align="right"><div align="right"> Date From :</div></td>
                            <td><input type="text" name="f_date" id="f_date" value="<?=$f_date?>" /> </td>
                            <td align="right"><div align="right"> Date To :</div></td>
                            <td><input type="text" name="t_date" id="t_date" value="<?=$t_date?>" /> </td>
                          </tr>
						  
					
                          <tr>
                            <td colspan="4"><div align="center">
							<input name="view_data" type="submit"  id="view_data" class="btn1 btn1-bg-update" value="CHECK IOM" />
