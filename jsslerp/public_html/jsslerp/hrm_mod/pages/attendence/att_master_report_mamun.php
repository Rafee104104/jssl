...
<!-- 		 <tr>
		...
		<th width="13%" bgcolor="#FFFACD">Emp-Code</th>
		...
		<th width="13%" bgcolor="#FFFACD">Employee Type</th>

		



		<th width="18%" bgcolor="#FFFACD">Designation</th>



		<th width="18%" bgcolor="#FFFACD">Date</th>



		<th width="22%" bgcolor="#FFFACD">In Time</th>



		<th width="25%" bgcolor="#FFFACD">Out Time</th>



		<th width="8%" bgcolor="#FFFACD">Schedule</th>
...
$emp_status_con .= ' and p.PBI_JOB_STATUS = "'.$_POST['JOB_STATUS'].'" ';
	...
	$sql="select p.* from personnel_basic_info p where 1 ".$dept_con.$desg_con.$emp_status_con.$section_con.$org_con." order by p.DEPT_ID";
   ...
   <!--      </tr> -->
       ...
       $min_time[$info->xenrollid]=$info->min_time;
        ...
        $org_con .= " and p.PBI_ORG = '".$_POST['PBI_ORG']."'";
		 ...
		 $sql="select p.* from personnel_basic_info p where 1 ".$dept_con.$desg_con.$section_con.$desg_con.$org_con."";
...

{
		...
		<th width="8%" bgcolor="#FFFACD">Date</th>
...
<?  } //} ?>
   ...
   ?>
       ...
       $min_time[$info->xenrollid]=$info->min_time;
		 ...
		 echo $sql = "select xenrollid,  max(xtime) as max_time  from hrm_attdump where xdate ='".$t_date."' group by xenrollid ";
...
<?  } }?>
...

 {
 		...
 		<th width="10%" bgcolor="#FFFACD">Employee Name</th>
        ...
        <th width="10%" bgcolor="#FFFACD">Department</th>
 		...
 		<th width="10%" bgcolor="#FFFACD">Date</th>
 		...
 		<th width="10%" bgcolor="#FFFACD">Status</th>
		...
		<td  width="50%" style="border:0px; border-color:white;">
			...
			<table width="100%"  >
				...
				<tr align="center" >
					...
					<?=find_a_field('user_group','group_name','id='.$_SESSION['proj_id'])?></strong></td>
