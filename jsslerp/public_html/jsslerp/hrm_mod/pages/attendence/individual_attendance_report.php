...
$module_name = find_a_field('user_module_manage','module_file','id='.$_SESSION["mod"]);
    ...
    <table width="100%" class="table1 table-bordered table-sm" cellspacing="0" cellpadding="0" id="grp">
      ...
      <?
		...
		$val[$data->att_date]['ot_final_min'] = $data->ot_final_min;
     ...
     //iom start time
      ...
      $dteDiff  = $dteStart->diff($dteEnd);
                    ...
                    {$bgcolor = '#66CDAA';$PRESENT++;}
                    else
                    {$bgcolor = '#F70D1A';  $PRESENT++; $absent++;
        ...
        <td bgcolor="<?=$bgcolor?>"></td>
        <?php } ?>	
		<td bgcolor="<?=$bgcolor?>"><?=round($val[$day_date]['ot_final_min']);?></td>
