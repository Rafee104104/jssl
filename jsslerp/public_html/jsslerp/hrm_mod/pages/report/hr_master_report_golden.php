...
<table id="" width="100%" cellspacing="0" cellpadding="2" border="0">
  ...
  <thead>
    ...
    <tr>
      ...
      <th colspan="2"><div align="center">Salary and Allowance</div></th>
...
$salaryCon .=' and a.PBI_JOB_STATUS="'.$_POST['job_status'].'"';
 echo $sqld = 'select t.*, a.PBI_ID,a.PBI_CODE,a.PBI_NAME, a.PBI_DOJ, d.DESG_SHORT_NAME as Designation
...
?>
    ...
    <?php /*?>  <td><?  $dd = 'select s_date,e_date from hrm_leave_info where s_date>="'.$m_s_date.'" and PBI_ID="'.$data->PBI_ID.'" and leave_status="GRANTED" and type in (1)';
...
?></td><?php */?>
     ...
     <?php /*?> <td><?  $dd = 'select s_date,e_date from hrm_leave_info where s_date>="'.$m_s_date.'" and PBI_ID="'.$data->PBI_ID.'" and leave_status="GRANTED" and type in (2)';
				$dumping = mysql_query($dd);
...
?></td><?php */?>
     ...
     <?php /*?> <td><?  $dd = 'select s_date,e_date from hrm_leave_info where s_date>="'.$m_s_date.'" and PBI_ID="'.$data->PBI_ID.'" and leave_status="GRANTED" and type in (3)';
				$dumping = mysql_query($dd);
...
$hr_action_remarks = find_a_field('admin_action_detail','ADMIN_ACTION_SUBJECT','EFFECT_MON="'.$_POST['mon'].'" and EFFECT_YEAR="'.$_POST['year'].'" and PBI_ID="'.$data->PBI_ID.'" ');
  ...
  ?>
    ...
    <tr>
      ...
      <td align="right" colspan="7" style="font-weight:bold;">Total:</td>
