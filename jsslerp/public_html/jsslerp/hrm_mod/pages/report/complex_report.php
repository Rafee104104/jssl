					...
					<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
						<div class="container n-form2">
							...
							<div class="form-group row m-0 pb-1">
								...
								<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
									<?php /*?><select name="domain" id="domain">
									  <option></option>
						...
						<div class="container n-form2">
							<div class="form-group row m-0 pb-1">
								<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text"></label>
								<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
									<?php /*?><select name="personal_file_status" id="personal_file_status" >
							...
							<div class="form-group row m-0 pb-1">
								...
								<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
									<select name="blood_group"  id="blood_group">
										<option></option>
										<? 	foreign_relation('personnel_basic_info','PBI_ID','PBI_BLOOD_GROUP',$blood_group, '1 group by PBI_BLOOD_GROUP');
										?>		
									</select>
								</div>
							</div>
						...
						<div class="container n-form2">
							<div class="form-group row m-0 pb-1">
								<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text"></label>
								<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
									<?php /*?><select name="PBI_SPECIALTY" id="PBI_SPECIALTY" >
										<option>
										  <?=$PBI_SPECIALTY?>
										</option>
							...
							<div class="form-group row m-0 pb-1">
								<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text"></label>
								<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
									<?php /*?><select name="functional_designation">
							...
							<div class="form-group row m-0 pb-1">
								<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Joining Date</label>
								<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
									<select name="joining">
										<option selected></option>
										<? foreign_relation('personnel_basic_info','PBI_ID','PBI_DOJ',$PBI_DOJ,'1 order by PBI_DOJ');?>								
									</select>
								</div>
							</div>
					...
					<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
							...
							<div class="form-group row m-0 pb-1">
								...
								<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
									<select name="project" id="project">
										<option></option>
										<? foreign_relation('project','PROJECT_ID','PROJECT_NAME',$PBI_PROJECT, ' 1 group by PROJECT_NAME');?>
									  </select>
								</div>
							</div>
						...
						<div class="container n-form2">
							<div class="form-group row m-0 pb-1">
								<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text"></label>
								<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
									<?php /*?><select name="region"  id="region">
									<option></option>
							...
							<div class="form-group row m-0 pb-1">
								<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text"></label>
								<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
									<?php /*?><select name="DESG_GRADE2"  id="DESG_GRADE2">
										  <option></option>								
						...
						<div class="container n-form2">
							...
							<div class="form-group row m-0 pb-1">
								<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text"></label>
								<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
									<?php /*?><select name="code_class" id="code_class">
									</select><?php */?>
								</div>
							</div>
							...
							<div class="form-group row m-0 pb-1">
								...
								<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
									<select name="employee_type">
										<? foreign_relation('personnel_basic_info','employee_type','employee_type',$employee_type,'1 group by employee_type');?>
									</select>
								</div>
							</div>
						</div>
