...
<form action="../report/hr_master_report_golden.php" target="_blank" method="post">
...
<!--            table start hear-->
            <table class="table1  table-striped table-bordered table-hover table-sm">
                ...
                <tr>
					<td><input type="radio"  id="report" name="report" value="78" checked="checked"/></td>
                    <td class="bold" align="left"> <label for="2">Salary Report</label> </td>
					
                    <td><input type="radio" "id="report" name="report" value="202" /></td>
