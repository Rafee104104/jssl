...
<form action="../report/master_report_golden.php" target="_blank" method="post">
...
<!--            <td><input type="radio" id="8" placeholder="test 2" id="report" name="report" value="79" /></td>
            ...
            <td><input type="radio" placeholder="test 2" id="1" name="report" value="1" checked="checked" /></td>
