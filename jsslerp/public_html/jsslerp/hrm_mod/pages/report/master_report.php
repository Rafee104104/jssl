...
$DEPARTMENT_con=' and a.PBI_DEPARTMENT = "'.$_POST['department'].'"';
  ...
  if($_POST['PBI_ORG']!='')
    ...
    if($_POST['PBI_ID']!='')
	$con.=' and a.PBI_CODE = "'.$_POST['PBI_ID'].'"';
...
a.PBI_JOB_STATUS as PBI_JOB_STATUS,
...
b.ta other_allowance,b.mobile_allowance,b.entertainment,b.food_allowance,
  ...
  <table width="100%" cellspacing="0" cellpadding="2" border="1" id="ExportTable">
    <thead>
      <tr>
        ...
        <th rowspan="2"><div align="center">Arrear</div></th>
		<th rowspan="2"><div align="center">OT Allowance</div></th>
        <th rowspan="2"><div align="center">Total Payment</div></th>
        <th colspan="8" align="center"><div align="center">Deduction</div></th>
        <th rowspan="2"><div align="center">Total Deduction </div></th>
        <th rowspan="2" align="center"><div align="center">Net Payable Salary </div></th>
...
?>
      <tr>
        ...
        <td align="right"><?=($data->salary_arrear>0)? $data->salary_arrear : '';     $totArrear += $data->salary_arrear?></td>
		<td align="right"><?=($data->over_time_amount>0)? $data->over_time_amount : '';     $totOT += $data->over_time_amount?></td>
        <td align="right"><?=($data->total_salary>0)? $data->total_salary : '';     $totSalary += $data->total_salary?></td>
        <td align="right"><?=($data->income_tax>0)? $data->income_tax : '';                   $totIincomeTax += $data->income_tax?></td>
        <td align="right"><?=($data->pf>0)? $data->pf : '';         $totPfDeduct += $data->pf?></td>
        <td align="right"><?=($data->pf_loan>0)? $data->pf_loan : '';           $totPfLoan += $data->pf_loan?></td>
      ...
      <tr>
        ...
        <td align="right"><strong><?=($totArrear>0)? number_format($totArrear,0) : '';?></strong></td>
		<td align="right"><strong><?=($totOT>0)? number_format($totOT,0) : '';?></strong></td>
        <td align="right"><strong><?=($totSalary>0)? number_format($totSalary,0) : '';?></strong></td>
        <td align="right"><strong><?=($totIincomeTax>0)? number_format($totIincomeTax,0) : '';?></strong></td>
        <td align="right"><strong><?=($totPfDeduct>0)? number_format($totPfDeduct,0) : '';?></strong></td>
