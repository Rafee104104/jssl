...
?>
 ...
 //foreign_relation('personnel_basic_info','PBI_ID','concat(PBI_ID," - ",PBI_NAME)',$emp_id,'1');
  ...
  <?php /*?> <input list="Search" name="emp_id" class="form-control" placeholder="Search">
      <datalist id="Search">
    <?php
     $sql = mysql_query("SELECT * FROM personnel_basic_info where 1 ");
...
?>			  
                        ...
                        <tr>
                          <td><?=++$s?></td>
                          <td><?=$data->PBI_NAME?></td>
						  <td><img src="../../../hrm_mod/pic/staff/<?=$data->emp_id?>.jpeg" class="avatar" alt="Avatar"></td>
...
<script>
	$(document).ready(function(){
		...
		$('.manage_establishment').click(function(){
			uni_modal("Manage Individual","./asset/manage.php?id="+$(this).attr('data-id'))
		})
