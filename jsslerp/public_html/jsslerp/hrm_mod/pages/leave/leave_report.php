                        ...
                        <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6" >
                            ...
                            <div class="form-group row m-0 mb-1 pl-3 pr-3">
                                ...
                                <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
                                    ...
                                    <input type="text" name="s_date" id="s_date" placeholder="From" value="<?=$s_date?>" required  autocomplete="off"/ >
                            ...
                            <div class="form-group row m-0 mb-1 pl-3 pr-3">
                               ...
                               <input type="text" name="e_date" id="e_date" placeholder="To" value="<?=$e_date?>" required autocomplete="off"/  >
