...
// ::::: Edit This Section ::::: 
$title='Level Type Information';			// Page Name and Page Title
...
{		
$now				= time();
$_POST['level_name'] = $_POST['level_name'];
$crud->insert();
$type=1;
...
<body>
   ...
   <td bgcolor="#E8E8E8" width="21%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Lavel :</td>
                  <td bgcolor="#E8E8E8" width="79%" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                  <input name="level_name" type="text" id="level_name" value="<?=$level_name?>" required /></td>
