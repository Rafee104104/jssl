...
<?php } ?>
<?php if (mysql_num_rows($queryd) < 8) { ?>
<?php for ($i = mysql_num_rows($queryd); $i < 8; $i++) { ?>
<div class="col-sm-4 col-lg-4 col-md-4 pt-1 pb-1">
...
<?php } ?>
<?php if (mysql_num_rows($queryd2) < 8) { ?>
<?php for ($i = mysql_num_rows($queryd2); $i < 8; $i++) { ?>
<div class="col-sm-4 col-lg-4 col-md-4 pt-1 pb-1">
<img src="null.png" style="border-radius: 50%;height:60px;width: 100%; padding: 0px 10px;" />
<h5 class="bold" style="margin: 0px; padding: 5px; text-align: center; font-size: 9px;">NULL</h5>
</div>
...
<? } ?> 								
<?php if (mysql_num_rows($queryd3) < 8) { ?>
<?php for ($i = mysql_num_rows($queryd3); $i < 8; $i++) { ?>
<div class="col-sm-4 col-lg-4 col-md-4 pt-1 pb-1">
<img src="null.png" style="border-radius: 50%;height:60px;width: 100%; padding: 0px 10px;" />
<h5 class="bold" style="margin: 0px; padding: 5px; text-align: center; font-size: 9px;">NULL</h5>
</div>
