...
basic_salary="'.$_POST['new_basic_salary'].'" WHERE PBI_ID='.$_SESSION['employee_selected'];
mysql_query($u_sql);
                              ...
                              <tbody>
                                <tr class="oe_form_group_row">
                                  ...
                                  <td  width="33%" colspan="1" class="oe_form_group_cell"><input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                                    <select name="INCREMENT_TYPE" required="required">
                                      <? foreign_relation('increment_type','TYPE_CODE','INCREMENT_TYPE',$INCREMENT_TYPE);?>
                                    </select>                                  </td>
