...
$res='select s.id,s.id, u.group_name,s.schedule_name,s.office_start_time,s.office_end_time,s.status,s.tolerance_time 
from hrm_schedule_info s, user_group u 
where u.id = s.group_for 
order by u.group_name,s.office_start_time';
