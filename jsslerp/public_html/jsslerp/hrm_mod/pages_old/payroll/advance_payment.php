...
<? }?>
                ...
                <tr class="oe_form_group_row">
                  ...
                  <td bgcolor="#FFFFFF" colspan="1" class="oe_form_group_cell">&nbsp;</td>
                  <td colspan="1" bgcolor="#FFFFFF" class="oe_form_group_cell_label oe_form_group_cell"><strong>Balance Amt. : </strong></td>
                  <td bgcolor="#FFFFFF" class="oe_form_group_cell">
<? 
echo 'am='.$advance_amt;
echo($advance_amt - find_a_field('salary_attendence','sum(advance_install)','PBI_ID='.$_SESSION['employee_selected']));
?></td>
                </tr>
                <tr class="oe_form_group_row">
