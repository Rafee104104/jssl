...
<option <?=($start_year=='2020')?'selected':''?>>2020</option>
<option <?=($start_year=='2021')?'selected':''?>>2021</option>
<option <?=($start_year=='2022')?'selected':''?>>2022</option>
<option <?=($start_year=='2023')?'selected':''?>>2023</option>
<option <?=($start_year=='2024')?'selected':''?>>2024</option>
<option <?=($start_year=='2025')?'selected':''?>>2025</option>
<option <?=($start_year=='2026')?'selected':''?>>2026</option>
<option <?=($start_year=='2027')?'selected':''?>>2027</option>
<option <?=($start_year=='2028')?'selected':''?>>2028</option>
<option <?=($start_year=='2029')?'selected':''?>>2029</option>
<option <?=($start_year=='2030')?'selected':''?>>2030</option>
<option <?=($start_year=='2031')?'selected':''?>>2031</option>
<option <?=($start_year=='2032')?'selected':''?>>2032</option>
<option <?=($start_year=='2033')?'selected':''?>>2033</option>
<option <?=($start_year=='2034')?'selected':''?>>2034</option>
<option <?=($start_year=='2035')?'selected':''?>>2035</option>
<option <?=($start_year=='2036')?'selected':''?>>2036</option>
<option <?=($start_year=='2037')?'selected':''?>>2037</option>
<option <?=($start_year=='2038')?'selected':''?>>2038</option>
<option <?=($start_year=='2039')?'selected':''?>>2039</option>
<option <?=($start_year=='2040')?'selected':''?>>2040</option>
...
<input name="current_year" type="text" id="current_year" value="<?=$current_year?>" required />
</td>
</tr>
<? }?>
                <tr class="oe_form_group_row">
