                                ...
                                <tr class="oe_form_group_row">
                                  <td class="oe_form_group_cell"><table width="100%" height="279" border="0" cellpadding="0" cellspacing="0" class="oe_form_group ">
                                      <tbody>
                                        ...
                                        <tr class="oe_form_group_row">
                                          <td bgcolor="#E8E8E8" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;<span class="style2">Incentive Allowance :</span></td>
<td bgcolor="#E8E8E8" class="oe_form_group_cell">
<input name="incentive_allowance" type="text" id="incentive_allowance" value="<?=$incentive_allowance?>" /></td>
                                        ...
                                        <tr class="oe_form_group_row">
                                          ...
                                          <td bgcolor="#E8E8E8" class="oe_form_group_cell"><select name="cash_bank">
                                              ...
                                              <option <?=($cash_bank=='IBBL')?'selected':'';?>>IBBL</option>
                                              <option <?=($cash_bank=='NCC')?'selected':'';?>>NCC</option>
											  <option <?=($cash_bank=='EBL')?'selected':'';?>>EBL</option>
											  <option <?=($cash_bank=='Prime')?'selected':'';?>>Prime</option>
                                            </select></td>
                                        </tr>
                                        <tr class="oe_form_group_row">
                                        ...
                                        <tr class="oe_form_group_row">
                                          ...
                                          <td bgcolor="#E8E8E8" class="oe_form_group_cell"><select name="mobile_allowance_rules" id="mobile_allowance_rules">
                                              <option selected value="<?=$mobile_allowance_rules?>">
                                              <?=$mobile_allowance_rules?>
                                              </option>
...
<td bgcolor="#FFFFFF" class="oe_form_group_cell"><input name="medical_allowance" type="text" id="medical_allowance" value="<?=$medical_allowance?>" /></td>-->
						...
						?>
                                            <?=find_a_field('dealer_info','concat( dealer_code ,"-",dealer_name_e,"(",product_group,")")','product_group="'.$group_code.'" and area_code="'.$area_code.'"')?>
                                            &nbsp;-&nbsp;
                                            <?=find_a_field('area','AREA_NAME','AREA_CODE='.$area_code)?>
                                            <? }?></td>
                                        </tr>
                                        <tr class="oe_form_group_row">
                                          ...
                                          <td bgcolor="#FFFFFF" class="oe_form_group_cell"><select name="vehicle_allowance_rules" id="vehicle_allowance_rules">
                                              <option selected value="<?=$vehicle_allowance_rules?>">
                                              <?=$vehicle_allowance_rules?>
                                              </option>
                                        ...
                                        <tr class="oe_form_group_row">
                                          ...
                                          <td bgcolor="#FFCCFF" class="oe_form_group_cell"><input name="mobile_ceiling2" type="text" class="style1" id="mobile_ceiling2" value="<?=($consolidated_salary!=0)?($consolidated_salary+$special_allowance):($basic_salary+$special_allowance+$house_rent+$ta+$mobile_allowance+$medical_allowance+$vehicle_allowance+($food_allowance*30))?>" readonly="" /></td>
                                          <td colspan="1" bgcolor="#FFCCFF" class="oe_form_group_cell_label oe_form_group_cell"><strong>Total Payable : </strong></td>
                                          <td bgcolor="#FFCCFF" class="oe_form_group_cell"><input name="total_payable" type="text" class="style1" id="total_payable" value="<?=($basic_salary+$special_allowance+$vehicle_allowance+$house_rent)?>" readonly="" /></td>
                                        </tr>
                                        <tr class="oe_form_group_row">
