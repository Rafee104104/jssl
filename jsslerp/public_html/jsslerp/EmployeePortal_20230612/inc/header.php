...
<link href="assets/scss/custom.css?version=1.0.1.1" rel="stylesheet" id="style">
      ...
      <div class="col-12 profile-sidebar">
        ...
        <div class="row">
		  ...
		  <img src="../../../assets/support/upload_view.php?name=<?=$image_path?>&folder=hrm_emp_pic&proj_id=<?=$cid1?>&mod=hrm_mod" alt="#">   
            ...
            <figure class="avatar avatar-100 rounded-15 shadow-sm"> <img src="assets/img/user1.jpg" alt=""> </figure>
