...
if(($ext2=='jpg' || $ext2=='jpeg' || $ext2=='pdf' || $ext2=='png' || $ext2=='pjp' || $ext2=='jfif' || $ext2=='pjpeg')){
...
function auto_insert_sales_chalan_secoundary_jssl($chalan_no)

{
	...
	echo $sql = "select sum(total_amt) as total_amt from sale_do_chalan c where  chalan_no=".$chalan_no;
	...
	add_to_sec_journal($proj_id, $jv_no, $jv_date, $dealer_ledger, $narration, ($invoice_amt+$transport_cost), '0', $tr_from, $tr_no,'',$tr_id,$cc_code,$group_for);
	...
	add_to_sec_journal($proj_id, $jv_no, $jv_date, $config_ledger->transport_challan, $narration, '0', ($transport_cost), $tr_from, $tr_no,'',$tr_id,$cc_code,$group_for);
