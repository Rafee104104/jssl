...
<link href="../../../dashboard_assets/css/new_new.css?v=2.1.2" rel="stylesheet" />
<style type="text/css">
...
<div class="wrapper">
			<div class="body_box">
						...
						<span class="title-image text-center" style="padding: 5px;"><img src="../../../logo/<?=$_SESSION['user']['group']?>.png" style="width:35%;"></span></div>
