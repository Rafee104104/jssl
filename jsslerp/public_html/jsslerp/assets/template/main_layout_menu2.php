...
$user_id=$_SESSION['user']['id'];
$module_sql='select m.module_name,m.id,m.module_link,m.module_icon_img,m.module_menu_icon,d.module_id,d.user_id from user_module_define d,user_module_manage m where d.module_id=m.id and d.status="enable" and d.user_id="'.$user_id.'" and m.id!='.$mod_id.' ';
...
<!--                                 <li class="li1 mt-1"><a href="../../../--><?//=$module_data->module_link;?><!--?mod_id=--><?//=$module_data->module_id;?><!--"><img src="../../../home/--><?//=$module_data->module_icon_img?><!--" style="width: 50%;position: absolute; left: 10px; padding-top: 5px;"></a><ul class="ul2"><li class="li2">--><?//=$module_data->module_name; ?><!--</li></ul></li>-->
                                 <li class="li1">
                                         ...
                                         <a href="../../../<?=$module_data->module_link;?>?mod_id=<?=$module_data->module_id;?>" class="menu-moule-icon" style="padding: 0px;    line-height: 0.0em !important;">
<!--                                         <a href="../../../--><?//=$module_data->module_link;?><!--?mod_id=--><?//=$module_data->module_id;?><!--" class="menu-moule-icon" style="padding: 0px;    line-height: 2.2em !important;">-->

                                             <!--                                             <img src="../../../home/module_icon/--><?//=$module_data->module_menu_icon?><!--" style="width: 75%;position: absolute; left: 7px; padding-top: 3px; ">-->
...
<!--                            </footer>-->
						...
						<!--			<img src="../../../logo/<?=$_SESSION['proj_id']?>.png" style="width:65%;" height="50px">-->
									<img src="../../../logo/<?=$_SESSION['user']['group']?>.png" class="logo-menu-cid-class">
								</div>
							</a>
