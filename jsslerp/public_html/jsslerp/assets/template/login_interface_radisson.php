    ...
    <style type="text/css">
        ...
        *{
        ...
        body{
			...
			background: linear-gradient(45deg,#060952,#090fa1,#0b0b4a,#1c1c8f);
			
			
			
/*			  background-image: url("../../../assets/images/login/radisson.png");
...
<!--                            <p>Lorem ipsuing elit. Molomos totam est voluptatum i omos totam est voluptatum i ure sit consectetur ill</p>-->
                            <!--<img src="../../../assets/images/login/erp001.png" width="100%" height="100%">-->
                        </div>
                    </div>
                </div>
            </div>
