...
<nav class="navbar navbar-expand-md navbar-light mb-1" id="menu-sr-1">
    <a href="#" class="navbar-brand" style="overflow: hidden !important;padding: 0;margin-left: 0px;"> 
		<img src="../../../logo/<?=$_SESSION['proj_id']?>.png" style="height: 100%;width: 100%;"> 
    </a>
    ...
    <div class="navbar-collapse collapse justify-content-stretch" id="navbar6">
        <ul class="navbar-nav">
                <?php if($title == Dashboard){?>
                            <li class="nav-item active">
                                <a class="nav-link titel_x m-0 pl-0 pr-0 text-capitalize" style="font-size: 14px; font-weight: 500;">
                                    <?=find_a_field('user_group','group_name','id='.$_SESSION['user']['group']);//echo $_SESSION['company_name']; ?>
                                 </a>
                            </li>
                 <? } else { ?>
                             <li class="nav-item active">
        ...
        <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown text-center">
                ...
                <div class="dropdown-menu Profile-set" aria-labelledby="navbarDropdown">
                    <div class="d-flex dropdown-item justify-content-between">
                        ...
                        <div class="sign_out">
                            <a href="../../../login/pages/main/logout.php" class="a"><i class="fa-regular fa-power-off"></i> </a>
                        </div>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                <div class="nav-link titel_x" id="clock" align="center">
