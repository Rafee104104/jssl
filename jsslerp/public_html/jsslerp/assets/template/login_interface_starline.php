    ...
    <style type="text/css">
        ...
        *{
        ...
        body{
			...
			background: linear-gradient(45deg,#ee2722,#fddb04);
        }
        .AppFormLeft{
            width: 300px;
        }
        ...
        .AppForm .AppFormLeft button{
            background: linear-gradient(45deg,#ff4b3c,#fdd605);
			/*background: #3940EB;*/
            border-radius: 30px;
        }
        ...
        .AppForm .AppFormRight{
           ...
           /* background-color: #e41a4c;*/
			...
			background: linear-gradient(45deg,#feee00,#ee1f24);
            height: 100%;
            /*height: 450px;*/
...
<!--                            <p>Lorem ipsuing elit. Molomos totam est voluptatum i omos totam est voluptatum i ure sit consectetur ill</p>-->
                            <img src="../../../assets/images/login/starline.png" width="100%">
