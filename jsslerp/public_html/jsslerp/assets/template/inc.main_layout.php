...
<div class="wrapper" style=" background-color: #ffffff;">
			<div class="body_box">
                ...
                if($temp->template_id==1){?>
                    ...
                    <div class="sidebar" style=" height:100%; overflow:scroll; scrollbar-width: none;" >
                        <div class="title-image text-center" style="padding: 5px;">
                            ...
                            <? include("../../../assets/template/main_layout_menu.php");?>
                        </div>
                    </div>
                ...
                elseif($temp->template_id==2){?>
						...
						<? include("../../../assets/template/main_layout_menu2.php");?>

                <?php
                }
				
                elseif($temp->template_id==3){?>
						<? include("../../../assets/template/main_layout_menu3.php");?>
                            ...
                            <div class="sr-main-content">
                                <div class="sr-main-content-padding" style="background-color: #fafafa;">
                                    <div class="sr-main-content-heading">
                                        <i class="fa-solid fa-database" style="padding-right:10px;"></i><?=$title?>
...
<div class="sr-main-content">
<div class="sr-main-content-padding" style="background-color: #fafafa;"><div class="sr-main-content-heading"><i class="fa-solid fa-database" style="padding-right:10px;"></i><?=$title?>
<? if($add_button_bar=='Mhafuz'){?>
